...
exports.generateSchools = generateSchools;
const SCHOOL_TYPES = [
    'Elementary',
    'Middle',
    'High',
...
function generateSchools(districtIds, schoolsPerDistrict) {
    const schools = [];
    let schoolCounter = 0;
    for (const districtId of districtIds) {
        for (let i = 0; i < schoolsPerDistrict; i++) {
            ...
            const enrollmentBase = schoolType === 'Elementary'
                ? 400
                : schoolType === 'Middle'
                    ? 600
                    : 1200;
...
//# sourceMappingURL=schools.seed.js.map