...
exports.ReminderGeneratorService = void 0;
const common_1 = require("@nestjs/common");
const base_1 = require("../../../common/base");
const sequelize_1 = require("@nestjs/sequelize");
const sequelize_2 = require("sequelize");
let ReminderGeneratorService = class ReminderGeneratorService extends base_1.BaseService {
    sequelize;
    ...
    async generateRemindersOptimized(date, organizationId, studentId, medicationId) {
        ...
        const reminders = await this.sequelize.query(`
...
exports.ReminderGeneratorService = ReminderGeneratorService;
exports.ReminderGeneratorService = ReminderGeneratorService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, sequelize_1.InjectConnection)()),
    __metadata("design:paramtypes", [sequelize_2.Sequelize])
], ReminderGeneratorService);
//# sourceMappingURL=reminder-generator.service.js.map