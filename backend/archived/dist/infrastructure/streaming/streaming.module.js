...
const streaming_query_service_1 = require("./streaming-query.service");
...
exports.StreamingModule = StreamingModule = __decorate([
    (0, common_1.Module)({
        providers: [streaming_query_service_1.StreamingQueryService],
        exports: [streaming_query_service_1.StreamingQueryService],
    })
], StreamingModule);
