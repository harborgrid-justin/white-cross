...
exports.ALL_RESPONSE_DTOS = exports.PHASE_2_RESPONSE_DTOS = exports.ERROR_RESPONSE_DTOS = void 0;
exports.createSwaggerConfig = createSwaggerConfig;
exports.addGlobalSchemas = addGlobalSchemas;
const swagger_1 = require("@nestjs/swagger");
const error_response_dto_1 = require("../dto/error-response.dto");
const student_response_dto_1 = require("../../services/student/dto/student-response.dto");
const appointment_response_dto_1 = require("../../services/appointment/dto/appointment-response.dto");
const medication_response_dto_1 = require("../../services/medication/dto/medication-response.dto");
const health_record_response_dto_1 = require("../../health-record/dto/health-record-response.dto");
const vaccination_response_dto_1 = require("../../health-record/vaccination/dto/vaccination-response.dto");
const allergy_response_dto_1 = require("../../health-record/allergy/dto/allergy-response.dto");
const user_response_dto_1 = require("../../services/user/dto/user-response.dto");
const auth_response_dto_1 = require("../../services/auth/dto/auth-response.dto");
const api_key_response_dto_1 = require("../../api-key-auth/dto/api-key-response.dto");
const emergency_broadcast_response_dto_1 = require("../../services/communication/emergency-broadcast/dto/emergency-broadcast-response.dto");
const emergency_template_response_dto_1 = require("../../services/communication/emergency-broadcast/dto/emergency-template-response.dto");
const broadcast_status_response_dto_1 = require("../../services/communication/emergency-broadcast/dto/broadcast-status-response.dto");
const send_broadcast_response_dto_1 = require("../../services/communication/emergency-broadcast/dto/send-broadcast-response.dto");
...
function createSwaggerConfig() {
    return new swagger_1.DocumentBuilder()
        ...
        .setDescription('Comprehensive HIPAA-compliant API for school health management systems. ' +
        ...
        .setVersion('1.0')
        .setContact('White Cross Support', 'https://whitecross.health', 'support@whitecross.health')
...
exports.ERROR_RESPONSE_DTOS = [
    error_response_dto_1.ErrorResponseDto,
    error_response_dto_1.ValidationErrorResponseDto,
    error_response_dto_1.ValidationErrorDetailDto,
    error_response_dto_1.BusinessErrorResponseDto,
    error_response_dto_1.HealthcareErrorResponseDto,
    error_response_dto_1.SecurityErrorResponseDto,
    error_response_dto_1.SystemErrorResponseDto,
    error_response_dto_1.DatabaseErrorResponseDto,
];
exports.PHASE_2_RESPONSE_DTOS = [
    student_response_dto_1.StudentResponseDto,
    student_response_dto_1.StudentDetailResponseDto,
    student_response_dto_1.PaginatedStudentResponseDto,
    appointment_response_dto_1.AppointmentResponseDto,
    appointment_response_dto_1.AppointmentDetailResponseDto,
    appointment_response_dto_1.PaginatedAppointmentResponseDto,
    medication_response_dto_1.MedicationResponseDto,
    medication_response_dto_1.MedicationDetailResponseDto,
    medication_response_dto_1.PaginatedMedicationResponseDto,
    health_record_response_dto_1.HealthRecordResponseDto,
    health_record_response_dto_1.HealthRecordDetailResponseDto,
    health_record_response_dto_1.PaginatedHealthRecordResponseDto,
    vaccination_response_dto_1.VaccinationResponseDto,
    vaccination_response_dto_1.VaccinationDetailResponseDto,
    vaccination_response_dto_1.PaginatedVaccinationResponseDto,
    allergy_response_dto_1.AllergyResponseDto,
    allergy_response_dto_1.AllergyDetailResponseDto,
    allergy_response_dto_1.PaginatedAllergyResponseDto,
    user_response_dto_1.UserResponseDto,
    auth_response_dto_1.AuthResponseDto,
    api_key_response_dto_1.ApiKeyResponseDto,
    emergency_broadcast_response_dto_1.EmergencyBroadcastResponseDto,
    emergency_template_response_dto_1.EmergencyTemplateResponseDto,
    broadcast_status_response_dto_1.BroadcastStatusResponseDto,
    send_broadcast_response_dto_1.SendBroadcastResponseDto,
    paginated_response_dto_1.PaginatedResponseDto,
];
exports.ALL_RESPONSE_DTOS = [
    ...exports.ERROR_RESPONSE_DTOS,
    ...exports.PHASE_2_RESPONSE_DTOS,
];
function addGlobalSchemas(document) {
