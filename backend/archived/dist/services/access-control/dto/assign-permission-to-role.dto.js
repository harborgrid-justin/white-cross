...
class AssignPermissionToRoleDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { permissionId: { required: true, type: () => String, format: "uuid" } };
    }
}
...
__decorate([
    ...
    (0, class_validator_1.IsUUID)('4', { message: 'Permission ID must be a valid UUID' }),
    __metadata("design:type", String)
], AssignPermissionToRoleDto.prototype, "permissionId", void 0);
//# sourceMappingURL=assign-permission-to-role.dto.js.map