...
class CreateInventoryItemDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String, maxLength: 255 }, category: { required: true, type: () => String, maxLength: 100 }, description: { required: false, type: () => String }, sku: { required: false, type: () => String, maxLength: 100 }, supplier: { required: false, type: () => String, maxLength: 255 }, unitCost: { required: false, type: () => Number, minimum: 0 }, reorderLevel: { required: true, type: () => Number, minimum: 0 }, reorderQuantity: { required: true, type: () => Number, minimum: 1 }, location: { required: false, type: () => String, maxLength: 255 }, notes: { required: false, type: () => String } };
    }
}
exports.CreateInventoryItemDto = CreateInventoryItemDto;
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Item name', example: 'Ibuprofen 200mg' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MaxLength)(255),
    __metadata("design:type", String)
], CreateInventoryItemDto.prototype, "name", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Item category', example: 'MEDICATION' }),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'SKU/Product code', example: 'IBU-200' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MaxLength)(100),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Unit cost', example: 5.99 }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Reorder level (trigger point)', example: 50 }),
