...
export class PrescriptionController {
  ...
  async findActiveByStudent(@Param('studentId') studentId: string): Promise<Prescription[]> {
  ...
  @ApiResponse({ status: 404, description: 'Prescription not found' })
  async update(@Param('id') id: string, @Body() updateDto: UpdatePrescriptionDto): Promise<Prescription> {
  ...
  @ApiResponse({ status: 404, description: 'Prescription not found' })
  async fill(@Param('id') id: string, @Body() fillDto: FillPrescriptionDto): Promise<Prescription> {
