...
export class AllExceptionsFilter implements ExceptionFilter {
  ...
  constructor(
    ...
    // Get request ID from context (generated by RequestContextMiddleware)
    // Falls back to header if context not available
    const requestId =
      getRequestId() ||
  ...
  private extractErrorInfo(
    ...
    if (isHttpException) {
      ...
      return {
        ...
        errorCode:
          responseObj.errorCode || SystemErrorCodes.INTERNAL_SERVER_ERROR,
      };
    }
  ...
  private logError(
    ...
    // Get context from AsyncLocalStorage or fall back to request object
