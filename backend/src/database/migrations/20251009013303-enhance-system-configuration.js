...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    try {
      ...
      // =====================================================
      // STEP 2: Create or alter ConfigCategory enum
      // =====================================================

      // Check if ConfigCategory exists, if not create it with base values
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE "ConfigCategory" AS ENUM ('GENERAL', 'SECURITY', 'NOTIFICATION');
        EXCEPTION
