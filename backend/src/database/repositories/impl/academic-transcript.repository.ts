...
@Injectable()
export class AcademicTranscriptRepository extends BaseRepository<
  AcademicTranscript,
  AcademicTranscriptAttributes,
  CreateAcademicTranscriptDTO
> {
  constructor(
  ...
  protected async validateCreate(
    data: CreateAcademicTranscriptDTO,
  ): Promise<void> {
  ...
  protected async validateUpdate(
    id: string,
    data: UpdateAcademicTranscriptDTO,
  ): Promise<void> {
  ...
  protected async invalidateCaches(entity: any): Promise<void> {
    try {
      ...
      await this.cacheManager.delete(
        `white-cross:academic-transcripts:student:${entityData.studentId}`,
      );

      // Invalidate academic year cache
      await this.cacheManager.delete(
        `white-cross:academic-transcripts:year:${entityData.academicYear}`,
      );
