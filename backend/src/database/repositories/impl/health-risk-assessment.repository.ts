...
@Injectable()
export class HealthRiskAssessmentRepository extends BaseRepository<
  any,
  HealthRiskAssessmentAttributes,
  CreateHealthRiskAssessmentDTO
> {
  constructor(
  ...
  protected async validateCreate(
    data: CreateHealthRiskAssessmentDTO,
  ): Promise<void> {}
