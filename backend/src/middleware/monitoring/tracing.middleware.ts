/**
 * LOC: WC-MID-TRACE-001
 * NestJS Distributed Tracing Middleware
 *
...
class HealthcareTraceUtils {
  ...
  private static extractPatientId(req: any): string | null {
    // Check URL path
...
export class TracingMiddleware implements NestMiddleware {
   ...
   */
  private createTracingContext(req: any): TracingContext {
    const user = req.user;
   ...
   */
  private extractParentSpanId(req: any): string | undefined {
   ...
   * Build operation name from request
   */
  private buildOperationName(req: any): string {
   ...
   */
  private injectTracingHeaders(req: any, context: TracingContext): void {
