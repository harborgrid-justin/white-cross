...
export function validateVitalSigns(
  ...
  if (vitals.temperature !== undefined) {
    if (typeof vitals.temperature !== 'number' || vitals.temperature <= 0) {
      ...
      result.warnings?.push(
        `Temperature ${vitals.temperature}°C is outside normal range (${ranges.temperature.min}-${ranges.temperature.max}°C)`,
      );
    }
  }
  ...
  if (vitals.systolicBP !== undefined) {
    if (typeof vitals.systolicBP !== 'number' || vitals.systolicBP <= 0) {
      ...
      vitals.systolicBP < ranges.systolicBP.min ||
      vitals.systolicBP > ranges.systolicBP.max
    ) {
      result.warnings?.push(
        `Systolic BP ${vitals.systolicBP} mmHg is outside normal range (${ranges.systolicBP.min}-${ranges.systolicBP.max} mmHg)`,
      );
    }
  }
  ...
  if (vitals.diastolicBP !== undefined) {
    if (typeof vitals.diastolicBP !== 'number' || vitals.diastolicBP <= 0) {
      ...
      vitals.diastolicBP < ranges.diastolicBP.min ||
      vitals.diastolicBP > ranges.diastolicBP.max
    ) {
      result.warnings?.push(
        `Diastolic BP ${vitals.diastolicBP} mmHg is outside normal range (${ranges.diastolicBP.min}-${ranges.diastolicBP.max} mmHg)`,
      );
    }
  }
  ...
  if (vitals.respiratoryRate !== undefined) {
    if (typeof vitals.respiratoryRate !== 'number' || vitals.respiratoryRate <= 0) {
      ...
      result.warnings?.push(
        `Respiratory rate ${vitals.respiratoryRate}/min is outside normal range (${ranges.respiratoryRate.min}-${ranges.respiratoryRate.max}/min)`,
      );
    }
  }
  ...
  if (vitals.oxygenSaturation !== undefined) {
    if (typeof vitals.oxygenSaturation !== 'number' || vitals.oxygenSaturation <= 0) {
      ...
      vitals.oxygenSaturation < ranges.oxygenSaturation.min ||
      vitals.oxygenSaturation > ranges.oxygenSaturation.max
    ) {
      result.warnings?.push(
        `Oxygen saturation ${vitals.oxygenSaturation}% is outside normal range (${ranges.oxygenSaturation.min}-${ranges.oxygenSaturation.max}%)`,
      );
    }
  }
