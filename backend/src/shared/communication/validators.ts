 ...
 */
export function validatePhoneNumber(phone: string, country: string = 'US'): boolean {
 ...
 */
export function validateSMSLength(message: string): { isValid: boolean; length: number; segments: number; maxLength: number } {
