...
describe('DiscoveryCacheService', () => {
  ...
  beforeEach(async () => {
    ...
    service = module.get<DiscoveryCacheService>(DiscoveryCacheService);
  });
  ...
  describe('initialization', () => {
    ...
    it('should be an instance of DiscoveryCacheService', () => {
      expect(service).toBeInstanceOf(DiscoveryCacheService);
    });
  });
