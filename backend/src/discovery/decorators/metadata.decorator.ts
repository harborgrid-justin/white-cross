...
export const RateLimit = (limit: number, windowMs: number = 60000): CustomDecorator<string> => 
  SetMetadata('rate-limit', { limit, windowMs });

// Custom decorator for monitoring
export const Monitored = (level: 'basic' | 'detailed' = 'basic'): CustomDecorator<string> => 
  SetMetadata('monitoring-level', level);
