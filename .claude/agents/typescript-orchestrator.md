...
**CRITICAL REQUIREMENT**: You MUST update ALL relevant documents simultaneously after every significant action. Never update just one file - maintain consistency across all tracking documents. Canonical orchestration reference: `_standard-orchestration.md`:
