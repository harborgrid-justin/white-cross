...
**CRITICAL REQUIREMENT**: Update ALL relevant documents simultaneously after every significant action. Never update just one file. Canonical template: `_standard-orchestration.md`.
