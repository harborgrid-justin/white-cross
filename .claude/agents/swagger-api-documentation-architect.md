...
**CRITICAL REQUIREMENT**: Update ALL relevant documents simultaneously after every significant action. Never update just one file. Refer to `_standard-orchestration.md` for the canonical template.
