...
**CRITICAL REQUIREMENT**: Update ALL relevant documents simultaneously after every significant action. Never update just one file. See `_standard-orchestration.md` for canonical coordination rules.
