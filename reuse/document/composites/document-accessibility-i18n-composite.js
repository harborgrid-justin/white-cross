...
exports.AccessibilityI18nCompositeService = void 0;
/**
 * File: /reuse/document/composites/document-accessibility-i18n-composite.ts
 ...
 */
let AccessibilityI18nCompositeService = (() => {
    let _classDecorators = [(0, common_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var AccessibilityI18nCompositeService = _classThis = class {
        constructor(sequelize) {
            this.sequelize = sequelize;
            this.logger = new common_1.Logger(AccessibilityI18nCompositeService.name);
        }
        // ============================================================================
         ...
         * ```
         */
        async performWcagAccessibilityAudit(documentBuffer, targetLevel) {
            this.logger.log(`Performing WCAG ${targetLevel} audit`);
            const structure = await (0, document_pdf_advanced_kit_1.analyzeAccessibility)(documentBuffer);
            const violations = [];
            // Check structure
            if (!structure.tagged) {
                violations.push({
         ...
         * ```
         */
        async validateWcag21LevelAA(htmlContent) {
            const violations = [];
            // Check for headings
         ...
         * ```
         */
        async generateAccessibilityComplianceReport(documentBuffer) {
            return await (0, document_pdf_advanced_kit_1.generateAccessibilityReport)(documentBuffer);
        }
        /**
         ...
         * ```
         */
        async validatePdfUaCompliance(pdfBuffer) {
            return await (0, document_pdf_advanced_kit_1.validatePDFUA)(pdfBuffer);
        }
        /**
         ...
         * ```
         */
        async checkColorContrastRatio(foreground, background, level) {
         ...
         * ```
         */
        async validateHeadingHierarchy(htmlContent) {
            const errors = [];
         ...
         * ```
         */
        async validateAriaAttributes(htmlContent) {
            const errors = [];
         ...
         * ```
         */
        async analyzeDocumentSemanticStructure(htmlContent) {
            return {
         ...
         * ```
         */
        async validateTableAccessibility(htmlContent) {
            const errors = [];
         ...
         * ```
         */
        async generateAccessibilityRemediations(auditResult) {
         ...
         * ```
         */
        async convertPdfToAccessible(pdfBuffer, options) {
            this.logger.log('Converting PDF to PDF/UA');
            return await (0, document_pdf_advanced_kit_1.convertToPDFUA)(pdfBuffer, options);
        }
        /**
         ...
         * ```
         */
        async analyzePdfAccessibilityStructure(pdfBuffer) {
            return await (0, document_pdf_advanced_kit_1.analyzeAccessibility)(pdfBuffer);
        }
        /**
         ...
         * ```
         */
        async addAltTextToPdfImages(pdfBuffer, altTextMap) {
            return await (0, document_pdf_advanced_kit_1.addAltTextToImages)(pdfBuffer, altTextMap);
        }
        /**
         ...
         * ```
         */
        async setPdfReadingOrder(pdfBuffer) {
            return await (0, document_pdf_advanced_kit_1.setReadingOrder)(pdfBuffer);
        }
        /**
         ...
         * ```
         */
        async tagPdfStructure(pdfBuffer) {
            return await (0, document_pdf_advanced_kit_1.convertToPDFUA)(pdfBuffer, { autoTag: true });
        }
        /**
         ...
         * ```
         */
        async setPdfDocumentLanguage(pdfBuffer, language) {
            return await (0, document_pdf_advanced_kit_1.convertToPDFUA)(pdfBuffer, { setLanguage: language });
        }
        /**
         ...
         * ```
         */
        async addPdfDocumentTitle(pdfBuffer, title) {
            return await (0, document_pdf_advanced_kit_1.convertToPDFUA)(pdfBuffer, { setTitle: title });
        }
        /**
         ...
         * ```
         */
        async validatePdfBookmarks(pdfBuffer) {
            const structure = await (0, document_pdf_advanced_kit_1.analyzeAccessibility)(pdfBuffer);
         ...
         * ```
         */
        async generateAriaLabels(htmlContent) {
            let enhanced = htmlContent;
            // Add ARIA labels to buttons without text
            enhanced = enhanced.replace(/<button([^>]*)>(\s*)<\/button>/gi, '<button$1 aria-label="Button">$2</button>');
            return enhanced;
        }
        /**
         ...
         * ```
         */
        async addAriaLandmarks(htmlContent) {
            if (!htmlContent.includes('role="main"') && !htmlContent.includes('<main>')) {
                htmlContent = htmlContent.replace(/<div class="content">/i, '<div class="content" role="main">');
            }
            return htmlContent;
        }
        /**
         ...
         * ```
         */
        async createSkipNavigationLinks(htmlContent) {
         ...
         * ```
         */
        async implementAriaLiveRegions(htmlContent) {
            return htmlContent.replace(/<div class="notifications">/gi, '<div class="notifications" role="alert" aria-live="polite">');
        }
        /**
         ...
         * ```
         */
        async enhanceFormAccessibility(htmlContent) {
            // Add required indicators
            let enhanced = htmlContent.replace(/<input([^>]*)required([^>]*)>/gi, '<input$1required$2 aria-required="true">');
            // Add error descriptions
            enhanced = enhanced.replace(/<input([^>]*)aria-invalid="true"([^>]*)>/gi, '<input$1aria-invalid="true"$2 aria-describedby="error-message">');
            return enhanced;
        }
        /**
         ...
         * ```
         */
        async generateScreenReaderAnnouncement(message, priority) {
         ...
         * ```
         */
        async translateDocumentContent(content, config) {
         ...
         * ```
         */
        async applyLocalizationSettings(content, settings) {
         ...
         * ```
         */
        async formatDateForLocale(date, locale, format) {
         ...
         * ```
         */
        async formatNumberForLocale(value, locale) {
         ...
         * ```
         */
        async supportRtlLanguages(content, language) {
         ...
         * ```
         */
        async manageTranslationGlossary(term, targetLanguage) {
            const glossary = {
                diagnosis: { es: 'diagnóstico', fr: 'diagnostic', de: 'Diagnose' },
                medication: { es: 'medicación', fr: 'médicament', de: 'Medikament' },
            };
         ...
         * ```
         */
        async validateLocaleSupport(locale) {
         ...
         * ```
         */
        async generateMultilingualMetadata(metadata, languages) {
            const multilingualMetadata = new Map();
         ...
         * ```
         */
        async implementKeyboardNavigation(htmlContent) {
         ...
         * ```
         */
        async setProperTabOrder(htmlContent) {
         ...
         * ```
         */
        async createKeyboardShortcutsDoc(config) {
         ...
         * ```
         */
        async addFocusIndicators(htmlContent) {
      ...
      :focus:not(:focus-visible) { outline: none; }
         ...
         * ```
         */
        async implementFocusTrap(modalHtml) {
            return modalHtml;
        }
        /**
         ...
         * ```
         */
        async validateKeyboardAccessibility(htmlContent) {
            const issues = [];
         ...
         * ```
         */
        async generateSection508Report(documentBuffer) {
         ...
         * ```
         */
        async generateWcag22Report(htmlContent, level) {
         ...
         * ```
         */
        async generateAuditSummary(audit) {
            return `
    ...
    `;
         ...
         * ```
         */
        async trackAccessibilityImprovements(documentId, currentAudit) {
         ...
         * ```
         */
        async generateAccessibilityScorecard(documentBuffer) {
            return {
                overallScore: 85,
                wcagCompliance: true,
         ...
         * ```
         */
        async validateMultiLanguageAccessibility(translations) {
         ...
         * ```
         */
        async generateComprehensiveAccessibilityReport(documentBuffer, languages) {
        ...
        generateRecommendations(violations) {
            ...
            return violations.map((v) => {
                ...
                const aPriority = priorityOrder[a.split(':')[0]] || 4;
                const bPriority = priorityOrder[b.split(':')[0]] || 4;
         ...
         */
        getDetailedRecommendation(violationId) {
    ...
    __setFunctionName(_classThis, "AccessibilityI18nCompositeService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        AccessibilityI18nCompositeService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AccessibilityI18nCompositeService = _classThis;
})();
exports.AccessibilityI18nCompositeService = AccessibilityI18nCompositeService;
// ============================================================================
// EXPORTS
// ============================================================================
exports.default = AccessibilityI18nCompositeService;
//# sourceMappingURL=document-accessibility-i18n-composite.js.map