 ...
 * Fund category
 */
export declare enum FundCategory {
 ...
 */
export declare enum FinancialStatementType {
 ...
 */
export declare enum GASBStatement {
 ...
 */
export declare enum NetPositionComponent {
 ...
 */
export declare enum FundBalanceClassification {
 ...
 * Report section
 */
export declare enum ReportSection {
 ...
 * Audit opinion type
 */
export declare enum AuditOpinionType {
 ...
 */
export declare class GovernmentFundModel extends Model {
    id: string;
    entityId: string;
    fundNumber: string;
    name: string;
 ...
 */
export declare class FinancialReportModel extends Model {
    id: string;
    entityId: string;
 ...
 */
export declare class FinancialDisclosureModel extends Model {
    id: string;
    entityId: string;
    fiscalYear: number;
 ...
 */
export declare class GenerateCAFRDto {
    entityId: string;
    fiscalYear: number;
 ...
 * ```
 */
export declare const createReportId: () => ReportId;
/**
 ...
 * ```
 */
export declare const createFundId: () => FundId;
/**
 ...
 * ```
 */
export declare const createAccountId: () => AccountId;
/**
 ...
 * ```
 */
export declare const createTransactionId: () => TransactionId;
/**
 ...
 * ```
 */
export declare const createDisclosureId: () => DisclosureId;
/**
 * @function createFund
 ...
 * ```
 */
export declare const createFund: (entityId: EntityId, fundNumber: string, name: string, type: FundType, category: FundCategory, description: string) => GovernmentFund;
/**
 ...
 * ```
 */
export declare const categorizeFund: (fundType: FundType) => FundCategory;
/**
 ...
 * ```
 */
export declare const createAccount: (fundId: FundId, accountNumber: string, name: string, classification: AccountClassification, normalBalance: "debit" | "credit") => Account;
/**
 ...
 * ```
 */
export declare const determineNormalBalance: (classification: AccountClassification) => "debit" | "credit";
/**
 ...
 * ```
 */
export declare const createTransaction: (fundId: FundId, transactionDate: Date, description: string, journalEntries: JournalEntry[], fiscalYear: number, fiscalPeriod: number, postedBy: string) => FinancialTransaction;
/**
 ...
 * ```
 */
export declare const validateJournalEntries: (entries: JournalEntry[]) => {
    isBalanced: boolean;
    totalDebit: number;
    totalCredit: number;
    difference: number;
 ...
 * ```
 */
export declare const reverseTransaction: (transaction: FinancialTransaction, reversalDate: Date, postedBy: string) => FinancialTransaction;
/**
 ...
 * ```
 */
export declare const createStatementOfNetPosition: (entityId: EntityId, asOfDate: Date, fiscalYear: number, governmental: NetPositionData, businessType: NetPositionData) => StatementOfNetPosition;
/**
 ...
 * ```
 */
export declare const createStatementOfActivities: (entityId: EntityId, fiscalYear: number, functions: FunctionActivity[], generalRevenues: GeneralRevenue[]) => StatementOfActivities;
/**
 ...
 * ```
 */
export declare const createFundBalanceSheet: (fundId: FundId, asOfDate: Date, fiscalYear: number, assets: FundAssets, liabilities: FundLiabilities, fundBalance: FundBalance) => FundBalanceSheet;
/**
 ...
 * ```
 */
export declare const classifyFundBalance: (totalFundBalance: number, constraints: {
    nonspendable?: number;
    restricted?: number;
    committed?: number;
    assigned?: number;
 ...
 * ```
 */
export declare const createStatementOfRevenuesExpenditures: (fundId: FundId, fiscalYear: number, revenues: RevenueCategory[], expenditures: ExpenditureCategory[], fundBalanceBeginning: number) => StatementOfRevenuesExpenditures;
/**
 ...
 * ```
 */
export declare const calculateBudgetVariance: (budgeted: number, actual: number) => {
    variance: number;
 ...
 * ```
 */
export declare const createReconciliation: (reconciliationType: string, fundBalance: number, adjustments: ReconciliationAdjustment[]) => ReconciliationStatement;
/**
 ...
 * ```
 */
export declare const addReconciliationAdjustment: (description: string, amount: number, explanation: string) => ReconciliationAdjustment;
/**
 * @function createCAFR
 ...
 * ```
 */
export declare const createCAFR: (entityId: EntityId, fiscalYear: number, introductorySection: IntroductorySection, financialSection: FinancialSection, statisticalSection: StatisticalSection) => CAFR;
/**
 ...
 * ```
 */
export declare const createIntroductorySection: (transmittalLetter: string, principalOfficials: PrincipalOfficial[]) => IntroductorySection;
/**
 ...
 * ```
 */
export declare const createFinancialSection: (auditorsReport: AuditorsReport, mda: string, basicStatements: BasicFinancialStatements, notes: Note[]) => FinancialSection;
/**
 * @function createNote
 ...
 * ```
 */
export declare const createNote: (noteNumber: string, title: string, content: string, gasb: GASBStatement[]) => Note;
/**
 ...
 * ```
 */
export declare const addNoteSubsection: (note: Note, letter: string, title: string, content: string) => Note;
/**
 ...
 * ```
 */
export declare const generateRequiredNotes: () => Array<{
    noteNumber: string;
    title: string;
    gasb: GASBStatement[];
}>;
 ...
 * ```
 */
export declare const createBudgetComparison: (fundId: FundId, revenues: RevenueCategory[], expenditures: ExpenditureCategory[]) => RequiredSupplementaryInfo;
/**
 ...
 * ```
 */
export declare const createPensionRSI: (fiscalYear: number, pensionData: Record<string, unknown>) => RequiredSupplementaryInfo;
/**
 ...
 * ```
 */
export declare const createFinancialTrendTable: (title: string, years: number[], data: Record<string, number[]>) => FinancialTrendTable;
/**
 ...
 * ```
 */
export declare const createRevenueCapacityTable: (title: string, years: number[], data: Record<string, number[]>) => RevenueCapacityTable;
/**
 ...
 * ```
 */
export declare const createDebtCapacityTable: (title: string, years: number[], data: Record<string, number[]>) => DebtCapacityTable;
/**
 ...
 * ```
 */
export declare const createFinancialDisclosure: (entityId: EntityId, fiscalYear: number, disclosureType: string, title: string, content: string, gasb: GASBStatement[]) => FinancialDisclosure;
/**
 ...
 * ```
 */
export declare const validateGASBCompliance: (cafr: CAFR) => {
    isCompliant: boolean;
 ...
 * ```
 */
export declare const createAuditorsReport: (auditFirm: string, reportDate: Date, opinionType: AuditOpinionType, opinionText: string) => AuditorsReport;
/**
 ...
 * ```
 */
export declare const addEmphasisOfMatter: (report: AuditorsReport, emphasis: string) => AuditorsReport;
/**
 ...
 * ```
 */
export declare const calculatePerCapita: (totalAmount: number, population: number) => number;
/**
 ...
 * ```
 */
export declare const calculateDebtRatio: (totalDebt: number, totalAssets: number) => number;
/**
 ...
 * ```
 */
export declare const formatFinancialAmount: (amount: number, showCents?: boolean) => string;
declare const _default: {
    createReportId: () => ReportId;
    createFundId: () => FundId;
    createAccountId: () => AccountId;
    createTransactionId: () => TransactionId;
    createDisclosureId: () => DisclosureId;
    createFund: (entityId: EntityId, fundNumber: string, name: string, type: FundType, category: FundCategory, description: string) => GovernmentFund;
    categorizeFund: (fundType: FundType) => FundCategory;
    createAccount: (fundId: FundId, accountNumber: string, name: string, classification: AccountClassification, normalBalance: "debit" | "credit") => Account;
    determineNormalBalance: (classification: AccountClassification) => "debit" | "credit";
    createTransaction: (fundId: FundId, transactionDate: Date, description: string, journalEntries: JournalEntry[], fiscalYear: number, fiscalPeriod: number, postedBy: string) => FinancialTransaction;
    validateJournalEntries: (entries: JournalEntry[]) => {
        isBalanced: boolean;
        totalDebit: number;
        totalCredit: number;
        difference: number;
    };
    reverseTransaction: (transaction: FinancialTransaction, reversalDate: Date, postedBy: string) => FinancialTransaction;
    createStatementOfNetPosition: (entityId: EntityId, asOfDate: Date, fiscalYear: number, governmental: NetPositionData, businessType: NetPositionData) => StatementOfNetPosition;
    createStatementOfActivities: (entityId: EntityId, fiscalYear: number, functions: FunctionActivity[], generalRevenues: GeneralRevenue[]) => StatementOfActivities;
    createFundBalanceSheet: (fundId: FundId, asOfDate: Date, fiscalYear: number, assets: FundAssets, liabilities: FundLiabilities, fundBalance: FundBalance) => FundBalanceSheet;
    classifyFundBalance: (totalFundBalance: number, constraints: {
        nonspendable?: number;
        restricted?: number;
        committed?: number;
        assigned?: number;
    }) => FundBalance;
    createStatementOfRevenuesExpenditures: (fundId: FundId, fiscalYear: number, revenues: RevenueCategory[], expenditures: ExpenditureCategory[], fundBalanceBeginning: number) => StatementOfRevenuesExpenditures;
    calculateBudgetVariance: (budgeted: number, actual: number) => {
        variance: number;
        variancePercent: number;
        favorable: boolean;
    };
    createReconciliation: (reconciliationType: string, fundBalance: number, adjustments: ReconciliationAdjustment[]) => ReconciliationStatement;
    addReconciliationAdjustment: (description: string, amount: number, explanation: string) => ReconciliationAdjustment;
    createCAFR: (entityId: EntityId, fiscalYear: number, introductorySection: IntroductorySection, financialSection: FinancialSection, statisticalSection: StatisticalSection) => CAFR;
    createIntroductorySection: (transmittalLetter: string, principalOfficials: PrincipalOfficial[]) => IntroductorySection;
    createFinancialSection: (auditorsReport: AuditorsReport, mda: string, basicStatements: BasicFinancialStatements, notes: Note[]) => FinancialSection;
    createNote: (noteNumber: string, title: string, content: string, gasb: GASBStatement[]) => Note;
    addNoteSubsection: (note: Note, letter: string, title: string, content: string) => Note;
    generateRequiredNotes: () => Array<{
        noteNumber: string;
        title: string;
        gasb: GASBStatement[];
    }>;
    createBudgetComparison: (fundId: FundId, revenues: RevenueCategory[], expenditures: ExpenditureCategory[]) => RequiredSupplementaryInfo;
    createPensionRSI: (fiscalYear: number, pensionData: Record<string, unknown>) => RequiredSupplementaryInfo;
    createFinancialTrendTable: (title: string, years: number[], data: Record<string, number[]>) => FinancialTrendTable;
    createRevenueCapacityTable: (title: string, years: number[], data: Record<string, number[]>) => RevenueCapacityTable;
    createDebtCapacityTable: (title: string, years: number[], data: Record<string, number[]>) => DebtCapacityTable;
    createFinancialDisclosure: (entityId: EntityId, fiscalYear: number, disclosureType: string, title: string, content: string, gasb: GASBStatement[]) => FinancialDisclosure;
    validateGASBCompliance: (cafr: CAFR) => {
        isCompliant: boolean;
        missingRequirements: string[];
    };
    createAuditorsReport: (auditFirm: string, reportDate: Date, opinionType: AuditOpinionType, opinionText: string) => AuditorsReport;
    addEmphasisOfMatter: (report: AuditorsReport, emphasis: string) => AuditorsReport;
    calculatePerCapita: (totalAmount: number, population: number) => number;
    calculateDebtRatio: (totalDebt: number, totalAssets: number) => number;
    formatFinancialAmount: (amount: number, showCents?: boolean) => string;
};
export default _default;
//# sourceMappingURL=government-financial-reporting-kit.d.ts.map