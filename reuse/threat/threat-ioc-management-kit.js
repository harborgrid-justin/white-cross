 ...
 * ```
 */
const collectIocs = async (iocs, config) => {
    const collected = [];
    for (const ioc of iocs) {
        ...
        if (config.confidenceThreshold) {
            const confidenceOrder = ['low', 'medium', 'high', 'critical'];
            ...
            if (iocConfidenceIndex < thresholdIndex)
                continue;
        }
        collected.push(ioc);
    }
...
exports.collectIocs = collectIocs;
;
    * ;
...
typescript
    * ;
const query = { types: ['ip'], confidenceLevels: ['high'], limit: 20 };
    * ;
...
typescript
    * ;
const ioc = { type: 'ip', value: '1.2.3.4', tags: ['malware'], ... };
    * ;
...
typescript
    * ;
const ioc = { type: 'ip', value: '1.2.3.4', tags: ['malware', 'c2'], ... };
    * ;
...
typescript
    * ;
const ioc = { type: 'ip', confidence: 'high', ... };
    * ;
const policy = { defaultTtlDays: 30, ... };
    * ;
...
typescript
    * ;
const policy = { defaultTtlDays: 30, autoExpire: true, ... };
    * ;
...
typescript
    * ;
const request = { operation: 'add-tags', iocIds: ['ioc-1'], parameters: { tags: ['test'] } };
    * ;
...
typescript
    * 
    * async;
updateIoc(, id, string, , dto, UpdateIocDto);
Promise < IocResponseDto > {
...
;
//# sourceMappingURL=threat-ioc-management-kit.js.map