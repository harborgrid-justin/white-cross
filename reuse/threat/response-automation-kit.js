...
exports.prioritizeResponseWorkloads = exports.manageResponseEscalation = exports.allocateResponseResources = exports.executeParallelResponses = exports.sequenceResponseActions = exports.coordinateMultiTeamResponse = exports.validateRemediationSuccess = exports.restoreSystemFromBackup = exports.revokeExcessivePermissions = exports.resetCompromisedCredentials = exports.deploySecurityPatches = exports.hardenSystemConfiguration = exports.removeMalwareAutomated = exports.verifyContainmentAction = exports.sinkholeMaliciousDomain = exports.blockMaliciousTraffic = exports.shutdownCompromisedService = exports.suspendUserAccount = exports.quarantineEndpoint = exports.isolateNetworkSegment = exports.orchestrateSOARAPICalls = exports.monitorSOARJobStatus = exports.executeSOARAction = exports.syncThreatIntelligence = exports.updateSOARIncident = exports.retrieveSOARCaseData = exports.triggerSOARWorkflow = exports.connectSOARPlatform = exports.generateDynamicPlaybook = exports.analyzePlaybookEffectiveness = exports.testPlaybookExecution = exports.managePlaybookVersion = exports.evaluateConditionalPlaybook = exports.executePlaybookStep = exports.updateResponsePlaybook = exports.createResponsePlaybook = exports.assessResponseImpact = exports.executeEmergencyProtocol = exports.rollbackResponse = exports.selectAdaptiveResponse = exports.trackResponseEffectiveness = exports.coordinateMultiStageResponse = exports.executeResponseWorkflow = exports.triggerAutomatedResponse = exports.getAlertTriageModelAttributes = exports.getRemediationWorkflowModelAttributes = exports.getContainmentActionModelAttributes = exports.getSOARIntegrationModelAttributes = exports.getAutomatedResponseModelAttributes = exports.getResponsePlaybookModelAttributes = void 0;
exports.manageOrchestrationState = void 0;
/**
 * File: /reuse/threat/response-automation-kit.ts
 ...
 * ```
 */
const getResponsePlaybookModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getResponsePlaybookModelAttributes = getResponsePlaybookModelAttributes;
/**
 ...
 * ```
 */
const getAutomatedResponseModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getAutomatedResponseModelAttributes = getAutomatedResponseModelAttributes;
/**
 ...
 * ```
 */
const getSOARIntegrationModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getSOARIntegrationModelAttributes = getSOARIntegrationModelAttributes;
/**
 ...
 * ```
 */
const getRemediationWorkflowModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getRemediationWorkflowModelAttributes = getRemediationWorkflowModelAttributes;
/**
 ...
 * ```
 */
const getAlertTriageModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getAlertTriageModelAttributes = getAlertTriageModelAttributes;
// ============================================================================
// UTILITY FUNCTIONS
// ============================================================================
 ...
 * ```
 */
const triggerAutomatedResponse = async (threatId, threatData) => {
...
exports.triggerAutomatedResponse = triggerAutomatedResponse;
/**
 ...
 * ```
 */
const executeResponseWorkflow = async (config) => {
    const response = {
        id: generateId(),
...
exports.executeResponseWorkflow = executeResponseWorkflow;
/**
 ...
 * ```
 */
const coordinateMultiStageResponse = async (playbookIds, sharedContext) => {
    const responses = [];
    for (const playbookId of playbookIds) {
        const response = await (0, exports.executeResponseWorkflow)({
            playbookId,
...
exports.coordinateMultiStageResponse = coordinateMultiStageResponse;
/**
 ...
 * ```
 */
const trackResponseEffectiveness = async (responseId, outcomeData) => {
...
exports.trackResponseEffectiveness = trackResponseEffectiveness;
/**
 ...
 * ```
 */
const selectAdaptiveResponse = async (threatProfile, availablePlaybooks) => {
    let bestMatch = null;
    let bestScore = 0;
...
exports.selectAdaptiveResponse = selectAdaptiveResponse;
/**
 ...
 * ```
 */
const rollbackResponse = async (responseId, reason) => {
...
exports.rollbackResponse = rollbackResponse;
/**
 ...
 * ```
 */
const executeEmergencyProtocol = async (criticalThreat) => {
...
exports.executeEmergencyProtocol = executeEmergencyProtocol;
/**
 ...
 * ```
 */
const assessResponseImpact = async (response, businessContext) => {
...
exports.assessResponseImpact = assessResponseImpact;
// ============================================================================
 ...
 * ```
 */
const createResponsePlaybook = async (playbookData) => {
    const playbook = {
        id: generateId(),
...
exports.createResponsePlaybook = createResponsePlaybook;
/**
 ...
 * ```
 */
const updateResponsePlaybook = async (playbookId, updates) => {
...
exports.updateResponsePlaybook = updateResponsePlaybook;
/**
 ...
 * ```
 */
const evaluateConditionalPlaybook = async (playbook, runtimeData) => {
...
exports.evaluateConditionalPlaybook = evaluateConditionalPlaybook;
/**
 ...
 * ```
 */
const managePlaybookVersion = async (playbookId, action, targetVersion) => {
...
exports.managePlaybookVersion = managePlaybookVersion;
/**
 ...
 * ```
 */
const testPlaybookExecution = async (playbookId, testScenario) => {
    const failures = [];
...
exports.testPlaybookExecution = testPlaybookExecution;
/**
 ...
 * ```
 */
const analyzePlaybookEffectiveness = async (playbookId, daysBack) => {
...
exports.analyzePlaybookEffectiveness = analyzePlaybookEffectiveness;
/**
 ...
 * ```
 */
const generateDynamicPlaybook = async (threatProfile, availableActions) => {
    const steps = [];
    let stepOrder = 1;
...
exports.generateDynamicPlaybook = generateDynamicPlaybook;
// ============================================================================
 ...
 * ```
 */
const connectSOARPlatform = async (connectionConfig) => {
...
exports.connectSOARPlatform = connectSOARPlatform;
/**
 ...
 * ```
 */
const triggerSOARWorkflow = async (integrationId, workflowName, parameters) => {
 ...
 * ```
 */
const retrieveSOARCaseData = async (integrationId, caseId) => {
...
exports.retrieveSOARCaseData = retrieveSOARCaseData;
/**
 ...
 * ```
 */
const updateSOARIncident = async (integrationId, incidentId, updates) => {
...
exports.updateSOARIncident = updateSOARIncident;
/**
 ...
 * ```
 */
const syncThreatIntelligence = async (integrationId, intelligenceData) => {
    const errors = [];
    let synced = 0;
    let failed = 0;
...
exports.syncThreatIntelligence = syncThreatIntelligence;
/**
 ...
 * ```
 */
const executeSOARAction = async (integrationId, action) => {
...
exports.executeSOARAction = executeSOARAction;
/**
 ...
 * ```
 */
const monitorSOARJobStatus = async (integrationId, jobId) => {
...
exports.monitorSOARJobStatus = monitorSOARJobStatus;
/**
 ...
 * ```
 */
const orchestrateSOARAPICalls = async (integrationId, apiCalls) => {
    const results = [];
    let successful = 0;
    let failed = 0;
...
exports.orchestrateSOARAPICalls = orchestrateSOARAPICalls;
// ============================================================================
 ...
 * ```
 */
const isolateNetworkSegment = async (targetSegment, isolationConfig) => {
    const action = {
        id: generateId(),
...
exports.isolateNetworkSegment = isolateNetworkSegment;
/**
 ...
 * ```
 */
const quarantineEndpoint = async (endpointId, quarantineConfig) => {
    const action = {
        id: generateId(),
...
exports.quarantineEndpoint = quarantineEndpoint;
/**
 ...
 * ```
 */
const suspendUserAccount = async (userId, reason, durationSeconds) => {
    const action = {
        id: generateId(),
 ...
 * ```
 */
const shutdownCompromisedService = async (serviceId, shutdownConfig) => {
    const action = {
        id: generateId(),
...
exports.shutdownCompromisedService = shutdownCompromisedService;
/**
 ...
 * ```
 */
const blockMaliciousTraffic = async (config) => {
    const action = {
        id: generateId(),
        actionType: 'traffic_blocking',
        targetType: 'ip',
...
exports.blockMaliciousTraffic = blockMaliciousTraffic;
/**
 ...
 * ```
 */
const sinkholeMaliciousDomain = async (domains, sinkholeIp) => {
    const action = {
        id: generateId(),
...
exports.sinkholeMaliciousDomain = sinkholeMaliciousDomain;
/**
 ...
 * ```
 */
const verifyContainmentAction = async (containmentId, verificationMethod) => {
...
exports.verifyContainmentAction = verifyContainmentAction;
// ============================================================================
 ...
 * ```
 */
const removeMalwareAutomated = async (endpointId, malwareInfo) => {
    const workflow = {
        id: generateId(),
...
exports.removeMalwareAutomated = removeMalwareAutomated;
/**
 ...
 * ```
 */
const hardenSystemConfiguration = async (targetAssets, hardeningProfile) => {
    const workflow = {
        id: generateId(),
...
exports.hardenSystemConfiguration = hardenSystemConfiguration;
/**
 ...
 * ```
 */
const deploySecurityPatches = async (config) => {
    const workflow = {
        id: generateId(),
        workflowType: 'patch_deployment',
...
exports.deploySecurityPatches = deploySecurityPatches;
/**
 ...
 * ```
 */
const resetCompromisedCredentials = async (userId, affectedSystems) => {
    const workflow = {
        id: generateId(),
...
exports.resetCompromisedCredentials = resetCompromisedCredentials;
/**
 ...
 * ```
 */
const revokeExcessivePermissions = async (principalId, permissionsToRevoke) => {
    const workflow = {
        id: generateId(),
...
exports.revokeExcessivePermissions = revokeExcessivePermissions;
/**
 ...
 * ```
 */
const restoreSystemFromBackup = async (assetId, backupId) => {
    const workflow = {
        id: generateId(),
...
exports.restoreSystemFromBackup = restoreSystemFromBackup;
/**
 ...
 * ```
 */
const validateRemediationSuccess = async (workflowId, validationTests) => {
    const results = [];
...
exports.validateRemediationSuccess = validateRemediationSuccess;
// ============================================================================
 ...
 * ```
 */
const coordinateMultiTeamResponse = async (incidentId, teams) => {
    const coordination = {};
    const timeline = [];
...
exports.coordinateMultiTeamResponse = coordinateMultiTeamResponse;
/**
 ...
 * ```
 */
const sequenceResponseActions = async (actions) => {
...
exports.sequenceResponseActions = sequenceResponseActions;
/**
 ...
 * ```
 */
const executeParallelResponses = async (parallelActions) => {
    const results = await Promise.all(parallelActions.map(async (item) => {
        const startTime = Date.now();
...
exports.executeParallelResponses = executeParallelResponses;
/**
 ...
 * ```
 */
const allocateResponseResources = async (incidentId, requirements) => {
    const allocated = {
...
exports.allocateResponseResources = allocateResponseResources;
/**
 ...
 * ```
 */
const manageResponseEscalation = async (responseId, escalationCriteria) => {
...
exports.manageResponseEscalation = manageResponseEscalation;
/**
 ...
 * ```
 */
const prioritizeResponseWorkloads = async (activeResponses) => {
...
exports.prioritizeResponseWorkloads = prioritizeResponseWorkloads;
/**
 ...
 * ```
 */
const manageOrchestrationState = async (orchestrationId, action, stateData) => {
...
exports.manageOrchestrationState = manageOrchestrationState;
// ============================================================================
// HELPER FUNCTIONS
// ============================================================================
function evaluateTriggerCondition(trigger, runtimeData) {
    // Simple condition evaluation
...
//# sourceMappingURL=response-automation-kit.js.map