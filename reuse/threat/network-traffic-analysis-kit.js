...
exports.updateNetworkThreatIntelCache = exports.queryNetworkThreatIntel = exports.integrateNetworkThreatIntel = exports.generateTrafficReport = exports.detectTrafficAnomalies = exports.calculateTrafficBaseline = exports.analyzeTrafficPatterns = exports.validateNetworkIOCs = exports.createIOCsFromNetworkThreats = exports.enrichIOCsWithNetworkContext = exports.matchNetworkIOCs = exports.analyzeDataTransferPatterns = exports.detectCloudExfiltration = exports.detectEncryptedExfiltration = exports.detectLargeUploads = exports.detectDataExfiltration = exports.checkC2Infrastructure = exports.detectDomainGeneration = exports.detectHTTPC2 = exports.detectDNSTunneling = exports.detectBeaconingPattern = exports.detectC2Communication = exports.detectGenericAnomalies = exports.detectHTTPAnomalies = exports.detectDNSAnomalies = exports.detectTCPAnomalies = exports.detectProtocolAnomalies = exports.extractPacketIOCs = exports.inspectDNSQuery = exports.inspectHTTPHeaders = exports.analyzePacketPayload = exports.matchPacketSignatures = exports.deepPacketInspection = exports.exportNetworkFlows = exports.filterNetworkFlows = exports.aggregateFlowsByTimeWindow = exports.detectNetworkBeaconing = exports.enrichNetworkFlows = exports.correlateNetworkFlows = exports.calculateFlowAnomalyScore = exports.calculateFlowThreatScore = exports.analyzeNetworkFlows = exports.getC2DetectionModelAttributes = exports.getProtocolAnomalyModelAttributes = exports.getPacketCaptureModelAttributes = exports.getNetworkFlowModelAttributes = exports.ExfiltrationMethod = exports.C2Pattern = exports.ProtocolAnomalyType = exports.NetworkProtocol = void 0;
/**
 * File: /reuse/threat/network-traffic-analysis-kit.ts
...
(function (NetworkProtocol) {
    ...
    NetworkProtocol["UNKNOWN"] = "UNKNOWN";
})(NetworkProtocol || (exports.NetworkProtocol = NetworkProtocol = {}));
/**
 * Protocol anomaly types
 */
var ProtocolAnomalyType;
(function (ProtocolAnomalyType) {
    ProtocolAnomalyType["MALFORMED_PACKET"] = "MALFORMED_PACKET";
    ProtocolAnomalyType["INVALID_HEADER"] = "INVALID_HEADER";
    ProtocolAnomalyType["PROTOCOL_VIOLATION"] = "PROTOCOL_VIOLATION";
    ProtocolAnomalyType["UNUSUAL_PORT"] = "UNUSUAL_PORT";
    ProtocolAnomalyType["SUSPICIOUS_FLAGS"] = "SUSPICIOUS_FLAGS";
    ProtocolAnomalyType["FRAGMENTATION_ATTACK"] = "FRAGMENTATION_ATTACK";
    ProtocolAnomalyType["TUNNEL_DETECTED"] = "TUNNEL_DETECTED";
    ProtocolAnomalyType["ENCRYPTION_ANOMALY"] = "ENCRYPTION_ANOMALY";
    ProtocolAnomalyType["DNS_TUNNELING"] = "DNS_TUNNELING";
    ProtocolAnomalyType["HTTP_ANOMALY"] = "HTTP_ANOMALY";
})(ProtocolAnomalyType || (exports.ProtocolAnomalyType = ProtocolAnomalyType = {}));
/**
 * C2 (Command & Control) communication patterns
 */
var C2Pattern;
(function (C2Pattern) {
    C2Pattern["BEACONING"] = "BEACONING";
    C2Pattern["DNS_TUNNELING"] = "DNS_TUNNELING";
    C2Pattern["HTTP_C2"] = "HTTP_C2";
    C2Pattern["HTTPS_C2"] = "HTTPS_C2";
    C2Pattern["IRC_C2"] = "IRC_C2";
    C2Pattern["CUSTOM_PROTOCOL"] = "CUSTOM_PROTOCOL";
    C2Pattern["DOMAIN_GENERATION"] = "DOMAIN_GENERATION";
    C2Pattern["FAST_FLUX"] = "FAST_FLUX";
    C2Pattern["TOR_USAGE"] = "TOR_USAGE";
})(C2Pattern || (exports.C2Pattern = C2Pattern = {}));
/**
 * Data exfiltration indicators
 */
var ExfiltrationMethod;
(function (ExfiltrationMethod) {
    ExfiltrationMethod["LARGE_UPLOAD"] = "LARGE_UPLOAD";
    ExfiltrationMethod["DNS_EXFILTRATION"] = "DNS_EXFILTRATION";
    ExfiltrationMethod["ICMP_TUNNELING"] = "ICMP_TUNNELING";
    ExfiltrationMethod["ENCRYPTED_CHANNEL"] = "ENCRYPTED_CHANNEL";
    ExfiltrationMethod["STEGANOGRAPHY"] = "STEGANOGRAPHY";
    ExfiltrationMethod["CLOUD_UPLOAD"] = "CLOUD_UPLOAD";
    ExfiltrationMethod["EMAIL_EXFILTRATION"] = "EMAIL_EXFILTRATION";
    ExfiltrationMethod["FTP_UPLOAD"] = "FTP_UPLOAD";
})(ExfiltrationMethod || (exports.ExfiltrationMethod = ExfiltrationMethod = {}));
// ============================================================================
 ...
 * ```
 */
const getNetworkFlowModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getNetworkFlowModelAttributes = getNetworkFlowModelAttributes;
/**
 ...
 * ```
 */
const getPacketCaptureModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getPacketCaptureModelAttributes = getPacketCaptureModelAttributes;
/**
 ...
 * ```
 */
const getProtocolAnomalyModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getProtocolAnomalyModelAttributes = getProtocolAnomalyModelAttributes;
/**
 ...
 * ```
 */
const getC2DetectionModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getC2DetectionModelAttributes = getC2DetectionModelAttributes;
// ============================================================================
 ...
 * ```
 */
const analyzeNetworkFlows = async (flows, options) => {
    const analyzedFlows = [];
    const threats = [];
    ...
    for (const flow of flows) {
        ...
        if (options?.enableThreatScoring !== false) {
            flow.threatScore = (0, exports.calculateFlowThreatScore)(flow);
            totalThreatScore += flow.threatScore;
        }
        // Calculate anomaly score
        if (options?.enableAnomalyDetection !== false) {
            flow.anomalyScore = (0, exports.calculateFlowAnomalyScore)(flow);
        }
        // Detect threats
...
exports.analyzeNetworkFlows = analyzeNetworkFlows;
/**
 ...
 * ```
 */
const calculateFlowThreatScore = (flow) => {
    let score = 0;
...
exports.calculateFlowThreatScore = calculateFlowThreatScore;
/**
 ...
 * ```
 */
const calculateFlowAnomalyScore = (flow) => {
    let score = 0;
...
exports.calculateFlowAnomalyScore = calculateFlowAnomalyScore;
/**
 ...
 * ```
 */
const correlateNetworkFlows = async (flows, timeWindow = 300000) => {
    const correlations = [];
...
exports.correlateNetworkFlows = correlateNetworkFlows;
/**
 ...
 * ```
 */
const enrichNetworkFlows = async (flows) => {
    const enrichedFlows = [];
    for (const flow of flows) {
...
exports.enrichNetworkFlows = enrichNetworkFlows;
/**
 ...
 * ```
 */
const detectNetworkBeaconing = async (flows, options) => {
    const beacons = [];
    ...
    for (const [key, pairFlows] of sourceDestMap.entries()) {
        ...
        const consistentIntervals = intervals.filter(i => Math.abs(i - avgInterval) < tolerance).length;
...
exports.detectNetworkBeaconing = detectNetworkBeaconing;
/**
 ...
 * ```
 */
const aggregateFlowsByTimeWindow = async (flows, windowSize) => {
...
exports.aggregateFlowsByTimeWindow = aggregateFlowsByTimeWindow;
/**
 ...
 * ```
 */
const filterNetworkFlows = (flows, criteria) => {
    return flows.filter(flow => {
        if (criteria.protocol && flow.protocol !== criteria.protocol)
            return false;
        if (criteria.sourceIp && flow.sourceIp !== criteria.sourceIp)
            return false;
        if (criteria.destinationIp && flow.destinationIp !== criteria.destinationIp)
            return false;
        if (criteria.minThreatScore && (!flow.threatScore || flow.threatScore < criteria.minThreatScore))
            return false;
        if (criteria.maxThreatScore && flow.threatScore && flow.threatScore > criteria.maxThreatScore)
            return false;
        if (criteria.startTime && flow.startTime < criteria.startTime)
            return false;
        if (criteria.endTime && flow.startTime > criteria.endTime)
            return false;
        return true;
    });
};
exports.filterNetworkFlows = filterNetworkFlows;
/**
 ...
 * ```
 */
const exportNetworkFlows = async (flows, format) => {
    switch (format) {
        case 'json':
...
exports.exportNetworkFlows = exportNetworkFlows;
// ============================================================================
 ...
 * ```
 */
const deepPacketInspection = async (packets, options) => {
    const results = [];
    for (const packet of packets) {
        const threats = [];
        // Signature-based detection
        if (options?.enableSignatureMatching !== false) {
            const signatures = (0, exports.matchPacketSignatures)(packet);
            threats.push(...signatures);
        }
        // Payload analysis
        if (options?.enablePayloadAnalysis !== false && packet.payloadAscii) {
            const payloadThreats = (0, exports.analyzePacketPayload)(packet.payloadAscii);
            threats.push(...payloadThreats);
        }
        // Protocol-specific inspection
        if (packet.headers.http) {
            const httpThreats = (0, exports.inspectHTTPHeaders)(packet.headers.http);
            threats.push(...httpThreats);
        }
        if (packet.headers.dns) {
            const dnsThreats = (0, exports.inspectDNSQuery)(packet.headers.dns);
...
exports.deepPacketInspection = deepPacketInspection;
/**
 ...
 * ```
 */
const matchPacketSignatures = (packet) => {
    const indicators = [];
    ...
    if (packet.payloadAscii) {
        const maliciousPatterns = [
            ...
            { pattern: /eval\(/i, type: 'CODE_INJECTION', severity: 'HIGH' },
...
exports.matchPacketSignatures = matchPacketSignatures;
/**
 ...
 * ```
 */
const analyzePacketPayload = (payload) => {
    const indicators = [];
...
exports.analyzePacketPayload = analyzePacketPayload;
/**
 ...
 * ```
 */
const inspectHTTPHeaders = (headers) => {
    const indicators = [];
...
exports.inspectHTTPHeaders = inspectHTTPHeaders;
/**
 ...
 * ```
 */
const inspectDNSQuery = (dnsHeader) => {
    const indicators = [];
...
exports.inspectDNSQuery = inspectDNSQuery;
/**
 ...
 * ```
 */
const extractPacketIOCs = async (packets) => {
    const iocs = [];
...
exports.extractPacketIOCs = extractPacketIOCs;
// ============================================================================
 ...
 * ```
 */
const detectProtocolAnomalies = async (packets) => {
    const anomalies = [];
    for (const packet of packets) {
        // TCP anomalies
        if (packet.protocol === NetworkProtocol.TCP && packet.headers.tcp) {
            const tcpAnomalies = (0, exports.detectTCPAnomalies)(packet);
            anomalies.push(...tcpAnomalies);
        }
        // DNS anomalies
        if (packet.headers.dns) {
            const dnsAnomalies = (0, exports.detectDNSAnomalies)(packet);
            anomalies.push(...dnsAnomalies);
        }
        // HTTP anomalies
        if (packet.headers.http) {
            const httpAnomalies = (0, exports.detectHTTPAnomalies)(packet);
            anomalies.push(...httpAnomalies);
        }
        // Generic anomalies
        const genericAnomalies = (0, exports.detectGenericAnomalies)(packet);
        anomalies.push(...genericAnomalies);
    }
    return anomalies;
};
exports.detectProtocolAnomalies = detectProtocolAnomalies;
/**
 ...
 * ```
 */
const detectTCPAnomalies = (packet) => {
    const anomalies = [];
...
exports.detectTCPAnomalies = detectTCPAnomalies;
/**
 ...
 * ```
 */
const detectDNSAnomalies = (packet) => {
    const anomalies = [];
    if (!packet.headers.dns)
        return anomalies;
...
exports.detectDNSAnomalies = detectDNSAnomalies;
/**
 ...
 * ```
 */
const detectHTTPAnomalies = (packet) => {
    const anomalies = [];
    if (!packet.headers.http)
        return anomalies;
...
exports.detectHTTPAnomalies = detectHTTPAnomalies;
/**
 ...
 * ```
 */
const detectGenericAnomalies = (packet) => {
    const anomalies = [];
 ...
 * ```
 */
const detectC2Communication = async (flows, packets) => {
    const detections = [];
    // Detect beaconing
    const beaconingDetections = await (0, exports.detectBeaconingPattern)(flows);
    detections.push(...beaconingDetections);
    // Detect DNS tunneling
    if (packets) {
        const dnsTunnelingDetections = await (0, exports.detectDNSTunneling)(packets);
        detections.push(...dnsTunnelingDetections);
    }
    // Detect HTTP/HTTPS C2
    const httpC2Detections = await (0, exports.detectHTTPC2)(flows);
    detections.push(...httpC2Detections);
    // Detect domain generation algorithms
    const dgaDetections = await (0, exports.detectDomainGeneration)(flows);
 ...
 * ```
 */
const detectBeaconingPattern = async (flows) => {
    const detections = [];
    const sourceDestMap = new Map();
...
exports.detectBeaconingPattern = detectBeaconingPattern;
/**
 ...
 * ```
 */
const detectDNSTunneling = async (packets) => {
    const detections = [];
...
exports.detectDNSTunneling = detectDNSTunneling;
/**
 ...
 * ```
 */
const detectHTTPC2 = async (flows) => {
    const detections = [];
    const httpFlows = flows.filter(f => f.applicationProtocol === 'HTTP' || f.applicationProtocol === 'HTTPS' ||
...
exports.detectHTTPC2 = detectHTTPC2;
/**
 ...
 * ```
 */
const detectDomainGeneration = async (flows) => {
    const detections = [];
...
exports.detectDomainGeneration = detectDomainGeneration;
/**
 ...
 * ```
 */
const checkC2Infrastructure = async (ip) => {
...
exports.checkC2Infrastructure = checkC2Infrastructure;
// ============================================================================
 ...
 * ```
 */
const detectDataExfiltration = async (flows) => {
    const detections = [];
    // Detect large uploads
    const largeUploads = (0, exports.detectLargeUploads)(flows);
    detections.push(...largeUploads);
    // Detect unusual encrypted traffic
    const encryptedExfil = (0, exports.detectEncryptedExfiltration)(flows);
    detections.push(...encryptedExfil);
    // Detect cloud service uploads
    const cloudExfil = (0, exports.detectCloudExfiltration)(flows);
 ...
 * ```
 */
const detectLargeUploads = (flows) => {
    const detections = [];
    for (const flow of flows) {
...
exports.detectLargeUploads = detectLargeUploads;
/**
 ...
 * ```
 */
const detectEncryptedExfiltration = (flows) => {
    const detections = [];
    const encryptedFlows = flows.filter(f => f.destinationPort === 443 ||
...
exports.detectEncryptedExfiltration = detectEncryptedExfiltration;
/**
 ...
 * ```
 */
const detectCloudExfiltration = (flows) => {
    const detections = [];
...
exports.detectCloudExfiltration = detectCloudExfiltration;
/**
 ...
 * ```
 */
const analyzeDataTransferPatterns = async (flows, baseline) => {
    const anomalies = [];
    if (!baseline) {
...
exports.analyzeDataTransferPatterns = analyzeDataTransferPatterns;
// ============================================================================
 ...
 * ```
 */
const matchNetworkIOCs = async (flows, iocs) => {
    const matches = [];
...
exports.matchNetworkIOCs = matchNetworkIOCs;
/**
 ...
 * ```
 */
const enrichIOCsWithNetworkContext = async (iocs, flows) => {
    const enrichedIOCs = [];
    for (const ioc of iocs) {
        const enriched = { ...ioc };
        if (ioc.indicatorType === 'IP') {
            // Find flows involving this IP
            const relatedFlows = flows.filter(f => f.sourceIp === ioc.value || f.destinationIp === ioc.value);
...
exports.enrichIOCsWithNetworkContext = enrichIOCsWithNetworkContext;
/**
 ...
 * ```
 */
const createIOCsFromNetworkThreats = (threats) => {
    const iocs = [];
...
exports.createIOCsFromNetworkThreats = createIOCsFromNetworkThreats;
/**
 ...
 * ```
 */
const validateNetworkIOCs = async (iocs, flows) => {
...
exports.validateNetworkIOCs = validateNetworkIOCs;
// ============================================================================
 ...
 * ```
 */
const analyzeTrafficPatterns = async (flows, options) => {
    const patterns = [];
    const timeWindow = options?.timeWindow || 3600000; // 1 hour default
    // Aggregate flows by time window
    const aggregated = await (0, exports.aggregateFlowsByTimeWindow)(flows, timeWindow);
 ...
 * ```
 */
const calculateTrafficBaseline = async (historicalFlows) => {
...
exports.calculateTrafficBaseline = calculateTrafficBaseline;
/**
 ...
 * ```
 */
const detectTrafficAnomalies = async (flows, baseline) => {
    const anomalies = [];
...
exports.detectTrafficAnomalies = detectTrafficAnomalies;
/**
 ...
 * ```
 */
const generateTrafficReport = async (flows, options) => {
    const totalBytes = flows.reduce((sum, f) => sum + f.bytesIn + f.bytesOut, 0);
    const protocols = new Map();
    const topSourceIPs = new Map();
    const topDestIPs = new Map();
    let threatCount = 0;
    for (const flow of flows) {
        protocols.set(flow.protocol, (protocols.get(flow.protocol) || 0) + 1);
...
exports.generateTrafficReport = generateTrafficReport;
// ============================================================================
 ...
 * ```
 */
const integrateNetworkThreatIntel = async (flows, threatIntel) => {
    const results = [];
...
exports.integrateNetworkThreatIntel = integrateNetworkThreatIntel;
/**
 ...
 * ```
 */
const queryNetworkThreatIntel = async (indicators, providers) => {
    const results = [];
...
exports.queryNetworkThreatIntel = queryNetworkThreatIntel;
/**
 ...
 * ```
 */
const updateNetworkThreatIntelCache = async (newIntel) => {
...
exports.updateNetworkThreatIntelCache = updateNetworkThreatIntelCache;
// ============================================================================
// HELPER FUNCTIONS
// ============================================================================
/**
 ...
 */
const detectApplicationProtocol = (flow) => {
 ...
 */
const getMaxSeverity = (indicators) => {
 ...
 */
const containsShellcode = (content) => {
 ...
 */
const calculateWindowAnomalyScore = (metrics) => {
    let score = 0;
    // High packet count
...
//# sourceMappingURL=network-traffic-analysis-kit.js.map