 ...
 * File: /reuse/threat/composites/downstream/ml-based-security-analytics.ts
 * Locator: WC-MLSA-001
 * Purpose: Ml Analytics - Production-grade implementation
 *
 ...
 * Exports: NestJS controller and service for ml-analytics operations
 *
 * LLM Context: Production-ready ml-analytics system for White Cross healthcare threat
 * intelligence platform. Provides comprehensive ml-analytics capabilities including
...
@ApiBearerAuth()
export class MlBasedSecurityAnalyticsController {
  private readonly logger = createLogger(MlBasedSecurityAnalyticsController.name);

  constructor(private readonly service: MlBasedSecurityAnalyticsService) {}
  ...
  @ApiOperation({ summary: 'Create new ml-analytics operation' })
   ...
   */
  @Get(':id')
  @ApiOperation({ summary: 'Get ml-analytics operation by ID' })
   ...
   */
  @Get()
  @ApiOperation({ summary: 'List all ml-analytics operations' })
   ...
   */
  @Put(':id')
  @ApiOperation({ summary: 'Update ml-analytics operation' })
  @ApiParam({ name: 'id', description: 'Operation ID' })
  ...
  @ApiOperation({ summary: 'Delete ml-analytics operation' })
  @ApiParam({ name: 'id', description: 'Operation ID' })
   ...
   */
  @Get('stats/summary')
  @ApiOperation({ summary: 'Get ml-analytics operation statistics' })
...
@Injectable()
export class MlBasedSecurityAnalyticsService {
  private readonly logger = createLogger(MlBasedSecurityAnalyticsService.name);
...
export default {
  MlBasedSecurityAnalyticsController,
  MlBasedSecurityAnalyticsService,
};
