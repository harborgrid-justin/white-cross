 ...
 * File: /reuse/threat/composites/downstream/microservices-threat-detection-controllers.ts
 * Locator: WC-MTDC-001
 * Purpose: Threat Detection - Production-grade implementation
 *
 ...
 * Exports: NestJS controller and service for threat-detection operations
 *
 * LLM Context: Production-ready threat-detection system for White Cross healthcare threat
 * intelligence platform. Provides comprehensive threat-detection capabilities including
...
@ApiBearerAuth()
export class MicroservicesThreatDetectionControllersController {
  private readonly logger = createLogger(MicroservicesThreatDetectionControllersController.name);

  constructor(private readonly service: MicroservicesThreatDetectionControllersService) {}
  ...
  @ApiOperation({ summary: 'Create new threat-detection operation' })
   ...
   */
  @Get(':id')
  @ApiOperation({ summary: 'Get threat-detection operation by ID' })
   ...
   */
  @Get()
  @ApiOperation({ summary: 'List all threat-detection operations' })
   ...
   */
  @Put(':id')
  @ApiOperation({ summary: 'Update threat-detection operation' })
  @ApiParam({ name: 'id', description: 'Operation ID' })
  ...
  @ApiOperation({ summary: 'Delete threat-detection operation' })
  @ApiParam({ name: 'id', description: 'Operation ID' })
   ...
   */
  @Get('stats/summary')
  @ApiOperation({ summary: 'Get threat-detection operation statistics' })
...
@Injectable()
export class MicroservicesThreatDetectionControllersService {
  private readonly logger = createLogger(MicroservicesThreatDetectionControllersService.name);
...
export default {
  MicroservicesThreatDetectionControllersController,
  MicroservicesThreatDetectionControllersService,
};
