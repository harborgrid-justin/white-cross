 ...
 * File: /reuse/threat/composites/downstream/client-sdk-generators.ts
 * Locator: WC-CSG-001
 * Purpose: Client Sdk Generators - Production-grade implementation
 *
...
@Controller('api/v1/client-sdk-generators')
@ApiTags('client-sdk-generators')
@ApiBearerAuth()
export class ClientSdkGeneratorsController {
  private readonly logger = createLogger(ClientSdkGeneratorsController.name);

  constructor(private readonly service: ClientSdkGeneratorsService) {}
...
@Injectable()
export class ClientSdkGeneratorsService {
  private readonly logger = createLogger(ClientSdkGeneratorsService.name);
...
export default {
  ClientSdkGeneratorsController,
  ClientSdkGeneratorsService,
};
