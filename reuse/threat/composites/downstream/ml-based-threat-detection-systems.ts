...
/**
 * File: /reuse/threat/composites/downstream/ml-based-threat-detection-systems.ts
 * Locator: WC-MLTDS-001
 * Purpose: Ml Detection - Production-grade implementation
 *
 ...
 * Exports: NestJS controller and service for ml-detection operations
 *
 * LLM Context: Production-ready ml-detection system for White Cross healthcare threat
 * intelligence platform. Provides comprehensive ml-detection capabilities including
...
@Controller('api/v1/ml-detection')
@ApiTags('ml-detection')
@ApiBearerAuth()
export class MlBasedThreatDetectionSystemsController {
  private readonly logger = createLogger(MlBasedThreatDetectionSystemsController.name);

  constructor(private readonly service: MlBasedThreatDetectionSystemsService) {}
  ...
  @ApiOperation({ summary: 'Create new ml-detection operation' })
   ...
   */
  @Get(':id')
  @ApiOperation({ summary: 'Get ml-detection operation by ID' })
   ...
   */
  @Get()
  @ApiOperation({ summary: 'List all ml-detection operations' })
   ...
   */
  @Put(':id')
  @ApiOperation({ summary: 'Update ml-detection operation' })
  @ApiParam({ name: 'id', description: 'Operation ID' })
  ...
  @ApiOperation({ summary: 'Delete ml-detection operation' })
  @ApiParam({ name: 'id', description: 'Operation ID' })
   ...
   */
  @Get('stats/summary')
  @ApiOperation({ summary: 'Get ml-detection operation statistics' })
...
@Injectable()
export class MlBasedThreatDetectionSystemsService {
  private readonly logger = createLogger(MlBasedThreatDetectionSystemsService.name);
...
export default {
  MlBasedThreatDetectionSystemsController,
  MlBasedThreatDetectionSystemsService,
};
