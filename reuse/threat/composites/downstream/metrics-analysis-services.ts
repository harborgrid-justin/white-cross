 ...
 * File: /reuse/threat/composites/downstream/metrics-analysis-services.ts
 * Locator: WC-MAS-001
 * Purpose: Analytics - Production-grade implementation
 *
 ...
 * Exports: NestJS controller and service for analytics operations
 *
 * LLM Context: Production-ready analytics system for White Cross healthcare threat
 * intelligence platform. Provides comprehensive analytics capabilities including
...
@ApiTags('analytics')
@ApiBearerAuth()
export class MetricsAnalysisServicesController {
  private readonly logger = createLogger(MetricsAnalysisServicesController.name);

  constructor(private readonly service: MetricsAnalysisServicesService) {}
  ...
  @ApiOperation({ summary: 'Create new analytics operation' })
   ...
   */
  @Get(':id')
  @ApiOperation({ summary: 'Get analytics operation by ID' })
   ...
   */
  @Get()
  @ApiOperation({ summary: 'List all analytics operations' })
   ...
   */
  @Put(':id')
  @ApiOperation({ summary: 'Update analytics operation' })
  @ApiParam({ name: 'id', description: 'Operation ID' })
  ...
  @ApiOperation({ summary: 'Delete analytics operation' })
  @ApiParam({ name: 'id', description: 'Operation ID' })
   ...
   */
  @Get('stats/summary')
  @ApiOperation({ summary: 'Get analytics operation statistics' })
...
@Injectable()
export class MetricsAnalysisServicesService {
  private readonly logger = createLogger(MetricsAnalysisServicesService.name);
...
export default {
  MetricsAnalysisServicesController,
  MetricsAnalysisServicesService,
};
