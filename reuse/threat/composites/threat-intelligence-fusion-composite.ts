...
export {
  ...
  validateIntelFeedSchema,
  mergeIntelFeeds,
  prioritizeIntelFeeds,
  filterIntelByRelevance,
  categorizeIntelData,
  transformIntelFormat,
  deduplicateIntelligence,
  fuzzyMatchIntelligence,
  canonicalizeIntelValue,
  detectDuplicatePatterns,
  mergeDuplicateIntel,
  correlateAcrossSources,
  findIntelOverlaps,
  calculateCorrelationScore,
  identifyIntelClusters,
  ...
  rankIntelSources,
  detectIntelConflicts,
  resolveConflictByVoting,
  resolveConflictByReliability,
  flagUnresolvableConflicts,
  enrichFromMultipleSources,
  crossReferenceIntelligence,
  enhanceIntelMetadata,
  supplementMissingFields,
  generateFusionReport,
  analyzeFusionEffectiveness,
  trackFusionMetrics,
  visualizeFusionResults,
  // Type exports
  ...
  IntelligenceType,
  ThreatSeverity,
  getIntelFeedSourceModelAttributes,
  getFusedIntelligenceModelAttributes,
  getSourceReliabilityMetricsModelAttributes,
  getIntelCorrelationModelAttributes,
} from '../threat-intelligence-fusion-kit';
...
export {
  ...
  aggregateConfidenceScores as aggregateCorrelationConfidenceScores,
  calculateConfidenceInterval,
  normalizeConfidenceMetrics,
  // Type exports
  type CorrelationConfig,
  type CorrelationResult,
  type IOCRelationship,
...
export {
  ...
  detectBehavioralAnomalies as detectEventBehavioralAnomalies,
  ...
  // Type exports
  type SecurityEvent,
  type CorrelationResult as EventCorrelationResult,
  EventSeverity,
  AttackStage,
