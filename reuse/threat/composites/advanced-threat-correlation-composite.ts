...
import {
  ...
  GraphMetrics,
} from '../threat-graph-analysis-kit';

import {
  // Attribution analysis
  createAttributionAnalysis,
  calculateMultiFactorAttribution,
...
} from '../threat-attribution-analysis-kit';
 ...
 */
export const apiCorrelateThreatsByAttributes = correlateThreatsByAttributes;
 ...
 *                   example: 0.85
 */
export const apiCalculateWeightedCorrelation = calculateWeightedCorrelation;
 ...
 *         $ref: '#/components/responses/ValidationError'
 */
export const apiCrossReferenceIOCs = crossReferenceIOCs;
 ...
 */
export const apiBuildCorrelationMatrix = buildCorrelationMatrix;
 ...
 */
export const apiFindCorrelationClusters = findCorrelationClusters;
 ...
 *                   example: 0.87
 */
export const apiScoreCorrelationStrength = scoreCorrelationStrength;
 ...
 */
export const apiNormalizeCorrelationData = normalizeCorrelationData;
 ...
 *                   $ref: '#/components/schemas/CorrelationResult'
 */
export const apiAggregateCorrelationResults = aggregateCorrelationResults;
 ...
 *         $ref: '#/components/responses/ValidationError'
 */
export const apiDiscoverIOCRelationships = discoverIOCRelationships;
 ...
 *                   example: 0.85
 */
export const apiCalculateRelationshipStrength = calculateRelationshipStrength;
 ...
 */
export const apiBuildRelationshipGraph = buildRelationshipGraph;
 ...
 */
export const apiFindConnectedIOCs = findConnectedIOCs;
 ...
 *                   type: string
 */
export const apiDetectIOCClusters = detectIOCClusters;
 ...
 *                   type: integer
 */
export const apiAnalyzeGraphConnectivity = analyzeGraphConnectivity;
 ...
 *                   type: string
 */
export const apiExtractRelationshipPaths = extractRelationshipPaths;
 ...
 */
export const apiScoreRelationshipConfidence = scoreRelationshipConfidence;
 ...
 */
export const apiAnalyzeTemporalPatterns = analyzeTemporalPatterns;
 ...
 */
export const apiCorrelateEventSequences = correlateEventSequences;
 ...
 */
export const apiDetectTimeBasedClusters = detectTimeBasedClusters;
 ...
 */
export const apiCalculateTemporalProximity = calculateTemporalProximity;
 ...
 */
export const apiBuildTimelineCorrelation = buildTimelineCorrelation;
 ...
 *                 $ref: '#/components/schemas/TemporalAnomaly'
 */
export const apiFindTemporalAnomalies = findTemporalAnomalies;
 ...
 */
export const apiAggregateTimeWindows = aggregateTimeWindows;
 ...
 */
export const apiScoreTemporalRelevance = scoreTemporalRelevance;
 ...
 */
export const apiCorrelateByGeoLocation = correlateByGeoLocation;
 ...
 *                   example: "km"
 */
export const apiCalculateGeoProximity = calculateGeoProximity;
 ...
 *                 $ref: '#/components/schemas/GeoCluster'
 */
export const apiClusterByRegion = clusterByRegion;
 ...
 */
export const apiDetectGeoAnomalies = detectGeoAnomalies;
 ...
 *               $ref: '#/components/schemas/HeatmapData'
 */
export const apiBuildSpatialHeatmap = buildSpatialHeatmap;
 ...
 */
export const apiScoreGeoCorrelation = scoreGeoCorrelation;
 ...
 */
export const apiCorrelateBehaviorPatterns = correlateBehaviorPatterns;
 ...
 */
export const apiDetectBehavioralAnomalies = detectBehavioralAnomalies;
 ...
 */
export const apiFingerprintThreatBehavior = fingerprintThreatBehavior;
 ...
 */
export const apiMatchBehaviorSignatures = matchBehaviorSignatures;
 ...
 */
export const apiScoreBehaviorSimilarity = scoreBehaviorSimilarity;
 ...
 */
export const apiClassifyThreatBehavior = classifyThreatBehavior;
 ...
 */
export const apiCreateThreatGraph = createThreatGraph;
 ...
 */
export const apiAddNode = addNode;
 ...
 *         description: Updated graph
 */
export const apiAddEdge = addEdge;
 ...
 */
export const apiBuildGraphFromIndicators = buildGraphFromIndicators;
 ...
 */
export const apiMergeGraphs = mergeGraphs;
 ...
 */
export const apiFilterGraph = filterGraph;
 ...
 */
export const apiBreadthFirstSearch = breadthFirstSearch;
 ...
 */
export const apiDepthFirstSearch = depthFirstSearch;
 ...
 */
export const apiGetNeighbors = getNeighbors;
 ...
 */
export const apiFindAllPaths = findAllPaths;
 ...
 */
export const apiFindShortestPath = findShortestCorrelationPath;
 ...
 */
export const apiCalculateCentrality = calculateCentralityMetrics;
 ...
 */
export const apiDetectCommunities = detectThreatCommunities;
 ...
 */
export const apiAnalyzeGraphDensity = analyzeGraphDensity;
 ...
 */
export const apiExtractSubgraphs = extractSubgraphs;
 ...
 */
export const apiCalculateCorrelationConfidence = calculateCorrelationConfidence;
 ...
 */
export const apiWeightEvidenceSources = weightEvidenceSources;
 ...
 */
export const apiAggregateConfidenceScores = aggregateConfidenceScores;
 ...
 */
export const apiCalculateConfidenceInterval = calculateConfidenceInterval;
 ...
 */
export const apiNormalizeConfidenceMetrics = normalizeConfidenceMetrics;
 ...
 */
export const apiCreateAttributionAnalysis = createAttributionAnalysis;
 ...
 *                     type: number
 */
export const apiCalculateMultiFactorAttribution = calculateMultiFactorAttribution;
