 ...
 */
export { createDataLakeConfig, validateDataLakeConfig, generatePartitionKey, calculateOptimalShardCount, ingestTimeSeriesData, determinePartition, queryTimeSeriesData, aggregateTimeSeriesData, createPartition, mergePartitions, splitPartition, rebalanceShards, applyRetentionPolicy, archivePartitions, restoreArchivedData, estimateStorageCosts, generateOptimizedQueryPlan, analyzeQueryPerformance, createMaterializedView, compressPartition, decompressPartition, deduplicateData, identifyDuplicatePartitions, calculateDataLakeStatistics, monitorDataLakeHealth, generateOptimizationReport, formatBytes, formatDuration, type DataLakeConfig, type RetentionPolicy, type IndexingStrategy, type PartitionStrategy, type ShardStrategy, type CompressionAlgorithm, StorageTier, } from '../threat-data-lake-kit';
export { correlateEventsInTimeWindow, detectMultiStageAttacks, aggregateEventsByDimensions, detectComplexEventPatterns, correlateEventsByStatisticalAnomaly, generateIncidentsFromCorrelations, calculateCorrelationConfidence, calculateWindowDuration, findEventClusters, detectBehavioralAnomalies, findTemporalSequences, detectEventVelocitySpikes, getCorrelationStats, purgeOldCorrelations, mergeCorrelationResults, calculateCorrelationScore, type SecurityEvent, type CorrelationResult, type TimeWindowConfig, CorrelationType, CorrelationWindow, EventSeverity, } from '../security-event-correlation-kit';
export { correlateThreatsByAttributes, calculateWeightedCorrelation, buildCorrelationMatrix, findCorrelationClusters, scoreCorrelationStrength, normalizeCorrelationData, aggregateCorrelationResults, analyzeTemporalPatterns, correlateEventSequences, detectTimeBasedClusters, calculateTemporalProximity, buildTimelineCorrelation, findTemporalAnomalies, aggregateTimeWindows, scoreTemporalRelevance, type CorrelationConfig, type CorrelationResult as ThreatCorrelationResult, type TemporalCorrelation, type TimeWindow, } from '../threat-correlation-kit';
/**
 ...
 */
//# sourceMappingURL=threat-data-analytics-composite.d.ts.map