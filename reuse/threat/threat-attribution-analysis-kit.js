...
exports.generateAttributionExecutiveSummary = exports.identifyAttributionKnowledgeGaps = exports.generateAttributionPlaybook = exports.calculateAttributionROI = exports.generateAttributionTimeline = exports.validateAttributionMethodology = exports.exportAttributionToJSON = exports.identifyAttributionBias = exports.generateAttributionConfidenceInterval = exports.calculateAttributionDecay = exports.compareAttributionAnalyses = exports.generateAlternativeHypotheses = exports.identifyFalsePositiveRisks = exports.calculateAttributionProbability = exports.createAttributionSwaggerDocs = exports.createAttributionModels = exports.createAttributionAnalysisService = exports.generateAttributionReport = exports.analyzeTargetPatterns = exports.analyzeTimingPatterns = exports.analyzeTemporalConsistency = exports.calculateAttributionConfidence = exports.correlateGeolocationWithActors = exports.analyzeGeolocationPatterns = exports.createGeolocationIntelligence = exports.compareLinguisticPatterns = exports.performLinguisticAnalysis = exports.identifyCodeFamilies = exports.calculateCodeSimilarityConfidence = exports.performCodeSimilarity = exports.analyzePassiveDNS = exports.identifyInfrastructurePivots = exports.analyzeInfrastructureCorrelation = exports.createInfrastructureCorrelation = exports.analyzeEvidenceDiversity = exports.validateAttributionEvidence = exports.createAttributionEvidence = exports.rankAttributionCandidates = exports.calculateMultiFactorAttribution = exports.createAttributionAnalysis = void 0;
passive;
DNS ?  : PassiveDNSData[];
// ============================================================================
 ...
 * ```
 */
const createAttributionAnalysis = (data) => {
    const now = new Date();
    return {
...
exports.createAttributionAnalysis = createAttributionAnalysis;
/**
 ...
 * ```
 */
const calculateMultiFactorAttribution = (factors) => {
    if (factors.length === 0) {
...
exports.calculateMultiFactorAttribution = calculateMultiFactorAttribution;
/**
 ...
 * ```
 */
const rankAttributionCandidates = (candidates) => {
    ...
    ranked.forEach((candidate, index) => {
        ...
        if (avgScore >= 80)
            candidate.likelihood = 'very-high';
        else if (avgScore >= 60)
            ...
            candidate.likelihood = 'very-low';
    });
    return ranked;
};
exports.rankAttributionCandidates = rankAttributionCandidates;
/**
 ...
 * ```
 */
const createAttributionEvidence = (data) => {
    return {
...
exports.createAttributionEvidence = createAttributionEvidence;
/**
 ...
 * ```
 */
const analyzeEvidenceDiversity = (evidence) => {
    const types = {};
    const categories = {};
    evidence.forEach(ev => {
...
exports.analyzeEvidenceDiversity = analyzeEvidenceDiversity;
// ============================================================================
 ...
 * ```
 */
const createInfrastructureCorrelation = (data) => {
    const now = new Date();
    return {
...
exports.createInfrastructureCorrelation = createInfrastructureCorrelation;
/**
 ...
 * ```
 */
const analyzeInfrastructureCorrelation = (infrastructure, actorId) => {
...
exports.analyzeInfrastructureCorrelation = analyzeInfrastructureCorrelation;
/**
 ...
 * ```
 */
const analyzePassiveDNS = (passiveDNS) => {
    const ipHistory = {};
...
exports.analyzePassiveDNS = analyzePassiveDNS;
// ============================================================================
 ...
 * ```
 */
const performCodeSimilarity = (sampleId, comparisonId, data) => {
    ...
    const similarityScore = Math.round(funcScore * 0.3 +
        stringScore * 0.15 +
        libraryScore * 0.1 +
...
exports.performCodeSimilarity = performCodeSimilarity;
/**
 ...
 * ```
 */
const calculateCodeSimilarityConfidence = (analysis) => {
    const reasons = [];
...
exports.calculateCodeSimilarityConfidence = calculateCodeSimilarityConfidence;
/**
 ...
 * ```
 */
const identifyCodeFamilies = (analyses, threshold = 70) => {
    const adjacencyMap = {};
...
exports.identifyCodeFamilies = identifyCodeFamilies;
// ============================================================================
 ...
 * ```
 */
const performLinguisticAnalysis = (textId, text, textType) => {
...
exports.performLinguisticAnalysis = performLinguisticAnalysis;
/**
...
const detectLanguage = (text) => {
    ...
    if (englishMatches > russianMatches && englishMatches > chineseMatches)
        return 'English';
    if (russianMatches > englishMatches && russianMatches > chineseMatches)
        return 'Russian';
    if (chineseMatches > 0)
        return 'Chinese';
    return 'Unknown';
 ...
 */
const extractCharacteristicTerms = (text) => {
 ...
 */
const analyzeGrammarPatterns = (text) => {
    const patterns = [];
 ...
 */
const detectTranslationIndicators = (text) => {
    const indicators = [];
 ...
 * ```
 */
const compareLinguisticPatterns = (analysis1, analysis2) => {
...
exports.compareLinguisticPatterns = compareLinguisticPatterns;
// ============================================================================
 ...
 * ```
 */
const createGeolocationIntelligence = (data) => {
    return {
...
exports.createGeolocationIntelligence = createGeolocationIntelligence;
/**
 ...
 * ```
 */
const analyzeGeolocationPatterns = (geoData) => {
...
exports.analyzeGeolocationPatterns = analyzeGeolocationPatterns;
/**
 ...
 * ```
 */
const correlateGeolocationWithActors = (geoData, actorPatterns) => {
...
exports.correlateGeolocationWithActors = correlateGeolocationWithActors;
// ============================================================================
 ...
 * ```
 */
const calculateAttributionConfidence = (data) => {
    const evidenceValidation = (0, exports.validateAttributionEvidence)(data.evidence);
    const evidenceQuality = evidenceValidation.quality;
    const evidenceQuantity = data.evidence.length;
    const diversityAnalysis = (0, exports.analyzeEvidenceDiversity)(data.evidence);
    ...
    const factorContributions = data.factors.map(factor => ({
    ...
    const overallConfidence = Math.round(evidenceQuality * 0.3 +
    ...
    if (evidenceQuality < 50)
        uncertaintyFactors.push('Low evidence quality');
    if (evidenceQuantity < 3)
        uncertaintyFactors.push('Insufficient evidence');
    if (evidenceDiversity < 40)
        uncertaintyFactors.push('Limited evidence diversity');
    if (conflictingEvidence > 0)
        uncertaintyFactors.push(`${conflictingEvidence} conflicting evidence items`);
    const recommendations = [];
    if (evidenceQuantity < 5)
        recommendations.push('Gather additional evidence');
    if (evidenceDiversity < 50)
        recommendations.push('Seek diverse evidence types');
    if (verifiedEvidence < evidenceQuantity * 0.5)
        recommendations.push('Validate existing evidence');
    return {
        overallConfidence,
        factorContributions,
        evidenceQuality,
 ...
 * ```
 */
const analyzeTemporalConsistency = (evidence) => {
    if (evidence.length === 0) {
...
exports.analyzeTemporalConsistency = analyzeTemporalConsistency;
// ============================================================================
 ...
 * ```
 */
const analyzeTimingPatterns = (data) => {
    ...
    let activityPattern = 'intermittent';
...
exports.analyzeTimingPatterns = analyzeTimingPatterns;
// ============================================================================
 ...
 * ```
 */
const analyzeTargetPatterns = (data) => {
    ...
    const targetCategories = Object.entries(sectorCounts).map(([sector, count]) => ({
        category: sector,
        count,
    ...
    const geographicFocus = Object.entries(countryCounts)
        .sort((a, b) => b[1] - a[1])
        .slice(0, 5)
    ...
    let targetingStrategy = 'opportunistic';
    if (topSectorPercentage > 70)
        targetingStrategy = 'highly-targeted';
    else if (topSectorPercentage > 40)
        targetingStrategy = 'selective';
    else if (victims.length > 100)
        targetingStrategy = 'indiscriminate';
    return {
        actorId: data.actorId,
        targetCategories,
        geographicFocus,
...
exports.analyzeTargetPatterns = analyzeTargetPatterns;
// ============================================================================
 ...
 * ```
 */
const generateAttributionReport = (data) => {
    return {
...
exports.generateAttributionReport = generateAttributionReport;
// ============================================================================
 ...
 * ```
 */
const createAttributionAnalysisService = () => {
    return 'ThreatAttributionAnalysisService template - see example above';
};
exports.createAttributionAnalysisService = createAttributionAnalysisService;
// ============================================================================
 ...
 * ```
 */
const createAttributionModels = () => {
    return 'Attribution Sequelize models - see example above';
};
exports.createAttributionModels = createAttributionModels;
// ============================================================================
 ...
 * ```
 */
const createAttributionSwaggerDocs = () => {
    return 'Swagger API documentation - see example above';
};
exports.createAttributionSwaggerDocs = createAttributionSwaggerDocs;
// ============================================================================
 ...
 * ```
 */
const calculateAttributionProbability = (candidates) => {
...
exports.calculateAttributionProbability = calculateAttributionProbability;
/**
 ...
 * ```
 */
const identifyFalsePositiveRisks = (analysis) => {
    const indicators = [];
    const mitigation = [];
    let riskScore = 0;
    // Low evidence diversity
    const diversity = (0, exports.analyzeEvidenceDiversity)(analysis.evidenceCollection);
...
exports.identifyFalsePositiveRisks = identifyFalsePositiveRisks;
/**
 ...
 * ```
 */
const generateAlternativeHypotheses = (analysis) => {
    const hypotheses = [];
...
exports.generateAlternativeHypotheses = generateAlternativeHypotheses;
/**
 ...
 * ```
 */
const compareAttributionAnalyses = (analyses) => {
    const actorCounts = {};
    const agreements = [];
    const conflicts = [];
    analyses.forEach(analysis => {
...
exports.compareAttributionAnalyses = compareAttributionAnalyses;
/**
 ...
 * ```
 */
const calculateAttributionDecay = (analysis, daysSinceAnalysis) => {
    const recommendations = [];
...
exports.calculateAttributionDecay = calculateAttributionDecay;
/**
 ...
 * ```
 */
const generateAttributionConfidenceInterval = (analysis, confidenceLevel = 95) => {
    const mean = analysis.attributionScore;
    // Simplified confidence interval based on evidence quality
    const evidenceValidation = (0, exports.validateAttributionEvidence)(analysis.evidenceCollection);
...
exports.generateAttributionConfidenceInterval = generateAttributionConfidenceInterval;
/**
 ...
 * ```
 */
const identifyAttributionBias = (analysis, context) => {
    const biases = [];
    const mitigation = [];
    ...
    if (context.previousAttributions && context.analyst) {
        ...
        const topActor = analysis.topCandidates[0]?.actorId;
        const sameActorCount = analystPreviousAttrs.filter(a => a.topCandidates[0]?.actorId === topActor).length;
        if (sameActorCount >= 3) {
...
exports.identifyAttributionBias = identifyAttributionBias;
/**
 ...
 * ```
 */
const exportAttributionToJSON = (analysis, includeEvidence = true) => {
    return {
        id: analysis.id,
        ...
        evidenceSummary: {
            ...
            types: (0, exports.analyzeEvidenceDiversity)(analysis.evidenceCollection).types,
        },
...
exports.exportAttributionToJSON = exportAttributionToJSON;
/**
 ...
 * ```
 */
const validateAttributionMethodology = (analysis) => {
    const issues = [];
    let score = 100;
    ...
    const validation = (0, exports.validateAttributionEvidence)(analysis.evidenceCollection);
    if (!validation.valid) {
...
exports.validateAttributionMethodology = validateAttributionMethodology;
/**
 ...
 * ```
 */
const generateAttributionTimeline = (evidence) => {
...
exports.generateAttributionTimeline = generateAttributionTimeline;
/**
 ...
 * ```
 */
const calculateAttributionROI = (analysis, costs) => {
    // Calculate costs
...
exports.calculateAttributionROI = calculateAttributionROI;
/**
 ...
 * ```
 */
const generateAttributionPlaybook = (analysis) => {
    const defensive = [];
    const offensive = [];
    const intelligence = [];
...
exports.generateAttributionPlaybook = generateAttributionPlaybook;
/**
 ...
 * ```
 */
const identifyAttributionKnowledgeGaps = (analysis) => {
    const gaps = [];
    const priorities = [];
    const recommendations = [];
...
exports.identifyAttributionKnowledgeGaps = identifyAttributionKnowledgeGaps;
/**
 ...
 * ```
 */
const generateAttributionExecutiveSummary = (analysis, report) => {
    const topCandidate = analysis.topCandidates[0];
    const keyPoints = [];
    const recommendations = [];
...
exports.generateAttributionExecutiveSummary = generateAttributionExecutiveSummary;
//# sourceMappingURL=threat-attribution-analysis-kit.js.map