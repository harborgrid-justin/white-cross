...
exports.parseXmlFeed = exports.applyFeedFilters = exports.routeIndicators = exports.filterIndicators = exports.invalidateFeedCache = exports.getCachedFeedData = exports.cacheFeedData = exports.normalizeConfidenceScores = exports.applyFeedTransformations = exports.transformFeedData = exports.calculateOptimalPollInterval = exports.coordinateFeedUpdates = exports.createFeedPriorityQueue = exports.generateFeedReport = exports.analyzeFeedQuality = exports.calculateFeedMetrics = exports.createFeedApiSpec = exports.createFeedManagementController = exports.defineFeedHealthModel = exports.defineThreatIndicatorModel = exports.defineThreatFeedModel = exports.validateRateLimitConfig = exports.createFeedRateLimiter = exports.generateDeduplicationKey = exports.deduplicateIndicators = exports.calculateFeedErrorRate = exports.calculateFeedUptime = exports.monitorFeedHealth = exports.enrichIndicator = exports.aggregateThreatFeeds = exports.validateIndicator = exports.parseCsvFeed = exports.parseJsonFeed = exports.normalizeThreatIndicator = exports.processWebhookPayload = exports.validateWebhookSource = exports.validateWebhookSignature = exports.calculateNextPollTime = exports.validatePollingConfig = exports.createFeedPollingScheduler = exports.createFileFeedConnector = exports.createWebhookFeedConnector = exports.createRestFeedConnector = void 0;
// ============================================================================
 ...
 * ```
 */
const createRestFeedConnector = (config) => {
...
exports.createRestFeedConnector = createRestFeedConnector;
/**
 ...
 * ```
 */
const createWebhookFeedConnector = (config, webhookConfig) => {
    let isConnected = false;
    const connect = async () => {
...
exports.createWebhookFeedConnector = createWebhookFeedConnector;
/**
 ...
 * ```
 */
const createFileFeedConnector = (config) => {
    let isConnected = false;
    const connect = async () => {
...
exports.createFileFeedConnector = createFileFeedConnector;
// ============================================================================
 ...
 * ```
 */
const createFeedPollingScheduler = (config, fetchFn) => {
    let intervalId = null;
    let isRunning = false;
    const start = () => {
        if (isRunning) {
...
exports.createFeedPollingScheduler = createFeedPollingScheduler;
/**
 ...
 * ```
 */
const validatePollingConfig = (config) => {
 ...
 * ```
 */
const calculateNextPollTime = (failureCount, baseInterval, backoffMultiplier) => {
    if (failureCount === 0)
        return baseInterval;
    return baseInterval * Math.pow(backoffMultiplier, failureCount);
};
exports.calculateNextPollTime = calculateNextPollTime;
// ============================================================================
// WEBHOOK HANDLING
// ============================================================================
/**
 ...
 * ```
 */
const validateWebhookSource = (sourceIp, whitelist) => {
    if (!whitelist || whitelist.length === 0)
        return true;
    return whitelist.includes(sourceIp);
};
exports.validateWebhookSource = validateWebhookSource;
/**
 ...
 * ```
 */
const processWebhookPayload = (payload, format) => {
 ...
 * ```
 */
const normalizeThreatIndicator = (rawData, rules) => {
    const normalized = {
        id: '',
        type: 'ip',
        value: '',
...
exports.normalizeThreatIndicator = normalizeThreatIndicator;
/**
...
exports.parseJsonFeed = parseJsonFeed;
/**
 ...
 * ```
 */
const parseCsvFeed = (csvData, columnMapping) => {
    ...
    for (let i = 1; i < lines.length; i++) {
        ...
        headers.forEach((header, index) => {
            ...
            if (targetField) {
                indicator[targetField] = values[index];
            }
        });
...
exports.parseCsvFeed = parseCsvFeed;
/**
 ...
 * ```
 */
const aggregateThreatFeeds = (feedIndicators, rule) => {
    const aggregated = [];
    ...
    indicatorMap.forEach((indicators, key) => {
        ...
        switch (rule.mergeStrategy) {
            ...
            case 'consensus':
                ...
                break;
            case 'latest':
                merged = indicators.reduce((latest, current) => current.lastSeen > latest.lastSeen ? current : latest);
                break;
            default:
                merged = indicators[0];
        }
 ...
 */
const mergeByConsensus = (indicators, conflictResolution) => {
    const base = indicators[0];
    switch (conflictResolution) {
        case 'highest-confidence':
            return indicators.reduce((highest, current) => current.confidence > highest.confidence ? current : highest);
        case 'newest':
            return indicators.reduce((newest, current) => current.lastSeen > newest.lastSeen ? current : newest);
        default:
            return base;
    }
};
 ...
 * ```
 */
const enrichIndicator = (indicator, enrichmentData) => {
    return {
        ...indicator,
        metadata: {
            ...indicator.metadata,
...
exports.enrichIndicator = enrichIndicator;
// ============================================================================
 ...
 * ```
 */
const monitorFeedHealth = async (feedId, healthCheckFn) => {
    const startTime = Date.now();
    const health = {
        feedId,
        status: 'healthy',
 ...
 * ```
 */
const calculateFeedUptime = (totalChecks, successfulChecks) => {
    if (totalChecks === 0)
        return 0;
    return (successfulChecks / totalChecks) * 100;
};
exports.calculateFeedUptime = calculateFeedUptime;
/**
 ...
 * ```
 */
const calculateFeedErrorRate = (totalRequests, failedRequests) => {
    if (totalRequests === 0)
        return 0;
    return (failedRequests / totalRequests) * 100;
};
exports.calculateFeedErrorRate = calculateFeedErrorRate;
// ============================================================================
// DEDUPLICATION
// ============================================================================
/**
 ...
 * ```
 */
const deduplicateIndicators = (indicators, config) => {
    const seen = new Set();
    const deduplicated = [];
    for (const indicator of indicators) {
        const key = (0, exports.generateDeduplicationKey)(indicator, config);
        if (!seen.has(key)) {
            seen.add(key);
...
exports.deduplicateIndicators = deduplicateIndicators;
/**
 ...
 * ```
 */
const generateDeduplicationKey = (indicator, config) => {
    const values = config.fields.map(field => indicator[field]);
 ...
 * ```
 */
const createFeedRateLimiter = (config) => {
    const requestLog = [];
    const checkLimit = () => {
        const now = Date.now();
...
exports.createFeedRateLimiter = createFeedRateLimiter;
/**
 ...
 * ```
 */
const defineThreatFeedModel = (sequelize, DataTypes) => {
...
exports.defineThreatFeedModel = defineThreatFeedModel;
/**
 ...
 * ```
 */
const defineThreatIndicatorModel = (sequelize, DataTypes) => {
...
exports.defineThreatIndicatorModel = defineThreatIndicatorModel;
/**
 ...
 * ```
 */
const defineFeedHealthModel = (sequelize, DataTypes) => {
...
exports.defineFeedHealthModel = defineFeedHealthModel;
// ============================================================================
// NESTJS CONTROLLERS
// ============================================================================
/**
 ...
 * ```
 */
const createFeedManagementController = () => {
    return `
...
exports.createFeedManagementController = createFeedManagementController;
/**
...
exports.createFeedApiSpec = createFeedApiSpec;
// ============================================================================
 ...
 * ```
 */
const calculateFeedMetrics = async (feedId, timeWindow) => {
    return {
        feedId,
...
exports.calculateFeedMetrics = calculateFeedMetrics;
/**
 ...
 * ```
 */
const analyzeFeedQuality = (metrics) => {
    if (metrics.indicatorsReceived === 0)
        return 0;
...
exports.analyzeFeedQuality = analyzeFeedQuality;
/**
 ...
 * ```
 */
const generateFeedReport = async (feedId, startDate, endDate) => {
    return {
        feedId,
...
exports.generateFeedReport = generateFeedReport;
// ============================================================================
 ...
 * ```
 */
const createFeedPriorityQueue = (feeds) => {
    return [...feeds].sort((a, b) => b.priority - a.priority);
};
exports.createFeedPriorityQueue = createFeedPriorityQueue;
/**
 ...
 * ```
 */
const coordinateFeedUpdates = async (feeds, maxConcurrent) => {
    const queue = (0, exports.createFeedPriorityQueue)(feeds);
    // Implementation would use concurrency control
};
exports.coordinateFeedUpdates = coordinateFeedUpdates;
/**
 ...
 * ```
 */
const calculateOptimalPollInterval = (feed, metrics) => {
    const baseInterval = feed.pollInterval || 300000;
    const qualityScore = (0, exports.analyzeFeedQuality)(metrics);
...
exports.calculateOptimalPollInterval = calculateOptimalPollInterval;
// ============================================================================
 ...
 * ```
 */
const transformFeedData = (rawData, format) => {
    // Transform based on format
    return [];
};
exports.transformFeedData = transformFeedData;
/**
 ...
 * ```
 */
const applyFeedTransformations = (indicator, transformations) => {
...
exports.applyFeedTransformations = applyFeedTransformations;
/**
 ...
 * ```
 */
const normalizeConfidenceScores = (indicators, feedWeights) => {
    return indicators.map(indicator => ({
        ...indicator,
        confidence: Math.min(100, indicator.confidence * (feedWeights[indicator.source] || 1.0)),
    }));
};
exports.normalizeConfidenceScores = normalizeConfidenceScores;
// ============================================================================
 ...
 * ```
 */
const cacheFeedData = async (feedId, indicators, ttl) => {
    // Implementation would use Redis or similar cache
};
exports.cacheFeedData = cacheFeedData;
/**
 ...
 * ```
 */
const getCachedFeedData = async (feedId) => {
    // Implementation would retrieve from cache
    return null;
};
exports.getCachedFeedData = getCachedFeedData;
/**
 ...
 * ```
 */
const invalidateFeedCache = async (feedId) => {
 ...
 * ```
 */
const filterIndicators = (indicators, criteria) => {
    return indicators.filter(indicator => {
        for (const [key, value] of Object.entries(criteria)) {
            const indicatorValue = indicator[key];
 ...
 * ```
 */
const routeIndicators = (indicators, handlers) => {
    indicators.forEach(indicator => {
...
exports.routeIndicators = routeIndicators;
/**
 ...
 * ```
 */
const applyFeedFilters = (indicators, feedId) => {
 ...
 * ```
 */
const parseXmlFeed = (xmlData, mapping) => {
...
exports.parseXmlFeed = parseXmlFeed;
// ============================================================================
// EXPORTS
// ============================================================================
exports.default = {
    // Feed connectors
    createRestFeedConnector: exports.createRestFeedConnector,
    createWebhookFeedConnector: exports.createWebhookFeedConnector,
    createFileFeedConnector: exports.createFileFeedConnector,
    // Polling
    createFeedPollingScheduler: exports.createFeedPollingScheduler,
    validatePollingConfig: exports.validatePollingConfig,
    calculateNextPollTime: exports.calculateNextPollTime,
    // Webhooks
    validateWebhookSignature: exports.validateWebhookSignature,
    validateWebhookSource: exports.validateWebhookSource,
    processWebhookPayload: exports.processWebhookPayload,
    // Normalization
    normalizeThreatIndicator: exports.normalizeThreatIndicator,
    parseJsonFeed: exports.parseJsonFeed,
    parseCsvFeed: exports.parseCsvFeed,
    parseXmlFeed: exports.parseXmlFeed,
    validateIndicator: exports.validateIndicator,
    // Aggregation
    aggregateThreatFeeds: exports.aggregateThreatFeeds,
    enrichIndicator: exports.enrichIndicator,
    // Health monitoring
    monitorFeedHealth: exports.monitorFeedHealth,
    calculateFeedUptime: exports.calculateFeedUptime,
    calculateFeedErrorRate: exports.calculateFeedErrorRate,
    // Deduplication
    deduplicateIndicators: exports.deduplicateIndicators,
    generateDeduplicationKey: exports.generateDeduplicationKey,
    // Rate limiting
    createFeedRateLimiter: exports.createFeedRateLimiter,
    validateRateLimitConfig: exports.validateRateLimitConfig,
    // Metrics and analytics
    calculateFeedMetrics: exports.calculateFeedMetrics,
    analyzeFeedQuality: exports.analyzeFeedQuality,
    generateFeedReport: exports.generateFeedReport,
    // Scheduling
    createFeedPriorityQueue: exports.createFeedPriorityQueue,
    coordinateFeedUpdates: exports.coordinateFeedUpdates,
    calculateOptimalPollInterval: exports.calculateOptimalPollInterval,
    // Transformation
    transformFeedData: exports.transformFeedData,
    applyFeedTransformations: exports.applyFeedTransformations,
    normalizeConfidenceScores: exports.normalizeConfidenceScores,
    // Caching
    cacheFeedData: exports.cacheFeedData,
    getCachedFeedData: exports.getCachedFeedData,
    invalidateFeedCache: exports.invalidateFeedCache,
    // Filtering and routing
    filterIndicators: exports.filterIndicators,
    routeIndicators: exports.routeIndicators,
    applyFeedFilters: exports.applyFeedFilters,
    // Sequelize models
    defineThreatFeedModel: exports.defineThreatFeedModel,
    defineThreatIndicatorModel: exports.defineThreatIndicatorModel,
    defineFeedHealthModel: exports.defineFeedHealthModel,
    // NestJS
    createFeedManagementController: exports.createFeedManagementController,
    createFeedApiSpec: exports.createFeedApiSpec,
};
//# sourceMappingURL=threat-feeds-integration-kit.js.map