...
exports.generateIntelligenceSharingPackage = exports.trackIntelligenceProvenance = exports.adjustIntelligenceConfidence = exports.detectIntelligenceGaps = exports.recommendIntelligence = exports.scoreIntelligenceQuality = exports.convertFromSTIX = exports.convertToSTIX = exports.generateIntelligenceSummaryReport = exports.correlateIntelligenceAcrossSources = exports.deduplicateIntelligence = exports.importThreatIntelligence = exports.exportThreatIntelligence = exports.getCachedEnrichment = exports.cacheEnrichmentData = exports.batchEnrichIntelligence = exports.enrichThreatIntelligence = exports.validateThreatIntelligence = exports.calculatePriorityScore = exports.sortIntelligenceByPriority = exports.applyPriorityRules = exports.findRelatedIntelligence = exports.advancedIntelligenceQuery = exports.searchThreatIntelligence = exports.archiveExpiredIntelligence = exports.extendIntelligenceExpiration = exports.updateIntelligenceStatus = exports.manageIntelligenceLifecycle = exports.createNormalizationRule = exports.batchNormalizeThreatData = exports.normalizeThreatData = exports.filterIntelligence = exports.synchronizeIntelligenceSources = exports.fetchIntelligenceFromSource = exports.aggregateIntelligence = exports.getIntelligenceValidationModelAttributes = exports.getEnrichmentCacheModelAttributes = exports.getIntelligenceSourceModelAttributes = exports.getThreatIntelligenceModelAttributes = exports.EnrichmentType = exports.TransformationType = exports.ReferenceType = exports.IndicatorType = exports.IntelligenceStatus = exports.IntelligencePriority = exports.TLPLevel = exports.ThreatSeverity = exports.IntelligenceType = exports.ReliabilityRating = exports.SourceType = void 0;
exports.automateIntelligenceEnrichment = exports.performIntelligenceHealthCheck = exports.generateIntelligenceTimeline = exports.performIntelligenceTriage = exports.calculateIntelligenceROI = exports.fuseIntelligence = void 0;
/**
 * File: /reuse/threat/threat-intelligence-platform-kit.ts
...
var SourceType;
(function (SourceType) {
    SourceType["COMMERCIAL_FEED"] = "COMMERCIAL_FEED";
    SourceType["OPEN_SOURCE"] = "OPEN_SOURCE";
    SourceType["GOVERNMENT"] = "GOVERNMENT";
    SourceType["COMMUNITY"] = "COMMUNITY";
    SourceType["INTERNAL"] = "INTERNAL";
    SourceType["SHARING_COMMUNITY"] = "SHARING_COMMUNITY";
    SourceType["DARK_WEB"] = "DARK_WEB";
    SourceType["SOCIAL_MEDIA"] = "SOCIAL_MEDIA";
})(SourceType || (exports.SourceType = SourceType = {}));
/**
 * Source reliability ratings
 */
var ReliabilityRating;
(function (ReliabilityRating) {
    ReliabilityRating["A_COMPLETELY_RELIABLE"] = "A_COMPLETELY_RELIABLE";
    ReliabilityRating["B_USUALLY_RELIABLE"] = "B_USUALLY_RELIABLE";
    ReliabilityRating["C_FAIRLY_RELIABLE"] = "C_FAIRLY_RELIABLE";
    ReliabilityRating["D_NOT_USUALLY_RELIABLE"] = "D_NOT_USUALLY_RELIABLE";
    ReliabilityRating["E_UNRELIABLE"] = "E_UNRELIABLE";
    ReliabilityRating["F_RELIABILITY_UNKNOWN"] = "F_RELIABILITY_UNKNOWN";
})(ReliabilityRating || (exports.ReliabilityRating = ReliabilityRating = {}));
/**
 * Intelligence types
 */
var IntelligenceType;
(function (IntelligenceType) {
    IntelligenceType["STRATEGIC"] = "STRATEGIC";
    IntelligenceType["TACTICAL"] = "TACTICAL";
    IntelligenceType["OPERATIONAL"] = "OPERATIONAL";
 ...
 */
var IntelligencePriority;
(function (IntelligencePriority) {
    IntelligencePriority["CRITICAL"] = "CRITICAL";
    IntelligencePriority["HIGH"] = "HIGH";
    IntelligencePriority["MEDIUM"] = "MEDIUM";
    IntelligencePriority["LOW"] = "LOW";
})(IntelligencePriority || (exports.IntelligencePriority = IntelligencePriority = {}));
/**
 * Intelligence status
 */
var IntelligenceStatus;
(function (IntelligenceStatus) {
    IntelligenceStatus["PENDING_VALIDATION"] = "PENDING_VALIDATION";
    IntelligenceStatus["VALIDATED"] = "VALIDATED";
    IntelligenceStatus["ACTIVE"] = "ACTIVE";
    IntelligenceStatus["EXPIRED"] = "EXPIRED";
    IntelligenceStatus["DEPRECATED"] = "DEPRECATED";
    IntelligenceStatus["FALSE_POSITIVE"] = "FALSE_POSITIVE";
})(IntelligenceStatus || (exports.IntelligenceStatus = IntelligenceStatus = {}));
/**
 * Indicator types
 */
var IndicatorType;
...
(function (ReferenceType) {
    ...
    ReferenceType["RESEARCH"] = "RESEARCH";
...
(function (TransformationType) {
    ...
    TransformationType["PARSE_DATE"] = "PARSE_DATE";
    TransformationType["EXTRACT_DOMAIN"] = "EXTRACT_DOMAIN";
    TransformationType["NORMALIZE_IP"] = "NORMALIZE_IP";
    TransformationType["HASH"] = "HASH";
    TransformationType["DEFANG"] = "DEFANG";
...
(function (EnrichmentType) {
    ...
    EnrichmentType["REPUTATION"] = "REPUTATION";
    EnrichmentType["MALWARE_ANALYSIS"] = "MALWARE_ANALYSIS";
    EnrichmentType["PASSIVE_DNS"] = "PASSIVE_DNS";
    EnrichmentType["THREAT_ACTOR"] = "THREAT_ACTOR";
})(EnrichmentType || (exports.EnrichmentType = EnrichmentType = {}));
// ============================================================================
 ...
 * ```
 */
const getIntelligenceSourceModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getIntelligenceSourceModelAttributes = getIntelligenceSourceModelAttributes;
/**
 ...
 * ```
 */
const getEnrichmentCacheModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getEnrichmentCacheModelAttributes = getEnrichmentCacheModelAttributes;
/**
 ...
 * ```
 */
const getIntelligenceValidationModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getIntelligenceValidationModelAttributes = getIntelligenceValidationModelAttributes;
// ============================================================================
 ...
 * ```
 */
const aggregateIntelligence = async (sources, options) => {
    const aggregated = [];
    ...
    for (const source of enabledSources) {
        try {
            ...
            const sourceIntelligence = await (0, exports.fetchIntelligenceFromSource)(source);
            for (const intel of sourceIntelligence) {
                ...
                if (options?.minReliability) {
                    ...
                    if (sourceReliabilityIdx > minReliabilityIdx)
                        continue;
                }
                // Apply age filter
                if (options?.maxAge) {
 ...
 * ```
 */
const fetchIntelligenceFromSource = async (source) => {
    if (!source.enabled) {
...
exports.fetchIntelligenceFromSource = fetchIntelligenceFromSource;
/**
 ...
 */
const generateIntelligenceKey = (intel) => {
 ...
 */
const mergeIntelligence = (existing, newIntel) => {
    return {
        ...existing,
 ...
 */
const mergeIndicators = (existing, newIndicators) => {
    ...
    newIndicators.forEach(ind => {
        ...
        if (indicatorMap.has(key)) {
            ...
            indicatorMap.set(key, {
                ...
                lastSeen: new Date(Math.max(existingInd.lastSeen.getTime(), ind.lastSeen.getTime())),
            });
        }
        else {
            indicatorMap.set(key, ind);
 ...
 * ```
 */
const synchronizeIntelligenceSources = async (sources) => {
    const results = {
        totalIntelligence: 0,
        bySource: {},
        errors: [],
    ...
    for (const source of sources.filter(s => s.enabled)) {
        try {
            const intelligence = await (0, exports.fetchIntelligenceFromSource)(source);
...
exports.synchronizeIntelligenceSources = synchronizeIntelligenceSources;
/**
 ...
 * ```
 */
const filterIntelligence = (intelligence, criteria) => {
    return intelligence.filter(intel => {
        ...
        if (criteria.minSeverity) {
            ...
            if (intelSeverityIdx < minSeverityIdx)
                return false;
        }
        // Confidence filter
...
exports.filterIntelligence = filterIntelligence;
// ============================================================================
 ...
 * ```
 */
const normalizeThreatData = (rawData, rule) => {
    if (!rule.enabled) {
    ...
    rule.transformations.forEach(transform => {
        if (mappedData[transform.field] !== undefined) {
            mappedData[transform.field] = applyTransformation(mappedData[transform.field], transform);
        }
    });
 ...
 */
const defangIndicator = (indicator) => {
    return indicator
        .replace(/\./g, '[.]')
        .replace(/http:/g, 'hxxp:')
 ...
 * ```
 */
const batchNormalizeThreatData = (rawDataArray, rule) => {
    const normalized = [];
    for (const rawData of rawDataArray) {
        try {
            const intel = (0, exports.normalizeThreatData)(rawData, rule);
...
exports.batchNormalizeThreatData = batchNormalizeThreatData;
/**
 ...
 * ```
 */
const createNormalizationRule = (sourceType, schema) => {
    const fieldMappings = Object.entries(schema).map(([sourceField, config]) => ({
        sourceField,
...
exports.createNormalizationRule = createNormalizationRule;
// ============================================================================
 ...
 * ```
 */
const manageIntelligenceLifecycle = (intelligence, policy) => {
    const now = Date.now();
    const results = {
        active: [],
        expired: [],
    ...
    for (const intel of intelligence) {
        ...
        const retentionPeriod = policy.retentionBySeverity[intel.severity] || policy.defaultRetention;
...
exports.manageIntelligenceLifecycle = manageIntelligenceLifecycle;
/**
 ...
 * ```
 */
const updateIntelligenceStatus = (intel) => {
    const now = new Date();
    // Check if expired
    ...
    if (intel.status === IntelligenceStatus.PENDING_VALIDATION &&
        now >= intel.validFrom) {
        return { ...intel, status: IntelligenceStatus.ACTIVE };
    }
    return intel;
};
exports.updateIntelligenceStatus = updateIntelligenceStatus;
/**
 ...
 * ```
 */
const extendIntelligenceExpiration = (intel, extensionPeriod) => {
...
exports.extendIntelligenceExpiration = extendIntelligenceExpiration;
/**
 ...
 * ```
 */
const archiveExpiredIntelligence = (intelligence) => {
    const results = {
        archived: 0,
        errors: [],
    };
...
exports.archiveExpiredIntelligence = archiveExpiredIntelligence;
// ============================================================================
 ...
 * ```
 */
const searchThreatIntelligence = async (intelligence, query) => {
    ...
    if (query.indicatorTypes && query.indicatorTypes.length > 0) {
        filtered = filtered.filter(intel => intel.indicators.some(ind => query.indicatorTypes.includes(ind.type)));
    }
    // Severity filter
    ...
    if (query.tags && query.tags.length > 0) {
        filtered = filtered.filter(intel => query.tags.some(tag => intel.tags.includes(tag)));
    }
    // Date range filter
    if (query.dateRange) {
        filtered = filtered.filter(intel => {
            const createdTime = intel.createdAt.getTime();
            return (createdTime >= query.dateRange.start.getTime() &&
...
exports.searchThreatIntelligence = searchThreatIntelligence;
/**
 ...
 */
const calculateSearchAggregations = (intelligence) => {
    const aggregations = {
        bySeverity: {},
        byType: {},
        byStatus: {},
 ...
 * ```
 */
const advancedIntelligenceQuery = async (intelligence, advancedQuery) => {
    ...
    if (advancedQuery.booleanQuery) {
        ...
        if (must && must.length > 0) {
            results = results.filter(intel => must.every(clause => {
                const fieldValue = intel[clause.field];
        ...
        if (should && should.length > 0) {
            results = results.filter(intel => should.some(clause => {
                const fieldValue = intel[clause.field];
                if (Array.isArray(fieldValue)) {
                    return fieldValue.includes(clause.value);
                }
        ...
        if (mustNot && mustNot.length > 0) {
            results = results.filter(intel => mustNot.every(clause => {
                const fieldValue = intel[clause.field];
                if (Array.isArray(fieldValue)) {
                    return !fieldValue.includes(clause.value);
                }
    ...
    if (advancedQuery.fuzzySearch) {
        ...
        results = results.filter(intel => {
            const fieldValue = String(intel[field] || '').toLowerCase();
    ...
    if (advancedQuery.rangeQuery) {
        ...
        results = results.filter(intel => {
            const fieldValue = intel[field];
            let matches = true;
            if (gte !== undefined && fieldValue < gte)
                matches = false;
            if (lte !== undefined && fieldValue > lte)
                matches = false;
            return matches;
        });
    }
...
exports.advancedIntelligenceQuery = advancedIntelligenceQuery;
/**
...
const findRelatedIntelligence = (intel, allIntelligence) => {
    ...
    for (const other of allIntelligence) {
        ...
        if (intel.mitreAttack && other.mitreAttack) {
            const mitreOverlap = intel.mitreAttack.filter(t => other.mitreAttack?.includes(t));
...
exports.findRelatedIntelligence = findRelatedIntelligence;
// ============================================================================
...
exports.applyPriorityRules = applyPriorityRules;
/**
 ...
 * ```
 */
const sortIntelligenceByPriority = (intelligence, options) => {
    const priorityOrder = [
        IntelligencePriority.CRITICAL,
        IntelligencePriority.HIGH,
        IntelligencePriority.MEDIUM,
...
exports.sortIntelligenceByPriority = sortIntelligenceByPriority;
/**
 ...
 * ```
 */
const calculatePriorityScore = (intel) => {
    let score = 0;
 ...
 * ```
 */
const validateThreatIntelligence = async (intel) => {
    const issues = [];
    let confidence = 100;
...
exports.validateThreatIntelligence = validateThreatIntelligence;
/**
 ...
 * ```
 */
const enrichThreatIntelligence = async (intel, services) => {
    const enrichment = {
        enrichedAt: new Date(),
        enrichmentSources: [],
    };
...
exports.enrichThreatIntelligence = enrichThreatIntelligence;
/**
 ...
 */
const performEnrichment = async (intel, service) => {
 ...
 * ```
 */
const batchEnrichIntelligence = async (intelligence, services) => {
    const enriched = [];
    for (const intel of intelligence) {
        try {
            const enrichedIntel = await (0, exports.enrichThreatIntelligence)(intel, services);
...
exports.batchEnrichIntelligence = batchEnrichIntelligence;
/**
 ...
 * ```
 */
const cacheEnrichmentData = (indicatorType, indicatorValue, enrichmentType, enrichmentData, ttl = 3600000 // 1 hour default
) => {
    return {
        id: crypto.randomUUID(),
        indicatorType,
...
exports.cacheEnrichmentData = cacheEnrichmentData;
/**
 ...
 * ```
 */
const getCachedEnrichment = (indicatorType, indicatorValue, enrichmentType, cache) => {
    const entry = cache.find(c => c.indicatorType === indicatorType &&
 ...
 * ```
 */
const exportThreatIntelligence = (intelligence, format) => {
    if (format === 'json') {
...
exports.exportThreatIntelligence = exportThreatIntelligence;
/**
 ...
 * ```
 */
const importThreatIntelligence = (data, format) => {
    if (format === 'json') {
...
exports.importThreatIntelligence = importThreatIntelligence;
/**
 ...
 * ```
 */
const deduplicateIntelligence = (intelligence, options) => {
    const threshold = options?.threshold || 0.8;
    const mergeStrategy = options?.mergeStrategy || 'merge';
    const deduped = [];
    const processedIds = new Set();
    for (const intel of intelligence) {
        if (processedIds.has(intel.id))
            continue;
        // Find similar intelligence
        const similar = intelligence.filter(other => other.id !== intel.id &&
        ...
        if (similar.length > 0) {
            ...
            if (mergeStrategy === 'keep_first') {
                ...
                const latest = [intel, ...similar].sort((a, b) => b.updatedAt.getTime() - a.updatedAt.getTime())[0];
                deduped.push(latest);
            }
            else {
...
exports.deduplicateIntelligence = deduplicateIntelligence;
/**
 ...
 */
const calculateIntelligenceSimilarity = (intel1, intel2) => {
    let score = 0;
    let factors = 0;
    // Title similarity
 ...
 * ```
 */
const correlateIntelligenceAcrossSources = (intelligence, options) => {
...
exports.correlateIntelligenceAcrossSources = correlateIntelligenceAcrossSources;
/**
 ...
 * ```
 */
const generateIntelligenceSummaryReport = (intelligence, timeRange) => {
    let filtered = intelligence;
    if (timeRange) {
        filtered = intelligence.filter(i => i.createdAt >= timeRange.start && i.createdAt <= timeRange.end);
    }
    const report = {
        total: filtered.length,
        bySeverity: {},
    ...
    const indicatorTypeCounts = new Map();
    filtered.forEach(intel => {
        ...
        intel.indicators.forEach(ind => {
            indicatorTypeCounts.set(ind.type, (indicatorTypeCounts.get(ind.type) || 0) + 1);
        });
    });
...
exports.generateIntelligenceSummaryReport = generateIntelligenceSummaryReport;
/**
 ...
 * ```
 */
const convertFromSTIX = (stixBundle, sourceId) => {
    const intelligence = [];
    ...
    stixBundle.objects.forEach((obj) => {
        if (obj.type === 'indicator') {
            intelligence.push({
                ...
                indicators: [],
                tags: obj.labels || [],
                references: (obj.external_references || []).map((ref) => ({
 ...
 * ```
 */
const scoreIntelligenceQuality = (intel) => {
    const breakdown = {
        completeness: 0,
        reliability: 0,
        freshness: 0,
    ...
    if (intel.title && intel.title.length > 10)
        completenessScore += 5;
    if (intel.description && intel.description.length > 50)
        completenessScore += 5;
    if (intel.indicators && intel.indicators.length > 0)
    ...
    if (intel.mitreAttack && intel.mitreAttack.length > 0)
        actionabilityScore += 5;
    if (intel.enrichment)
        actionabilityScore += 5;
    if (intel.recommendedActions)
        actionabilityScore += 5;
...
exports.scoreIntelligenceQuality = scoreIntelligenceQuality;
/**
 ...
 * ```
 */
const recommendIntelligence = (intelligence, context) => {
    const scored = intelligence.map(intel => {
        let relevanceScore = 0;
        // Sector relevance
        if (context.sector) {
            const sectorTags = intel.tags.filter(t => t.toLowerCase().includes(context.sector.toLowerCase()));
            relevanceScore += sectorTags.length * 10;
        }
        // Recent threat relevance
        if (context.recentThreats) {
            const threatMatches = context.recentThreats.filter(threat => intel.tags.some(tag => tag.toLowerCase().includes(threat.toLowerCase())) ||
                intel.title.toLowerCase().includes(threat.toLowerCase()));
            relevanceScore += threatMatches.length * 15;
        }
        // Asset relevance
        if (context.assets) {
            const assetMatches = context.assets.filter(asset => intel.tags.some(tag => tag.toLowerCase().includes(asset.toLowerCase())));
...
exports.recommendIntelligence = recommendIntelligence;
/**
 ...
 * ```
 */
const detectIntelligenceGaps = (intelligence, requirements) => {
    const gaps = [];
    const coverage = {};
    ...
    if (requirements.requiredMitreTactics) {
        ...
        requirements.requiredMitreTactics.forEach(tactic => {
            if (coveredTactics.has(tactic)) {
                ...
                recommendations.push(`Acquire intelligence covering MITRE ATT&CK tactic: ${tactic}`);
            }
        });
    }
    // Sector coverage
    if (requirements.requiredSectors) {
        requirements.requiredSectors.forEach(sector => {
            const sectorIntel = intelligence.filter(intel => intel.tags.some(tag => tag.toLowerCase().includes(sector.toLowerCase())));
    ...
    if (requirements.requiredIndicatorTypes) {
        ...
        intelligence.forEach(intel => {
            intel.indicators.forEach(ind => coveredTypes.add(ind.type));
        });
...
exports.detectIntelligenceGaps = detectIntelligenceGaps;
/**
 ...
 * ```
 */
const adjustIntelligenceConfidence = (intel, sourceTrackRecord) => {
...
exports.adjustIntelligenceConfidence = adjustIntelligenceConfidence;
/**
 ...
 * ```
 */
const trackIntelligenceProvenance = (intel, stage, details) => {
...
exports.trackIntelligenceProvenance = trackIntelligenceProvenance;
/**
 ...
 * ```
 */
const generateIntelligenceSharingPackage = (intelligence, maxTLP) => {
    ...
    return {
        ...
        summary: (0, exports.generateIntelligenceSummaryReport)(shareable),
    };
};
exports.generateIntelligenceSharingPackage = generateIntelligenceSharingPackage;
/**
 ...
 * ```
 */
const fuseIntelligence = (intelligenceSets, options) => {
    const allIntelligence = intelligenceSets.flat();
    // First deduplicate
    const deduplicated = (0, exports.deduplicateIntelligence)(allIntelligence, {
...
exports.fuseIntelligence = fuseIntelligence;
/**
 ...
 * ```
 */
const calculateIntelligenceROI = (intelligence, outcomes) => {
    const totalIntelligence = intelligence.length;
    const actionableIntelligence = intelligence.filter(i => i.indicators.length > 0 && i.status === IntelligenceStatus.ACTIVE).length;
    ...
    const effectivenessScore = actionableIntelligence > 0
        ? (outcomes.threatsBlocked / actionableIntelligence) * 100
        : 0;
    // Calculate efficiency (true positives vs false positives)
    const efficiency = outcomes.threatsBlocked + outcomes.falsePositives > 0
...
exports.calculateIntelligenceROI = calculateIntelligenceROI;
/**
 ...
 * ```
 */
const performIntelligenceTriage = (intelligence) => {
    const triage = {
        critical: [],
        high: [],
        medium: [],
    ...
    intelligence.forEach(intel => {
        ...
        const quality = (0, exports.scoreIntelligenceQuality)(intel);
...
exports.performIntelligenceTriage = performIntelligenceTriage;
/**
 ...
 * ```
 */
const generateIntelligenceTimeline = (intelligence, options) => {
...
exports.generateIntelligenceTimeline = generateIntelligenceTimeline;
/**
...
const calculateTrend = (values) => {
    ...
    const historicalAvg = values.slice(0, -7).reduce((a, b) => a + b, 0) / Math.max(1, values.length - 7);
 ...
 * ```
 */
const performIntelligenceHealthCheck = (intelligence) => {
    const issues = [];
    const recommendations = [];
    const totalIntelligence = intelligence.length;
    const activeIntelligence = intelligence.filter(i => i.status === IntelligenceStatus.ACTIVE).length;
    const expiredIntelligence = intelligence.filter(i => i.status === IntelligenceStatus.EXPIRED).length;
    // Calculate average quality
    const qualityScores = intelligence.map(i => (0, exports.scoreIntelligenceQuality)(i).overall);
    const avgQuality = qualityScores.reduce((sum, q) => sum + q, 0) / totalIntelligence || 0;
    // Calculate average confidence
    const avgConfidence = intelligence.reduce((sum, i) => sum + i.confidence, 0) / totalIntelligence || 0;
    // Check source diversity
    const uniqueSources = new Set(intelligence.map(i => i.sourceId));
    const sourceDiversity = uniqueSources.size;
    // Identify issues
    const lowQualityCount = intelligence.filter(i => (0, exports.scoreIntelligenceQuality)(i).overall < 50).length;
...
exports.performIntelligenceHealthCheck = performIntelligenceHealthCheck;
/**
 ...
 * ```
 */
const automateIntelligenceEnrichment = async (intel, services, options) => {
    ...
    if (parallel) {
        ...
        enrichedIntel = await (0, exports.enrichThreatIntelligence)(enrichedIntel, enabledServices);
    }
    // Track provenance
    enrichedIntel = (0, exports.trackIntelligenceProvenance)(enrichedIntel, 'automated_enrichment', {
        servicesUsed: enabledServices.map(s => s.name),
        parallel,
    });
    return enrichedIntel;
};
exports.automateIntelligenceEnrichment = automateIntelligenceEnrichment;
//# sourceMappingURL=threat-intelligence-platform-kit.js.map