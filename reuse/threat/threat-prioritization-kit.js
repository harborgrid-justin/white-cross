 ...
 * ```
 */
const enqueueThreat = (queue, threat, priorityScore) => {
    const priorityLevel = (0, exports.determinePriorityLevel)(priorityScore);
    const queueKey = priorityLevel.toLowerCase();
    // Insert in sorted order (highest priority first)
    const targetQueue = [...queue[queueKey], threat].sort((a, b) => b.priorityScore - a.priorityScore);
    return {
        ...queue,
...
exports.enqueueThreat = enqueueThreat;
/**
 ...
 * ```
 */
const dequeueThreat = (queue, threatId) => {
    const queues = ['p1', 'p2', 'p3', 'p4', 'p5'];
...
exports.dequeueThreat = dequeueThreat;
/**
 ...
 * ```
 */
const rebalancePriorityQueue = (queue, updatedScores) => {
    let newQueue = (0, exports.createPriorityQueue)();
    const allThreats = [
        ...queue.p1,
        ...queue.p2,
        ...queue.p3,
    ...
    allThreats.forEach(threat => {
        ...
        newQueue = (0, exports.enqueueThreat)(newQueue, { ...threat, priorityScore: score }, score);
    });
    return newQueue;
};
exports.rebalancePriorityQueue = rebalancePriorityQueue;
/**
 ...
 * ```
 */
const getNextThreat = (queue, skipThreatIds) => {
...
exports.getNextThreat = getNextThreat;
/**
 ...
 * ```
 */
const calculateQueueStatistics = (queue) => {
    const now = Date.now();
    const allThreats = [...queue.p1, ...queue.p2, ...queue.p3, ...queue.p4, ...queue.p5];
    const waitTimes = allThreats.map(t => (now - t.queuedAt.getTime()) / (1000 * 60));
...
exports.calculateQueueStatistics = calculateQueueStatistics;
// ============================================================================
 ...
 * ```
 */
const adjustPriorityForBusinessContext = (basePriority, context, threatTime) => {
    ...
    if (threatTime) {
        ...
        const inCriticalPeriod = context.criticalPeriods.some(period => threatTime >= period.start && threatTime <= period.end);
        if (inCriticalPeriod) {
            adjusted *= 1.5;
        }
    }
...
exports.adjustPriorityForBusinessContext = adjustPriorityForBusinessContext;
/**
 ...
 * ```
 */
const calculateStakeholderPriority = (affectedStakeholders, basePriority) => {
...
exports.calculateStakeholderPriority = calculateStakeholderPriority;
/**
 ...
 * ```
 */
const isInCriticalBusinessPeriod = (threatTime, context) => {
    return context.criticalPeriods.some(period => threatTime >= period.start && threatTime <= period.end);
};
exports.isInCriticalBusinessPeriod = isInCriticalBusinessPeriod;
// ============================================================================
 ...
 * ```
 */
const calculateAssetPriorityMultiplier = (affectedAssets) => {
...
exports.calculateAssetPriorityMultiplier = calculateAssetPriorityMultiplier;
/**
 ...
 * ```
 */
const calculateDependencyImpact = (assetId, dependencyGraph) => {
...
exports.calculateDependencyImpact = calculateDependencyImpact;
/**
 ...
 * ```
 */
const calculateAssetBasedPriority = (asset, baseThreatScore) => {
...
exports.calculateAssetBasedPriority = calculateAssetBasedPriority;
// ============================================================================
 ...
 * ```
 */
const calculateTimeUrgency = (params) => {
...
exports.calculateTimeUrgency = calculateTimeUrgency;
/**
 ...
 * ```
 */
const adjustPriorityForTimeWindow = (basePriority, timeWindow) => {
    return Math.min(100, Math.round(basePriority * timeWindow.priorityModifier));
};
exports.adjustPriorityForTimeWindow = adjustPriorityForTimeWindow;
/**
 ...
 * ```
 */
const calculateAgingDecay = (detectionTime, maxAgeHours = 48) => {
...
exports.calculateAgingDecay = calculateAgingDecay;
// ============================================================================
 ...
 * ```
 */
const calculateSLAStatus = (threat, slaConfig) => {
 ...
 * ```
 */
const determinePriorityLevel = (priorityScore) => {
    if (priorityScore >= 85)
        return 'P1';
    if (priorityScore >= 70)
        return 'P2';
...
exports.determinePriorityLevel = determinePriorityLevel;
/**
 ...
 * ```
 */
const calculateSLADueDate = (priorityLevel, slaConfig, startTime) => {
 ...
 * ```
 */
const requiresSLAEscalation = (slaStatus) => {
    return slaStatus.escalationRequired || slaStatus.breached;
};
exports.requiresSLAEscalation = requiresSLAEscalation;
// ============================================================================
 ...
 * ```
 */
const evaluateTriageRule = (rule, threatData) => {
    if (!rule.enabled)
        return false;
...
exports.evaluateTriageRule = evaluateTriageRule;
/**
 ...
 * ```
 */
const applyTriageRules = (threatData, rules) => {
    const matchedRules = rules
        .filter(rule => (0, exports.evaluateTriageRule)(rule, threatData))
        .sort((a, b) => b.priority - a.priority);
    return matchedRules.map(rule => rule.action);
};
exports.applyTriageRules = applyTriageRules;
/**
 ...
 * ```
 */
const createAutoAssignmentRule = (name, conditions, assignToRole) => {
    return {
 ...
 * ```
 */
const shouldEscalateThreat = (threat, slaStatus, queueWaitTime) => {
    // Already escalated
    if (threat.escalated)
        return false;
    // SLA breach or near breach
    if (slaStatus.breached || slaStatus.escalationRequired)
        return true;
    ...
    if (queueWaitTime > maxWaitTimes[threat.priorityLevel])
        return true;
    return false;
};
exports.shouldEscalateThreat = shouldEscalateThreat;
/**
 ...
 * ```
 */
const calculateEscalationLevel = (threat, currentLevel, policy) => {
    const maxLevel = policy.levels.length;
    return Math.min(currentLevel + 1, maxLevel);
};
exports.calculateEscalationLevel = calculateEscalationLevel;
/**
 ...
 * ```
 */
const executeEscalationPolicy = (threat, policy, escalationLevel) => {
...
exports.executeEscalationPolicy = executeEscalationPolicy;
// ============================================================================
 ...
 * ```
 */
const calculateComprehensivePriority = (params, weights) => {
    ...
    const overall = Math.round(params.threatScore * finalWeights.threatScore +
...
exports.calculateComprehensivePriority = calculateComprehensivePriority;
// ============================================================================
 ...
 * ```
 */
const createThreatPrioritizationService = () => {
    return `
...
exports.createThreatPrioritizationService = createThreatPrioritizationService;
/**
 ...
 * ```
 */
const createThreatPriorityModel = () => {
    return `
...
exports.createThreatPriorityModel = createThreatPriorityModel;
/**
 ...
 * ```
 */
const createPrioritizationSwagger = () => {
    return `
...
exports.createPrioritizationSwagger = createPrioritizationSwagger;
// ============================================================================
// EXPORTS
// ============================================================================
exports.default = {
    // Queue management
    createPriorityQueue: exports.createPriorityQueue,
    enqueueThreat: exports.enqueueThreat,
    dequeueThreat: exports.dequeueThreat,
    rebalancePriorityQueue: exports.rebalancePriorityQueue,
    getNextThreat: exports.getNextThreat,
    calculateQueueStatistics: exports.calculateQueueStatistics,
    // Business context
    adjustPriorityForBusinessContext: exports.adjustPriorityForBusinessContext,
    calculateStakeholderPriority: exports.calculateStakeholderPriority,
    isInCriticalBusinessPeriod: exports.isInCriticalBusinessPeriod,
    // Asset-based
    calculateAssetPriorityMultiplier: exports.calculateAssetPriorityMultiplier,
    calculateDependencyImpact: exports.calculateDependencyImpact,
    calculateAssetBasedPriority: exports.calculateAssetBasedPriority,
    // Time-sensitive
    calculateTimeUrgency: exports.calculateTimeUrgency,
    adjustPriorityForTimeWindow: exports.adjustPriorityForTimeWindow,
    calculateAgingDecay: exports.calculateAgingDecay,
    // SLA management
    calculateSLAStatus: exports.calculateSLAStatus,
    determinePriorityLevel: exports.determinePriorityLevel,
    calculateSLADueDate: exports.calculateSLADueDate,
    requiresSLAEscalation: exports.requiresSLAEscalation,
    // Triage automation
    evaluateTriageRule: exports.evaluateTriageRule,
    applyTriageRules: exports.applyTriageRules,
    createAutoAssignmentRule: exports.createAutoAssignmentRule,
    // Escalation
    shouldEscalateThreat: exports.shouldEscalateThreat,
    calculateEscalationLevel: exports.calculateEscalationLevel,
    executeEscalationPolicy: exports.executeEscalationPolicy,
    // Comprehensive
    calculateComprehensivePriority: exports.calculateComprehensivePriority,
    // NestJS patterns
    createThreatPrioritizationService: exports.createThreatPrioritizationService,
    createThreatPriorityModel: exports.createThreatPriorityModel,
    createPrioritizationSwagger: exports.createPrioritizationSwagger,
};
//# sourceMappingURL=threat-prioritization-kit.js.map