...
exports.generateEffectivenessDashboard = exports.compareResponseExecutions = exports.identifyPlaybookOptimizations = exports.analyzePlaybookPerformance = exports.calculateResponseEffectiveness = exports.generateComplianceReport = exports.getResponseAuditTrail = exports.logResponseAction = exports.estimateResponseDowntime = exports.calculateBusinessImpact = exports.performImpactAssessment = exports.validateRollbackSafety = exports.generateRollbackSteps = exports.executeResponseRollback = exports.orchestrateSequentialSteps = exports.orchestrateParallelSteps = exports.evaluateStepConditions = exports.executeResponseStep = exports.executeResponsePlaybook = exports.executeCollectForensics = exports.executeSnapshotSystem = exports.executeKillProcess = exports.executeDisableUserAccount = exports.executeIsolateEndpoint = exports.executeQuarantineFile = exports.executeBlockIP = exports.clonePlaybook = exports.updatePlaybook = exports.evaluatePlaybookTriggers = exports.validatePlaybook = exports.createResponsePlaybook = exports.getResponseAuditLogModelAttributes = exports.getResponseExecutionModelAttributes = exports.getResponsePlaybookModelAttributes = exports.StepStatus = exports.ExecutionStatus = exports.ResponseAction = exports.TriggerType = exports.ResponseSeverity = exports.ThreatType = void 0;
/**
 * File: /reuse/threat/automated-threat-response-kit.ts
...
})(ResponseSeverity || (exports.ResponseSeverity = ResponseSeverity = {}));
/**
 * Trigger types for automated responses
 */
var TriggerType;
(function (TriggerType) {
    TriggerType["IOC_DETECTED"] = "IOC_DETECTED";
    TriggerType["THREAT_SCORE_THRESHOLD"] = "THREAT_SCORE_THRESHOLD";
    TriggerType["BEHAVIORAL_ANOMALY"] = "BEHAVIORAL_ANOMALY";
    TriggerType["POLICY_VIOLATION"] = "POLICY_VIOLATION";
    TriggerType["MANUAL"] = "MANUAL";
    TriggerType["SCHEDULED"] = "SCHEDULED";
    TriggerType["CASCADE"] = "CASCADE";
...
(function (ResponseAction) {
    ...
    ResponseAction["BLOCK_DOMAIN"] = "BLOCK_DOMAIN";
    ResponseAction["BLOCK_URL"] = "BLOCK_URL";
    ResponseAction["QUARANTINE_FILE"] = "QUARANTINE_FILE";
    ResponseAction["QUARANTINE_EMAIL"] = "QUARANTINE_EMAIL";
    ResponseAction["ISOLATE_ENDPOINT"] = "ISOLATE_ENDPOINT";
    ResponseAction["ISOLATE_NETWORK_SEGMENT"] = "ISOLATE_NETWORK_SEGMENT";
    ResponseAction["DISABLE_USER_ACCOUNT"] = "DISABLE_USER_ACCOUNT";
    ResponseAction["RESET_PASSWORD"] = "RESET_PASSWORD";
    ResponseAction["REVOKE_SESSION"] = "REVOKE_SESSION";
    ResponseAction["KILL_PROCESS"] = "KILL_PROCESS";
    ResponseAction["SNAPSHOT_SYSTEM"] = "SNAPSHOT_SYSTEM";
    ResponseAction["COLLECT_FORENSICS"] = "COLLECT_FORENSICS";
    ResponseAction["NOTIFY_TEAM"] = "NOTIFY_TEAM";
    ResponseAction["CREATE_TICKET"] = "CREATE_TICKET";
    ResponseAction["RUN_SCRIPT"] = "RUN_SCRIPT";
    ResponseAction["PATCH_SYSTEM"] = "PATCH_SYSTEM";
    ResponseAction["UPDATE_FIREWALL_RULE"] = "UPDATE_FIREWALL_RULE";
    ResponseAction["ENABLE_MFA"] = "ENABLE_MFA";
    ResponseAction["BACKUP_DATA"] = "BACKUP_DATA";
...
(function (ExecutionStatus) {
    ...
    ExecutionStatus["ASSESSING_IMPACT"] = "ASSESSING_IMPACT";
    ExecutionStatus["AWAITING_APPROVAL"] = "AWAITING_APPROVAL";
 ...
 * ```
 */
const getResponseExecutionModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getResponseExecutionModelAttributes = getResponseExecutionModelAttributes;
/**
 ...
 * ```
 */
const getResponseAuditLogModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getResponseAuditLogModelAttributes = getResponseAuditLogModelAttributes;
// ============================================================================
 ...
 * ```
 */
const validatePlaybook = async (playbook) => {
    const errors = [];
 ...
 * ```
 */
const evaluatePlaybookTriggers = async (playbook, threatData) => {
...
exports.evaluatePlaybookTriggers = evaluatePlaybookTriggers;
/**
...
const updatePlaybook = async (playbookId, updates) => {
    ...
    const playbook = await (0, exports.createResponsePlaybook)({ id: playbookId, ...updates });
 ...
 * ```
 */
const clonePlaybook = async (playbookId, newName) => {
    // In production, fetch original from database
    const original = await (0, exports.createResponsePlaybook)({ id: playbookId });
    const clone = await (0, exports.createResponsePlaybook)({
        ...original,
        id: crypto.randomUUID(),
        name: newName,
        version: '1.0.0',
...
exports.clonePlaybook = clonePlaybook;
// ============================================================================
 ...
 * ```
 */
const executeBlockIP = async (ipAddress, options) => {
...
exports.executeBlockIP = executeBlockIP;
/**
 ...
 * ```
 */
const executeQuarantineFile = async (filePath, options) => {
...
exports.executeQuarantineFile = executeQuarantineFile;
/**
 ...
 * ```
 */
const executeIsolateEndpoint = async (endpointId, options) => {
...
exports.executeIsolateEndpoint = executeIsolateEndpoint;
/**
 ...
 * ```
 */
const executeDisableUserAccount = async (userId, options) => {
...
exports.executeDisableUserAccount = executeDisableUserAccount;
/**
 ...
 * ```
 */
const executeKillProcess = async (endpointId, processId, options) => {
...
exports.executeKillProcess = executeKillProcess;
/**
 ...
 * ```
 */
const executeSnapshotSystem = async (systemId, options) => {
...
exports.executeSnapshotSystem = executeSnapshotSystem;
/**
 ...
 * ```
 */
const executeCollectForensics = async (targetId, options) => {
...
exports.executeCollectForensics = executeCollectForensics;
// ============================================================================
 ...
 * ```
 */
const executeResponsePlaybook = async (playbookId, triggerData, triggeredBy) => {
    const execution = {
        id: crypto.randomUUID(),
        playbookId,
...
exports.executeResponsePlaybook = executeResponsePlaybook;
/**
 ...
 * ```
 */
const executeResponseStep = async (step, execution) => {
    const executedStep = {
        stepId: step.id,
        stepName: step.name,
        action: step.action,
        ...
        try {
            ...
            switch (step.action) {
                case ResponseAction.BLOCK_IP:
                    result = await (0, exports.executeBlockIP)(step.parameters.ipAddress, step.parameters);
                    break;
                case ResponseAction.QUARANTINE_FILE:
                    result = await (0, exports.executeQuarantineFile)(step.parameters.filePath, step.parameters);
                    break;
                case ResponseAction.ISOLATE_ENDPOINT:
                    result = await (0, exports.executeIsolateEndpoint)(step.parameters.endpointId, step.parameters);
                    break;
                case ResponseAction.DISABLE_USER_ACCOUNT:
                    result = await (0, exports.executeDisableUserAccount)(step.parameters.userId, step.parameters);
                    break;
                default:
                    result = { success: true };
            }
            ...
            if (retries > maxRetries) {
                ...
                // Wait before retry
                await new Promise(resolve => setTimeout(resolve, step.retryPolicy.backoffMs * Math.pow(step.retryPolicy.backoffMultiplier, retries - 1)));
            }
        }
    }
    return executedStep;
};
exports.executeResponseStep = executeResponseStep;
/**
 ...
 * ```
 */
const evaluateStepConditions = async (conditions, runtimeData) => {
...
exports.evaluateStepConditions = evaluateStepConditions;
/**
 ...
 * ```
 */
const orchestrateParallelSteps = async (steps, execution) => {
    const promises = steps.map(step => (0, exports.executeResponseStep)(step, execution));
    const results = await Promise.all(promises);
    return results;
};
exports.orchestrateParallelSteps = orchestrateParallelSteps;
/**
 ...
 * ```
 */
const orchestrateSequentialSteps = async (steps, execution) => {
    const results = [];
    for (const step of steps.sort((a, b) => a.order - b.order)) {
        const result = await (0, exports.executeResponseStep)(step, execution);
        results.push(result);
...
exports.orchestrateSequentialSteps = orchestrateSequentialSteps;
// ============================================================================
 ...
 * ```
 */
const executeResponseRollback = async (execution, rollbackSteps) => {
...
exports.executeResponseRollback = executeResponseRollback;
/**
 ...
 * ```
 */
const generateRollbackSteps = async (executedSteps) => {
    const rollbackSteps = [];
...
exports.generateRollbackSteps = generateRollbackSteps;
/**
 ...
 * ```
 */
const validateRollbackSafety = async (execution) => {
    const risks = [];
    ...
    const criticalSteps = execution.executedSteps.filter(s => [ResponseAction.ISOLATE_ENDPOINT, ResponseAction.ISOLATE_NETWORK_SEGMENT].includes(s.action));
 ...
 * ```
 */
const performImpactAssessment = async (playbook, targetData) => {
    const assessments = [];
...
exports.performImpactAssessment = performImpactAssessment;
/**
 ...
 * ```
 */
const calculateBusinessImpact = async (steps, businessContext) => {
 ...
 * ```
 */
const estimateResponseDowntime = async (steps) => {
    let totalDowntime = 0;
    const bySystem = {};
    for (const step of steps) {
        let stepDowntime = 0;
...
exports.estimateResponseDowntime = estimateResponseDowntime;
// ============================================================================
 ...
 * ```
 */
const logResponseAction = async (execution, action, actor, details) => {
    const entry = {
        id: crypto.randomUUID(),
        timestamp: new Date(),
        action,
...
exports.logResponseAction = logResponseAction;
/**
 ...
 * ```
 */
const getResponseAuditTrail = async (executionId) => {
    // In production, fetch from database
    return [];
};
exports.getResponseAuditTrail = getResponseAuditTrail;
/**
 ...
 * ```
 */
const generateComplianceReport = async (executionId) => {
    const trail = await (0, exports.getResponseAuditTrail)(executionId);
    const findings = [];
 ...
 * ```
 */
const calculateResponseEffectiveness = async (execution) => {
...
exports.calculateResponseEffectiveness = calculateResponseEffectiveness;
/**
 ...
 * ```
 */
const analyzePlaybookPerformance = async (playbookId, startDate, endDate) => {
...
exports.analyzePlaybookPerformance = analyzePlaybookPerformance;
/**
 ...
 * ```
 */
const identifyPlaybookOptimizations = async (playbookId) => {
...
exports.identifyPlaybookOptimizations = identifyPlaybookOptimizations;
/**
 ...
 * ```
 */
const compareResponseExecutions = async (executionIds) => {
    const comparison = {
...
exports.compareResponseExecutions = compareResponseExecutions;
/**
 ...
 * ```
 */
const generateEffectivenessDashboard = async (timeframe) => {
    return {
        timeframe,
        totalResponses: 156,
        successRate: 93.5,
...
exports.generateEffectivenessDashboard = generateEffectivenessDashboard;
//# sourceMappingURL=automated-threat-response-kit.js.map