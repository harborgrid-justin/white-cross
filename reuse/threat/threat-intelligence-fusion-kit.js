 ...
 */
var IntelFeedType;
(function (IntelFeedType) {
    IntelFeedType["COMMERCIAL"] = "COMMERCIAL";
    IntelFeedType["OPEN_SOURCE"] = "OPEN_SOURCE";
    IntelFeedType["ISAC"] = "ISAC";
    IntelFeedType["INTERNAL"] = "INTERNAL";
    IntelFeedType["GOVERNMENT"] = "GOVERNMENT";
    IntelFeedType["COMMUNITY"] = "COMMUNITY";
    IntelFeedType["VENDOR"] = "VENDOR";
})(IntelFeedType || (exports.IntelFeedType = IntelFeedType = {}));
/**
 * Intelligence feed formats
 */
var IntelFeedFormat;
(function (IntelFeedFormat) {
    IntelFeedFormat["STIX_1_X"] = "STIX_1_X";
    IntelFeedFormat["STIX_2_X"] = "STIX_2_X";
    IntelFeedFormat["JSON"] = "JSON";
    IntelFeedFormat["XML"] = "XML";
    IntelFeedFormat["CSV"] = "CSV";
    IntelFeedFormat["TAXII"] = "TAXII";
    IntelFeedFormat["MISP"] = "MISP";
    IntelFeedFormat["OPENIOC"] = "OPENIOC";
    IntelFeedFormat["CUSTOM"] = "CUSTOM";
})(IntelFeedFormat || (exports.IntelFeedFormat = IntelFeedFormat = {}));
/**
 * Intelligence types
 */
var IntelligenceType;
(function (IntelligenceType) {
    IntelligenceType["IP_ADDRESS"] = "IP_ADDRESS";
    IntelligenceType["DOMAIN"] = "DOMAIN";
    IntelligenceType["URL"] = "URL";
    IntelligenceType["EMAIL"] = "EMAIL";
    IntelligenceType["FILE_HASH"] = "FILE_HASH";
    IntelligenceType["CVE"] = "CVE";
    IntelligenceType["MALWARE_FAMILY"] = "MALWARE_FAMILY";
    IntelligenceType["THREAT_ACTOR"] = "THREAT_ACTOR";
    IntelligenceType["ATTACK_PATTERN"] = "ATTACK_PATTERN";
    IntelligenceType["CAMPAIGN"] = "CAMPAIGN";
    IntelligenceType["INDICATOR"] = "INDICATOR";
...
(function (CorrelationType) {
    CorrelationType["SAME_CAMPAIGN"] = "SAME_CAMPAIGN";
    CorrelationType["SAME_ACTOR"] = "SAME_ACTOR";
    CorrelationType["TEMPORAL"] = "TEMPORAL";
    CorrelationType["BEHAVIORAL"] = "BEHAVIORAL";
    CorrelationType["INFRASTRUCTURE"] = "INFRASTRUCTURE";
    CorrelationType["MALWARE_FAMILY"] = "MALWARE_FAMILY";
    CorrelationType["TARGET_SIMILARITY"] = "TARGET_SIMILARITY";
 ...
 * ```
 */
const getIntelFeedSourceModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getIntelFeedSourceModelAttributes = getIntelFeedSourceModelAttributes;
/**
 ...
 * ```
 */
const getFusedIntelligenceModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getFusedIntelligenceModelAttributes = getFusedIntelligenceModelAttributes;
/**
 ...
 * ```
 */
const getSourceReliabilityMetricsModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getSourceReliabilityMetricsModelAttributes = getSourceReliabilityMetricsModelAttributes;
/**
 ...
 * ```
 */
const getIntelCorrelationModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getIntelCorrelationModelAttributes = getIntelCorrelationModelAttributes;
// ============================================================================
 ...
 * ```
 */
const aggregateMultipleIntelFeeds = async (feeds, options) => {
    ...
    for (const feed of feeds.filter((f) => f.enabled)) {
        try {
            ...
            const normalized = await (0, exports.normalizeIntelFeedFormat)(rawData, feed.format);
    ...
    if (options?.enableEnrichment) {
        for (const item of result) {
            await (0, exports.enrichFromMultipleSources)(item, feeds);
        }
    }
    return result;
};
exports.aggregateMultipleIntelFeeds = aggregateMultipleIntelFeeds;
/**
 ...
 * ```
 */
const normalizeIntelFeedFormat = async (rawData, format) => {
    const normalized = [];
    switch (format) {
...
exports.normalizeIntelFeedFormat = normalizeIntelFeedFormat;
/**
 ...
 * ```
 */
const validateIntelFeedSchema = async (data, format) => {
    const errors = [];
    if (!data) {
...
exports.validateIntelFeedSchema = validateIntelFeedSchema;
/**
 ...
 * ```
 */
const mergeIntelFeeds = async (feeds, options) => {
...
exports.mergeIntelFeeds = mergeIntelFeeds;
/**
...
exports.prioritizeIntelFeeds = prioritizeIntelFeeds;
/**
 ...
 * ```
 */
const filterIntelByRelevance = (intelligence, criteria) => {
    return intelligence.filter((item) => {
        ...
        if (criteria.dateRange) {
            ...
            if (itemDate < criteria.dateRange.start.getTime() ||
...
exports.filterIntelByRelevance = filterIntelByRelevance;
/**
 ...
 * ```
 */
const categorizeIntelData = (intelligence) => {
    const categories = {
        network: [],
        malware: [],
        vulnerability: [],
...
exports.categorizeIntelData = categorizeIntelData;
/**
 ...
 * ```
 */
const transformIntelFormat = async (data, fromFormat, toFormat) => {
    // First normalize to internal format
    const normalized = await (0, exports.normalizeIntelFeedFormat)(data, fromFormat);
            ...
            return {
                Event: {
                    ...
                    Attribute: normalized.map((item) => ({
                        ...
                        Tag: item.tags.map((tag) => ({ name: tag })),
                    })),
                },
            };
        default:
...
exports.transformIntelFormat = transformIntelFormat;
// ============================================================================
...
const deduplicateIntelligence = (intelligence, options) => {
    ...
    for (const item of intelligence) {
        ...
        if (deduplicatedMap.has(key)) {
            ...
            const merged = (0, exports.mergeDuplicateIntel)([existing, item]);
 ...
 * ```
 */
const fuzzyMatchIntelligence = (item, candidates, threshold = 0.8) => {
    for (const candidate of candidates) {
        if (item.type !== candidate.type)
            continue;
        const similarity = calculateStringSimilarity(item.normalizedValue, candidate.normalizedValue);
...
exports.fuzzyMatchIntelligence = fuzzyMatchIntelligence;
/**
 ...
 * ```
 */
const canonicalizeIntelValue = (type, value) => {
...
exports.canonicalizeIntelValue = canonicalizeIntelValue;
/**
 ...
 * ```
 */
const detectDuplicatePatterns = (intelligence) => {
...
exports.detectDuplicatePatterns = detectDuplicatePatterns;
/**
 ...
 * ```
 */
const mergeDuplicateIntel = (duplicates) => {
    ...
    for (const dup of duplicates) {
        ...
        if (dup.firstSeen < minFirstSeen)
            minFirstSeen = dup.firstSeen;
        if (dup.lastSeen > maxLastSeen)
            maxLastSeen = dup.lastSeen;
    ...
    const agreementScore = (severities.filter((s) => s === mostCommonSeverity).length / severities.length) * 100;
    return {
        ...base,
        sources: allSources,
...
exports.mergeDuplicateIntel = mergeDuplicateIntel;
// ============================================================================
 ...
 * ```
 */
const correlateAcrossSources = (intelligence, options) => {
    const correlations = [];
...
exports.correlateAcrossSources = correlateAcrossSources;
/**
 ...
 * ```
 */
const findIntelOverlaps = (feeds, intelligence) => {
    const overlaps = [];
...
exports.findIntelOverlaps = findIntelOverlaps;
/**
 ...
 * ```
 */
const calculateCorrelationScore = (item1, item2) => {
    let score = 0;
    // Shared sources (40 points max)
    const sharedSources = item1.sources.filter((s1) => item2.sources.some((s2) => s2.feedId === s1.feedId));
 ...
 * ```
 */
const identifyIntelClusters = (intelligence, minCorrelation = 70) => {
    const clusters = [];
    ...
    for (const item of intelligence) {
        ...
        for (const candidate of intelligence) {
            if (processed.has(candidate.id))
                continue;
            const correlation = (0, exports.calculateCorrelationScore)(item, candidate);
        ...
        if (cluster.length > 1) {
            ...
            for (let i = 0; i < cluster.length; i++) {
                for (let j = i + 1; j < cluster.length; j++) {
                    ...
                    totalCorrelation += (0, exports.calculateCorrelationScore)(item1, item2);
                    pairCount++;
                }
            }
            clusters.push({
...
exports.identifyIntelClusters = identifyIntelClusters;
/**
 ...
 * ```
 */
const buildCorrelationGraph = (intelligence, correlations) => {
...
exports.buildCorrelationGraph = buildCorrelationGraph;
/**
 ...
 * ```
 */
const analyzeSourceAgreement = (intelligence) => {
...
exports.analyzeSourceAgreement = analyzeSourceAgreement;
// ============================================================================
 ...
 * ```
 */
const calculateMultiSourceConfidence = (sources, reliabilityMetrics) => {
    if (sources.length === 0)
        return 0;
...
exports.calculateMultiSourceConfidence = calculateMultiSourceConfidence;
/**
 ...
 * ```
 */
const weightSourceReliability = (confidence, reliability) => {
    // Apply reliability as a multiplier
    const reliabilityFactor = reliability / 100;
    return confidence * reliabilityFactor;
};
exports.weightSourceReliability = weightSourceReliability;
/**
 ...
 * ```
 */
const adjustConfidenceByAge = (confidence, lastSeen, options) => {
...
exports.adjustConfidenceByAge = adjustConfidenceByAge;
/**
 ...
 * ```
 */
const aggregateConfidenceScores = (scores, method = 'weighted_average') => {
    if (scores.length === 0)
        return 0;
    switch (method) {
        case 'average':
 ...
 * ```
 */
const normalizeConfidenceRange = (confidence, options) => {
...
exports.normalizeConfidenceRange = normalizeConfidenceRange;
// ============================================================================
 ...
 * ```
 */
const calculateSourceReliability = (metrics) => {
    ...
    const reliability = metrics.accuracy * weights.accuracy +
 ...
 * ```
 */
const trackSourceAccuracy = (feedId, wasAccurate, metrics) => {
    ...
    updated.history.push({
        ...
        reliability: (0, exports.calculateSourceReliability)(updated),
    });
    ...
    updated.overallReliability = (0, exports.calculateSourceReliability)(updated);
    return updated;
};
exports.trackSourceAccuracy = trackSourceAccuracy;
/**
 ...
 * ```
 */
const updateReliabilityMetrics = (allMetrics, feedId, updates) => {
    ...
    if (index === -1) {
        ...
        newMetrics.overallReliability = (0, exports.calculateSourceReliability)(newMetrics);
...
exports.updateReliabilityMetrics = updateReliabilityMetrics;
/**
 ...
 * ```
 */
const rankIntelSources = (metrics, options) => {
...
exports.rankIntelSources = rankIntelSources;
// ============================================================================
 ...
 * ```
 */
const detectIntelConflicts = (item) => {
    const conflicts = [];
    ...
    for (const source of item.sources) {
        ...
        const sourceSeverity = (source.rawData?.severity || item.severity);
...
exports.detectIntelConflicts = detectIntelConflicts;
/**
 ...
 * ```
 */
const resolveConflictByVoting = (conflictingValues) => {
    const votes = new Map();
...
exports.resolveConflictByVoting = resolveConflictByVoting;
/**
 ...
 * ```
 */
const resolveConflictByReliability = (conflictingValues) => {
    ...
    const reliabilityGap = sorted.length > 1 ? mostReliable.reliability - sorted[1].reliability : mostReliable.reliability;
...
exports.resolveConflictByReliability = resolveConflictByReliability;
/**
 ...
 * ```
 */
const flagUnresolvableConflicts = (intelligence, threshold = 40) => {
    const flagged = [];
    for (const item of intelligence) {
        const conflicts = (0, exports.detectIntelConflicts)(item);
        if (conflicts.length > 0) {
            const requiresReview = item.conflictResolution?.confidence !== undefined &&
...
exports.flagUnresolvableConflicts = flagUnresolvableConflicts;
// ============================================================================
 ...
 * ```
 */
const enrichFromMultipleSources = async (item, sources) => {
...
exports.enrichFromMultipleSources = enrichFromMultipleSources;
/**
 ...
 * ```
 */
const crossReferenceIntelligence = async (item, databases) => {
    const results = [];
...
exports.crossReferenceIntelligence = crossReferenceIntelligence;
/**
 ...
 * ```
 */
const enhanceIntelMetadata = (item, additionalData) => {
    return {
        ...item,
        metadata: {
            ...item.metadata,
...
exports.enhanceIntelMetadata = enhanceIntelMetadata;
/**
 ...
 * ```
 */
const supplementMissingFields = (item, referenceData) => {
    const supplemented = { ...item };
    // Find similar items in reference data
    const similar = referenceData.filter((ref) => ref.type === item.type && ref.normalizedValue === item.normalizedValue);
    if (similar.length === 0)
        return supplemented;
    // Supplement tags
...
exports.supplementMissingFields = supplementMissingFields;
// ============================================================================
 ...
 * ```
 */
const generateFusionReport = (intelligence, correlations, sourceMetrics, timeRange) => {
    const filteredIntel = intelligence.filter((item) => item.lastSeen >= timeRange.start && item.lastSeen <= timeRange.end);
    ...
    const averageSourcesPerItem = filteredIntel.reduce((sum, item) => sum + item.sources.length, 0) / totalIntelligence || 0;
    const averageConfidence = filteredIntel.reduce((sum, item) => sum + item.confidence, 0) / totalIntelligence || 0;
    const averageQualityScore = filteredIntel.reduce((sum, item) => sum + item.fusionMetadata.qualityScore, 0) /
        totalIntelligence || 0;
    // Source metrics
    const sourceContributions = new Map();
    const sourceAgreement = new Map();
    for (const item of filteredIntel) {
        for (const source of item.sources) {
            sourceContributions.set(source.feedId, (sourceContributions.get(source.feedId) || 0) + 1);
    ...
    for (const corr of correlations) {
        ...
        if (corr.correlationScore > 80)
            strongCorrelations++;
    }
    // Conflict analysis
    const conflictedItems = filteredIntel.filter((item) => item.conflictResolution);
    const resolvedConflicts = conflictedItems.filter((item) => item.conflictResolution?.confidence && item.conflictResolution.confidence > 50);
    ...
    const mediumQuality = filteredIntel.filter((item) => item.fusionMetadata.qualityScore >= 50 && item.fusionMetadata.qualityScore <= 80).length;
...
exports.generateFusionReport = generateFusionReport;
/**
 ...
 * ```
 */
const analyzeFusionEffectiveness = (fusedIntel, originalIntel) => {
    const originalAvgConfidence = originalIntel.reduce((sum, item) => sum + item.confidence, 0) / originalIntel.length || 0;
    const fusedAvgConfidence = fusedIntel.reduce((sum, item) => sum + item.confidence, 0) / fusedIntel.length || 0;
    const originalAvgQuality = originalIntel.reduce((sum, item) => sum + (item.fusionMetadata?.qualityScore || 0), 0) /
        originalIntel.length || 0;
    const fusedAvgQuality = fusedIntel.reduce((sum, item) => sum + item.fusionMetadata.qualityScore, 0) /
        fusedIntel.length || 0;
...
exports.analyzeFusionEffectiveness = analyzeFusionEffectiveness;
/**
 ...
 * ```
 */
const trackFusionMetrics = (intelligence, interval = 'daily') => {
...
exports.trackFusionMetrics = trackFusionMetrics;
/**
 ...
 * ```
 */
const visualizeFusionResults = (intelligence, correlations) => {
    ...
    for (const item of intelligence) {
        for (const source of item.sources) {
            sourceContributions.set(source.feedName, (sourceContributions.get(source.feedName) || 0) + 1);
        }
    }
    const sourcesTable = {
        type: 'table',
    ...
    // Correlation graph
    const correlationGraph = (0, exports.buildCorrelationGraph)(intelligence, correlations);
    return {
...
exports.visualizeFusionResults = visualizeFusionResults;
// ============================================================================
// HELPER FUNCTIONS
// ============================================================================
/**
 ...
 */
const calculateIntelHash = (type, value) => {
    const canonical = (0, exports.canonicalizeIntelValue)(type, value);
    return crypto.createHash('sha256').update(`${type}:${canonical}`).digest('hex');
};
/**
 * Helper: Creates fused intelligence item.
 */
const createFusedIntelligence = (item, feed) => {
    const now = new Date();
    const hash = calculateIntelHash(item.type, item.value);
    return {
        id: crypto.randomUUID(),
        type: item.type,
        value: item.value,
        normalizedValue: (0, exports.canonicalizeIntelValue)(item.type, item.value),
        hash,
        severity: item.severity,
        confidence: item.confidence,
        sources: [
 ...
 */
const mergeFusedIntelligence = (existing, newItem, feed) => {
    const newSource = {
        feedId: feed.id,
        feedName: feed.name,
        provider: feed.provider,
    ...
    const avgConfidence = (0, exports.calculateMultiSourceConfidence)(allSources, []);
    return {
        ...existing,
        sources: allSources,
 ...
 */
const mapSTIXTypeToIntelType = (stixType) => {
    // Simplified mapping
 ...
 */
const extractSTIXValue = (pattern) => {
 ...
 */
const mapMISPTypeToIntelType = (mispType) => {
    if (mispType.includes('ip'))
        return IntelligenceType.IP_ADDRESS;
    if (mispType.includes('domain'))
        return IntelligenceType.DOMAIN;
    if (mispType.includes('url'))
        return IntelligenceType.URL;
    return IntelligenceType.INDICATOR;
};
/**
 * Helper: Maps MISP threat level.
 */
const mapMISPThreatLevel = (level) => {
 ...
 */
const findSimilarIntelKey = (item, candidates, threshold) => {
    const matchKey = (0, exports.fuzzyMatchIntelligence)(item, candidates, threshold);
 ...
 */
const enrichGeolocation = async (value, sources) => {
 ...
 */
const enrichReputation = async (value, sources) => {
    return {
        score: 65,
        category: 'suspicious',
        sources: sources.slice(0, 2).map((s) => s.name),
 ...
 */
const enrichWhois = async (value, sources) => {
    return {
 ...
 */
const enrichThreatContext = async (value, sources) => {
    return {
 ...
 */
const enrichRelatedIndicators = async (value, sources) => {
    return [
        {
...
//# sourceMappingURL=threat-intelligence-fusion-kit.js.map