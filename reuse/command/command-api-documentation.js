...
exports.createCommandExternalDocs = exports.createCommandTag = exports.createPermissionDoc = exports.createRoleRequirementDoc = exports.createCommandJWTScheme = exports.createNotificationSchema = exports.createAuditTrailSchema = exports.createBatchOperationResponse = exports.createCommandErrorResponse = exports.createCommandSuccessResponse = exports.createDecisionSupportOperationDoc = exports.createPredictiveAnalysisSchema = exports.createDecisionQuerySchema = exports.createDecisionRecommendationSchema = exports.createSituationAwarenessOperationDoc = exports.createHazardAssessmentSchema = exports.createTacticalMapSchema = exports.createSituationReportSchema = exports.createCommandHierarchyOperationDoc = exports.createAuthorityDelegationSchema = exports.createCommandAssignmentSchema = exports.createCommandStructureSchema = exports.createMultiAgencyOperationDoc = exports.createSharedResourceSchema = exports.createAgencyInformationSchema = exports.createMultiAgencyCoordinationSchema = exports.createReportingOperationDoc = exports.createReportingQueryDocs = exports.createResourceUtilizationSchema = exports.createIncidentStatisticsSchema = exports.createAnalyticsQuerySchema = exports.createRealTimeOperationDoc = exports.createWebSocketEventSchema = exports.createDashboardDataSchema = exports.createRealTimeStatusSchema = exports.createResourceOperationDoc = exports.createResourceReallocationSchema = exports.createResourceAvailabilityQueryDocs = exports.createResourceStatusSchema = exports.createResourceAllocationSchema = exports.createIncidentOperationDoc = exports.createIncidentFilterQueryDocs = exports.createIncidentUpdateSchema = exports.createIncidentResponseSchema = exports.createIncidentCreationSchema = void 0;
// ============================================================================
 ...
 * ```
 */
const createIncidentCreationSchema = (includeLocation = true) => {
    const properties = {
        type: {
            type: 'string',
...
exports.createIncidentCreationSchema = createIncidentCreationSchema;
/**
 ...
 * ```
 */
const createIncidentResponseSchema = (includeResources = true) => {
    const properties = {
...
exports.createIncidentResponseSchema = createIncidentResponseSchema;
/**
 ...
 * ```
 */
const createIncidentUpdateSchema = () => {
    return {
        type: 'object',
        properties: {
            status: {
...
exports.createIncidentUpdateSchema = createIncidentUpdateSchema;
/**
 ...
 * ```
 */
const createIncidentFilterQueryDocs = () => {
    return [
        {
            name: 'status',
            required: false,
...
exports.createIncidentFilterQueryDocs = createIncidentFilterQueryDocs;
/**
 ...
 * ```
 */
const createIncidentOperationDoc = (operation) => {
    const operations = {
        create: {
            summary: 'Create new incident',
            description: 'Creates a new incident in the command center system with location, severity, and initial details',
            tags: ['Incidents'],
        },
        update: {
        ...
        list: {
            ...
            description: 'Retrieves a paginated list of incidents with optional filtering by status, severity, type, and date range',
            tags: ['Incidents'],
        },
        get: {
...
exports.createIncidentOperationDoc = createIncidentOperationDoc;
// ============================================================================
 ...
 * ```
 */
const createResourceAllocationSchema = () => {
    return {
        type: 'object',
        properties: {
            incidentId: {
...
exports.createResourceAllocationSchema = createResourceAllocationSchema;
/**
 ...
 * ```
 */
const createResourceStatusSchema = () => {
    return {
        type: 'object',
        properties: {
...
exports.createResourceStatusSchema = createResourceStatusSchema;
/**
 ...
 * ```
 */
const createResourceAvailabilityQueryDocs = () => {
    return [
        {
            name: 'type',
            required: false,
...
exports.createResourceAvailabilityQueryDocs = createResourceAvailabilityQueryDocs;
/**
 ...
 * ```
 */
const createResourceReallocationSchema = () => {
    return {
        type: 'object',
        properties: {
            resourceId: {
...
exports.createResourceReallocationSchema = createResourceReallocationSchema;
/**
 ...
 * ```
 */
const createResourceOperationDoc = (operation) => {
    const operations = {
        allocate: {
...
exports.createResourceOperationDoc = createResourceOperationDoc;
// ============================================================================
 ...
 * ```
 */
const createRealTimeStatusSchema = () => {
    return {
        type: 'object',
        properties: {
            entityType: {
...
exports.createRealTimeStatusSchema = createRealTimeStatusSchema;
/**
 ...
 * ```
 */
const createDashboardDataSchema = () => {
    return {
        type: 'object',
        properties: {
...
exports.createDashboardDataSchema = createDashboardDataSchema;
/**
 ...
 * ```
 */
const createWebSocketEventSchema = (eventType) => {
    return {
        type: 'object',
        properties: {
            event: {
...
exports.createWebSocketEventSchema = createWebSocketEventSchema;
/**
 ...
 * ```
 */
const createRealTimeOperationDoc = (operation) => {
    const operations = {
        dashboard: {
            summary: 'Get command center dashboard',
            description: 'Retrieves real-time dashboard data including active incidents, resource status, and personnel availability',
...
exports.createRealTimeOperationDoc = createRealTimeOperationDoc;
// ============================================================================
 ...
 * ```
 */
const createAnalyticsQuerySchema = () => {
    return {
        type: 'object',
        properties: {
            reportType: {
...
exports.createAnalyticsQuerySchema = createAnalyticsQuerySchema;
/**
 ...
 * ```
 */
const createIncidentStatisticsSchema = () => {
    return {
        type: 'object',
        properties: {
            period: {
...
exports.createIncidentStatisticsSchema = createIncidentStatisticsSchema;
/**
 ...
 * ```
 */
const createResourceUtilizationSchema = () => {
    return {
        type: 'object',
        properties: {
            period: {
...
exports.createResourceUtilizationSchema = createResourceUtilizationSchema;
/**
 ...
 * ```
 */
const createReportingQueryDocs = () => {
    return [
        {
            name: 'reportType',
            required: true,
...
exports.createReportingQueryDocs = createReportingQueryDocs;
/**
 ...
 * ```
 */
const createReportingOperationDoc = (operation) => {
    const operations = {
        statistics: {
            summary: 'Get incident statistics',
            description: 'Generates statistical analysis of incidents for a specified period with breakdown by type and severity',
...
exports.createReportingOperationDoc = createReportingOperationDoc;
// ============================================================================
 ...
 * ```
 */
const createMultiAgencyCoordinationSchema = () => {
    return {
        type: 'object',
        properties: {
            incidentId: {
...
exports.createMultiAgencyCoordinationSchema = createMultiAgencyCoordinationSchema;
/**
 ...
 * ```
 */
const createAgencyInformationSchema = () => {
    return {
        type: 'object',
        properties: {
...
exports.createAgencyInformationSchema = createAgencyInformationSchema;
/**
 ...
 * ```
 */
const createSharedResourceSchema = () => {
    return {
        type: 'object',
        properties: {
...
exports.createSharedResourceSchema = createSharedResourceSchema;
/**
 ...
 * ```
 */
const createMultiAgencyOperationDoc = (operation) => {
    const operations = {
        coordinate: {
            summary: 'Request multi-agency coordination',
            description: 'Initiates multi-agency coordination for an incident with mutual aid or unified command',
...
exports.createMultiAgencyOperationDoc = createMultiAgencyOperationDoc;
// ============================================================================
 ...
 * ```
 */
const createCommandStructureSchema = () => {
    return {
        type: 'object',
        properties: {
            incidentId: { type: 'string', format: 'uuid' },
...
exports.createCommandStructureSchema = createCommandStructureSchema;
/**
 ...
 * ```
 */
const createCommandAssignmentSchema = () => {
    return {
        type: 'object',
        properties: {
            incidentId: { type: 'string', format: 'uuid' },
...
exports.createCommandAssignmentSchema = createCommandAssignmentSchema;
/**
 ...
 * ```
 */
const createAuthorityDelegationSchema = () => {
    return {
        type: 'object',
        properties: {
...
exports.createAuthorityDelegationSchema = createAuthorityDelegationSchema;
/**
 ...
 * ```
 */
const createCommandHierarchyOperationDoc = (operation) => {
    const operations = {
        structure: {
...
exports.createCommandHierarchyOperationDoc = createCommandHierarchyOperationDoc;
// ============================================================================
 ...
 * ```
 */
const createSituationReportSchema = () => {
    return {
        type: 'object',
        properties: {
...
exports.createSituationReportSchema = createSituationReportSchema;
/**
...
exports.createTacticalMapSchema = createTacticalMapSchema;
/**
 ...
 * ```
 */
const createHazardAssessmentSchema = () => {
    return {
        type: 'object',
        properties: {
...
exports.createHazardAssessmentSchema = createHazardAssessmentSchema;
/**
 ...
 * ```
 */
const createSituationAwarenessOperationDoc = (operation) => {
    const operations = {
        report: {
            summary: 'Submit situation report',
            description: 'Submits a situation report with current status, actions taken, and planned actions',
...
exports.createSituationAwarenessOperationDoc = createSituationAwarenessOperationDoc;
// ============================================================================
 ...
 * ```
 */
const createDecisionRecommendationSchema = () => {
    return {
        type: 'object',
        properties: {
...
exports.createDecisionRecommendationSchema = createDecisionRecommendationSchema;
/**
 ...
 * ```
 */
const createDecisionQuerySchema = () => {
    return {
        type: 'object',
        properties: {
            incidentId: { type: 'string', format: 'uuid' },
...
exports.createDecisionQuerySchema = createDecisionQuerySchema;
/**
 ...
 * ```
 */
const createPredictiveAnalysisSchema = () => {
    return {
        type: 'object',
        properties: {
...
exports.createPredictiveAnalysisSchema = createPredictiveAnalysisSchema;
/**
 ...
 * ```
 */
const createDecisionSupportOperationDoc = (operation) => {
    const operations = {
        recommend: {
            summary: 'Get decision recommendation',
            description: 'Provides AI-powered decision recommendations based on current situation and objectives',
...
exports.createDecisionSupportOperationDoc = createDecisionSupportOperationDoc;
// ============================================================================
 ...
 * ```
 */
const createCommandSuccessResponse = (type, description) => {
    return {
        status: 200,
        description,
        type,
...
exports.createCommandSuccessResponse = createCommandSuccessResponse;
/**
 ...
 * ```
 */
const createCommandErrorResponse = (statusCode) => {
    const errorMessages = {
...
exports.createCommandErrorResponse = createCommandErrorResponse;
/**
 ...
 * ```
 */
const createBatchOperationResponse = (operationType) => {
    return {
        type: 'object',
        properties: {
...
exports.createAuditTrailSchema = createAuditTrailSchema;
/**
 ...
 * ```
 */
const createNotificationSchema = (notificationType) => {
    return {
        type: 'object',
        properties: {
 ...
 * ```
 */
const createCommandJWTScheme = () => {
    return {
        type: 'http',
        scheme: 'bearer',
        bearerFormat: 'JWT',
        description: 'JWT token obtained from authentication endpoint. Must include command center permissions.',
    };
};
exports.createCommandJWTScheme = createCommandJWTScheme;
/**
 ...
 * ```
 */
const createRoleRequirementDoc = (requiredRoles) => {
...
exports.createRoleRequirementDoc = createRoleRequirementDoc;
/**
 ...
 * ```
 */
const createPermissionDoc = (permissions) => {
    return `**Required Permissions:**\n${permissions.map((p) => `- ${p}`).join('\n')}\n\nUser must have all listed permissions to perform this operation.`;
};
exports.createPermissionDoc = createPermissionDoc;
/**
 ...
 * ```
 */
const createCommandTag = (name, description) => {
    return {
        name,
        description,
    };
};
exports.createCommandTag = createCommandTag;
/**
 ...
 * ```
 */
const createCommandExternalDocs = (topic) => {
    return {
        url: `https://docs.whitecross.emergency/command/${topic}`,
        description: `Comprehensive documentation for ${topic}`,
    };
};
exports.createCommandExternalDocs = createCommandExternalDocs;
// ============================================================================
// EXPORTS
// ============================================================================
exports.default = {
    // Incident Management
    createIncidentCreationSchema: exports.createIncidentCreationSchema,
    createIncidentResponseSchema: exports.createIncidentResponseSchema,
    createIncidentUpdateSchema: exports.createIncidentUpdateSchema,
    createIncidentFilterQueryDocs: exports.createIncidentFilterQueryDocs,
    createIncidentOperationDoc: exports.createIncidentOperationDoc,
    // Resource Allocation
    createResourceAllocationSchema: exports.createResourceAllocationSchema,
    createResourceStatusSchema: exports.createResourceStatusSchema,
    createResourceAvailabilityQueryDocs: exports.createResourceAvailabilityQueryDocs,
    createResourceReallocationSchema: exports.createResourceReallocationSchema,
    createResourceOperationDoc: exports.createResourceOperationDoc,
    // Real-Time Status
    createRealTimeStatusSchema: exports.createRealTimeStatusSchema,
    createDashboardDataSchema: exports.createDashboardDataSchema,
    createWebSocketEventSchema: exports.createWebSocketEventSchema,
    createRealTimeOperationDoc: exports.createRealTimeOperationDoc,
    // Reporting & Analytics
    createAnalyticsQuerySchema: exports.createAnalyticsQuerySchema,
    createIncidentStatisticsSchema: exports.createIncidentStatisticsSchema,
    createResourceUtilizationSchema: exports.createResourceUtilizationSchema,
    createReportingQueryDocs: exports.createReportingQueryDocs,
    createReportingOperationDoc: exports.createReportingOperationDoc,
    // Multi-Agency Coordination
    createMultiAgencyCoordinationSchema: exports.createMultiAgencyCoordinationSchema,
    createAgencyInformationSchema: exports.createAgencyInformationSchema,
    createSharedResourceSchema: exports.createSharedResourceSchema,
    createMultiAgencyOperationDoc: exports.createMultiAgencyOperationDoc,
    // Command Hierarchy
    createCommandStructureSchema: exports.createCommandStructureSchema,
    createCommandAssignmentSchema: exports.createCommandAssignmentSchema,
    createAuthorityDelegationSchema: exports.createAuthorityDelegationSchema,
    createCommandHierarchyOperationDoc: exports.createCommandHierarchyOperationDoc,
    // Situation Awareness
    createSituationReportSchema: exports.createSituationReportSchema,
    createTacticalMapSchema: exports.createTacticalMapSchema,
    createHazardAssessmentSchema: exports.createHazardAssessmentSchema,
    createSituationAwarenessOperationDoc: exports.createSituationAwarenessOperationDoc,
    // Decision Support
    createDecisionRecommendationSchema: exports.createDecisionRecommendationSchema,
    createDecisionQuerySchema: exports.createDecisionQuerySchema,
    createPredictiveAnalysisSchema: exports.createPredictiveAnalysisSchema,
    createDecisionSupportOperationDoc: exports.createDecisionSupportOperationDoc,
    // Common Responses
    createCommandSuccessResponse: exports.createCommandSuccessResponse,
    createCommandErrorResponse: exports.createCommandErrorResponse,
    createBatchOperationResponse: exports.createBatchOperationResponse,
    createAuditTrailSchema: exports.createAuditTrailSchema,
    createNotificationSchema: exports.createNotificationSchema,
    // Security & Auth
    createCommandJWTScheme: exports.createCommandJWTScheme,
    createRoleRequirementDoc: exports.createRoleRequirementDoc,
    createPermissionDoc: exports.createPermissionDoc,
    createCommandTag: exports.createCommandTag,
    createCommandExternalDocs: exports.createCommandExternalDocs,
};
//# sourceMappingURL=command-api-documentation.js.map