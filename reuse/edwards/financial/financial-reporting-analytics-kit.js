...
exports.generateCommonSizeStatement = exports.generateBudgetVsActual = exports.generateYearOverYearGrowth = exports.publishFinancialReport = exports.validateFinancialReportIntegrity = exports.archiveFinancialReport = exports.generateFinancialRatios = exports.compareFinancialStatements = exports.getReportHistory = exports.scheduleRecurringReport = exports.exportFinancialReport = exports.getDrillDownTransactions = exports.generateSegmentReporting = exports.generateManagementDashboard = exports.performVarianceAnalysis = exports.calculateFinancialKPIs = exports.generateXBRLReport = exports.generateConsolidatedFinancials = exports.generateTrialBalance = exports.generateCashFlowStatement = exports.generateIncomeStatement = exports.generateBalanceSheet = exports.createFinancialKPIDefinitionModel = exports.createFinancialReportHeaderModel = exports.GenerateXBRLDto = exports.GenerateCashFlowDto = exports.GenerateIncomeStatementDto = exports.GenerateBalanceSheetDto = void 0;
/**
 * File: /reuse/edwards/financial/financial-reporting-analytics-kit.ts
...
let GenerateBalanceSheetDto = (() => {
    ...
    let _includeComparative_decorators;
    let _includeComparative_initializers = [];
    let _includeComparative_extraInitializers = [];
    let _comparisonType_decorators;
    let _comparisonType_initializers = [];
    let _comparisonType_extraInitializers = [];
    let _detailLevel_decorators;
    let _detailLevel_initializers = [];
    let _detailLevel_extraInitializers = [];
    return _a = class GenerateBalanceSheetDto {
            constructor() {
                this.reportDate = __runInitializers(this, _reportDate_initializers, void 0);
                this.fiscalYear = (__runInitializers(this, _reportDate_extraInitializers), __runInitializers(this, _fiscalYear_initializers, void 0));
                ...
                this.includeComparative = (__runInitializers(this, _entityId_extraInitializers), __runInitializers(this, _includeComparative_initializers, void 0));
                this.comparisonType = (__runInitializers(this, _includeComparative_extraInitializers), __runInitializers(this, _comparisonType_initializers, void 0));
                this.detailLevel = (__runInitializers(this, _comparisonType_extraInitializers), __runInitializers(this, _detailLevel_initializers, void 0));
                __runInitializers(this, _detailLevel_extraInitializers);
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _reportDate_decorators = [(0, swagger_1.ApiProperty)({ description: 'Report date', example: '2024-12-31' })];
            _fiscalYear_decorators = [(0, swagger_1.ApiProperty)({ description: 'Fiscal year', example: 2024 })];
            _fiscalPeriod_decorators = [(0, swagger_1.ApiProperty)({ description: 'Fiscal period', example: 12 })];
            _entityId_decorators = [(0, swagger_1.ApiProperty)({ description: 'Entity ID', example: 1 })];
            _includeComparative_decorators = [(0, swagger_1.ApiProperty)({ description: 'Include comparative period', default: true })];
            _comparisonType_decorators = [(0, swagger_1.ApiProperty)({ description: 'Comparison period type', enum: ['prior_period', 'prior_year'], default: 'prior_year' })];
            _detailLevel_decorators = [(0, swagger_1.ApiProperty)({ description: 'Level of detail', enum: ['summary', 'detailed', 'full'], default: 'detailed' })];
            ...
            __esDecorate(null, null, _includeComparative_decorators, { kind: "field", name: "includeComparative", static: false, private: false, access: { has: obj => "includeComparative" in obj, get: obj => obj.includeComparative, set: (obj, value) => { obj.includeComparative = value; } }, metadata: _metadata }, _includeComparative_initializers, _includeComparative_extraInitializers);
            ...
            __esDecorate(null, null, _detailLevel_decorators, { kind: "field", name: "detailLevel", static: false, private: false, access: { has: obj => "detailLevel" in obj, get: obj => obj.detailLevel, set: (obj, value) => { obj.detailLevel = value; } }, metadata: _metadata }, _detailLevel_initializers, _detailLevel_extraInitializers);
            if (_metadata) Object.defineProperty(_a, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        })(),
        _a;
})();
exports.GenerateBalanceSheetDto = GenerateBalanceSheetDto;
let GenerateIncomeStatementDto = (() => {
    var _a;
    let _reportDate_decorators;
    let _reportDate_initializers = [];
    let _reportDate_extraInitializers = [];
    ...
    let _includeBudget_decorators;
    let _includeBudget_initializers = [];
    let _includeBudget_extraInitializers = [];
    let _includePriorPeriod_decorators;
    let _includePriorPeriod_initializers = [];
    let _includePriorPeriod_extraInitializers = [];
    return _a = class GenerateIncomeStatementDto {
            constructor() {
                this.reportDate = __runInitializers(this, _reportDate_initializers, void 0);
                this.fiscalYear = (__runInitializers(this, _reportDate_extraInitializers), __runInitializers(this, _fiscalYear_initializers, void 0));
                this.fiscalPeriod = (__runInitializers(this, _fiscalYear_extraInitializers), __runInitializers(this, _fiscalPeriod_initializers, void 0));
                this.entityId = (__runInitializers(this, _fiscalPeriod_extraInitializers), __runInitializers(this, _entityId_initializers, void 0));
                this.periodType = (__runInitializers(this, _entityId_extraInitializers), __runInitializers(this, _periodType_initializers, void 0));
                this.includeBudget = (__runInitializers(this, _periodType_extraInitializers), __runInitializers(this, _includeBudget_initializers, void 0));
                this.includePriorPeriod = (__runInitializers(this, _includeBudget_extraInitializers), __runInitializers(this, _includePriorPeriod_initializers, void 0));
                __runInitializers(this, _includePriorPeriod_extraInitializers);
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            ...
            _fiscalPeriod_decorators = [(0, swagger_1.ApiProperty)({ description: 'Fiscal period', example: 12 })];
            _entityId_decorators = [(0, swagger_1.ApiProperty)({ description: 'Entity ID', example: 1 })];
            _periodType_decorators = [(0, swagger_1.ApiProperty)({ description: 'Period type', enum: ['month', 'quarter', 'year', 'ytd'], default: 'month' })];
            _includeBudget_decorators = [(0, swagger_1.ApiProperty)({ description: 'Include budget comparison', default: true })];
            _includePriorPeriod_decorators = [(0, swagger_1.ApiProperty)({ description: 'Include prior period', default: true })];
            __esDecorate(null, null, _reportDate_decorators, { kind: "field", name: "reportDate", static: false, private: false, access: { has: obj => "reportDate" in obj, get: obj => obj.reportDate, set: (obj, value) => { obj.reportDate = value; } }, metadata: _metadata }, _reportDate_initializers, _reportDate_extraInitializers);
            __esDecorate(null, null, _fiscalYear_decorators, { kind: "field", name: "fiscalYear", static: false, private: false, access: { has: obj => "fiscalYear" in obj, get: obj => obj.fiscalYear, set: (obj, value) => { obj.fiscalYear = value; } }, metadata: _metadata }, _fiscalYear_initializers, _fiscalYear_extraInitializers);
            __esDecorate(null, null, _fiscalPeriod_decorators, { kind: "field", name: "fiscalPeriod", static: false, private: false, access: { has: obj => "fiscalPeriod" in obj, get: obj => obj.fiscalPeriod, set: (obj, value) => { obj.fiscalPeriod = value; } }, metadata: _metadata }, _fiscalPeriod_initializers, _fiscalPeriod_extraInitializers);
            __esDecorate(null, null, _entityId_decorators, { kind: "field", name: "entityId", static: false, private: false, access: { has: obj => "entityId" in obj, get: obj => obj.entityId, set: (obj, value) => { obj.entityId = value; } }, metadata: _metadata }, _entityId_initializers, _entityId_extraInitializers);
            ...
            __esDecorate(null, null, _includeBudget_decorators, { kind: "field", name: "includeBudget", static: false, private: false, access: { has: obj => "includeBudget" in obj, get: obj => obj.includeBudget, set: (obj, value) => { obj.includeBudget = value; } }, metadata: _metadata }, _includeBudget_initializers, _includeBudget_extraInitializers);
            __esDecorate(null, null, _includePriorPeriod_decorators, { kind: "field", name: "includePriorPeriod", static: false, private: false, access: { has: obj => "includePriorPeriod" in obj, get: obj => obj.includePriorPeriod, set: (obj, value) => { obj.includePriorPeriod = value; } }, metadata: _metadata }, _includePriorPeriod_initializers, _includePriorPeriod_extraInitializers);
            if (_metadata) Object.defineProperty(_a, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        })(),
        _a;
})();
exports.GenerateIncomeStatementDto = GenerateIncomeStatementDto;
let GenerateCashFlowDto = (() => {
    var _a;
    let _reportDate_decorators;
    let _reportDate_initializers = [];
    let _reportDate_extraInitializers = [];
    ...
    return _a = class GenerateCashFlowDto {
            constructor() {
                this.reportDate = __runInitializers(this, _reportDate_initializers, void 0);
                this.fiscalYear = (__runInitializers(this, _reportDate_extraInitializers), __runInitializers(this, _fiscalYear_initializers, void 0));
                this.fiscalPeriod = (__runInitializers(this, _fiscalYear_extraInitializers), __runInitializers(this, _fiscalPeriod_initializers, void 0));
                this.entityId = (__runInitializers(this, _fiscalPeriod_extraInitializers), __runInitializers(this, _entityId_initializers, void 0));
                this.method = (__runInitializers(this, _entityId_extraInitializers), __runInitializers(this, _method_initializers, void 0));
        ...
        (() => {
            ...
            _fiscalPeriod_decorators = [(0, swagger_1.ApiProperty)({ description: 'Fiscal period', example: 12 })];
            _entityId_decorators = [(0, swagger_1.ApiProperty)({ description: 'Entity ID', example: 1 })];
            _method_decorators = [(0, swagger_1.ApiProperty)({ description: 'Method', enum: ['direct', 'indirect'], default: 'indirect' })];
            __esDecorate(null, null, _reportDate_decorators, { kind: "field", name: "reportDate", static: false, private: false, access: { has: obj => "reportDate" in obj, get: obj => obj.reportDate, set: (obj, value) => { obj.reportDate = value; } }, metadata: _metadata }, _reportDate_initializers, _reportDate_extraInitializers);
            __esDecorate(null, null, _fiscalYear_decorators, { kind: "field", name: "fiscalYear", static: false, private: false, access: { has: obj => "fiscalYear" in obj, get: obj => obj.fiscalYear, set: (obj, value) => { obj.fiscalYear = value; } }, metadata: _metadata }, _fiscalYear_initializers, _fiscalYear_extraInitializers);
            __esDecorate(null, null, _fiscalPeriod_decorators, { kind: "field", name: "fiscalPeriod", static: false, private: false, access: { has: obj => "fiscalPeriod" in obj, get: obj => obj.fiscalPeriod, set: (obj, value) => { obj.fiscalPeriod = value; } }, metadata: _metadata }, _fiscalPeriod_initializers, _fiscalPeriod_extraInitializers);
            __esDecorate(null, null, _entityId_decorators, { kind: "field", name: "entityId", static: false, private: false, access: { has: obj => "entityId" in obj, get: obj => obj.entityId, set: (obj, value) => { obj.entityId = value; } }, metadata: _metadata }, _entityId_initializers, _entityId_extraInitializers);
...
let GenerateXBRLDto = (() => {
    ...
    let _entityId_initializers = [];
    let _entityId_extraInitializers = [];
    let _taxonomyVersion_decorators;
    let _taxonomyVersion_initializers = [];
    let _taxonomyVersion_extraInitializers = [];
    let _reportType_decorators;
    let _reportType_initializers = [];
    let _reportType_extraInitializers = [];
    return _a = class GenerateXBRLDto {
            constructor() {
                this.reportDate = __runInitializers(this, _reportDate_initializers, void 0);
                this.fiscalYear = (__runInitializers(this, _reportDate_extraInitializers), __runInitializers(this, _fiscalYear_initializers, void 0));
                this.entityId = (__runInitializers(this, _fiscalYear_extraInitializers), __runInitializers(this, _entityId_initializers, void 0));
                this.taxonomyVersion = (__runInitializers(this, _entityId_extraInitializers), __runInitializers(this, _taxonomyVersion_initializers, void 0));
                this.reportType = (__runInitializers(this, _taxonomyVersion_extraInitializers), __runInitializers(this, _reportType_initializers, void 0));
                __runInitializers(this, _reportType_extraInitializers);
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            ...
            _fiscalYear_decorators = [(0, swagger_1.ApiProperty)({ description: 'Fiscal year', example: 2024 })];
            _entityId_decorators = [(0, swagger_1.ApiProperty)({ description: 'Entity ID', example: 1 })];
            _taxonomyVersion_decorators = [(0, swagger_1.ApiProperty)({ description: 'Taxonomy version', example: 'US-GAAP-2024' })];
            _reportType_decorators = [(0, swagger_1.ApiProperty)({ description: 'Report type', enum: ['10-Q', '10-K', 'annual', 'quarterly'] })];
            __esDecorate(null, null, _reportDate_decorators, { kind: "field", name: "reportDate", static: false, private: false, access: { has: obj => "reportDate" in obj, get: obj => obj.reportDate, set: (obj, value) => { obj.reportDate = value; } }, metadata: _metadata }, _reportDate_initializers, _reportDate_extraInitializers);
            __esDecorate(null, null, _fiscalYear_decorators, { kind: "field", name: "fiscalYear", static: false, private: false, access: { has: obj => "fiscalYear" in obj, get: obj => obj.fiscalYear, set: (obj, value) => { obj.fiscalYear = value; } }, metadata: _metadata }, _fiscalYear_initializers, _fiscalYear_extraInitializers);
            __esDecorate(null, null, _entityId_decorators, { kind: "field", name: "entityId", static: false, private: false, access: { has: obj => "entityId" in obj, get: obj => obj.entityId, set: (obj, value) => { obj.entityId = value; } }, metadata: _metadata }, _entityId_initializers, _entityId_extraInitializers);
            __esDecorate(null, null, _taxonomyVersion_decorators, { kind: "field", name: "taxonomyVersion", static: false, private: false, access: { has: obj => "taxonomyVersion" in obj, get: obj => obj.taxonomyVersion, set: (obj, value) => { obj.taxonomyVersion = value; } }, metadata: _metadata }, _taxonomyVersion_initializers, _taxonomyVersion_extraInitializers);
...
exports.GenerateXBRLDto = GenerateXBRLDto;
// ============================================================================
// SEQUELIZE MODELS
// ============================================================================
/**
 ...
 * ```
 */
const createFinancialReportHeaderModel = (sequelize) => {
    class FinancialReportHeader extends sequelize_1.Model {
    }
    FinancialReportHeader.init({
        ...
        reportType: {
            type: sequelize_1.DataTypes.ENUM('balance_sheet', 'income_statement', 'cash_flow', 'trial_balance', 'consolidated', 'segment', 'xbrl', 'management_dashboard'),
            allowNull: false,
        ...
        status: {
            type: sequelize_1.DataTypes.ENUM('draft', 'generating', 'generated', 'published', 'archived'),
            allowNull: false,
            defaultValue: 'draft',
...
exports.createFinancialReportHeaderModel = createFinancialReportHeaderModel;
/**
 ...
 * ```
 */
const createFinancialKPIDefinitionModel = (sequelize) => {
    class FinancialKPIDefinition extends sequelize_1.Model {
    }
    FinancialKPIDefinition.init({
        ...
        category: {
            type: sequelize_1.DataTypes.ENUM('liquidity', 'profitability', 'efficiency', 'leverage', 'market', 'custom'),
            allowNull: false,
...
exports.createFinancialKPIDefinitionModel = createFinancialKPIDefinitionModel;
// ============================================================================
 ...
 * ```
 */
const generateBalanceSheet = async (sequelize, params, transaction) => {
    const query = `
 ...
 * ```
 */
const generateIncomeStatement = async (sequelize, params, transaction) => {
    const query = `
 ...
 * ```
 */
const generateCashFlowStatement = async (sequelize, params, transaction) => {
    // Get net income from income statement
    const incomeStmt = await (0, exports.generateIncomeStatement)(sequelize, {
        reportDate: params.reportDate,
        fiscalYear: params.fiscalYear,
        fiscalPeriod: params.fiscalPeriod,
        entityId: params.entityId,
  ...
  `;
    ...
    const beginningCash = Number(beginningCashResult[0]?.beginning_cash || 0);
 ...
 * ```
 */
const generateTrialBalance = async (sequelize, fiscalYear, fiscalPeriod, entityId, includeInactive = false, transaction) => {
    const query = `
 ...
 * ```
 */
const generateConsolidatedFinancials = async (sequelize, parentEntityId, fiscalYear, fiscalPeriod, consolidationType, transaction) => {
  ...
  `;
    ...
    for (const sub of subsidiaries) {
        const balanceSheet = await (0, exports.generateBalanceSheet)(sequelize, {
            reportDate: new Date(),
            fiscalYear,
            fiscalPeriod,
        ...
        const incomeStatement = await (0, exports.generateIncomeStatement)(sequelize, {
            reportDate: new Date(),
            fiscalYear,
            fiscalPeriod,
            entityId: sub.entity_id,
  ...
  `;
    ...
    const consolidatedBalanceSheet = await (0, exports.generateBalanceSheet)(sequelize, {
        reportDate: new Date(),
        fiscalYear,
        fiscalPeriod,
    ...
    const consolidatedIncomeStatement = await (0, exports.generateIncomeStatement)(sequelize, {
        reportDate: new Date(),
        fiscalYear,
        fiscalPeriod,
        entityId: parentEntityId,
...
exports.generateConsolidatedFinancials = generateConsolidatedFinancials;
/**
 ...
 * ```
 */
const generateXBRLReport = async (sequelize, params, transaction) => {
    const entityQuery = `
...
exports.generateXBRLReport = generateXBRLReport;
/**
 ...
 * ```
 */
const calculateFinancialKPIs = async (sequelize, entityId, fiscalYear, fiscalPeriod, transaction) => {
    const balanceSheet = await (0, exports.generateBalanceSheet)(sequelize, {
        reportDate: new Date(),
        fiscalYear,
        fiscalPeriod,
 ...
 * ```
 */
const performVarianceAnalysis = async (sequelize, entityId, fiscalYear, fiscalPeriod, analysisType, thresholdPercent = 10, transaction) => {
    let comparisonQuery = '';
    switch (analysisType) {
        case 'budget':
            comparisonQuery = `
    ...
    for (const row of results) {
        ...
        if (favorability === 'favorable')
            favorableVariances += Math.abs(variance);
        if (favorability === 'unfavorable')
            unfavorableVariances += Math.abs(variance);
        if (isSignificant)
 ...
 * ```
 */
const generateManagementDashboard = async (sequelize, entityId, fiscalYear, fiscalPeriod, transaction) => {
    const kpis = await (0, exports.calculateFinancialKPIs)(sequelize, entityId, fiscalYear, fiscalPeriod, transaction);
    const balanceSheet = await (0, exports.generateBalanceSheet)(sequelize, {
        reportDate: new Date(),
        fiscalYear,
        fiscalPeriod,
    ...
    const cashFlow = await (0, exports.generateCashFlowStatement)(sequelize, {
        reportDate: new Date(),
        fiscalYear,
        fiscalPeriod,
        entityId,
...
exports.generateManagementDashboard = generateManagementDashboard;
/**
 ...
 * ```
 */
const generateSegmentReporting = async (sequelize, entityId, fiscalYear, fiscalPeriod, segmentType, transaction) => {
    const segmentQuery = `
    SELECT
      s.id as segment_id,
      s.segment_name,
...
exports.generateSegmentReporting = generateSegmentReporting;
/**
 ...
 * ```
 */
const getDrillDownTransactions = async (sequelize, accountCode, fiscalYear, fiscalPeriod, limit = 50, offset = 0, transaction) => {
    const accountQuery = `
  ...
  `;
    ...
    const balanceAmount = Number(balanceResult[0]?.balance_amount || 0);
    return {
        accountCode,
...
exports.getDrillDownTransactions = getDrillDownTransactions;
/**
 ...
 * ```
 */
const exportFinancialReport = async (sequelize, reportId, format, transaction) => {
    const ReportHeader = (0, exports.createFinancialReportHeaderModel)(sequelize);
 ...
 * ```
 */
const scheduleRecurringReport = async (sequelize, reportType, entityId, frequency, recipients, userId, transaction) => {
    const query = `
...
exports.scheduleRecurringReport = scheduleRecurringReport;
/**
 ...
 * ```
 */
const getReportHistory = async (sequelize, entityId, reportType, limit = 20, offset = 0, transaction) => {
    const ReportHeader = (0, exports.createFinancialReportHeaderModel)(sequelize);
 ...
 * ```
 */
const compareFinancialStatements = async (sequelize, entityId, fiscalYears, fiscalPeriod, reportType, transaction) => {
    const reports = [];
    for (const year of fiscalYears) {
        if (reportType === 'balance_sheet') {
            const report = await (0, exports.generateBalanceSheet)(sequelize, {
            ...
            const report = await (0, exports.generateIncomeStatement)(sequelize, {
                reportDate: new Date(year, 11, 31),
                fiscalYear: year,
                fiscalPeriod,
                entityId,
...
exports.compareFinancialStatements = compareFinancialStatements;
/**
 ...
 * ```
 */
const generateFinancialRatios = async (sequelize, entityId, fiscalYear, fiscalPeriod, transaction) => {
    const balanceSheet = await (0, exports.generateBalanceSheet)(sequelize, {
        reportDate: new Date(),
        fiscalYear,
        fiscalPeriod,
...
exports.generateFinancialRatios = generateFinancialRatios;
/**
 ...
 * ```
 */
const archiveFinancialReport = async (sequelize, reportId, archiveLocation, userId, transaction) => {
    const ReportHeader = (0, exports.createFinancialReportHeaderModel)(sequelize);
    const report = await ReportHeader.findByPk(reportId, { transaction });
    if (!report) {
        throw new Error('Report not found');
...
exports.archiveFinancialReport = archiveFinancialReport;
/**
 ...
 * ```
 */
const validateFinancialReportIntegrity = async (sequelize, reportId, transaction) => {
    const ReportHeader = (0, exports.createFinancialReportHeaderModel)(sequelize);
    const report = await ReportHeader.findByPk(reportId, { transaction });
    if (!report) {
    ...
    if (report.reportType === 'trial_balance') {
        const trialBalance = await (0, exports.generateTrialBalance)(sequelize, report.fiscalYear, report.fiscalPeriod, report.entityId, false, transaction);
...
exports.validateFinancialReportIntegrity = validateFinancialReportIntegrity;
/**
 ...
 * ```
 */
const publishFinancialReport = async (sequelize, reportId, userId, transaction) => {
    const ReportHeader = (0, exports.createFinancialReportHeaderModel)(sequelize);
    const report = await ReportHeader.findByPk(reportId, { transaction });
    if (!report) {
        throw new Error('Report not found');
    ...
    const validation = await (0, exports.validateFinancialReportIntegrity)(sequelize, reportId, transaction);
    if (!validation.valid) {
...
exports.publishFinancialReport = publishFinancialReport;
/**
 ...
 * ```
 */
const generateYearOverYearGrowth = async (sequelize, entityId, currentYear, numberOfYears = 3, transaction) => {
...
exports.generateYearOverYearGrowth = generateYearOverYearGrowth;
/**
 ...
 * ```
 */
const generateBudgetVsActual = async (sequelize, entityId, fiscalYear, fiscalPeriod = 0, transaction) => {
...
exports.generateBudgetVsActual = generateBudgetVsActual;
/**
 ...
 * ```
 */
const generateCommonSizeStatement = async (sequelize, entityId, fiscalYear, fiscalPeriod, statementType, transaction) => {
...
exports.generateCommonSizeStatement = generateCommonSizeStatement;
