 ...
 * ```
 */
export declare const loadCoverageConfig: () => CoverageConfig;
/**
 ...
 * ```
 */
export declare const validateCoverageConfig: (config: CoverageConfig) => string[];
/**
 ...
 * Coverage types
 */
export type CoverageType = 'general_liability' | 'professional_liability' | 'medical_malpractice' | 'property' | 'workers_compensation' | 'cyber_liability' | 'directors_officers' | 'employment_practices' | 'commercial_auto' | 'umbrella' | 'excess' | 'equipment_breakdown' | 'business_interruption' | 'clinical_trials' | 'data_breach';
/**
 * Coverage limit types
 */
export type CoverageLimitType = 'per_occurrence' | 'aggregate' | 'per_claim' | 'annual' | 'lifetime' | 'per_person' | 'per_accident' | 'combined_single_limit';
/**
 * Deductible types
 */
export type DeductibleType = 'per_occurrence' | 'per_claim' | 'annual_aggregate' | 'calendar_year' | 'policy_year' | 'waiting_period' | 'percentage';
/**
 * Coverage definition
 */
...
export interface CoverageComparison {
    ...
    coverageTypes: CoverageType[];
    limitComparison: Map<CoverageType, Array<{
        policyId: string;
        limit: number;
    }>>;
    deductibleComparison: Map<CoverageType, Array<{
        policyId: string;
        deductible: number;
    }>>;
 ...
 * ```
 */
export declare const createCoverageModel: (sequelize: Sequelize) => any;
/**
 ...
 * ```
 */
export declare const createCoverageEndorsementModel: (sequelize: Sequelize) => any;
/**
 ...
 * ```
 */
export declare const createCoverageDefinition: (coverage: CoverageDefinition) => Promise<CoverageDefinition>;
/**
 ...
 * ```
 */
export declare const getCoverageByType: (policyId: string, coverageType: CoverageType) => Promise<CoverageDefinition | null>;
/**
 ...
 * ```
 */
export declare const listPolicyCoverages: (policyId: string, activeOnly?: boolean) => Promise<CoverageDefinition[]>;
/**
 ...
 * ```
 */
export declare const activateCoverage: (coverageId: string, effectiveDate?: Date) => Promise<CoverageDefinition>;
/**
 ...
 * ```
 */
export declare const deactivateCoverage: (coverageId: string, effectiveDate?: Date, reason?: string) => Promise<CoverageDefinition>;
/**
 ...
 * ```
 */
export declare const defineCoverageLimit: (coverageId: string, limit: CoverageLimit) => Promise<CoverageLimit>;
/**
 ...
 * ```
 */
export declare const updateCoverageLimit: (coverageId: string, limitId: string, updates: Partial<CoverageLimit>) => Promise<CoverageLimit>;
/**
 ...
 * ```
 */
export declare const getRemainingLimit: (coverageId: string, limitType: CoverageLimitType, asOfDate?: Date) => Promise<number>;
/**
 ...
 * ```
 */
export declare const validateLimitCompliance: (limit: CoverageLimit, state: string) => Promise<{
    isCompliant: boolean;
    issues: string[];
}>;
/**
 ...
 * ```
 */
export declare const applySublimit: (coverageId: string, sublimit: CoverageSublimit) => Promise<CoverageSublimit>;
/**
 ...
 * ```
 */
export declare const defineCoverageDeductible: (coverageId: string, deductible: CoverageDeductible) => Promise<CoverageDeductible>;
/**
 ...
 * ```
 */
export declare const calculateApplicableDeductible: (coverageId: string, claimAmount: number, lossDate: Date) => Promise<number>;
/**
 ...
 * ```
 */
export declare const trackDeductibleAccumulation: (coverageId: string, amount: number, claimId: string) => Promise<{
 ...
 * ```
 */
export declare const updateDeductibleAmount: (coverageId: string, deductibleId: string, newAmount: number) => Promise<CoverageDeductible>;
/**
 ...
 * ```
 */
export declare const waiveDeductible: (coverageId: string, claimId: string, reason: string, approvedBy: string) => Promise<{
    waived: boolean;
 ...
 * ```
 */
export declare const addCoverageEndorsement: (endorsement: CoverageEndorsement) => Promise<CoverageEndorsement>;
/**
 ...
 * ```
 */
export declare const approveEndorsement: (endorsementId: string, approvedBy: string) => Promise<CoverageEndorsement>;
/**
 ...
 * ```
 */
export declare const listCoverageEndorsements: (coverageId: string, status?: string) => Promise<CoverageEndorsement[]>;
/**
 ...
 * ```
 */
export declare const cancelEndorsement: (endorsementId: string, reason: string) => Promise<CoverageEndorsement>;
/**
 ...
 * ```
 */
export declare const calculateEndorsementPremiumImpact: (coverageId: string, endorsementChanges: Partial<CoverageEndorsement>) => Promise<{
    premiumChange: number;
    newPremium: number;
}>;
/**
 ...
 * ```
 */
export declare const addCoverageExclusion: (exclusion: CoverageExclusion) => Promise<CoverageExclusion>;
/**
 ...
 * ```
 */
export declare const listCoverageExclusions: (coverageId: string, activeOnly?: boolean) => Promise<CoverageExclusion[]>;
/**
 ...
 * ```
 */
export declare const checkClaimExclusions: (coverageId: string, claimDetails: Record<string, any>) => Promise<{
    isExcluded: boolean;
    exclusions: string[];
}>;
/**
 ...
 * ```
 */
export declare const removeCoverageExclusion: (exclusionId: string, effectiveDate: Date) => Promise<void>;
/**
 ...
 * ```
 */
export declare const getStateMandatedExclusions: (state: string, coverageType: CoverageType) => Promise<CoverageExclusion[]>;
/**
 ...
 * ```
 */
export declare const listAvailableOptionalCoverages: (policyId: string, criteria?: Record<string, any>) => Promise<OptionalCoverage[]>;
/**
 ...
 * ```
 */
export declare const addOptionalCoverage: (policyId: string, optionalCoverageId: string, selectedLimit: CoverageLimit, selectedDeductible: CoverageDeductible) => Promise<CoverageDefinition>;
/**
 ...
 * ```
 */
export declare const removeOptionalCoverage: (coverageId: string, effectiveDate: Date) => Promise<void>;
/**
 ...
 * ```
 */
export declare const evaluateOptionalCoverageRecommendations: (policyId: string, riskProfile: Record<string, any>) => Promise<OptionalCoverage[]>;
/**
 ...
 * ```
 */
export declare const calculateOptionalCoveragePremium: (optionalCoverageId: string, selectedLimit: CoverageLimit, selectedDeductible: CoverageDeductible, factors?: Record<string, any>) => Promise<number>;
/**
 ...
 * ```
 */
export declare const defineCoverageTerritory: (territory: CoverageTerritory) => Promise<CoverageTerritory>;
/**
 ...
 * ```
 */
export declare const validateClaimTerritory: (coverageId: string, claimLocation: string) => Promise<{
    isCovered: boolean;
    reason?: string;
}>;
/**
 ...
 * ```
 */
export declare const expandCoverageTerritory: (coverageId: string, additionalAreas: string[], premiumAdjustment?: number) => Promise<CoverageTerritory>;
/**
 ...
 * ```
 */
export declare const analyzeCoverageGaps: (policyId: string, asOfDate?: Date) => Promise<CoverageGap[]>;
/**
 ...
 * ```
 */
export declare const identifyCoverageOverlaps: (policyId: string) => Promise<Array<{
    coverageType: CoverageType;
    overlappingCoverages: string[];
}>>;
/**
 ...
 * ```
 */
export declare const validateContinuousCoverage: (policyId: string, coverageType: CoverageType, startDate: Date, endDate: Date) => Promise<{
 ...
 * ```
 */
export declare const addAdditionalInsured: (additionalInsured: AdditionalInsured) => Promise<AdditionalInsured>;
/**
 ...
 * ```
 */
export declare const listAdditionalInsureds: (coverageId: string, activeOnly?: boolean) => Promise<AdditionalInsured[]>;
/**
 ...
 * ```
 */
export declare const removeAdditionalInsured: (additionalInsuredId: string, effectiveDate: Date) => Promise<void>;
/**
 ...
 * ```
 */
export declare const coordinateUmbrellaCoverage: (coordination: UmbrellaCoverageCoordination) => Promise<UmbrellaCoverageCoordination>;
declare const _default: {
    loadCoverageConfig: () => CoverageConfig;
    validateCoverageConfig: (config: CoverageConfig) => string[];
    createCoverageModel: (sequelize: Sequelize) => any;
    createCoverageEndorsementModel: (sequelize: Sequelize) => any;
    createCoverageDefinition: (coverage: CoverageDefinition) => Promise<CoverageDefinition>;
    getCoverageByType: (policyId: string, coverageType: CoverageType) => Promise<CoverageDefinition | null>;
    listPolicyCoverages: (policyId: string, activeOnly?: boolean) => Promise<CoverageDefinition[]>;
    activateCoverage: (coverageId: string, effectiveDate?: Date) => Promise<CoverageDefinition>;
    deactivateCoverage: (coverageId: string, effectiveDate?: Date, reason?: string) => Promise<CoverageDefinition>;
    defineCoverageLimit: (coverageId: string, limit: CoverageLimit) => Promise<CoverageLimit>;
    updateCoverageLimit: (coverageId: string, limitId: string, updates: Partial<CoverageLimit>) => Promise<CoverageLimit>;
    getRemainingLimit: (coverageId: string, limitType: CoverageLimitType, asOfDate?: Date) => Promise<number>;
    validateLimitCompliance: (limit: CoverageLimit, state: string) => Promise<{
        isCompliant: boolean;
        issues: string[];
    }>;
    applySublimit: (coverageId: string, sublimit: CoverageSublimit) => Promise<CoverageSublimit>;
    defineCoverageDeductible: (coverageId: string, deductible: CoverageDeductible) => Promise<CoverageDeductible>;
    calculateApplicableDeductible: (coverageId: string, claimAmount: number, lossDate: Date) => Promise<number>;
    trackDeductibleAccumulation: (coverageId: string, amount: number, claimId: string) => Promise<{
        totalAccumulated: number;
        remainingDeductible: number;
    }>;
    updateDeductibleAmount: (coverageId: string, deductibleId: string, newAmount: number) => Promise<CoverageDeductible>;
    waiveDeductible: (coverageId: string, claimId: string, reason: string, approvedBy: string) => Promise<{
        waived: boolean;
        originalAmount: number;
    }>;
    addCoverageEndorsement: (endorsement: CoverageEndorsement) => Promise<CoverageEndorsement>;
    approveEndorsement: (endorsementId: string, approvedBy: string) => Promise<CoverageEndorsement>;
    listCoverageEndorsements: (coverageId: string, status?: string) => Promise<CoverageEndorsement[]>;
    cancelEndorsement: (endorsementId: string, reason: string) => Promise<CoverageEndorsement>;
    calculateEndorsementPremiumImpact: (coverageId: string, endorsementChanges: Partial<CoverageEndorsement>) => Promise<{
        premiumChange: number;
        newPremium: number;
    }>;
    addCoverageExclusion: (exclusion: CoverageExclusion) => Promise<CoverageExclusion>;
    listCoverageExclusions: (coverageId: string, activeOnly?: boolean) => Promise<CoverageExclusion[]>;
    checkClaimExclusions: (coverageId: string, claimDetails: Record<string, any>) => Promise<{
        isExcluded: boolean;
        exclusions: string[];
    }>;
    removeCoverageExclusion: (exclusionId: string, effectiveDate: Date) => Promise<void>;
    getStateMandatedExclusions: (state: string, coverageType: CoverageType) => Promise<CoverageExclusion[]>;
    listAvailableOptionalCoverages: (policyId: string, criteria?: Record<string, any>) => Promise<OptionalCoverage[]>;
    addOptionalCoverage: (policyId: string, optionalCoverageId: string, selectedLimit: CoverageLimit, selectedDeductible: CoverageDeductible) => Promise<CoverageDefinition>;
    removeOptionalCoverage: (coverageId: string, effectiveDate: Date) => Promise<void>;
    evaluateOptionalCoverageRecommendations: (policyId: string, riskProfile: Record<string, any>) => Promise<OptionalCoverage[]>;
    calculateOptionalCoveragePremium: (optionalCoverageId: string, selectedLimit: CoverageLimit, selectedDeductible: CoverageDeductible, factors?: Record<string, any>) => Promise<number>;
    defineCoverageTerritory: (territory: CoverageTerritory) => Promise<CoverageTerritory>;
    validateClaimTerritory: (coverageId: string, claimLocation: string) => Promise<{
        isCovered: boolean;
        reason?: string;
    }>;
    expandCoverageTerritory: (coverageId: string, additionalAreas: string[], premiumAdjustment?: number) => Promise<CoverageTerritory>;
    analyzeCoverageGaps: (policyId: string, asOfDate?: Date) => Promise<CoverageGap[]>;
    identifyCoverageOverlaps: (policyId: string) => Promise<Array<{
        coverageType: CoverageType;
        overlappingCoverages: string[];
    }>>;
    validateContinuousCoverage: (policyId: string, coverageType: CoverageType, startDate: Date, endDate: Date) => Promise<{
        isContinuous: boolean;
        gaps: CoverageGap[];
    }>;
    addAdditionalInsured: (additionalInsured: AdditionalInsured) => Promise<AdditionalInsured>;
    listAdditionalInsureds: (coverageId: string, activeOnly?: boolean) => Promise<AdditionalInsured[]>;
    removeAdditionalInsured: (additionalInsuredId: string, effectiveDate: Date) => Promise<void>;
    coordinateUmbrellaCoverage: (coordination: UmbrellaCoverageCoordination) => Promise<UmbrellaCoverageCoordination>;
};
export default _default;
//# sourceMappingURL=coverage-management-kit.d.ts.map