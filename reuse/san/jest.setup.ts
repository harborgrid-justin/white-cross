...
expect.extend({
   ...
   */
  toBeValidSANVolumeId(received: string) {
   ...
   */
  toBeValidLUNNumber(received: number) {
   ...
   */
  toBeWithinPerformanceThreshold(received: number, expected: number, tolerance: number = 0.1) {
   ...
   */
  toHaveRequiredVolumeProperties(received: any) {
...
// Declare global test helpers for TypeScript
declare global {
  var testHelpers: {
