  ...
  DigitalResource.init(
    {
      ...
      resourceType: {
        type: DataTypes.ENUM('ebook', 'journal', 'database', 'video', 'audio', 'dataset', 'software', 'archive'),
        allowNull: false,
      },
      accessLevel: {
        type: DataTypes.ENUM('public', 'campus', 'licensed', 'course_reserve', 'restricted'),
        allowNull: false,
      },
      resourceData: {
        type: DataTypes.JSON,
  ...
  ResourceLicense.init(
    {
      ...
      licenseType: {
        type: DataTypes.ENUM('perpetual', 'subscription', 'concurrent', 'unlimited', 'pay_per_view'),
        allowNull: false,
      },
      startDate: {
        type: DataTypes.DATE,
...
export class DigitalResourceAccessService {
  private readonly logger = new Logger(DigitalResourceAccessService.name);
