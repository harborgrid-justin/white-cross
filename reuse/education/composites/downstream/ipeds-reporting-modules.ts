...
/**
 * LOC: EDU-COMP-DOWNSTREAM-IPEDS-005
 * File: /reuse/education/composites/downstream/ipeds-reporting-modules.ts
 *
...
/**
 * Production-grade IPEDSReportingModulesComposite for Ellucian SIS competitors.
 */
...
@ApiTags('Ipeds Reporting Modules')
...
@Injectable()
export class IPEDSReportingModulesComposite {  constructor(
...
export default IPEDSReportingModulesComposite;
