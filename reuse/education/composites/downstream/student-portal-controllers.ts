/**
 * LOC: EDU-COMP-DOWNSTREAM-012
 * File: /reuse/education/composites/downstream/student-portal-controllers.ts
 *
...
/**
 * File: /reuse/education/composites/downstream/student-portal-controllers.ts
 * Locator: WC-COMP-DOWNSTREAM-012
 * Purpose: Student Portal Controllers - Production-grade portal API controllers
 *
 ...
 * Composes functions to provide portal API controllers with full operational capabilities.
 */
...
export const createServiceModel = (sequelize: Sequelize) => {
  ...
  ServiceModel.init(
    ...
    {
      sequelize,
      tableName: 'student_portal_controllers',
      timestamps: true,
...
@Injectable()
export class StudentPortalControllersCompositeService {
  private readonly logger = new Logger(StudentPortalControllersCompositeService.name);
...
export default StudentPortalControllersCompositeService;
