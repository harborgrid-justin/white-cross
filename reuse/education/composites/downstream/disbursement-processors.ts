...
/**
 * Production-ready Sequelize model for DirectDeposit
 *
 * Features:
...
export const createDirectDepositModel = (sequelize: Sequelize) => {
  ...
  DirectDeposit.init(
    ...
    },
    {
      ...
      hooks: {
        beforeCreate: async (record: DirectDeposit, options: any) => {
        ...
        afterCreate: async (record: DirectDeposit, options: any) => {
          console.log(`[AUDIT] DirectDeposit created: ${record.id}`);
        },
        beforeUpdate: async (record: DirectDeposit, options: any) => {
        ...
        afterUpdate: async (record: DirectDeposit, options: any) => {
          console.log(`[AUDIT] DirectDeposit updated: ${record.id}`);
        },
        beforeDestroy: async (record: DirectDeposit, options: any) => {
          if (options.transaction) {
            await sequelize.query(
              `INSERT INTO audit_logs (action, table_name, record_id, user_id, data, created_at)
               VALUES (:action, :tableName, :recordId, :userId, :data, NOW())`,
        ...
        afterDestroy: async (record: DirectDeposit, options: any) => {
          console.log(`[AUDIT] DirectDeposit deleted: ${record.id}`);
        },
      },
      scopes: {
        defaultScope: {
...
/**
 * Production-ready Sequelize model for Disbursement
 *
 * Features:
 * - Lifecycle hooks for FERPA/HIPAA compliance auditing
 * - Comprehensive validations with custom validators
...
export const createDisbursementModel = (sequelize: Sequelize) => {
  ...
  Disbursement.init(
    ...
    },
    {
      ...
      hooks: {
        beforeCreate: async (record: Disbursement, options: any) => {
          // Audit logging for FERPA/HIPAA compliance
          if (options.transaction) {
            await sequelize.query(
              `INSERT INTO audit_logs (action, table_name, record_id, user_id, data, created_at)
        ...
        afterCreate: async (record: Disbursement, options: any) => {
          console.log(`[AUDIT] Disbursement created: ${record.id}`);
        },
        beforeUpdate: async (record: Disbursement, options: any) => {
          const changed = record.changed();
          if (changed && options.transaction) {
            await sequelize.query(
              `INSERT INTO audit_logs (action, table_name, record_id, user_id, data, created_at)
        ...
        afterUpdate: async (record: Disbursement, options: any) => {
          console.log(`[AUDIT] Disbursement updated: ${record.id}`);
        },
        beforeDestroy: async (record: Disbursement, options: any) => {
          if (options.transaction) {
            await sequelize.query(
              `INSERT INTO audit_logs (action, table_name, record_id, user_id, data, created_at)
               VALUES (:action, :tableName, :recordId, :userId, :data, NOW())`,
        ...
        afterDestroy: async (record: Disbursement, options: any) => {
          console.log(`[AUDIT] Disbursement deleted: ${record.id}`);
        },
      },
      scopes: {
        defaultScope: {
