        ...
        beforeCreate: async (record: RegistrationSystemsRecord, options: any) => {
          ...
          if (options.transaction) {
            await sequelize.query(
              ...
              {
                replacements: {
                  action: 'CREATE_REGISTRATIONSYSTEMS',
                  tableName: 'registration_systems_records',
                  recordId: record.id,
        ...
        beforeUpdate: async (record: RegistrationSystemsRecord, options: any) => {
          ...
          if (changed && options.transaction) {
            await sequelize.query(
              ...
              {
                replacements: {
                  action: 'UPDATE_REGISTRATIONSYSTEMS',
                  tableName: 'registration_systems_records',
                  recordId: record.id,
                  userId: options.userId || 'system',
        ...
        beforeDestroy: async (record: RegistrationSystemsRecord, options: any) => {
          if (options.transaction) {
            await sequelize.query(
              ...
              {
                replacements: {
                  action: 'DELETE_REGISTRATIONSYSTEMS',
                  tableName: 'registration_systems_records',
                  recordId: record.id,
                  userId: options.userId || 'system',
                  data: JSON.stringify(record.toJSON()),
...
@Injectable()
export class RegistrationSystemsComposite {  constructor(
