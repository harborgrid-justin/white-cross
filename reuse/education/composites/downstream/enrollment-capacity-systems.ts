...
/**
 * LOC: EDU-COMP-DOWN-ENROLLMENT-CAPACITY-SYSTEMS
 * File: /reuse/education/composites/downstream/enrollment-capacity-systems.ts
 * Purpose: Production-grade composite for enrollment-capacity-systems
 */
...
@Injectable()
export class EnrollmentCapacitySystemsService {  constructor(
...
export default EnrollmentCapacitySystemsService;
