...
/**
 * LOC: EDU-COMP-DOWN-GRADE-REPORTING-MODULES
 * File: /reuse/education/composites/downstream/grade-reporting-modules.ts
 * Purpose: Production-grade composite for grade-reporting-modules
 */
...
@Injectable()
export class GradeReportingModulesService {  constructor(
...
export default GradeReportingModulesService;
