/**
 * LOC: EDU-COMP-DOWNSTREAM-013
 * File: /reuse/education/composites/downstream/student-portal-modules.ts
 *
...
/**
 * File: /reuse/education/composites/downstream/student-portal-modules.ts
 * Locator: WC-COMP-DOWNSTREAM-013
 * Purpose: Student Portal Modules - Production-grade portal modules
 *
 ...
 * Composes functions to provide portal modules with full operational capabilities.
 */
...
export const createServiceModel = (sequelize: Sequelize) => {
  ...
  ServiceModel.init(
    ...
    {
      sequelize,
      tableName: 'student_portal_modules',
      timestamps: true,
...
@Injectable()
export class StudentPortalModulesCompositeService {
  private readonly logger = new Logger(StudentPortalModulesCompositeService.name);
...
export default StudentPortalModulesCompositeService;
