...
exports.StudentBillingAccountsCompositeService = exports.createAccountHoldModel = exports.createPaymentPlanModel = exports.createStudentPaymentModel = exports.createStudentChargeModel = exports.createStudentAccountModel = void 0;
/**
 * File: /reuse/education/composites/student-billing-accounts-composite.ts
...
const createStudentAccountModel = (sequelize) => {
    ...
    StudentAccount.init({
        ...
        accountStatus: {
            type: sequelize_1.DataTypes.ENUM('active', 'suspended', 'hold', 'collections', 'closed'),
            allowNull: false,
            defaultValue: 'active',
 ...
 */
const createStudentChargeModel = (sequelize) => {
    class StudentCharge extends sequelize_1.Model {
    }
    StudentCharge.init({
        id: {
            type: sequelize_1.DataTypes.UUID,
        ...
        chargeType: {
            type: sequelize_1.DataTypes.ENUM('tuition', 'fees', 'housing', 'meal_plan', 'parking', 'health', 'technology', 'lab', 'other'),
            allowNull: false,
            comment: 'Charge type',
        },
        chargeDescription: {
...
exports.createStudentChargeModel = createStudentChargeModel;
/**
 ...
 */
const createStudentPaymentModel = (sequelize) => {
    class StudentPayment extends sequelize_1.Model {
    }
    StudentPayment.init({
        id: {
            type: sequelize_1.DataTypes.UUID,
        ...
        paymentMethod: {
            type: sequelize_1.DataTypes.ENUM('credit_card', 'debit_card', 'ach', 'check', 'cash', 'wire', 'financial_aid'),
            allowNull: false,
...
exports.createStudentPaymentModel = createStudentPaymentModel;
/**
...
const createPaymentPlanModel = (sequelize) => {
    ...
    PaymentPlan.init({
        ...
        status: {
            type: sequelize_1.DataTypes.ENUM('active', 'complete', 'cancelled', 'defaulted'),
            allowNull: false,
            defaultValue: 'active',
            comment: 'Plan status',
        },
 ...
 */
const createAccountHoldModel = (sequelize) => {
    class AccountHoldModel extends sequelize_1.Model {
    }
    AccountHoldModel.init({
        ...
        holdType: {
            type: sequelize_1.DataTypes.ENUM('financial', 'registration', 'transcript', 'diploma', 'library', 'conduct', 'parking'),
            allowNull: false,
            comment: 'Hold type',
        },
        holdReason: {
...
exports.createAccountHoldModel = createAccountHoldModel;
// ============================================================================
 ...
 */
let StudentBillingAccountsCompositeService = (() => {
    let _classDecorators = [(0, common_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var StudentBillingAccountsCompositeService = _classThis = class {
        constructor(sequelize) {
            this.sequelize = sequelize;
            this.logger = new common_1.Logger(StudentBillingAccountsCompositeService.name);
        }
        // ============================================================================
         ...
         * ```
         */
        async createStudentAccount(studentId, academicYear) {
         ...
         * ```
         */
        async updateAccountBalance(studentId, chargeAmount, paymentAmount) {
         ...
         * ```
         */
        async calculatePastDueBalance(studentId, asOfDate) {
         ...
         * ```
         */
        async generateAccountStatement(studentId, startDate, endDate) {
         ...
         * ```
         */
        async emailAccountStatement(studentId, email) {
         ...
         * ```
         */
        async exportAccountData(studentId, format) {
            const account = await this.getStudentAccount(studentId);
            if (format === 'json') {
         ...
         * ```
         */
        async archiveStudentAccount(studentId, reason) {
         ...
         * ```
         */
        async calculateTuition(studentId, termId, creditHours, level, residency) {
         ...
         * ```
         */
        async assessMandatoryFees(studentId, termId, creditHours) {
            const fees = [
                {
                    feeId: 'FEE-001',
                    studentId,
         ...
         * ```
         */
        async assessCourseFee(studentId, courseId) {
            return {
         ...
         * ```
         */
        async processFeeWaiver(feeId, reason, approvedBy) {
         ...
         * ```
         */
        async applyLateRegistrationFee(studentId, termId) {
            return {
                feeId: `LATE-${Date.now()}`,
                studentId,
                termId,
         ...
         * ```
         */
        async assessHousingCharge(studentId, termId, housingType) {
            const rates = {
                single: 4500,
                double: 3500,
                suite: 5000,
         ...
         * ```
         */
        async assessMealPlanCharge(studentId, termId, planType) {
            const rates = {
                'unlimited': 2500,
                '14-meals': 2000,
                '10-meals': 1500,
         ...
         * ```
         */
        async generateChargeSummary(studentId, termId) {
         ...
         * ```
         */
        async processCreditCardPayment(studentId, amount, cardInfo) {
         ...
         * ```
         */
        async processACHPayment(studentId, amount, bankInfo) {
         ...
         * ```
         */
        async recordCheckPayment(studentId, amount, checkNumber, bankName) {
            return {
         ...
         * ```
         */
        async processPaymentRefund(studentId, refundAmount, reason) {
         ...
         * ```
         */
        async allocatePaymentToCharges(paymentId, allocations) {
         ...
         * ```
         */
        async createPaymentPlan(planConfig) {
         ...
         * ```
         */
        async processInstallmentPayment(planId, installmentNumber, amount) {
         ...
         * ```
         */
        async applyPaymentPlanLateFee(planId, installmentNumber) {
            const lateFee = 25.00;
         ...
         * ```
         */
        async cancelPaymentPlan(planId, reason) {
         ...
         * ```
         */
        async getPaymentPlanStatus(planId) {
         ...
         * ```
         */
        async sendPaymentPlanReminder(planId, daysBeforeDue) {
         ...
         * ```
         */
        async calculateWithdrawalRefund(studentId, termId, withdrawalDate) {
         ...
         * ```
         */
        async processRefundRequest(studentId, refundCalc, approvedBy) {
         ...
         * ```
         */
        async issueRefund(refundId, method) {
         ...
         * ```
         */
        async applyAccountCredit(studentId, creditAmount, reason) {
         ...
         * ```
         */
        async applyCreditToCharges(studentId, creditId, termId) {
         ...
         * ```
         */
        async placeFinancialHold(studentId, reason, amount) {
         ...
         * ```
         */
        async placeRegistrationHold(studentId, reason) {
            return {
                holdId: `HOLD-${Date.now()}`,
                studentId,
         ...
         * ```
         */
        async placeTranscriptHold(studentId, reason) {
            return {
                holdId: `HOLD-${Date.now()}`,
                studentId,
                holdType: 'transcript',
         ...
         * ```
         */
        async removeAccountHold(holdId, clearedBy) {
         ...
         * ```
         */
        async transferToCollections(studentId, balance, agencyName) {
         ...
         * ```
         */
        async createCollectionsPaymentArrangement(collectionId, monthlyPayment, numberOfMonths) {
            const schedule = [];
         ...
         * ```
         */
        async processCollectionsPayment(collectionId, amount) {
         ...
         * ```
         */
        async settleCollectionsAccount(collectionId, settlementAmount, reason) {
         ...
         * ```
         */
        async generate1098TForm(studentId, taxYear) {
    ...
    __setFunctionName(_classThis, "StudentBillingAccountsCompositeService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        StudentBillingAccountsCompositeService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return StudentBillingAccountsCompositeService = _classThis;
})();
exports.StudentBillingAccountsCompositeService = StudentBillingAccountsCompositeService;
// ============================================================================
// EXPORTS
// ============================================================================
exports.default = StudentBillingAccountsCompositeService;
//# sourceMappingURL=student-billing-accounts-composite.js.map