/**
 * LOC: USACE-DS-PERS-060
 * File: /reuse/frontend/composites/usace/downstream/qualification-tracking-dashboards.ts
 *
...
// NESTJS SERVICE
@Injectable()
export class QualificationTrackingDashboardsService {
  private readonly logger = new Logger(QualificationTrackingDashboardsService.name);
...
export default {
  ...
  QualificationTrackingDashboardsService
};
