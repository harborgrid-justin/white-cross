/**
 * LOC: USACE-DS-MAINT-054
 * File: /reuse/frontend/composites/usace/downstream/preventive-maintenance-dashboards.ts
 *
...
// NESTJS SERVICE
@Injectable()
export class PreventiveMaintenanceDashboardsService {
  private readonly logger = new Logger(PreventiveMaintenanceDashboardsService.name);
...
export default {
  ...
  PreventiveMaintenanceDashboardsService
};
