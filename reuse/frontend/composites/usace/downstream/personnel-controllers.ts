/**
 * LOC: USACE-DS-PERS-057
 * File: /reuse/frontend/composites/usace/downstream/personnel-controllers.ts
 *
...
// NESTJS SERVICE
@Injectable()
export class PersonnelControllersService {
  private readonly logger = new Logger(PersonnelControllersService.name);
