/**
 * LOC: USACE-DS-MAINT-055
 * File: /reuse/frontend/composites/usace/downstream/work-planning-interfaces.ts
 *
...
// NESTJS SERVICE
@Injectable()
export class WorkPlanningInterfacesService {
  private readonly logger = new Logger(WorkPlanningInterfacesService.name);
