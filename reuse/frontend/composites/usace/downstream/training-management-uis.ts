/**
 * LOC: USACE-DS-PERS-059
 * File: /reuse/frontend/composites/usace/downstream/training-management-uis.ts
 *
...
// NESTJS SERVICE
@Injectable()
export class TrainingManagementUisService {
  private readonly logger = new Logger(TrainingManagementUisService.name);
