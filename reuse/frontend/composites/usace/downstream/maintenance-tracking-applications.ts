/**
 * LOC: USACE-DS-MAINT-056
 * File: /reuse/frontend/composites/usace/downstream/maintenance-tracking-applications.ts
 *
...
// NESTJS SERVICE
@Injectable()
export class MaintenanceTrackingApplicationsService {
  private readonly logger = new Logger(MaintenanceTrackingApplicationsService.name);
...
export default {
  ...
  MaintenanceTrackingApplicationsService
};
