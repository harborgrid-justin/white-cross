/**
 * LOC: USACE-DS-PERS-061
 * File: /reuse/frontend/composites/usace/downstream/staffing-optimization-engines.ts
 *
...
// NESTJS SERVICE
@Injectable()
export class StaffingOptimizationEnginesService {
  private readonly logger = new Logger(StaffingOptimizationEnginesService.name);
...
export default {
  ...
  StaffingOptimizationEnginesService
};
