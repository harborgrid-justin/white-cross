...
exports.PublishingPriority = exports.RecurrenceFrequency = exports.PublishingChannel = exports.PublishingStatus = void 0;
exports.usePublish = usePublish;
exports.useUnpublish = useUnpublish;
exports.useSchedulePublish = useSchedulePublish;
exports.usePublishingCalendar = usePublishingCalendar;
exports.useContentSchedule = useContentSchedule;
exports.useTimelineView = useTimelineView;
exports.useScheduleManager = useScheduleManager;
exports.useCalendarView = useCalendarView;
exports.usePublishNow = usePublishNow;
exports.usePublishLater = usePublishLater;
exports.usePublishRecurring = usePublishRecurring;
exports.useEmbargoContent = useEmbargoContent;
exports.useUnpublishAt = useUnpublishAt;
exports.useExpireContent = useExpireContent;
exports.usePreviewScheduled = usePreviewScheduled;
exports.useViewScheduled = useViewScheduled;
exports.useEditScheduled = useEditScheduled;
exports.useTimezoneHandling = useTimezoneHandling;
exports.useDateTimeSelector = useDateTimeSelector;
exports.usePublishingRules = usePublishingRules;
exports.usePublishingPolicies = usePublishingPolicies;
exports.useMultiChannelPublish = useMultiChannelPublish;
exports.useCrossPlatformPublish = useCrossPlatformPublish;
exports.usePublishingQueue = usePublishingQueue;
exports.usePublishingStatus = usePublishingStatus;
exports.usePublishingNotifications = usePublishingNotifications;
exports.usePublishingAlerts = usePublishingAlerts;
exports.useRescheduleContent = useRescheduleContent;
exports.useCancelSchedule = useCancelSchedule;
exports.PublishNow = PublishNow;
exports.PublishLater = PublishLater;
exports.ScheduleManager = ScheduleManager;
exports.CalendarView = CalendarView;
exports.TimelineView = TimelineView;
exports.formatPublishDate = formatPublishDate;
exports.validateSchedule = validateSchedule;
exports.calculateNextRecurrence = calculateNextRecurrence;
...
(function (PublishingStatus) {
    ...
    PublishingStatus["UNPUBLISHED"] = "unpublished";
    PublishingStatus["FAILED"] = "failed";
    PublishingStatus["EMBARGOED"] = "embargoed";
    PublishingStatus["EXPIRED"] = "expired";
...
(function (PublishingChannel) {
    PublishingChannel["WEB"] = "web";
    PublishingChannel["MOBILE"] = "mobile";
    PublishingChannel["EMAIL"] = "email";
    PublishingChannel["RSS"] = "rss";
    PublishingChannel["SOCIAL_MEDIA"] = "social_media";
    PublishingChannel["API"] = "api";
    PublishingChannel["PRINT"] = "print";
 ...
 */
var PublishingPriority;
(function (PublishingPriority) {
    PublishingPriority["LOW"] = "low";
    PublishingPriority["NORMAL"] = "normal";
    PublishingPriority["HIGH"] = "high";
    PublishingPriority["URGENT"] = "urgent";
})(PublishingPriority || (exports.PublishingPriority = PublishingPriority = {}));
/* ============================================================================
...
function usePublish(options = {}) {
    ...
    const [publication, setPublication] = (0, react_1.useState)(null);
    const publish = (0, react_1.useCallback)(async (contentId, publishOptions) => {
 ...
 * ```
 */
function useUnpublish() {
    const [isUnpublishing, setIsUnpublishing] = (0, react_1.useState)(false);
    const [error, setError] = (0, react_1.useState)(null);
    const unpublish = (0, react_1.useCallback)(async (publicationId, channels) => {
 ...
 * ```
 */
function useSchedulePublish(options = {}) {
    const [isScheduling, setIsScheduling] = (0, react_1.useState)(false);
    const [error, setError] = (0, react_1.useState)(null);
    const [schedule, setSchedule] = (0, react_1.useState)(null);
    const schedulePublish = (0, react_1.useCallback)(async (contentId, publishAt, scheduleOptions) => {
 ...
 * ```
 */
function usePublishingCalendar(params) {
    ...
    const fetchEvents = (0, react_1.useCallback)(async () => {
        ...
        try {
            ...
            if (params?.channels)
                queryParams.set('channels', params.channels.join(','));
 ...
 * ```
 */
function useContentSchedule(contentId) {
    const [schedules, setSchedules] = (0, react_1.useState)([]);
    const [isLoading, setIsLoading] = (0, react_1.useState)(false);
    const [error, setError] = (0, react_1.useState)(null);
    const fetchSchedules = (0, react_1.useCallback)(async () => {
        setIsLoading(true);
        setError(null);
        try {
    ...
    const updateSchedule = (0, react_1.useCallback)(async (scheduleId, updates) => {
        try {
 ...
 * ```
 */
function useTimelineView(initialGroupBy = 'day') {
    const [groupBy, setGroupBy] = (0, react_1.useState)(initialGroupBy);
...
function useScheduleManager() {
    ...
    const createSchedule = (0, react_1.useCallback)(async (schedule) => {
        const response = await fetch('/api/schedules', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    const updateSchedule = (0, react_1.useCallback)(async (id, updates) => {
    ...
    const deleteSchedule = (0, react_1.useCallback)(async (id) => {
 ...
 * ```
 */
function useCalendarView(initialView = 'month') {
    const [view, setView] = (0, react_1.useState)(initialView);
    const [currentDate, setCurrentDate] = (0, react_1.useState)(new Date());
    const navigateToDate = (0, react_1.useCallback)((date) => {
        setCurrentDate(date);
    }, []);
    const navigateNext = (0, react_1.useCallback)(() => {
    ...
    const navigatePrevious = (0, react_1.useCallback)(() => {
        const newDate = new Date(currentDate);
        switch (view) {
            case 'day':
                newDate.setDate(newDate.getDate() - 1);
    ...
    const navigateToToday = (0, react_1.useCallback)(() => {
 ...
 * ```
 */
function usePublishNow(options) {
    const { publish, isPublishing, error, publication } = usePublish({
        ...options,
        immediate: true,
    });
    const publishNow = (0, react_1.useCallback)(async (contentId) => {
 ...
 * ```
 */
function usePublishLater(options) {
    const { schedulePublish, isScheduling, error, schedule } = useSchedulePublish(options);
    const publishLater = (0, react_1.useCallback)(async (contentId, publishAt, unpublishAt) => {
 ...
 * ```
 */
function usePublishRecurring(options) {
    const { schedulePublish, isScheduling, error } = useSchedulePublish(options);
    const [recurringSchedules, setRecurringSchedules] = (0, react_1.useState)([]);
    const createRecurring = (0, react_1.useCallback)(async (contentId, recurrence, startDate) => {
    ...
    const cancelRecurring = (0, react_1.useCallback)(async (scheduleId) => {
 ...
 * ```
 */
function useEmbargoContent(contentId) {
    const [embargos, setEmbargos] = (0, react_1.useState)([]);
    const [isLoading, setIsLoading] = (0, react_1.useState)(false);
    const [error, setError] = (0, react_1.useState)(null);
    const fetchEmbargos = (0, react_1.useCallback)(async () => {
        setIsLoading(true);
        try {
            const response = await fetch(`/api/content/${contentId}/embargos`);
            if (!response.ok)
                throw new Error('Failed to fetch embargos');
            const data = await response.json();
            setEmbargos(data);
        }
        catch (err) {
    ...
    const createEmbargo = (0, react_1.useCallback)(async (embargo) => {
        const response = await fetch(`/api/content/${contentId}/embargos`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
        ...
        if (!response.ok)
            throw new Error('Failed to create embargo');
        await fetchEmbargos();
        return response.json();
    }, [contentId, fetchEmbargos]);
    const removeEmbargo = (0, react_1.useCallback)(async (embargoId) => {
        const response = await fetch(`/api/embargos/${embargoId}`, {
            method: 'DELETE',
        });
        if (!response.ok)
            throw new Error('Failed to remove embargo');
        await fetchEmbargos();
    }, [fetchEmbargos]);
    const updateEmbargo = (0, react_1.useCallback)(async (embargoId, updates) => {
        const response = await fetch(`/api/embargos/${embargoId}`, {
            method: 'PATCH',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify(updates),
        ...
        if (!response.ok)
            throw new Error('Failed to update embargo');
        await fetchEmbargos();
    }, [fetchEmbargos]);
    return {
        embargos,
 ...
 * ```
 */
function useUnpublishAt() {
    const [isScheduling, setIsScheduling] = (0, react_1.useState)(false);
    const [error, setError] = (0, react_1.useState)(null);
    const scheduleUnpublish = (0, react_1.useCallback)(async (publicationId, unpublishAt) => {
        setIsScheduling(true);
        setError(null);
        try {
    ...
    const cancelUnpublish = (0, react_1.useCallback)(async (publicationId) => {
        const response = await fetch(`/api/publications/${publicationId}/unpublish`, {
            method: 'DELETE',
        });
        if (!response.ok)
            throw new Error('Failed to cancel unpublish');
    }, []);
    return {
        scheduleUnpublish,
        cancelUnpublish,
 ...
 * ```
 */
function useExpireContent() {
    const [isUpdating, setIsUpdating] = (0, react_1.useState)(false);
    const [error, setError] = (0, react_1.useState)(null);
    const setExpiration = (0, react_1.useCallback)(async (publicationId, expiresAt) => {
        setIsUpdating(true);
        setError(null);
        try {
    ...
    const removeExpiration = (0, react_1.useCallback)(async (publicationId) => {
        setIsUpdating(true);
        setError(null);
        try {
            const response = await fetch(`/api/publications/${publicationId}/expiration`, {
            ...
            if (!response.ok)
                throw new Error('Failed to remove expiration');
        }
        catch (err) {
            const error = err instanceof Error ? err : new Error('Unknown error');
            setError(error);
 ...
 * ```
 */
function usePreviewScheduled(scheduleId) {
    const [preview, setPreview] = (0, react_1.useState)('');
    const [isLoading, setIsLoading] = (0, react_1.useState)(false);
    const [error, setError] = (0, react_1.useState)(null);
    const generatePreview = (0, react_1.useCallback)(async () => {
        setIsLoading(true);
        setError(null);
        try {
 ...
 * ```
 */
function useViewScheduled(scheduleId) {
    const [schedule, setSchedule] = (0, react_1.useState)(null);
    const [isLoading, setIsLoading] = (0, react_1.useState)(false);
    const [error, setError] = (0, react_1.useState)(null);
    const fetchSchedule = (0, react_1.useCallback)(async () => {
        setIsLoading(true);
        setError(null);
        try {
            const response = await fetch(`/api/schedule/${scheduleId}`);
 ...
 * ```
 */
function useEditScheduled(scheduleId) {
    const { schedule, isLoading, refetch } = useViewScheduled(scheduleId);
    const [isUpdating, setIsUpdating] = (0, react_1.useState)(false);
    const [error, setError] = (0, react_1.useState)(null);
    const updateSchedule = (0, react_1.useCallback)(async (updates) => {
        setIsUpdating(true);
        setError(null);
        try {
            const response = await fetch(`/api/schedule/${scheduleId}`, {
 ...
 * ```
 */
function useTimezoneHandling(initialTimezone) {
    const [currentTimezone, setCurrentTimezone] = (0, react_1.useState)(initialTimezone || {
        id: 'UTC',
        name: 'Coordinated Universal Time',
        offset: 0,
        abbreviation: 'UTC',
    });
    const availableTimezones = (0, react_1.useMemo)(() => [
    ...
    const convertToTimezone = (0, react_1.useCallback)((date, targetTimezone) => {
        const utcTime = date.getTime();
        const targetOffset = targetTimezone.offset * 60 * 1000;
        return new Date(utcTime + targetOffset);
    }, []);
    const formatInTimezone = (0, react_1.useCallback)((date, timezone = currentTimezone, format = 'long') => {
 ...
 * ```
 */
function useDateTimeSelector(options) {
    ...
    const isValid = (0, react_1.useMemo)(() => {
        ...
        if (options?.excludeDates?.some(d => d.toDateString() === selectedDate.toDateString())) {
    ...
    const setDate = (0, react_1.useCallback)((date) => {
        setSelectedDate(date);
    }, []);
    const resetDate = (0, react_1.useCallback)(() => {
...
function usePublishingRules() {
    ...
    const createRule = (0, react_1.useCallback)(async (rule) => {
        const response = await fetch('/api/publishing-rules', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    const updateRule = (0, react_1.useCallback)(async (id, updates) => {
    ...
    const deleteRule = (0, react_1.useCallback)(async (id) => {
        const response = await fetch(`/api/publishing-rules/${id}`, {
            method: 'DELETE',
        });
        if (!response.ok)
    ...
    const evaluateRules = (0, react_1.useCallback)((contentMetadata) => {
        return rules
 ...
 * ```
 */
function usePublishingPolicies() {
    const [policies, setPolicies] = (0, react_1.useState)([]);
    const [isLoading, setIsLoading] = (0, react_1.useState)(false);
    const [error, setError] = (0, react_1.useState)(null);
    const fetchPolicies = (0, react_1.useCallback)(async () => {
        setIsLoading(true);
        try {
    ...
    const createPolicy = (0, react_1.useCallback)(async (policy) => {
        const response = await fetch('/api/publishing-policies', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    const validateAgainstPolicy = (0, react_1.useCallback)(async (contentId, channels, publisherId) => {
        const applicablePolicies = policies.filter(policy => channels.some(channel => policy.allowedChannels.includes(channel)));
        for (const policy of applicablePolicies) {
            ...
            const unauthorizedChannels = channels.filter(channel => !policy.allowedChannels.includes(channel));
 ...
 * ```
 */
function useMultiChannelPublish() {
    const [isPublishing, setIsPublishing] = (0, react_1.useState)(false);
    const [progress, setProgress] = (0, react_1.useState)({ completed: 0, total: 0, failed: 0 });
    const [results, setResults] = (0, react_1.useState)(new Map());
    const [error, setError] = (0, react_1.useState)(null);
    const publishToChannels = (0, react_1.useCallback)(async (contentId, config) => {
        setIsPublishing(true);
        setError(null);
    ...
    const rollbackPublications = async (channels) => {
        // Implement rollback logic
        const promises = channels.map(channel => fetch(`/api/publish/rollback`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
 ...
 * ```
 */
function useCrossPlatformPublish() {
    const { publishToChannels, isPublishing, progress, results } = useMultiChannelPublish();
    const [platformConfigs, setPlatformConfigs] = (0, react_1.useState)(new Map());
    const publishCrossPlatform = (0, react_1.useCallback)(async (contentId, platformSettings) => {
    ...
    const platforms = (0, react_1.useMemo)(() => ({
...
function usePublishingQueue() {
    ...
    const addToQueue = (0, react_1.useCallback)(async (schedule) => {
        const response = await fetch('/api/publishing-queue', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    const removeFromQueue = (0, react_1.useCallback)(async (queueItemId) => {
    ...
    const reorderQueue = (0, react_1.useCallback)(async (queueItemId, newPosition) => {
    ...
    const retryFailed = (0, react_1.useCallback)(async (queueItemId) => {
 ...
 * ```
 */
function usePublishingStatus(contentId) {
    const [status, setStatus] = (0, react_1.useState)(PublishingStatus.DRAFT);
    const [isMonitoring, setIsMonitoring] = (0, react_1.useState)(false);
    const [statusHistory, setStatusHistory] = (0, react_1.useState)([]);
    ...
    const startMonitoring = (0, react_1.useCallback)((pollInterval = 5000) => {
 ...
 * ```
 */
function usePublishingNotifications() {
 ...
 * ```
 */
function usePublishingAlerts() {
    const [alerts, setAlerts] = (0, react_1.useState)([]);
    const addAlert = (0, react_1.useCallback)((alert) => {
        const newAlert = {
            ...alert,
            id: `alert-${Date.now()}`,
            timestamp: new Date(),
    ...
    const dismissAlert = (0, react_1.useCallback)((alertId) => {
        setAlerts(prev => prev.map(alert => alert.id === alertId ? { ...alert, dismissed: true } : alert));
    }, []);
    const clearDismissed = (0, react_1.useCallback)(() => {
        setAlerts(prev => prev.filter(alert => !alert.dismissed));
    }, []);
    const activeAlerts = (0, react_1.useMemo)(() => alerts.filter(alert => !alert.dismissed), [alerts]);
    const hasActiveAlerts = (0, react_1.useMemo)(() => activeAlerts.length > 0, [activeAlerts]);
    const criticalAlerts = (0, react_1.useMemo)(() => activeAlerts.filter(alert => alert.severity === 'critical'), [activeAlerts]);
    return {
        alerts: activeAlerts,
        allAlerts: alerts,
        criticalAlerts,
 ...
 * ```
 */
function useRescheduleContent() {
    const [isRescheduling, setIsRescheduling] = (0, react_1.useState)(false);
    const [error, setError] = (0, react_1.useState)(null);
    const reschedule = (0, react_1.useCallback)(async (scheduleId, newPublishAt, options) => {
    ...
    const bulkReschedule = (0, react_1.useCallback)(async (scheduleIds, newPublishAt) => {
        setIsRescheduling(true);
        setError(null);
        try {
            ...
            if (!response.ok)
                throw new Error('Failed to bulk reschedule');
            return await response.json();
        }
        catch (err) {
            const error = err instanceof Error ? err : new Error('Unknown error');
...
function useCancelSchedule() {
    const [isCanceling, setIsCanceling] = (0, react_1.useState)(false);
    const [error, setError] = (0, react_1.useState)(null);
    const cancelSchedule = (0, react_1.useCallback)(async (scheduleId, reason) => {
        setIsCanceling(true);
        setError(null);
        try {
    ...
    const bulkCancel = (0, react_1.useCallback)(async (scheduleIds, reason) => {
        setIsCanceling(true);
        setError(null);
        try {
            ...
            if (!response.ok)
                throw new Error('Failed to bulk cancel');
            return await response.json();
        }
        catch (err) {
            const error = err instanceof Error ? err : new Error('Unknown error');
 ...
 * ```
 */
function PublishNow({ contentId, channels, onSuccess, onError, children, className, }) {
    const { publishNow, isPublishing } = usePublishNow({ channels, onSuccess, onError });
    return onClick = {}();
    publishNow(contentId);
}
 ...
 * ```
 */
function PublishLater({ contentId, onScheduled, children, className, }) {
    const { publishLater, isScheduling } = usePublishLater({
 ...
 * ```
 */
function ScheduleManager({ onScheduleClick, className, }) {
    ...
    return className = { className } >
        Schedule;
    Manager({ schedules, : .length }, schedules) < (/h3>);
    {
        schedules.map(schedule => key = { schedule, : .id }, onClick = {}(), onScheduleClick?.(schedule));
    }
     >
        { schedule, : .contentId } < /strong>
        < p > Scheduled;
    {
        schedule.publishAt.toLocaleString();
    }
    /p>
        < p > Status;
    {
 ...
 * ```
 */
function CalendarView({ onEventClick, className, }) {
        ...
        onClick;
    {
     ...
     > Previous < /button>
        ...
        < button;
    onClick = { navigateNext } > Next < /button>
        < select;
    value = { view };
    ...
    value = "month" > Month < /option>
        ...
        < (/div>);
    {
        events.map(event => key = { event, : .id }, onClick = {}(), onEventClick?.(event));
    }
     >
        { event, : .title } < /strong>
 ...
 * ```
 */
function TimelineView({ groupBy = 'day', onItemClick, className, }) {
    ...
    value = "month" > Month < /option>
        < (/select>);
    {
        timeline.map(group => key = { group, : .label } >
            { group, : .date.toLocaleDateString() } < (/h4>), { group, : .items.map(item => key = { item, : .id }, onClick = {}(), onItemClick?.(item)) } >
 ...
 */
function formatPublishDate(date, timezone, format = 'long') {
    if (format === 'relative') {
        const now = new Date();
 ...
 */
function validateSchedule(schedule, policy) {
    const errors = [];
    ...
    if (policy?.schedulingRestrictions) {
        ...
        if (blackoutDates && schedule.publishAt) {
            const isBlackedOut = blackoutDates.some(blackout => blackout.toDateString() === schedule.publishAt.toDateString());
            if (isBlackedOut) {
 ...
 */
function calculateNextRecurrence(baseDate, recurrence) {
...
//# sourceMappingURL=publishing-scheduling-kit.js.map