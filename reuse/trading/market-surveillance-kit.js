...
exports.AlertStatus = exports.AlertSeverity = exports.MarketManipulationType = exports.RegulatoryJurisdiction = void 0;
exports.detectLayering = detectLayering;
exports.detectSpoofing = detectSpoofing;
exports.detectWashTrading = detectWashTrading;
exports.detectPumpAndDump = detectPumpAndDump;
exports.detectPaintingTheTape = detectPaintingTheTape;
exports.detectMarkingTheClose = detectMarkingTheClose;
exports.detectQuoteStuffing = detectQuoteStuffing;
exports.detectCornering = detectCornering;
exports.detectRampingPrices = detectRampingPrices;
exports.detectCircularTrading = detectCircularTrading;
exports.detectCrossingAtBidAsk = detectCrossingAtBidAsk;
exports.calculateManipulationScore = calculateManipulationScore;
exports.detectInsiderTradingPattern = detectInsiderTradingPattern;
exports.analyzeTradeTimingAnomaly = analyzeTradeTimingAnomaly;
exports.monitorMaterialEventTrading = monitorMaterialEventTrading;
exports.detectFrontRunning = detectFrontRunning;
exports.analyzeBrokerDealerActivity = analyzeBrokerDealerActivity;
exports.trackRestrictedListViolations = trackRestrictedListViolations;
exports.correlateNewsToTrades = correlateNewsToTrades;
exports.generateInsiderAlert = generateInsiderAlert;
exports.identifyUnusualVolume = identifyUnusualVolume;
exports.detectPriceManipulation = detectPriceManipulation;
exports.analyzeOrderBookImbalance = analyzeOrderBookImbalance;
exports.detectAbnormalSpread = detectAbnormalSpread;
exports.monitorRapidCancellation = monitorRapidCancellation;
exports.analyzeTradeConcentration = analyzeTradeConcentration;
exports.detectAccountLinking = detectAccountLinking;
exports.monitorCrossMarketManipulation = monitorCrossMarketManipulation;
exports.analyzeTradingPatternSimilarity = analyzeTradingPatternSimilarity;
exports.generateAnomalyScore = generateAnomalyScore;
exports.validateMARCompliance = validateMARCompliance;
exports.validateEMIRCompliance = validateEMIRCompliance;
exports.validateSECCompliance = validateSECCompliance;
exports.validateFINRACompliance = validateFINRACompliance;
exports.validateMiFIDIICompliance = validateMiFIDIICompliance;
exports.generateRegulatoryAlert = generateRegulatoryAlert;
exports.submitSuspiciousActivityReport = submitSuspiciousActivityReport;
exports.generateTransactionReport = generateTransactionReport;
exports.trackRegulatoryDeadlines = trackRegulatoryDeadlines;
exports.archiveRegulatoryEvidence = archiveRegulatoryEvidence;
exports.generateSurveillanceDashboard = generateSurveillanceDashboard;
exports.calculateSurveillanceMetrics = calculateSurveillanceMetrics;
exports.prioritizeAlerts = prioritizeAlerts;
exports.assignAlertToAnalyst = assignAlertToAnalyst;
exports.trackAlertResolution = trackAlertResolution;
exports.generateSurveillanceReport = generateSurveillanceReport;
exports.monitorSystemHealthMetrics = monitorSystemHealthMetrics;
exports.configureSurveillanceThresholds = configureSurveillanceThresholds;
exports.exportAlertData = exportAlertData;
exports.integrateBestExecutionMonitoring = integrateBestExecutionMonitoring;
// ============================================================================
// TYPE DEFINITIONS
// ============================================================================
/**
...
(function (RegulatoryJurisdiction) {
    ...
    RegulatoryJurisdiction["FCA"] = "FCA";
    RegulatoryJurisdiction["ESMA"] = "ESMA";
    RegulatoryJurisdiction["MAS"] = "MAS";
    RegulatoryJurisdiction["ASIC"] = "ASIC";
    RegulatoryJurisdiction["HKMA"] = "HKMA";
    RegulatoryJurisdiction["CFTC"] = "CFTC";
    RegulatoryJurisdiction["FSA"] = "FSA"; // Japan Financial Services Agency
})(RegulatoryJurisdiction || (exports.RegulatoryJurisdiction = RegulatoryJurisdiction = {}));
/**
 * Market manipulation type enumeration
 */
var MarketManipulationType;
(function (MarketManipulationType) {
    MarketManipulationType["LAYERING"] = "LAYERING";
    MarketManipulationType["SPOOFING"] = "SPOOFING";
    MarketManipulationType["WASH_TRADING"] = "WASH_TRADING";
    MarketManipulationType["PUMP_AND_DUMP"] = "PUMP_AND_DUMP";
    MarketManipulationType["PAINTING_THE_TAPE"] = "PAINTING_THE_TAPE";
    MarketManipulationType["MARKING_THE_CLOSE"] = "MARKING_THE_CLOSE";
    MarketManipulationType["QUOTE_STUFFING"] = "QUOTE_STUFFING";
    MarketManipulationType["CORNERING"] = "CORNERING";
    MarketManipulationType["RAMPING"] = "RAMPING";
    MarketManipulationType["CIRCULAR_TRADING"] = "CIRCULAR_TRADING";
    MarketManipulationType["FRONT_RUNNING"] = "FRONT_RUNNING";
    MarketManipulationType["CHURNING"] = "CHURNING"; // Excessive trading to generate commissions
})(MarketManipulationType || (exports.MarketManipulationType = MarketManipulationType = {}));
/**
 ...
 * }
 */
async function detectLayering(orders, config, transaction) {
    const detections = [];
 ...
 */
async function detectSpoofing(orders, config, transaction) {
    const detections = [];
 ...
 */
async function detectWashTrading(trades, config, transaction) {
 ...
 */
async function detectPumpAndDump(trades, marketData, transaction) {
    const alerts = [];
    // Group trades by security
    const groupedTrades = groupTradesBySecurity(trades);
    for (const [securityId, securityTrades] of groupedTrades.entries()) {
 ...
 */
function detectPaintingTheTape(trades) {
    const alerts = [];
    ...
    for (const window of timeWindows) {
        ...
        if (smallTrades.length >= 10) {
            ...
            if (priceProgression.trend === 'increasing' && priceProgression.consistency > 0.8) {
                alerts.push(createAlert(MarketManipulationType.PAINTING_THE_TAPE, AlertSeverity.MEDIUM, window.securityId, smallTrades, `${smallTrades.length} small trades creating artificial price progression`));
            }
        }
    }
    return alerts;
 ...
 */
function detectMarkingTheClose(trades, marketClose) {
    const alerts = [];
    // Filter trades near market close (last 10 minutes)
    const closeWindow = 10 * 60 * 1000; // 10 minutes in milliseconds
    const closingTrades = trades.filter(t => marketClose.getTime() - t.timestamp.getTime() <= closeWindow &&
    ...
    for (const [securityId, securityTrades] of groupedTrades.entries()) {
        ...
        if (Math.abs(priceMovement) > 2 && volumeRatio < 0.05) { // >2% move on <5% of daily volume
            alerts.push(createAlert(MarketManipulationType.MARKING_THE_CLOSE, AlertSeverity.HIGH, securityId, securityTrades, `Significant price movement (${priceMovement.toFixed(2)}%) near close on low volume`));
        }
    }
    return alerts;
}
 ...
 */
async function detectQuoteStuffing(quotes, config, transaction) {
    const detections = [];
 ...
 */
function detectCornering(positions, marketData) {
    const alerts = [];
    ...
    for (const [securityId, securityPositions] of groupedPositions.entries()) {
        ...
        if (concentrationRatio > 0.10) { // 10% of float
            ...
            alerts.push(createAlert(MarketManipulationType.CORNERING, AlertSeverity.CRITICAL, securityId, largestPositions, `Potential cornering: ${(concentrationRatio * 100).toFixed(1)}% of float controlled`));
        }
    }
    return alerts;
}
 ...
 */
function detectRampingPrices(trades, marketData) {
    const alerts = [];
    // Group by security
    const groupedTrades = groupTradesBySecurity(trades);
    for (const [securityId, securityTrades] of groupedTrades.entries()) {
        ...
        for (const trade of sortedTrades) {
            ...
            if (consecutiveBuys >= 10 && priceIncrease > 5) { // 10+ consecutive buys, 5%+ increase
                alerts.push(createAlert(MarketManipulationType.RAMPING, AlertSeverity.HIGH, securityId, sortedTrades, `Potential ramping: ${consecutiveBuys} consecutive buys, ${priceIncrease.toFixed(2)}% price increase`));
                break;
            }
        }
    }
 ...
 */
function detectCircularTrading(trades) {
    const alerts = [];
    ...
    for (const cycle of cycles) {
        if (cycle.length >= 3) { // At least 3 accounts in circle
            alerts.push(createAlert(MarketManipulationType.CIRCULAR_TRADING, AlertSeverity.HIGH, cycle.securityId, cycle.trades, `Circular trading detected among ${cycle.length} related accounts`));
        }
    }
    return alerts;
}
 ...
 */
function detectCrossingAtBidAsk(trades, orderBook) {
    const alerts = [];
    ...
    for (const trade of trades) {
        if (trade.buyAccountOwner === trade.sellAccountOwner) {
            ...
            if (atBidAsk) {
                alerts.push(createAlert(MarketManipulationType.WASH_TRADING, AlertSeverity.MEDIUM, trade.securityId, [trade], 'Self-crossing at bid/ask detected'));
            }
        }
    }
    return alerts;
 ...
 */
function calculateManipulationScore(alert, historicalData) {
 ...
 */
async function detectInsiderTradingPattern(trades, materialEvents, config, transaction) {
    const patterns = [];
    ...
    for (const event of materialEvents) {
        ...
        const priorTrades = trades.filter(t => t.securityId === event.eventId &&
 ...
 */
function analyzeTradeTimingAnomaly(trade, traderHistory) {
    const reasons = [];
    let score = 0;
 ...
 */
function monitorMaterialEventTrading(trades, events) {
    const analysis = [];
 ...
 */
function detectFrontRunning(traderTrades, clientOrders) {
    const detections = [];
    // For each client order, check if trader traded ahead
    for (const clientOrder of clientOrders) {
        const priorTraderTrades = traderTrades.filter(t => t.securityId === clientOrder.securityId &&
 ...
 */
function analyzeBrokerDealerActivity(brokerTrades, clientTrades) {
    const conflicts = [];
    // Check for broker trading same securities as clients
    for (const brokerTrade of brokerTrades) {
        const relatedClientTrades = clientTrades.filter(ct => ct.securityId === brokerTrade.securityId &&
 ...
 */
function trackRestrictedListViolations(trades, restrictedList) {
    const violations = [];
    for (const trade of trades) {
 ...
 */
function correlateNewsToTrades(trades, newsEvents) {
    const correlations = [];
    for (const newsEvent of newsEvents) {
        ...
        const tradesBeforeNews = trades.filter(t => t.securityId === newsEvent.securityId &&
            t.timestamp < newsEvent.timestamp &&
            newsEvent.timestamp.getTime() - t.timestamp.getTime() <= windowBefore);
        const tradesAfterNews = trades.filter(t => t.securityId === newsEvent.securityId &&
            t.timestamp >= newsEvent.timestamp &&
 ...
 */
function generateInsiderAlert(pattern) {
    const evidence = {
        dataPoints: [
            {
                timestamp: new Date(),
 ...
 */
function identifyUnusualVolume(trades, historicalData) {
    const anomalies = [];
    // Group by security
    const groupedTrades = groupTradesBySecurity(trades);
    for (const [securityId, securityTrades] of groupedTrades.entries()) {
 ...
 */
function detectPriceManipulation(trades, marketData) {
    const alerts = [];
 ...
 */
function analyzeOrderBookImbalance(orderBook, threshold = 0.3) {
    const buyVolume = orderBook.bids.reduce((sum, bid) => sum + bid.quantity, 0);
    const sellVolume = orderBook.asks.reduce((sum, ask) => sum + ask.quantity, 0);
 ...
 */
function detectAbnormalSpread(quotes, historicalData) {
    const anomalies = [];
 ...
 */
function monitorRapidCancellation(orders, threshold = 0.8) {
    const analysis = [];
    // Group by trader
 ...
 */
function analyzeTradeConcentration(trades) {
 ...
 */
function detectAccountLinking(trades, accounts) {
    const linkedGroups = [];
 ...
 */
function monitorCrossMarketManipulation(trades) {
    const analysis = [];
    // Group by security
    const groupedTrades = groupTradesBySecurity(trades);
    for (const [securityId, securityTrades] of groupedTrades.entries()) {
 ...
 */
function analyzeTradingPatternSimilarity(trades1, trades2) {
    const pattern1 = {
 ...
 */
function generateAnomalyScore(trades, historicalProfile) {
    let anomalyScore = 0;
    // Volume anomaly
 ...
 */
function validateMARCompliance(alert) {
    const requirements = [
 ...
 */
function validateEMIRCompliance(trades) {
    const reportableTrades = [];
    const missingData = [];
    for (const trade of trades) {
        ...
        if (trade.assetClass === 'derivative') {
            ...
            if (!trade.uti)
                missingData.push(`${trade.tradeId}: Missing UTI (Unique Transaction Identifier)`);
            if (!trade.lei)
                missingData.push(`${trade.tradeId}: Missing LEI (Legal Entity Identifier)`);
            if (!trade.clearingStatus)
                missingData.push(`${trade.tradeId}: Missing clearing status`);
        }
    }
    return {
 ...
 */
function validateSECCompliance(alert) {
 ...
 */
function validateFINRACompliance(trades, bestExecution) {
    const violations = [];
 ...
 */
function validateMiFIDIICompliance(trades) {
    const missingFields = [];
    for (const trade of trades) {
        // Check MiFID II required fields
        if (!trade.tradingVenue)
            missingFields.push(`${trade.tradeId}: Missing trading venue`);
        if (!trade.executionTimestamp)
            missingFields.push(`${trade.tradeId}: Missing execution timestamp`);
        if (!trade.clientIdentification)
            missingFields.push(`${trade.tradeId}: Missing client identification`);
        if (!trade.investmentDecisionPerson)
            missingFields.push(`${trade.tradeId}: Missing investment decision person`);
        if (!trade.executionPerson)
            missingFields.push(`${trade.tradeId}: Missing execution person`);
    }
    return {
 ...
 */
function generateRegulatoryAlert(alert, jurisdiction) {
    return {
 ...
 */
async function submitSuspiciousActivityReport(alert, jurisdiction, transaction) {
 ...
 */
function generateTransactionReport(trades, jurisdiction) {
    return {
        reportId: generateReportId(),
        jurisdiction,
        trades,
 ...
 */
function trackRegulatoryDeadlines(reports) {
    const tracking = [];
    const now = new Date();
 ...
 */
async function archiveRegulatoryEvidence(alert, retentionYears = 7, transaction) {
 ...
 */
async function generateSurveillanceDashboard(dateRange, transaction) {
 ...
 */
function calculateSurveillanceMetrics(metrics) {
 ...
 */
async function assignAlertToAnalyst(alertId, analystId, transaction) {
 ...
 */
async function trackAlertResolution(alertId) {
    const alert = await fetchAlert(alertId);
 ...
 */
async function generateSurveillanceReport(dateRange, transaction) {
 ...
 */
function monitorSystemHealthMetrics() {
    return {
        status: 'healthy',
 ...
 */
function configureSurveillanceThresholds(config) {
    const defaultConfig = {
 ...
 */
function exportAlertData(alerts, format = 'json') {
    if (format === 'json') {
 ...
 */
function integrateBestExecutionMonitoring(trades, benchmarks) {
    const metrics = [];
    for (const trade of trades) {
...
// ============================================================================
function groupOrdersByTraderAndSecurity(orders) {
...
function calculatePriceImpact(orders) {
    if (orders.length < 2)
        return 0;
    const prices = orders.map(o => o.price);
...
function calculateConfidenceScore(pattern, type) {
    let score = 50;
    if (pattern.cancellationRate > 0.9)
        score += 25;
    if (pattern.totalOrders > 20)
        score += 15;
    if (pattern.averageTimeToCancel < 1000)
        score += 10;
    return Math.min(100, score);
}
function groupTradesBySecurity(trades) {
    const grouped = new Map();
    trades.forEach(trade => {
...
async function checkAccountRelationship(accountId1, accountId2) {
    // Would check for common beneficial owner, related entities, etc.
    return false;
}
function analyzeVolumePattern(trades) {
    const currentVolume = trades.reduce((sum, t) => sum + t.quantity, 0);
...
function analyzePricePattern(trades, marketData) {
...
function createAlert(type, severity, securityId, trades, description) {
    return {
        alertId: generateAlertId(),
        alertType: type,
        severity,
...
function groupTradesByTimeWindows(trades, windowSize) {
    return []; // Implementation would group trades into time windows
}
function analyzePriceProgression(trades) {
    return { trend: 'increasing', consistency: 0.9 };
}
function calculatePriceMovement(trades) {
    if (trades.length < 2)
        return 0;
    const prices = trades.map(t => t.price);
    const firstPrice = prices[0];
...
function calculateClosingVolumeRatio(closingTrades, allTrades) {
...
function groupQuotesByTraderAndSecurity(quotes) {
    const grouped = new Map();
...
function groupByTimeWindows(quotes, windowSize) {
    return []; // Implementation would group quotes into time windows
}
function groupPositionsBySecurity(positions) {
    const grouped = new Map();
...
function calculateTimingScore(trade, event) {
...
function calculateSizeScore(trade, history) {
...
function calculateBehaviorScore(trade, history) {
    let score = 0;
...
function calculateEventProfit(trades, event) {
...
function calculateAverageDaysBeforeEvent(trades, event) {
    const daysArray = trades.map(t => (event.announcementDate.getTime() - t.timestamp.getTime()) / (1000 * 60 * 60 * 24));
    return daysArray.reduce((sum, d) => sum + d, 0) / daysArray.length;
}
function calculateInsiderTradingRisk(trades, event, profit) {
    let risk = 50;
    if (profit.unrealizedProfit > 100000)
        risk += 25;
    if (trades.length > 5)
        risk += 15;
    if (event.priceImpact > 10)
        risk += 10;
    return Math.min(100, risk);
}
function calculateFrontRunningProfit(trades, clientOrder) {
    return trades.reduce((sum, t) => {
        const priceDiff = clientOrder.price - t.price;
        return sum + (priceDiff * t.quantity);
    }, 0);
}
function groupOrdersByTrader(orders) {
    const grouped = new Map();
    orders.forEach(order => {
...
function calculateTimingPattern(trades) {
    return {}; // Would calculate timing pattern characteristics
}
function calculateSizePattern(trades) {
...
function determineReportType(alertType, jurisdiction) {
...
async function submitToRegulator(report) {
    return generateAcknowledgmentId();
}
function calculateReportingDeadline(report) {
...
async function fetchAlertsByDateRange(start, end) {
    return [];
}
async function fetchTradesByDateRange(start, end) {
    return [];
}
async function fetchAlert(alertId) {
    return {};
}
async function fetchAlertStatusHistory(alertId) {
    return [];
}
function generateDetectionId() {
    return `DET-${Date.now()}-${Math.random().toString(36).substr(2, 9)}`;
}
function generateIdentificationId() {
...
function generateAcknowledgmentId() {
    return `ACK-${Date.now()}-${Math.random().toString(36).substr(2, 9)}`;
}
//# sourceMappingURL=market-surveillance-kit.js.map