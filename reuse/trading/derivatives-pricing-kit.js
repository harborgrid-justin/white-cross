...
exports.InvalidParameterError = exports.ConvergenceError = exports.DerivativePricingError = exports.BarrierType = exports.OptionStyle = exports.OptionType = void 0;
exports.asBasisPoints = asBasisPoints;
exports.asPercentage = asPercentage;
exports.asVolatility = asVolatility;
exports.bpsToPercentage = bpsToPercentage;
exports.cumulativeNormalDistribution = cumulativeNormalDistribution;
exports.normalDensity = normalDensity;
exports.yearFraction = yearFraction;
exports.blackScholesCall = blackScholesCall;
exports.blackScholesPut = blackScholesPut;
exports.black76FuturesOption = black76FuturesOption;
exports.binomialTreeCRR = binomialTreeCRR;
exports.binomialTreeJR = binomialTreeJR;
exports.monteCarloEuropean = monteCarloEuropean;
exports.monteCarloAsian = monteCarloAsian;
exports.monteCarloBarrier = monteCarloBarrier;
exports.americanOptionBinomial = americanOptionBinomial;
...
exports.calculateCharm = calculateCharm;
exports.calculateVanna = calculateVanna;
exports.calculateVolga = calculateVolga;
exports.portfolioGreeks = portfolioGreeks;
exports.impliedVolatilityFromDelta = impliedVolatilityFromDelta;
exports.commodityFuturesPrice = commodityFuturesPrice;
exports.indexFuturesPrice = indexFuturesPrice;
exports.bondFuturesPrice = bondFuturesPrice;
exports.currencyFuturesPrice = currencyFuturesPrice;
exports.interestRateSwapValue = interestRateSwapValue;
exports.swapParRate = swapParRate;
exports.crossCurrencySwapValue = crossCurrencySwapValue;
exports.creditDefaultSwapPrice = creditDefaultSwapPrice;
exports.cdsSpreadCalculation = cdsSpreadCalculation;
exports.fxSwapPoints = fxSwapPoints;
exports.totalReturnSwap = totalReturnSwap;
exports.barrierOptionUpAndOut = barrierOptionUpAndOut;
exports.barrierOptionDownAndOut = barrierOptionDownAndOut;
exports.asianOptionAnalytic = asianOptionAnalytic;
exports.digitalOption = digitalOption;
exports.lookbackOption = lookbackOption;
exports.strategyPayoff = strategyPayoff;
exports.strategyGreeks = strategyGreeks;
exports.breakEvenAnalysis = breakEvenAnalysis;
exports.maxProfitLoss = maxProfitLoss;
exports.impliedVolatilityNewton = impliedVolatilityNewton;
exports.impliedVolatilityBrent = impliedVolatilityBrent;
exports.volatilitySmileFit = volatilitySmileFit;
exports.sabrVolatilitySurface = sabrVolatilitySurface;
exports.historicalVolatility = historicalVolatility;
exports.valueAtRiskParametric = valueAtRiskParametric;
exports.expectedShortfall = expectedShortfall;
exports.scenarioAnalysis = scenarioAnalysis;
exports.stressTestFramework = stressTestFramework;
/**
 * Option type
 */
var OptionType;
...
(function (BarrierType) {
    BarrierType["UpAndOut"] = "up-and-out";
    BarrierType["DownAndOut"] = "down-and-out";
    BarrierType["UpAndIn"] = "up-and-in";
    BarrierType["DownAndIn"] = "down-and-in";
})(BarrierType || (exports.BarrierType = BarrierType = {}));
// ============================================================================
// Custom Error Classes
// ============================================================================
class DerivativePricingError extends Error {
...
exports.DerivativePricingError = DerivativePricingError;
class ConvergenceError extends DerivativePricingError {
...
class InvalidParameterError extends DerivativePricingError {
 ...
 * ```
 */
function blackScholesCall(data) {
 ...
 */
function black76FuturesOption(futuresPrice, strike, timeToExpiry, riskFreeRate, volatility, optionType) {
    const r = riskFreeRate / 100;
    const sigma = volatility / 100;
    const sqrtT = Math.sqrt(timeToExpiry);
 ...
 * @returns Option price
 */
function binomialTreeCRR(data, optionType, style, steps = 100) {
    validateMarketData(data);
    const { spot, strike, timeToExpiry, riskFreeRate, dividendYield = asPercentage(0), volatility } = data;
    const r = riskFreeRate / 100;
    const q = dividendYield / 100;
 ...
 * @returns Option price
 */
function binomialTreeJR(data, optionType, style, steps = 100) {
    validateMarketData(data);
    const { spot, strike, timeToExpiry, riskFreeRate, dividendYield = asPercentage(0), volatility } = data;
    const r = riskFreeRate / 100;
    const q = dividendYield / 100;
 ...
 * @returns Option price
 */
function monteCarloEuropean(data, optionType, paths = 10000, seed) {
    validateMarketData(data);
    const { spot, strike, timeToExpiry, riskFreeRate, dividendYield = asPercentage(0), volatility } = data;
    const r = riskFreeRate / 100;
    const q = dividendYield / 100;
 ...
 * @returns Option price
 */
function monteCarloAsian(data, optionType, observations, paths = 10000) {
    validateMarketData(data);
    const { spot, strike, timeToExpiry, riskFreeRate, dividendYield = asPercentage(0), volatility } = data;
    const r = riskFreeRate / 100;
    const q = dividendYield / 100;
 ...
 * @returns Option price
 */
function monteCarloBarrier(data, barrierType, barrier, optionType, paths = 10000, steps = 100) {
    validateMarketData(data);
    const { spot, strike, timeToExpiry, riskFreeRate, dividendYield = asPercentage(0), volatility } = data;
    const r = riskFreeRate / 100;
    const q = dividendYield / 100;
 ...
 * @returns Option price
 */
function americanOptionBinomial(data, optionType, steps = 100) {
 ...
 * @returns Delta
 */
function calculateDelta(data, optionType) {
    validateMarketData(data);
    const { spot, strike, timeToExpiry, riskFreeRate, dividendYield = asPercentage(0), volatility } = data;
    const r = riskFreeRate / 100;
    const q = dividendYield / 100;
 ...
 */
function calculateTheta(data, optionType) {
    validateMarketData(data);
    const { spot, strike, timeToExpiry, riskFreeRate, dividendYield = asPercentage(0), volatility } = data;
    const r = riskFreeRate / 100;
    const q = dividendYield / 100;
 ...
 */
function calculateRho(data, optionType) {
    validateMarketData(data);
    const { spot, strike, timeToExpiry, riskFreeRate, dividendYield = asPercentage(0), volatility } = data;
    const r = riskFreeRate / 100;
    const q = dividendYield / 100;
 ...
 * @returns Charm
 */
function calculateCharm(data, optionType) {
    validateMarketData(data);
    const { spot, strike, timeToExpiry, riskFreeRate, dividendYield = asPercentage(0), volatility } = data;
    const r = riskFreeRate / 100;
    const q = dividendYield / 100;
 ...
 */
function portfolioGreeks(data, optionType) {
    return {
 ...
 */
function impliedVolatilityFromDelta(targetDelta, data, optionType) {
 ...
 */
function commodityFuturesPrice(spot, riskFreeRate, convenienceYield, storageRate, timeToExpiry) {
    const r = riskFreeRate / 100;
 ...
 * @returns Futures price
 */
function indexFuturesPrice(spot, riskFreeRate, dividendYield, timeToExpiry) {
    const r = riskFreeRate / 100;
    const q = dividendYield / 100;
 ...
 * @returns Futures price
 */
function bondFuturesPrice(bondPrice, conversionFactor, accrued, repoRate, timeToExpiry) {
 ...
 * @returns Futures price
 */
function currencyFuturesPrice(spot, domesticRate, foreignRate, timeToExpiry) {
 ...
 */
function interestRateSwapValue(swap, discountCurve, forecastCurve, valuationDate) {
 ...
 */
function swapParRate(notional, maturity, frequency, discountCurve) {
 ...
 */
function crossCurrencySwapValue(notionalDomestic, notionalForeign, domesticRate, foreignRate, spotFX, maturity, frequency, discountCurveDomestic, discountCurveForeign) {
    const periods = Math.floor(maturity * frequency);
    let domesticPV = 0;
    let foreignPV = 0;
    // Domestic leg
 ...
 * @returns CDS value
 */
function creditDefaultSwapPrice(cds, defaultProbability, discountCurve, valuationDate) {
 ...
 */
function cdsSpreadCalculation(notional, defaultProbability, recoveryRate, maturity, discountCurve) {
 ...
 */
function fxSwapPoints(spot, domesticRate, foreignRate, days) {
 ...
 * @returns TRS value
 */
function totalReturnSwap(notional, assetReturn, fundingSpread, referenceRate, maturity) {
 ...
 * @returns Option price
 */
function barrierOptionUpAndOut(data, barrier, rebate, optionType) {
    validateMarketData(data);
 ...
 * @returns Option price
 */
function barrierOptionDownAndOut(data, barrier, rebate, optionType) {
    validateMarketData(data);
    if (data.spot <= barrier) {
        return rebate;
    }
 ...
 * @returns Option price
 */
function asianOptionAnalytic(data, observations, optionType) {
 ...
 * @returns Option price
 */
function digitalOption(data, payout, optionType) {
    validateMarketData(data);
    const { spot, strike, timeToExpiry, riskFreeRate, dividendYield = asPercentage(0), volatility } = data;
    const r = riskFreeRate / 100;
    const q = dividendYield / 100;
 ...
 * @returns Option price
 */
function lookbackOption(data, optionType, paths = 10000, steps = 100) {
    validateMarketData(data);
 ...
 */
function strategyPayoff(strategy, spotPrices) {
 ...
 */
function breakEvenAnalysis(strategy) {
 ...
 */
function impliedVolatilityNewton(marketPrice, data, optionType) {
    const tolerance = 1e-6;
    const maxIterations = 100;
 ...
 * @returns Implied volatility
 */
function impliedVolatilityBrent(marketPrice, data, optionType) {
    const tolerance = 1e-6;
    const maxIterations = 100;
 ...
 */
function volatilitySmileFit(smilePoints, degree = 2) {
 ...
 * @returns Implied volatility
 */
function sabrVolatilitySurface(params, forward, strike, timeToExpiry) {
 ...
 */
function historicalVolatility(prices, method = 'close-to-close', annualizationFactor = 252) {
    if (prices.length < 2) {
 ...
 */
function valueAtRiskParametric(portfolioValue, expectedReturn, volatility, confidenceLevel, timeHorizon) {
 ...
 */
function expectedShortfall(portfolioValue, expectedReturn, volatility, confidenceLevel, timeHorizon) {
 ...
 */
function scenarioAnalysis(baseValue, scenarios, sensitivities) {
 ...
 */
function stressTestFramework(baseValue, stressTests, sensitivities) {
 ...
 */
function interpolateRates(curve, targetMaturity) {
    if (curve.length === 0) {
...
//# sourceMappingURL=derivatives-pricing-kit.js.map