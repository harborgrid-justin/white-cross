 ...
 */
export function calculateVWMA(prices: readonly PricePoint[], period: number): number[] {
  if (period <= 0 || !Number.isInteger(period)) {
    throw new Error(`Invalid period: ${period}. Must be a positive integer.`);
  }
  if (prices.length === 0) {
 ...
 */
export function calculateDEMA(data: readonly number[], period: number): number[] {
 ...
 */
export function calculateTEMA(data: readonly number[], period: number): number[] {
  const ema1 = calculateEMA(data, period);
  const ema2 = calculateEMA(ema1.filter(v => !Number.isNaN(v)), period);
 ...
 */
export function calculateHMA(data: readonly number[], period: number): number[] {
  if (period <= 0 || !Number.isInteger(period)) {
    throw new Error(`Invalid period: ${period}. Must be a positive integer.`);
  }
  ...
  const result: number[] = new Array(data.length - validRawHMA.length).fill(NaN);
 ...
 */
export function calculateRSI(data: readonly number[], period: number = 14): number[] {
  if (period <= 0 || !Number.isInteger(period)) {
    throw new Error(`Invalid period: ${period}. Must be a positive integer.`);
  }
...
export function calculateMACD(
  ...
  const signalLine: number[] = new Array(macdLine.length - validMACDLine.length).fill(NaN);
...
export function calculateStochastic(
  ...
  const kLine: number[] = new Array(kPeriod - 1).fill(NaN);
 ...
 */
export function calculateROC(data: readonly number[], period: number = 12): number[] {
  if (period <= 0 || !Number.isInteger(period)) {
    throw new Error(`Invalid period: ${period}. Must be a positive integer.`);
  }
 ...
 */
export function calculateWilliamsR(prices: readonly PricePoint[], period: number = 14): number[] {
  if (period <= 0 || !Number.isInteger(period)) {
 ...
 */
export function calculateCCI(prices: readonly PricePoint[], period: number = 20): number[] {
  if (period <= 0 || !Number.isInteger(period)) {
    throw new Error(`Invalid period: ${period}`);
  }
  if (prices.length < period) {
 ...
 */
export function calculateMFI(prices: readonly PricePoint[], period: number = 14): number[] {
  if (period <= 0 || !Number.isInteger(period)) {
    throw new Error(`Invalid period: ${period}`);
  }
 ...
 */
export function calculateMomentum(data: readonly number[], period: number = 10): number[] {
  if (period <= 0 || !Number.isInteger(period)) {
    throw new Error(`Invalid period: ${period}`);
  }
  if (data.length <= period) {
 ...
 */
export function calculateATR(prices: readonly PricePoint[], period: number = 14): number[] {
  if (period <= 0 || !Number.isInteger(period)) {
    throw new Error(`Invalid period: ${period}`);
  }
  if (prices.length < period + 1) {
 ...
 */
export function calculateStandardDeviation(data: readonly number[], period: number): number[] {
  if (period <= 0 || !Number.isInteger(period)) {
    throw new Error(`Invalid period: ${period}`);
  }
  if (data.length < period) {
 ...
 */
export function calculateHistoricVolatility(
  data: readonly number[],
  period: number = 30,
...
export function calculateDonchianChannels(
  ...
  const upper: number[] = new Array(period - 1).fill(NaN);
  const lower: number[] = new Array(period - 1).fill(NaN);
  const middle: number[] = new Array(period - 1).fill(NaN);
 ...
 */
export function calculateADX(prices: readonly PricePoint[], period: number = 14): number[] {
  if (period <= 0 || !Number.isInteger(period)) {
    throw new Error(`Invalid period: ${period}`);
  }
  ...
  const result: number[] = new Array(period * 2 - 1).fill(NaN);
...
export function calculateAroon(
  ...
  const up: number[] = new Array(period - 1).fill(NaN);
  const down: number[] = new Array(period - 1).fill(NaN);
 ...
 */
export function calculateLinearRegression(data: readonly number[], period: number): number[] {
 ...
 */
export function calculateOBV(prices: readonly PricePoint[]): number[] {
  if (prices.length === 0) {
    throw new Error('Price data cannot be empty');
  }
 ...
 */
export function calculateVWAP(prices: readonly PricePoint[]): number[] {
  if (prices.length === 0) {
    throw new Error('Price data cannot be empty');
  }
 ...
 */
export function calculateVPT(prices: readonly PricePoint[]): number[] {
  if (prices.length === 0) {
    throw new Error('Price data cannot be empty');
  }
 ...
 */
export function calculateAccumulationDistribution(prices: readonly PricePoint[]): number[] {
  if (prices.length === 0) {
    throw new Error('Price data cannot be empty');
  }
 ...
 */
export function calculateChaikinMoneyFlow(prices: readonly PricePoint[], period: number = 20): number[] {
  if (period <= 0 || !Number.isInteger(period)) {
    throw new Error(`Invalid period: ${period}`);
  }
  if (prices.length < period) {
 ...
 */
export function calculateFibonacciRetracement(high: number, low: number): FibonacciLevels {
  if (high <= low) {
...
): { ext618: number; ext1000: number; ext1618: number; ext2618: number } {
  if (high <= low) {
    throw new Error('High must be greater than low');
  }
 ...
 */
export function calculateFibonacciFan(
  startPrice: number,
  endPrice: number,
  startIndex: number,
  endIndex: number
  ...
  const createLine = (ratio: number) => (index: number): number => {
 ...
 */
export function calculateFibonacciArcs(
  startPrice: number,
  endPrice: number,
  startIndex: number,
  endIndex: number
  ...
  const createArc = (ratio: number) => (index: number): number => {
...
export function calculateIchimoku(
  ...
  const calculateHighLowAverage = (startIdx: number, period: number): number => {
 ...
 */
export function detectDoji(candle: PricePoint, threshold: number = 0.1): boolean {
...
export function detectHammer(
  candle: PricePoint,
  prevCandles: readonly PricePoint[]
  ...
  if (hasSmallBody && hasLongLowerShadow && hasSmallUpperShadow) {
    ...
    return {
      pattern: 'Hammer',
      strength: strength as 'strong' | 'moderate',
      bullish: true
    };
  }
 ...
 */
export function detectMorningEveningStar(
  candles: readonly [PricePoint, PricePoint, PricePoint]
): CandlestickPattern | null {
  if (candles.length !== 3) {
 ...
 */
export function detectHangingMan(
  candle: PricePoint,
  prevCandles: readonly PricePoint[]
): CandlestickPattern | null {
  const range = candle.high - candle.low;
