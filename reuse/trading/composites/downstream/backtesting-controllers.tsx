...
class BacktestOptimizationModel extends Model<any, any> {
  declare optimizationId: string;
  declare backtestId: string;
  declare parameterName: string;
  declare parameterValues: number[];
  declare optimalValue: number;
  declare optimizationResults: Record<string, any>[];
  declare metadata: Record<string, any>;
  declare createdAt: Date;
}
...
export function initBacktestModel(sequelize: Sequelize): typeof BacktestModel {
  BacktestModel.init(
    {
      backtestId: {
        type: DataTypes.UUID,
      ...
      backtestType: {
        type: DataTypes.ENUM(...Object.values(BacktestType)),
        allowNull: false,
        field: 'backtest_type',
      },
      status: {
