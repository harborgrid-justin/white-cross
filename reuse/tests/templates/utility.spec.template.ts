...
// Import your actual utility function
// import { yourUtilityFunction } from './your-utility';

/**
 * Example utility function interface for template demonstration
 * Replace with your actual function signature
 */
type ExampleUtilityFunction = (input: string, options?: { trim?: boolean; lowercase?: boolean }) => string;
