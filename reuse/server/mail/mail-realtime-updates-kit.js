...
exports.getPresenceEventSwaggerSchema = exports.getTypingEventSwaggerSchema = exports.getFolderUpdateEventSwaggerSchema = exports.getNewMailEventSwaggerSchema = exports.updateWebSocketMetrics = exports.initializeWebSocketMetrics = exports.retryEventDelivery = exports.acknowledgeEventDelivery = exports.recordEventDelivery = exports.renewExchangeStreamingSubscription = exports.processExchangeStreamingEvent = exports.createExchangeStreamingSubscription = exports.isTypingIndicatorValid = exports.startTypingIndicator = exports.removeConnectionFromPresence = exports.addConnectionToPresence = exports.getUserPresence = exports.updateUserPresence = exports.removeExpiredSubscriptions = exports.filterEventBySubscription = exports.updateEventSubscription = exports.createEventSubscription = exports.createSyncEvent = exports.createPresenceEvent = exports.createTypingEvent = exports.createFolderUpdateEvent = exports.createMailMovedEvent = exports.createMailUpdatedEvent = exports.createNewMailEvent = exports.createRoomConfiguration = exports.joinUserRooms = exports.generateConversationRoomId = exports.generateFolderRoomId = exports.generateUserRoomId = exports.validateWebSocketAuthentication = exports.handleClientReconnection = exports.handleClientDisconnection = exports.updateConnectionState = exports.createWebSocketConnection = exports.createHeartbeatConfiguration = exports.createGatewayConfiguration = exports.getEventDeliveryStatusModelAttributes = exports.getExchangeStreamingSubscriptionModelAttributes = exports.getPresenceRecordModelAttributes = exports.getEventSubscriptionModelAttributes = exports.getWebSocketConnectionModelAttributes = void 0;
/**
 * File: /reuse/server/mail/mail-realtime-updates-kit.ts
 ...
 * ```
 */
const getWebSocketConnectionModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getWebSocketConnectionModelAttributes = getWebSocketConnectionModelAttributes;
/**
 ...
 * ```
 */
const getEventSubscriptionModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getEventSubscriptionModelAttributes = getEventSubscriptionModelAttributes;
/**
 ...
 * ```
 */
const getPresenceRecordModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getPresenceRecordModelAttributes = getPresenceRecordModelAttributes;
/**
 ...
 * ```
 */
const getExchangeStreamingSubscriptionModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getExchangeStreamingSubscriptionModelAttributes = getExchangeStreamingSubscriptionModelAttributes;
/**
 ...
 * ```
 */
const getEventDeliveryStatusModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getEventDeliveryStatusModelAttributes = getEventDeliveryStatusModelAttributes;
// ============================================================================
 ...
 * ```
 */
const createGatewayConfiguration = (options) => {
    return {
...
exports.createGatewayConfiguration = createGatewayConfiguration;
/**
 ...
 * ```
 */
const createHeartbeatConfiguration = (options = {}) => {
    return {
...
exports.createHeartbeatConfiguration = createHeartbeatConfiguration;
// ============================================================================
 ...
 * ```
 */
const createWebSocketConnection = (socketId, userId, metadata) => {
    const now = new Date();
    return {
 ...
 * ```
 */
const updateConnectionState = (connection, state) => {
 ...
 * ```
 */
const handleClientDisconnection = (socketId, userId) => {
 ...
 * ```
 */
const handleClientReconnection = (newSocketId, previousSocketId, userId) => {
    const now = new Date();
    return {
        id: crypto.randomUUID(),
        userId,
...
exports.handleClientReconnection = handleClientReconnection;
/**
 ...
 * ```
 */
const validateWebSocketAuthentication = (token, secret) => {
    try {
...
exports.generateUserRoomId = generateUserRoomId;
/**
 ...
 * ```
 */
const generateFolderRoomId = (userId, folderId) => {
    return `user:${userId}:folder:${folderId}`;
};
exports.generateFolderRoomId = generateFolderRoomId;
/**
 ...
 * ```
 */
const generateConversationRoomId = (userId, conversationId) => {
    return `user:${userId}:conversation:${conversationId}`;
};
exports.generateConversationRoomId = generateConversationRoomId;
/**
 ...
 * ```
 */
const joinUserRooms = (socketId, userId, folderIds = []) => {
    const rooms = [(0, exports.generateUserRoomId)(userId)];
    folderIds.forEach((folderId) => {
        rooms.push((0, exports.generateFolderRoomId)(userId, folderId));
    });
    return rooms;
};
exports.joinUserRooms = joinUserRooms;
/**
 ...
 * ```
 */
const createRoomConfiguration = (roomType, identifier, members = []) => {
    return {
...
exports.createRoomConfiguration = createRoomConfiguration;
// ============================================================================
 ...
 * ```
 */
const createNewMailEvent = (userId, mailData) => {
    return {
        id: crypto.randomUUID(),
        eventType: 'mail:new',
        timestamp: new Date(),
...
exports.createNewMailEvent = createNewMailEvent;
/**
 ...
 * ```
 */
const createMailUpdatedEvent = (userId, messageId, folderId, changes) => {
    return {
        id: crypto.randomUUID(),
...
exports.createMailUpdatedEvent = createMailUpdatedEvent;
/**
 ...
 * ```
 */
const createMailMovedEvent = (userId, messageId, sourceFolderId, destinationFolderId, conversationId) => {
    return {
        id: crypto.randomUUID(),
...
exports.createMailMovedEvent = createMailMovedEvent;
/**
 ...
 * ```
 */
const createFolderUpdateEvent = (userId, folderId, eventType, folderData) => {
    return {
        id: crypto.randomUUID(),
        eventType,
        timestamp: new Date(),
...
exports.createFolderUpdateEvent = createFolderUpdateEvent;
/**
 ...
 * ```
 */
const createTypingEvent = (userId, isTyping, context) => {
    return {
        id: crypto.randomUUID(),
...
exports.createTypingEvent = createTypingEvent;
/**
 ...
 * ```
 */
const createPresenceEvent = (userId, status, statusMessage) => {
    return {
        id: crypto.randomUUID(),
        eventType: `presence:${status}`,
        timestamp: new Date(),
        userId,
        data: {
            status,
...
exports.createPresenceEvent = createPresenceEvent;
/**
 ...
 * ```
 */
const createSyncEvent = (userId, syncId, eventType, syncData) => {
    return {
        id: crypto.randomUUID(),
        eventType,
        timestamp: new Date(),
 ...
 * ```
 */
const createEventSubscription = (userId, socketId, eventTypes, options) => {
    return {
        id: crypto.randomUUID(),
        userId,
        socketId,
 ...
 * ```
 */
const updateEventSubscription = (subscription, updates) => {
    return {
        ...subscription,
...
exports.updateEventSubscription = updateEventSubscription;
/**
 ...
 * ```
 */
const filterEventBySubscription = (event, subscription) => {
    // Check if event type is subscribed
    if (!subscription.eventTypes.includes(event.eventType)) {
        return false;
    }
    // Check folder filter for mail events
    if (subscription.folderIds && event.data?.folderId) {
        if (!subscription.folderIds.includes(event.data.folderId)) {
            return false;
        }
    }
    ...
    if (subscription.filters) {
        ...
        if (filters.categories && eventData.categories) {
            const hasCategory = filters.categories.some((cat) => eventData.categories.includes(cat));
            if (!hasCategory) {
                return false;
            }
        }
...
exports.filterEventBySubscription = filterEventBySubscription;
/**
 ...
 * ```
 */
const removeExpiredSubscriptions = (subscriptions) => {
    const now = new Date();
    return subscriptions.filter((sub) => !sub.expiresAt || sub.expiresAt > now);
};
exports.removeExpiredSubscriptions = removeExpiredSubscriptions;
// ============================================================================
// PRESENCE TRACKING
// ============================================================================
/**
 ...
 * ```
 */
const updateUserPresence = (userId, status, socketId, statusMessage) => {
    const now = new Date();
    return {
        id: crypto.randomUUID(),
        userId,
 ...
 * ```
 */
const addConnectionToPresence = (presence, socketId) => {
...
exports.addConnectionToPresence = addConnectionToPresence;
/**
 ...
 * ```
 */
const removeConnectionFromPresence = (presence, socketId) => {
...
exports.removeConnectionFromPresence = removeConnectionFromPresence;
// ============================================================================
// TYPING INDICATORS
// ============================================================================
/**
 ...
 * ```
 */
const startTypingIndicator = (userId, recipientAddress, context) => {
    const now = new Date();
    return {
        id: crypto.randomUUID(),
        userId,
 ...
 * ```
 */
const isTypingIndicatorValid = (indicator) => {
    return new Date() < indicator.expiresAt;
};
exports.isTypingIndicatorValid = isTypingIndicatorValid;
// ============================================================================
 ...
 * ```
 */
const createExchangeStreamingSubscription = (userId, connectionId, folderIds) => {
    const now = new Date();
    return {
        id: crypto.randomUUID(),
        userId,
...
exports.createExchangeStreamingSubscription = createExchangeStreamingSubscription;
/**
 ...
 * ```
 */
const processExchangeStreamingEvent = (subscription, exchangeEvent) => {
    let eventType = 'mail:new';
...
exports.processExchangeStreamingEvent = processExchangeStreamingEvent;
/**
 ...
 * ```
 */
const renewExchangeStreamingSubscription = (subscription) => {
    return {
        ...subscription,
        expiresAt: new Date(Date.now() + 30 * 60 * 1000), // Extend by 30 minutes
    };
};
exports.renewExchangeStreamingSubscription = renewExchangeStreamingSubscription;
// ============================================================================
 ...
 * ```
 */
const recordEventDelivery = (eventId, socketId, userId) => {
    const now = new Date();
    return {
        id: crypto.randomUUID(),
        eventId,
...
exports.recordEventDelivery = recordEventDelivery;
/**
 ...
 * ```
 */
const acknowledgeEventDelivery = (delivery) => {
    return {
        ...delivery,
...
exports.acknowledgeEventDelivery = acknowledgeEventDelivery;
/**
 ...
 * ```
 */
const retryEventDelivery = (delivery) => {
    return {
        ...delivery,
...
exports.retryEventDelivery = retryEventDelivery;
// ============================================================================
 ...
 * ```
 */
const initializeWebSocketMetrics = () => {
    return {
        totalConnections: 0,
        activeConnections: 0,
        reconnections: 0,
...
exports.initializeWebSocketMetrics = initializeWebSocketMetrics;
/**
 ...
 * ```
 */
const updateWebSocketMetrics = (metrics, update) => {
...
exports.updateWebSocketMetrics = updateWebSocketMetrics;
// ============================================================================
 ...
 * ```
 */
const getNewMailEventSwaggerSchema = () => {
    return {
        eventName: 'mail:new',
...
exports.getNewMailEventSwaggerSchema = getNewMailEventSwaggerSchema;
/**
 ...
 * ```
 */
const getFolderUpdateEventSwaggerSchema = () => {
    return {
...
exports.getFolderUpdateEventSwaggerSchema = getFolderUpdateEventSwaggerSchema;
/**
 ...
 * ```
 */
const getTypingEventSwaggerSchema = () => {
    return {
...
exports.getTypingEventSwaggerSchema = getTypingEventSwaggerSchema;
/**
 ...
 * ```
 */
const getPresenceEventSwaggerSchema = () => {
    return {
...
exports.getPresenceEventSwaggerSchema = getPresenceEventSwaggerSchema;
// ============================================================================
// DEFAULT EXPORT
// ============================================================================
exports.default = {
    // Sequelize Models
    getWebSocketConnectionModelAttributes: exports.getWebSocketConnectionModelAttributes,
    getEventSubscriptionModelAttributes: exports.getEventSubscriptionModelAttributes,
    getPresenceRecordModelAttributes: exports.getPresenceRecordModelAttributes,
    getExchangeStreamingSubscriptionModelAttributes: exports.getExchangeStreamingSubscriptionModelAttributes,
    getEventDeliveryStatusModelAttributes: exports.getEventDeliveryStatusModelAttributes,
    // Gateway Configuration
    createGatewayConfiguration: exports.createGatewayConfiguration,
    createHeartbeatConfiguration: exports.createHeartbeatConfiguration,
    // Connection Management
    createWebSocketConnection: exports.createWebSocketConnection,
    updateConnectionState: exports.updateConnectionState,
    handleClientDisconnection: exports.handleClientDisconnection,
    handleClientReconnection: exports.handleClientReconnection,
    validateWebSocketAuthentication: exports.validateWebSocketAuthentication,
    // Room Management
    generateUserRoomId: exports.generateUserRoomId,
    generateFolderRoomId: exports.generateFolderRoomId,
    generateConversationRoomId: exports.generateConversationRoomId,
    joinUserRooms: exports.joinUserRooms,
    createRoomConfiguration: exports.createRoomConfiguration,
    // Event Creation
    createNewMailEvent: exports.createNewMailEvent,
    createMailUpdatedEvent: exports.createMailUpdatedEvent,
    createMailMovedEvent: exports.createMailMovedEvent,
    createFolderUpdateEvent: exports.createFolderUpdateEvent,
    createTypingEvent: exports.createTypingEvent,
    createPresenceEvent: exports.createPresenceEvent,
    createSyncEvent: exports.createSyncEvent,
    // Event Subscriptions
    createEventSubscription: exports.createEventSubscription,
    updateEventSubscription: exports.updateEventSubscription,
    filterEventBySubscription: exports.filterEventBySubscription,
    removeExpiredSubscriptions: exports.removeExpiredSubscriptions,
    // Presence Tracking
    updateUserPresence: exports.updateUserPresence,
    getUserPresence: exports.getUserPresence,
    addConnectionToPresence: exports.addConnectionToPresence,
    removeConnectionFromPresence: exports.removeConnectionFromPresence,
    // Typing Indicators
    startTypingIndicator: exports.startTypingIndicator,
    isTypingIndicatorValid: exports.isTypingIndicatorValid,
    // Exchange Server Integration
    createExchangeStreamingSubscription: exports.createExchangeStreamingSubscription,
    processExchangeStreamingEvent: exports.processExchangeStreamingEvent,
    renewExchangeStreamingSubscription: exports.renewExchangeStreamingSubscription,
    // Event Delivery
    recordEventDelivery: exports.recordEventDelivery,
    acknowledgeEventDelivery: exports.acknowledgeEventDelivery,
    retryEventDelivery: exports.retryEventDelivery,
    // Metrics
    initializeWebSocketMetrics: exports.initializeWebSocketMetrics,
    updateWebSocketMetrics: exports.updateWebSocketMetrics,
    // Swagger Documentation
    getNewMailEventSwaggerSchema: exports.getNewMailEventSwaggerSchema,
    getFolderUpdateEventSwaggerSchema: exports.getFolderUpdateEventSwaggerSchema,
    getTypingEventSwaggerSchema: exports.getTypingEventSwaggerSchema,
    getPresenceEventSwaggerSchema: exports.getPresenceEventSwaggerSchema,
};
//# sourceMappingURL=mail-realtime-updates-kit.js.map