...
exports.markReportExecuted = exports.getDueScheduledReports = exports.exportReport = exports.calculateNextRunTime = exports.scheduleReport = exports.updateDashboard = exports.listDashboards = exports.getDashboard = exports.createDashboard = exports.deleteCustomReport = exports.updateCustomReport = exports.listCustomReports = exports.executeCustomReport = exports.createCustomReport = exports.trackComplianceMetrics = exports.generateRetentionComplianceReport = exports.generateHIPAAComplianceReport = exports.updateSecurityIncident = exports.getSecurityIncidentStatistics = exports.getSecurityIncidents = exports.createSecurityIncident = exports.analyzeStorageByFolder = exports.projectStorageRequirements = exports.analyzeStorageByMailbox = exports.getStorageUsageMetrics = exports.getTopSpamSenders = exports.analyzeSpamRuleEffectiveness = exports.getSpamDetectionMetrics = exports.monitorBounceRatesByDomain = exports.getDeliveryTimePercentiles = exports.analyzeDeliveryFailures = exports.getDeliveryPerformanceMetrics = exports.compareMessageVolumePeriods = exports.analyzeMessageVolumeTrends = exports.generateMessageVolumeReport = exports.calculateMailboxGrowth = exports.getOrganizationMailboxStatistics = exports.getMailboxStatistics = exports.trackUserEngagement = exports.analyzeUserActivityPatterns = exports.getMostActiveUsers = exports.getUserActivityMetrics = exports.getTrafficByDomain = exports.analyzeTrafficPatternsByHour = exports.getRealtimeTrafficMetrics = exports.getEmailTrafficMetrics = exports.getSecurityIncidentModelAttributes = exports.getDashboardConfigurationModelAttributes = exports.getScheduledReportModelAttributes = exports.getMailAnalyticsMetricModelAttributes = void 0;
exports.getSecurityIncidentSwaggerSchema = exports.getDashboardSwaggerSchema = exports.getCustomReportSwaggerSchema = exports.getMailAnalyticsMetricSwaggerSchema = void 0;
/**
 * File: /reuse/server/mail/mail-analytics-reporting-kit.ts
 ...
 * ```
 */
const getMailAnalyticsMetricModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getMailAnalyticsMetricModelAttributes = getMailAnalyticsMetricModelAttributes;
/**
 ...
 * ```
 */
const getScheduledReportModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getScheduledReportModelAttributes = getScheduledReportModelAttributes;
/**
 ...
 * ```
 */
const getDashboardConfigurationModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getDashboardConfigurationModelAttributes = getDashboardConfigurationModelAttributes;
/**
 ...
 * ```
 */
const getSecurityIncidentModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getSecurityIncidentModelAttributes = getSecurityIncidentModelAttributes;
// ============================================================================
 ...
 * ```
 */
const getEmailTrafficMetrics = (period, organizationId) => {
    return {
        query: {
            where: {
                timestamp: {
...
exports.getEmailTrafficMetrics = getEmailTrafficMetrics;
/**
 ...
 * ```
 */
const getRealtimeTrafficMetrics = (minutes = 60, organizationId) => {
...
exports.getRealtimeTrafficMetrics = getRealtimeTrafficMetrics;
/**
 ...
 * ```
 */
const analyzeTrafficPatternsByHour = (period, organizationId) => {
    return {
        where: {
            timestamp: {
                $gte: period.startDate,
...
exports.analyzeTrafficPatternsByHour = analyzeTrafficPatternsByHour;
/**
 ...
 * ```
 */
const getTrafficByDomain = (period, topN = 10) => {
    return {
        where: {
            timestamp: {
                $gte: period.startDate,
...
exports.getTrafficByDomain = getTrafficByDomain;
// ============================================================================
 ...
 * ```
 */
const getUserActivityMetrics = (userId, period) => {
    return {
        where: {
            userId,
            timestamp: {
 ...
 * ```
 */
const getMostActiveUsers = (period, metricName, topN = 10, organizationId) => {
    return {
        where: {
            timestamp: {
                $gte: period.startDate,
 ...
 * ```
 */
const analyzeUserActivityPatterns = (userId, period) => {
    return {
        where: {
            userId,
            timestamp: {
...
exports.analyzeUserActivityPatterns = analyzeUserActivityPatterns;
/**
 ...
 * ```
 */
const trackUserEngagement = (userId, period) => {
    return {
        where: {
            userId,
            timestamp: {
...
exports.trackUserEngagement = trackUserEngagement;
// ============================================================================
// MAILBOX STATISTICS
// ============================================================================
/**
 ...
 * ```
 */
const getMailboxStatistics = (mailboxId, userId) => {
    return {
        mailboxQuery: {
...
exports.getMailboxStatistics = getMailboxStatistics;
/**
 ...
 * ```
 */
const getOrganizationMailboxStatistics = (organizationId, options = {}) => {
    return {
        where: {
            organizationId,
...
exports.getOrganizationMailboxStatistics = getOrganizationMailboxStatistics;
/**
 ...
 * ```
 */
const calculateMailboxGrowth = (mailboxId, period) => {
    return {
        where: {
            mailboxId,
            timestamp: {
...
exports.calculateMailboxGrowth = calculateMailboxGrowth;
// ============================================================================
 ...
 * ```
 */
const generateMessageVolumeReport = (period, organizationId) => {
    return {
        totalQuery: {
            where: {
                timestamp: {
...
exports.generateMessageVolumeReport = generateMessageVolumeReport;
/**
 ...
 * ```
 */
const analyzeMessageVolumeTrends = (metricName, period, organizationId) => {
...
exports.analyzeMessageVolumeTrends = analyzeMessageVolumeTrends;
/**
 ...
 * ```
 */
const compareMessageVolumePeriods = (currentPeriod, comparisonPeriod, organizationId) => {
    return {
        current: {
            where: {
                timestamp: {
...
exports.compareMessageVolumePeriods = compareMessageVolumePeriods;
// ============================================================================
 ...
 * ```
 */
const getDeliveryPerformanceMetrics = (period, organizationId) => {
    return {
        where: {
            timestamp: {
                $gte: period.startDate,
...
exports.getDeliveryPerformanceMetrics = getDeliveryPerformanceMetrics;
/**
 ...
 * ```
 */
const analyzeDeliveryFailures = (period, organizationId) => {
    return {
        where: {
            timestamp: {
                $gte: period.startDate,
...
exports.analyzeDeliveryFailures = analyzeDeliveryFailures;
/**
 ...
 * ```
 */
const getDeliveryTimePercentiles = (period, organizationId) => {
    return {
        where: {
            timestamp: {
                $gte: period.startDate,
...
exports.getDeliveryTimePercentiles = getDeliveryTimePercentiles;
/**
 ...
 * ```
 */
const monitorBounceRatesByDomain = (period, topN = 20) => {
    return {
        where: {
            timestamp: {
                $gte: period.startDate,
...
exports.monitorBounceRatesByDomain = monitorBounceRatesByDomain;
// ============================================================================
 ...
 * ```
 */
const getSpamDetectionMetrics = (period, organizationId) => {
    return {
        where: {
            timestamp: {
                $gte: period.startDate,
...
exports.getSpamDetectionMetrics = getSpamDetectionMetrics;
/**
 ...
 * ```
 */
const analyzeSpamRuleEffectiveness = (period, organizationId) => {
    return {
        where: {
            timestamp: {
                $gte: period.startDate,
...
exports.analyzeSpamRuleEffectiveness = analyzeSpamRuleEffectiveness;
/**
 ...
 * ```
 */
const getTopSpamSenders = (period, topN = 50, organizationId) => {
    return {
        where: {
            timestamp: {
                $gte: period.startDate,
...
exports.getTopSpamSenders = getTopSpamSenders;
// ============================================================================
 ...
 * ```
 */
const getStorageUsageMetrics = (organizationId) => {
    return {
        where: {
            ...(organizationId && { organizationId }),
            metricType: 'storage',
...
exports.getStorageUsageMetrics = getStorageUsageMetrics;
/**
 ...
 * ```
 */
const analyzeStorageByMailbox = (organizationId, threshold = 80) => {
    return {
        where: {
            ...(organizationId && { organizationId }),
            metricType: 'storage',
...
exports.analyzeStorageByMailbox = analyzeStorageByMailbox;
/**
 ...
 * ```
 */
const projectStorageRequirements = (period, projectionDays = 90, organizationId) => {
    return {
        historicalData: {
            where: {
                timestamp: {
...
exports.projectStorageRequirements = projectStorageRequirements;
/**
 ...
 * ```
 */
const analyzeStorageByFolder = (userId, mailboxId) => {
    return {
        where: {
            userId,
            ...(mailboxId && { mailboxId }),
...
exports.analyzeStorageByFolder = analyzeStorageByFolder;
// ============================================================================
 ...
 * ```
 */
const createSecurityIncident = (incident) => {
    return {
        data: {
 ...
 * ```
 */
const getSecurityIncidents = (filters) => {
    const where = {};
...
exports.getSecurityIncidents = getSecurityIncidents;
/**
 ...
 * ```
 */
const getSecurityIncidentStatistics = (period, organizationId) => {
    return {
        where: {
            detectionDate: {
                $gte: period.startDate,
...
exports.getSecurityIncidentStatistics = getSecurityIncidentStatistics;
/**
 ...
 * ```
 */
const updateSecurityIncident = (incidentId, updates) => {
    return {
        where: { id: incidentId },
        data: updates,
    };
};
exports.updateSecurityIncident = updateSecurityIncident;
// ============================================================================
 ...
 * ```
 */
const generateHIPAAComplianceReport = (period, organizationId) => {
    return {
        reportMetadata: {
            id: crypto.randomUUID(),
            reportType: 'hipaa',
 ...
 * ```
 */
const generateRetentionComplianceReport = (period, organizationId) => {
    return {
        reportMetadata: {
            id: crypto.randomUUID(),
 ...
 * ```
 */
const trackComplianceMetrics = (complianceType, period, organizationId) => {
    return {
        where: {
            timestamp: {
                $gte: period.startDate,
 ...
 * ```
 */
const executeCustomReport = (reportId, period) => {
    return {
        reportQuery: {
            where: { id: reportId },
        },
 ...
 * ```
 */
const listCustomReports = (filters) => {
    const where = {};
...
exports.listCustomReports = listCustomReports;
/**
 ...
 * ```
 */
const updateCustomReport = (reportId, updates) => {
    return {
        where: { id: reportId },
        data: {
            ...updates,
...
exports.updateCustomReport = updateCustomReport;
/**
...
exports.deleteCustomReport = deleteCustomReport;
// ============================================================================
 ...
 * ```
 */
const getDashboard = (dashboardId, userId) => {
    return {
        where: {
            id: dashboardId,
            $or: [
...
const scheduleReport = (reportId, schedule) => {
    const nextRun = (0, exports.calculateNextRunTime)(schedule);
    return {
        where: { id: reportId },
        data: {
            schedule,
...
exports.calculateNextRunTime = calculateNextRunTime;
/**
 ...
 * ```
 */
const exportReport = (reportData, options) => {
    return {
        data: reportData,
 ...
 * ```
 */
const markReportExecuted = (reportId) => {
    return {
        where: { id: reportId },
        data: {
            lastRun: new Date(),
...
exports.markReportExecuted = markReportExecuted;
// ============================================================================
 ...
 * ```
 */
const getMailAnalyticsMetricSwaggerSchema = () => {
    return {
...
exports.getMailAnalyticsMetricSwaggerSchema = getMailAnalyticsMetricSwaggerSchema;
/**
 ...
 * ```
 */
const getCustomReportSwaggerSchema = () => {
    return {
...
exports.getCustomReportSwaggerSchema = getCustomReportSwaggerSchema;
/**
 ...
 * ```
 */
const getDashboardSwaggerSchema = () => {
    return {
...
exports.getDashboardSwaggerSchema = getDashboardSwaggerSchema;
/**
 ...
 * ```
 */
const getSecurityIncidentSwaggerSchema = () => {
    return {
...
exports.getSecurityIncidentSwaggerSchema = getSecurityIncidentSwaggerSchema;
exports.default = {
    // Sequelize Models
    getMailAnalyticsMetricModelAttributes: exports.getMailAnalyticsMetricModelAttributes,
    getScheduledReportModelAttributes: exports.getScheduledReportModelAttributes,
    getDashboardConfigurationModelAttributes: exports.getDashboardConfigurationModelAttributes,
    getSecurityIncidentModelAttributes: exports.getSecurityIncidentModelAttributes,
    // Email Traffic Analytics
    getEmailTrafficMetrics: exports.getEmailTrafficMetrics,
    getRealtimeTrafficMetrics: exports.getRealtimeTrafficMetrics,
    analyzeTrafficPatternsByHour: exports.analyzeTrafficPatternsByHour,
    getTrafficByDomain: exports.getTrafficByDomain,
    // User Activity Tracking
    getUserActivityMetrics: exports.getUserActivityMetrics,
    getMostActiveUsers: exports.getMostActiveUsers,
    analyzeUserActivityPatterns: exports.analyzeUserActivityPatterns,
    trackUserEngagement: exports.trackUserEngagement,
    // Mailbox Statistics
    getMailboxStatistics: exports.getMailboxStatistics,
    getOrganizationMailboxStatistics: exports.getOrganizationMailboxStatistics,
    calculateMailboxGrowth: exports.calculateMailboxGrowth,
    // Message Volume Reporting
    generateMessageVolumeReport: exports.generateMessageVolumeReport,
    analyzeMessageVolumeTrends: exports.analyzeMessageVolumeTrends,
    compareMessageVolumePeriods: exports.compareMessageVolumePeriods,
    // Delivery Performance Metrics
    getDeliveryPerformanceMetrics: exports.getDeliveryPerformanceMetrics,
    analyzeDeliveryFailures: exports.analyzeDeliveryFailures,
    getDeliveryTimePercentiles: exports.getDeliveryTimePercentiles,
    monitorBounceRatesByDomain: exports.monitorBounceRatesByDomain,
    // Spam Detection Metrics
    getSpamDetectionMetrics: exports.getSpamDetectionMetrics,
    analyzeSpamRuleEffectiveness: exports.analyzeSpamRuleEffectiveness,
    getTopSpamSenders: exports.getTopSpamSenders,
    // Storage Usage Analytics
    getStorageUsageMetrics: exports.getStorageUsageMetrics,
    analyzeStorageByMailbox: exports.analyzeStorageByMailbox,
    projectStorageRequirements: exports.projectStorageRequirements,
    analyzeStorageByFolder: exports.analyzeStorageByFolder,
    // Security Incident Reporting
    createSecurityIncident: exports.createSecurityIncident,
    getSecurityIncidents: exports.getSecurityIncidents,
    getSecurityIncidentStatistics: exports.getSecurityIncidentStatistics,
    updateSecurityIncident: exports.updateSecurityIncident,
    // Compliance Reporting
    ...
    listCustomReports: exports.listCustomReports,
    updateCustomReport: exports.updateCustomReport,
    deleteCustomReport: exports.deleteCustomReport,
    // Dashboard Configuration
    createDashboard: exports.createDashboard,
    getDashboard: exports.getDashboard,
    listDashboards: exports.listDashboards,
    updateDashboard: exports.updateDashboard,
    // Report Scheduling and Export
    scheduleReport: exports.scheduleReport,
    calculateNextRunTime: exports.calculateNextRunTime,
    exportReport: exports.exportReport,
    getDueScheduledReports: exports.getDueScheduledReports,
    markReportExecuted: exports.markReportExecuted,
    // Swagger Documentation
    getMailAnalyticsMetricSwaggerSchema: exports.getMailAnalyticsMetricSwaggerSchema,
    getCustomReportSwaggerSchema: exports.getCustomReportSwaggerSchema,
    getDashboardSwaggerSchema: exports.getDashboardSwaggerSchema,
    getSecurityIncidentSwaggerSchema: exports.getSecurityIncidentSwaggerSchema,
};
//# sourceMappingURL=mail-analytics-reporting-kit.js.map