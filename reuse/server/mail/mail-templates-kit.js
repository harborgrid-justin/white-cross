...
exports.getCannedResponseSwaggerSchema = exports.getQuickReplySwaggerSchema = exports.getTemplateRenderContextSwaggerSchema = exports.getTemplateCreateDtoSwaggerSchema = exports.getTemplateVariableSwaggerSchema = exports.getMailTemplateSwaggerSchema = exports.incrementTemplateUsage = exports.stripHtmlTags = exports.getDefaultTemplateForCategory = exports.setTemplateAsDefault = exports.getTemplatesByCategory = exports.useCannedResponse = exports.listCannedResponses = exports.createCannedResponse = exports.useQuickReply = exports.listQuickReplies = exports.createQuickReply = exports.shareTemplate = exports.updateTemplateAccessControl = exports.checkTemplatePermission = exports.updateTemplateLocalization = exports.listTemplateLocalizations = exports.getTemplateLocalization = exports.createTemplateLocalization = exports.compareTemplateVersions = exports.restoreTemplateVersion = exports.getTemplateVersionHistory = exports.createTemplateVersion = exports.createSystemTemplates = exports.getSystemTemplate = exports.generateTemplatePreview = exports.validateTemplateVariables = exports.extractPlaceholders = exports.renderHandlebarsTemplate = exports.renderMjmlTemplate = exports.renderTemplate = exports.searchMailTemplates = exports.deleteMailTemplate = exports.updateMailTemplate = exports.getMailTemplateById = exports.createMailTemplate = exports.getCannedResponseModelAttributes = exports.getQuickReplyModelAttributes = exports.getTemplateLocalizationModelAttributes = exports.getTemplateVersionModelAttributes = exports.getMailTemplateModelAttributes = void 0;
/**
 * File: /reuse/server/mail/mail-templates-kit.ts
 ...
 * ```
 */
const getMailTemplateModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getMailTemplateModelAttributes = getMailTemplateModelAttributes;
/**
 ...
 * ```
 */
const getTemplateVersionModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getTemplateVersionModelAttributes = getTemplateVersionModelAttributes;
/**
 ...
 * ```
 */
const getTemplateLocalizationModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getTemplateLocalizationModelAttributes = getTemplateLocalizationModelAttributes;
/**
 ...
 * ```
 */
const getQuickReplyModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getQuickReplyModelAttributes = getQuickReplyModelAttributes;
/**
 ...
 * ```
 */
const getCannedResponseModelAttributes = () => ({
    id: {
        type: 'UUID',
        defaultValue: 'UUIDV4',
        primaryKey: true,
...
exports.getCannedResponseModelAttributes = getCannedResponseModelAttributes;
// ============================================================================
...
const createMailTemplate = (data) => {
    const placeholders = (0, exports.extractPlaceholders)(data.subject + (data.bodyHtml || '') + (data.bodyText || ''));
    return {
        data: {
 ...
 * ```
 */
const getMailTemplateById = (templateId, userId) => {
    const where = {
        id: templateId,
        isActive: true,
    };
 ...
 * ```
 */
const updateMailTemplate = (templateId, userId, updates) => {
    const updateData = {
        ...updates,
        updatedAt: new Date(),
        updatedBy: userId,
    ...
    if (updates.subject || updates.bodyHtml || updates.bodyText) {
        const content = (updates.subject || '') +
            (updates.bodyHtml || '') +
            (updates.bodyText || '');
        updateData.placeholders = (0, exports.extractPlaceholders)(content);
    }
 ...
 * ```
 */
const deleteMailTemplate = (templateId, userId, permanent = false) => {
    if (permanent) {
        return {
            where: {
                id: templateId,
 ...
 * ```
 */
const searchMailTemplates = (query) => {
    const where = {
...
exports.searchMailTemplates = searchMailTemplates;
// ============================================================================
// TEMPLATE RENDERING
// ============================================================================
/**
...
const renderTemplate = (template, context) => {
    ...
    // Render subject
    const subject = (0, exports.renderHandlebarsTemplate)(template.subject, mergedVars, context.helpers);
    // Render HTML body
    let bodyHtml = '';
    if (template.bodyMjml) {
        bodyHtml = (0, exports.renderMjmlTemplate)(template.bodyMjml, mergedVars);
    }
    else if (template.bodyHtml) {
        bodyHtml = (0, exports.renderHandlebarsTemplate)(template.bodyHtml, mergedVars, context.helpers);
    }
    // Render text body
    const bodyText = template.bodyText
        ? (0, exports.renderHandlebarsTemplate)(template.bodyText, mergedVars, context.helpers)
        : (0, exports.stripHtmlTags)(bodyHtml);
    return {
        subject,
        bodyHtml,
        bodyText,
 ...
 * ```
 */
const renderMjmlTemplate = (mjml, variables) => {
    // First apply variable substitution
    const processedMjml = (0, exports.renderHandlebarsTemplate)(mjml, variables);
...
exports.renderMjmlTemplate = renderMjmlTemplate;
/**
 ...
 * ```
 */
const renderHandlebarsTemplate = (template, variables, helpers) => {
 ...
 * ```
 */
const validateTemplateVariables = (schema, variables) => {
    const errors = [];
...
const generateTemplatePreview = (template) => {
    ...
    return (0, exports.renderTemplate)(template, { variables: sampleVars });
};
 ...
 * ```
 */
const getSystemTemplate = (category, language = 'en') => {
    const templates = {
        'welcome': {
            category: 'welcome',
            name: 'system-welcome',
 ...
 * ```
 */
const createSystemTemplates = (organizationId, language = 'en') => {
    const categories = [
        'welcome',
        'password-reset',
        'notification',
    ...
    return categories.map((category) => {
        const systemTemplate = (0, exports.getSystemTemplate)(category, language);
        return {
            id: crypto.randomUUID(),
            organizationId,
            ...
            placeholders: (0, exports.extractPlaceholders)(systemTemplate.subject + systemTemplate.bodyHtml),
            isActive: true,
            isDefault: true,
            version: 1,
            language,
...
exports.createSystemTemplates = createSystemTemplates;
// ============================================================================
// TEMPLATE VERSIONING
// ============================================================================
/**
 ...
 * ```
 */
const createTemplateVersion = (templateId, userId, changeLog) => {
    return {
        templateId,
        findTemplate: {
            where: { id: templateId },
 ...
 * ```
 */
const getTemplateVersionHistory = (templateId, limit = 10) => {
    return {
        where: { templateId },
        order: [['version', 'DESC']],
        limit,
 ...
 * ```
 */
const restoreTemplateVersion = (templateId, version, userId) => {
    return {
        findVersion: {
            where: { templateId, version },
        },
        updateTemplate: (versionData) => ({
            where: { id: templateId },
            data: {
 ...
 * ```
 */
const compareTemplateVersions = (templateId, version1, version2) => {
    return {
        where: {
            templateId,
 ...
 * ```
 */
const createTemplateLocalization = (templateId, language, locale, content) => {
    return {
        data: {
            id: crypto.randomUUID(),
            templateId,
...
exports.createTemplateLocalization = createTemplateLocalization;
/**
 ...
 * ```
 */
const getTemplateLocalization = (templateId, language, locale) => {
    const where = { templateId, language };
    if (locale) {
        where.locale = locale;
    }
    return {
...
exports.getTemplateLocalization = getTemplateLocalization;
/**
 ...
 * ```
 */
const listTemplateLocalizations = (templateId) => {
    return {
        where: { templateId },
        order: [['language', 'ASC'], ['locale', 'ASC']],
    };
};
exports.listTemplateLocalizations = listTemplateLocalizations;
/**
 ...
 * ```
 */
const updateTemplateLocalization = (localizationId, updates) => {
    return {
...
exports.updateTemplateLocalization = updateTemplateLocalization;
// ============================================================================
 ...
 * ```
 */
const checkTemplatePermission = (template, userId, permission) => {
 ...
 * ```
 */
const updateTemplateAccessControl = (templateId, userId, accessControl) => {
    return {
        where: {
            id: templateId,
...
exports.updateTemplateAccessControl = updateTemplateAccessControl;
/**
 ...
 * ```
 */
const shareTemplate = (templateId, userId, shareWith) => {
    return {
 ...
 * ```
 */
const createQuickReply = (userId, data) => {
    return {
        data: {
            id: crypto.randomUUID(),
            userId,
 ...
 * ```
 */
const listQuickReplies = (userId, category) => {
    const where = {
        userId,
        isActive: true,
    };
...
exports.listQuickReplies = listQuickReplies;
/**
 ...
 * ```
 */
const useQuickReply = (quickReplyId) => {
    return {
...
exports.useQuickReply = useQuickReply;
/**
 ...
 * ```
 */
const createCannedResponse = (userId, data) => {
    return {
        data: {
            id: crypto.randomUUID(),
            userId,
...
exports.createCannedResponse = createCannedResponse;
/**
 ...
 * ```
 */
const listCannedResponses = (userId, filters) => {
    const where = {};
...
exports.listCannedResponses = listCannedResponses;
/**
 ...
 * ```
 */
const useCannedResponse = (cannedResponseId) => {
    return {
...
exports.useCannedResponse = useCannedResponse;
// ============================================================================
 ...
 * ```
 */
const getTemplatesByCategory = (userId, organizationId) => {
 ...
 * ```
 */
const getDefaultTemplateForCategory = (category, userId) => {
    const where = {
        category,
        isDefault: true,
        isActive: true,
...
exports.getDefaultTemplateForCategory = getDefaultTemplateForCategory;
// ============================================================================
// HELPER FUNCTIONS
// ============================================================================
/**
...
exports.incrementTemplateUsage = incrementTemplateUsage;
// ============================================================================
 ...
 */
const getMailTemplateSwaggerSchema = () => {
    return {
        name: 'MailTemplate',
        type: 'object',
...
exports.getMailTemplateSwaggerSchema = getMailTemplateSwaggerSchema;
/**
 * Swagger schema for TemplateVariable.
 */
const getTemplateVariableSwaggerSchema = () => {
    return {
...
exports.getTemplateVariableSwaggerSchema = getTemplateVariableSwaggerSchema;
/**
 * Swagger schema for TemplateCreateDto.
 */
const getTemplateCreateDtoSwaggerSchema = () => {
    return {
...
exports.getTemplateCreateDtoSwaggerSchema = getTemplateCreateDtoSwaggerSchema;
/**
 * Swagger schema for TemplateRenderContext.
 */
const getTemplateRenderContextSwaggerSchema = () => {
    return {
...
exports.getTemplateRenderContextSwaggerSchema = getTemplateRenderContextSwaggerSchema;
/**
 * Swagger schema for QuickReply.
 */
const getQuickReplySwaggerSchema = () => {
    return {
        name: 'QuickReply',
        type: 'object',
...
exports.getQuickReplySwaggerSchema = getQuickReplySwaggerSchema;
/**
 * Swagger schema for CannedResponse.
 */
const getCannedResponseSwaggerSchema = () => {
    return {
        name: 'CannedResponse',
        type: 'object',
...
exports.getCannedResponseSwaggerSchema = getCannedResponseSwaggerSchema;
exports.default = {
    // Sequelize Models
    getMailTemplateModelAttributes: exports.getMailTemplateModelAttributes,
    getTemplateVersionModelAttributes: exports.getTemplateVersionModelAttributes,
    getTemplateLocalizationModelAttributes: exports.getTemplateLocalizationModelAttributes,
    getQuickReplyModelAttributes: exports.getQuickReplyModelAttributes,
    getCannedResponseModelAttributes: exports.getCannedResponseModelAttributes,
    // Template CRUD
    createMailTemplate: exports.createMailTemplate,
    getMailTemplateById: exports.getMailTemplateById,
    updateMailTemplate: exports.updateMailTemplate,
    deleteMailTemplate: exports.deleteMailTemplate,
    searchMailTemplates: exports.searchMailTemplates,
    // Template Rendering
    renderTemplate: exports.renderTemplate,
    renderMjmlTemplate: exports.renderMjmlTemplate,
    renderHandlebarsTemplate: exports.renderHandlebarsTemplate,
    ...
    // System Templates
    getSystemTemplate: exports.getSystemTemplate,
    createSystemTemplates: exports.createSystemTemplates,
    // Template Versioning
    ...
    // Template Localization
    createTemplateLocalization: exports.createTemplateLocalization,
    getTemplateLocalization: exports.getTemplateLocalization,
    listTemplateLocalizations: exports.listTemplateLocalizations,
    updateTemplateLocalization: exports.updateTemplateLocalization,
    // Template Access Control
    checkTemplatePermission: exports.checkTemplatePermission,
    updateTemplateAccessControl: exports.updateTemplateAccessControl,
    shareTemplate: exports.shareTemplate,
    // Quick Replies and Canned Responses
    createQuickReply: exports.createQuickReply,
    listQuickReplies: exports.listQuickReplies,
    useQuickReply: exports.useQuickReply,
    createCannedResponse: exports.createCannedResponse,
    listCannedResponses: exports.listCannedResponses,
    useCannedResponse: exports.useCannedResponse,
    // Template Categories
    getTemplatesByCategory: exports.getTemplatesByCategory,
    setTemplateAsDefault: exports.setTemplateAsDefault,
    getDefaultTemplateForCategory: exports.getDefaultTemplateForCategory,
    // Helpers
    stripHtmlTags: exports.stripHtmlTags,
    incrementTemplateUsage: exports.incrementTemplateUsage,
    // Swagger Documentation
    getMailTemplateSwaggerSchema: exports.getMailTemplateSwaggerSchema,
    getTemplateVariableSwaggerSchema: exports.getTemplateVariableSwaggerSchema,
    getTemplateCreateDtoSwaggerSchema: exports.getTemplateCreateDtoSwaggerSchema,
    getTemplateRenderContextSwaggerSchema: exports.getTemplateRenderContextSwaggerSchema,
    getQuickReplySwaggerSchema: exports.getQuickReplySwaggerSchema,
    getCannedResponseSwaggerSchema: exports.getCannedResponseSwaggerSchema,
};
//# sourceMappingURL=mail-templates-kit.js.map