 ...
 * ```
 */
export type PickByType<T, ValueType> = Pick<T, {
 ...
 * ```
 */
export type OmitByType<T, ValueType> = Pick<T, {
 ...
 * ```
 */
export type CamelCase<S extends string> = S extends `${infer First}_${infer Rest}` ? `${Lowercase<First>}${Capitalize<CamelCase<Rest>>}` : S extends `${infer First}-${infer Rest}` ? `${Lowercase<First>}${Capitalize<CamelCase<Rest>>}` : S extends `${infer First} ${infer Rest}` ? `${Lowercase<First>}${Capitalize<CamelCase<Rest>>}` : Lowercase<S>;
/**
 ...
 * ```
 */
export type SnakeCase<S extends string> = S extends `${infer First}${infer Rest}` ? First extends Uppercase<First> ? `_${Lowercase<First>}${SnakeCase<Rest>}` : `${First}${SnakeCase<Rest>}` : S;
/**
...
export type PathsToStringProps<T> = T extends string ? [] : {
    [K in Extract<keyof T, string>]: T[K] extends string ? [K] : T[K] extends object ? [K, ...PathsToStringProps<T[K]>] : never;
}[Extract<keyof T, string>] extends infer P ? P extends [] ? never : P extends [infer First, ...infer Rest] ? Rest extends [] ? First : `${First & string}.${PathsToStringProps<T[First & keyof T]> & string}` : never : never;
/**
 ...
 * ```
 */
export type GetByPath<T, P extends string> = P extends `${infer First}.${infer Rest}` ? First extends keyof T ? GetByPath<T[First], Rest> : never : P extends keyof T ? T[P] : never;
/**
 ...
 * ```
 */
export type SetByPath<T, P extends string, V> = P extends `${infer First}.${infer Rest}` ? First extends keyof T ? {
 ...
 * ```
 */
export type DeepPick<T, Path extends string> = Path extends `${infer First}.${infer Rest}` ? First extends keyof T ? {
    [K in First]: DeepPick<T[K], Rest>;
} : never : Path extends keyof T ? Pick<T, Path> : never;
/**
 ...
 * ```
 */
export declare function brand<T extends Brand<any, any>>(value: any): T;
/**
 ...
 * ```
 */
export declare function opaque<T extends Opaque<any, any>>(value: any): T;
/**
 ...
 * ```
 */
export declare function discriminate<T extends {
    tag: string;
}, K extends T['tag']>(union: T, tag: K): union is Extract<T, {
    tag: K;
}>;
/**
...
export type FluentBuilder<T, Built = {}> = {
    [K in Exclude<keyof T, keyof Built>]: (value: T[K]) => FluentBuilder<T, Built & Pick<T, K>>;
 ...
 * ```
 */
export declare function withDefaults<T extends object>(defaults: T, overrides?: Partial<T>): T;
/**
 ...
 * ```
 */
export declare function createStateMachine<States extends string, Events extends string>(initialState: States, transitions: Array<Transition<States, Events, States>>): StateMachine<States, Events>;
/**
 ...
 * ```
 */
export declare function deepPartial<T extends object>(obj: T): DeepPartial<T>;
/**
 ...
 * ```
 */
export declare function deepReadonly<T extends object>(obj: T): DeepReadonly<T>;
/**
 ...
 * ```
 */
export declare function pickByType<T extends object, V>(obj: T, predicate: (value: any) => value is V): Partial<PickByType<T, V>>;
/**
 ...
 * ```
 */
export declare function toCamelCaseKeys<T extends Record<string, any>>(obj: T): {
 ...
 * ```
 */
export declare function toSnakeCaseKeys<T extends Record<string, any>>(obj: T): any;
/**
 ...
 * ```
 */
export declare function getByPath<T extends object>(obj: T, path: string): any | undefined;
/**
 ...
 * ```
 */
export declare function setByPath<T extends object>(obj: T, path: string, value: any): T;
//# sourceMappingURL=typescript-advanced-utils.d.ts.map