...
interface VirtualResourceSchema {
  type: 'vm' | 'host' | 'datastore' | 'network' | 'cluster' | 'snapshot';
...
interface VirtualMachineStateSchema {
  state: 'running' | 'stopped' | 'suspended' | 'paused' | 'error';
  powerState: 'poweredOn' | 'poweredOff' | 'suspended';
  connectionState: 'connected' | 'disconnected' | 'orphaned';
}

interface HypervisorResourceSchema {
  cpu: {
    cores: number;
    threads: number;
    speed: number;
...
interface VirtualNetworkSchema {
  vlan: number;
  portGroup: string;
  vSwitch: string;
  nicType: 'vmxnet3' | 'e1000' | 'e1000e';
  macAddress: string;
  ipAddresses: string[];
}

interface VirtualStorageSchema {
  diskType: 'thick' | 'thin' | 'eagerZeroedThick';
...
interface SnapshotSchema {
  ...
  createdAt: string;
  size: number;
  state: VirtualMachineStateSchema;
  parent?: string;
  children?: string[];
}

interface VirtualApiVersionInfo {
  version: string;
  apiVersion: string;
  buildNumber: string;
 ...
 * ```
 */
export const createVirtualMachineSchema = (includeMetrics: boolean = false): Record<string, any> => {
 ...
 * ```
 */
export const createVMPowerOperationSchema = (
  operation: 'start' | 'stop' | 'restart' | 'suspend' | 'reset',
): Record<string, any> => {
  const baseSchema = {
    type: 'object',
 ...
 * ```
 */
export const createVMSnapshotSchema = (includeMemory: boolean = false): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createVMCloneSchema = (template: boolean = false): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createVMMigrationSchema = (storage: boolean = false): Record<string, any> => {
  const schema: Record<string, any> = {
    type: 'object',
 ...
 * ```
 */
export const createVMResourceAllocationSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createVMGuestCustomizationSchema = (osType: 'windows' | 'linux'): Record<string, any> => {
 ...
 * ```
 */
export const createVMConsoleSchema = (protocol: 'vnc' | 'rdp' | 'vmrc' | 'webmks'): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createHypervisorHostSchema = (includeHardware: boolean = false): Record<string, any> => {
  const schema: Record<string, any> = {
    type: 'object',
 ...
 * ```
 */
export const createHostMaintenanceModeSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createClusterSchema = (includeDRS: boolean = false, includeHA: boolean = false): Record<string, any> => {
  const schema: Record<string, any> = {
    type: 'object',
 ...
 * ```
 */
export const createDatastoreSchema = (type: 'vmfs' | 'nfs' | 'vsan' | 'vvol'): Record<string, any> => {
  const schema: Record<string, any> = {
    type: 'object',
 ...
 * ```
 */
export const createResourcePoolSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createVCenterSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createVirtualSwitchSchema = (type: 'standard' | 'distributed'): Record<string, any> => {
  const schema: Record<string, any> = {
    type: 'object',
 ...
 * ```
 */
export const createPortGroupSchema = (switchType: 'standard' | 'distributed'): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createVirtualNICSchema = (adapterType: 'vmxnet3' | 'e1000' | 'e1000e' | 'vmxnet2'): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createNSXNetworkSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createDistributedFirewallRuleSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createTaskStatusSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createTaskCancelSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createBatchOperationSchema = (operation: string): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createBatchOperationResultSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createScheduledTaskSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createTaskHistorySchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createApiVersionSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createApiHealthCheckSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createRateLimitSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createApiCapabilitySchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createApiDeprecationNoticeSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createVRealizeMetadataSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createVirtualErrorSchema = (statusCode: number): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createVMwareFaultSchema = (faultType: string): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createResourceQuotaErrorSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createConcurrentModificationErrorSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createInsufficientPermissionsErrorSchema = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createVirtualPaginatedResponse = (itemType: Type<any>, description: string): Record<string, any> => {
  return {
    type: 'object',
    description,
    properties: {
 ...
 * ```
 */
export const createAsyncOperationAcceptedResponse = (operation: string): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createBulkOperationResponse = (operation: string): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createExportOperationResponse = (format: 'ova' | 'ovf' | 'vmdk' | 'json'): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createImportValidationResponse = (): Record<string, any> => {
  return {
    type: 'object',
 ...
 * ```
 */
export const createMetricsCollectionResponse = (metricType: string): Record<string, any> => {
  return {
    type: 'object',
...
export default {
  ...
  createVMPowerOperationSchema,
  createVMSnapshotSchema,
  createVMCloneSchema,
  createVMMigrationSchema,
  createVMResourceAllocationSchema,
  createVMGuestCustomizationSchema,
  createVMConsoleSchema,

  // Hypervisor & Host Schemas
  createHypervisorHostSchema,
  createHostMaintenanceModeSchema,
  createClusterSchema,
  ...
  createVirtualSwitchSchema,
  createPortGroupSchema,
  createVirtualNICSchema,
  createNSXNetworkSchema,
  createDistributedFirewallRuleSchema,

  // Task & Async Operations
  createTaskStatusSchema,
  createTaskCancelSchema,
  createBatchOperationSchema,
  createBatchOperationResultSchema,
  createScheduledTaskSchema,
  createTaskHistorySchema,

  // API Versioning & Metadata
  createApiVersionSchema,
  createApiHealthCheckSchema,
  createRateLimitSchema,
  createApiCapabilitySchema,
  createApiDeprecationNoticeSchema,
  createVRealizeMetadataSchema,

  // Error & Validation
  createVirtualErrorSchema,
  createValidationErrorSchema,
  createVMwareFaultSchema,
  createResourceQuotaErrorSchema,
  createConcurrentModificationErrorSchema,
  createInsufficientPermissionsErrorSchema,

  // Response Helpers
  createVirtualPaginatedResponse,
  createAsyncOperationAcceptedResponse,
  createBulkOperationResponse,
  createExportOperationResponse,
  createImportValidationResponse,
  createMetricsCollectionResponse,
};
