...
interface ScheduleActivityData {
  ...
  duration: number;
  durationType: 'working_days' | 'calendar_days' | 'hours';
  ...
  successorIds?: string[];
  constraintType?: 'start_no_earlier' | 'finish_no_later' | 'must_start_on' | 'must_finish_on';
  constraintDate?: Date;
  isCritical: boolean;
  isMilestone: boolean;
}
...
interface ActivityRelationship {
  ...
  lagDays: number;
  lagType: 'working_days' | 'calendar_days';
}
...
interface CriticalPathResult {
  ...
  criticalPath: string[];
  totalDuration: number;
  criticalActivities: ScheduleActivityData[];
  nearCriticalActivities: ScheduleActivityData[];
...
interface ScheduleCompressionAnalysis {
  originalDuration: number;
  targetDuration: number;
  compressionMethod: 'crashing' | 'fast_tracking' | 'hybrid';
  compressedActivities: CompressedActivity[];
...
interface DelayAnalysis {
  ...
  analysisDate: Date;
  delayDays: number;
  delayType: 'excusable' | 'compensable' | 'concurrent' | 'non_excusable';
  rootCause: string;
  responsibleParty: string;
...
interface ResourceLevelingResult {
  ...
  leveledFinishDate: Date;
  scheduleImpact: number;
  overallocatedResources: number;
  resolvedAllocations: number;
  leveledActivities: LeveledActivity[];
}

interface LeveledActivity {
  activityId: string;
  activityName: string;
  originalStartDate: Date;
  leveledStartDate: Date;
  delayDays: number;
...
/**
 * Sequelize model for Schedule Activities with CPM calculations.
 *
 * @swagger
 * @openapi
 * components:
 ...
 * @returns {Model} ScheduleActivity model
 *
 * @example
 * ```typescript
 * const ScheduleActivity = createScheduleActivityModel(sequelize);
 ...
 * ```
 */
export const createScheduleActivityModel = (sequelize: Sequelize) => {
  class ScheduleActivity extends Model {
    ...
    public phase!: string;
    public workPackageId!: string | null;
    public duration!: number;
    public durationType!: string;
    public plannedStartDate!: Date;
    public plannedFinishDate!: Date;
    public actualStartDate!: Date | null;
    public actualFinishDate!: Date | null;
    public forecastStartDate!: Date | null;
    public forecastFinishDate!: Date | null;
    public earlyStartDate!: Date | null;
    public earlyFinishDate!: Date | null;
    public lateStartDate!: Date | null;
    public lateFinishDate!: Date | null;
    public totalFloat!: number;
    public freeFloat!: number;
    public status!: string;
    public percentComplete!: number;
    public constraintType!: string | null;
    public constraintDate!: Date | null;
    public isCritical!: boolean;
    public isMilestone!: boolean;
    public baselineStartDate!: Date | null;
    public baselineFinishDate!: Date | null;
    public baselineDuration!: number | null;
    public metadata!: Record<string, any>;
    public readonly createdAt!: Date;
    public readonly updatedAt!: Date;
  }

  ScheduleActivity.init(
    {
      id: {
        type: DataTypes.UUID,
      ...
      discipline: {
        ...
        allowNull: false,
        defaultValue: '',
        comment: 'Construction discipline',
      },
      phase: {
        type: DataTypes.STRING(100),
        allowNull: false,
      ...
      workPackageId: {
        type: DataTypes.STRING(50),
        allowNull: true,
        comment: 'Work package identifier',
      },
      duration: {
        type: DataTypes.INTEGER,
        allowNull: false,
        comment: 'Activity duration',
        validate: {
          min: 0,
        },
      },
      durationType: {
        type: DataTypes.ENUM('working_days', 'calendar_days', 'hours'),
        allowNull: false,
      ...
      forecastStartDate: {
        type: DataTypes.DATE,
        allowNull: true,
        comment: 'Forecasted start date',
      },
      forecastFinishDate: {
        type: DataTypes.DATE,
        allowNull: true,
        comment: 'Forecasted finish date',
      },
      earlyStartDate: {
        type: DataTypes.DATE,
        allowNull: true,
        comment: 'CPM early start',
      },
      earlyFinishDate: {
        type: DataTypes.DATE,
        allowNull: true,
        comment: 'CPM early finish',
      },
      lateStartDate: {
        type: DataTypes.DATE,
        allowNull: true,
        comment: 'CPM late start',
      },
      lateFinishDate: {
        type: DataTypes.DATE,
        allowNull: true,
        comment: 'CPM late finish',
      },
      totalFloat: {
        type: DataTypes.INTEGER,
        allowNull: false,
        defaultValue: 0,
        comment: 'Total float (days)',
      },
      freeFloat: {
        type: DataTypes.INTEGER,
        allowNull: false,
        defaultValue: 0,
        comment: 'Free float (days)',
      },
      status: {
        type: DataTypes.ENUM('not_started', 'in_progress', 'completed', 'suspended', 'cancelled'),
        allowNull: false,
      ...
      constraintType: {
        type: DataTypes.ENUM('start_no_earlier', 'finish_no_later', 'must_start_on', 'must_finish_on', 'as_late_as_possible'),
        allowNull: true,
        comment: 'Schedule constraint type',
      },
      constraintDate: {
        type: DataTypes.DATE,
        allowNull: true,
        comment: 'Constraint date',
      },
      isCritical: {
        type: DataTypes.BOOLEAN,
        allowNull: false,
        defaultValue: false,
        comment: 'Is on critical path',
      },
      isMilestone: {
        type: DataTypes.BOOLEAN,
        allowNull: false,
        defaultValue: false,
        comment: 'Is milestone activity',
      },
      baselineStartDate: {
        type: DataTypes.DATE,
        allowNull: true,
      ...
      baselineFinishDate: {
        type: DataTypes.DATE,
        allowNull: true,
        comment: 'Baseline finish date',
      },
      baselineDuration: {
        type: DataTypes.INTEGER,
        allowNull: true,
        comment: 'Baseline duration',
      },
      metadata: {
        type: DataTypes.JSON,
        allowNull: false,
...
/**
 * Sequelize model for Activity Relationships (dependencies).
 *
 * @param {Sequelize} sequelize - Sequelize instance
 * @returns {Model} ActivityRelationship model
 *
 * @example
 * ```typescript
 * const ActivityRelationship = createActivityRelationshipModel(sequelize);
 ...
 * ```
 */
export const createActivityRelationshipModel = (sequelize: Sequelize) => {
  class ActivityRelationship extends Model {
    public id!: string;
    public projectId!: string;
    public predecessorActivityId!: string;
    public successorActivityId!: string;
  ...
  ActivityRelationship.init(
    {
      ...
      predecessorActivityId: {
        type: DataTypes.STRING(50),
        allowNull: false,
        comment: 'Predecessor activity ID',
      },
      successorActivityId: {
        type: DataTypes.STRING(50),
        allowNull: false,
        comment: 'Successor activity ID',
      },
      relationshipType: {
        type: DataTypes.ENUM('FS', 'SS', 'FF', 'SF'),
        allowNull: false,
        defaultValue: 'FS',
        comment: 'Relationship type (Finish-to-Start, etc.)',
      },
      lagDays: {
        type: DataTypes.INTEGER,
        allowNull: false,
        defaultValue: 0,
        comment: 'Lag days (positive) or lead (negative)',
      },
      lagType: {
        type: DataTypes.ENUM('working_days', 'calendar_days'),
        allowNull: false,
        defaultValue: 'working_days',
        comment: 'Lag type',
      },
      isDriving: {
        ...
        allowNull: false,
        defaultValue: false,
        comment: 'Is driving relationship for successor',
      },
      metadata: {
        type: DataTypes.JSON,
        allowNull: false,
...
/**
 * Sequelize model for Resource Assignments.
 *
 * @param {Sequelize} sequelize - Sequelize instance
 * @returns {Model} ResourceAssignment model
 */
export const createResourceAssignmentModel = (sequelize: Sequelize) => {
  ...
  ResourceAssignment.init(
    {
      ...
      resourceType: {
        type: DataTypes.ENUM('labor', 'equipment', 'material', 'subcontractor'),
        allowNull: false,
      ...
      unitsRequired: {
        ...
        allowNull: false,
        comment: 'Units required',
      },
      unitsAvailable: {
        type: DataTypes.DECIMAL(10, 2),
        allowNull: false,
        comment: 'Units available',
      },
      utilizationPercent: {
        type: DataTypes.DECIMAL(5, 2),
        allowNull: false,
        defaultValue: 0,
        comment: 'Resource utilization %',
      },
      costPerUnit: {
        type: DataTypes.DECIMAL(10, 2),
        allowNull: false,
      ...
      startDate: {
        type: DataTypes.DATE,
        allowNull: false,
        comment: 'Resource start date',
      },
      endDate: {
        type: DataTypes.DATE,
        allowNull: false,
        comment: 'Resource end date',
      },
      isOverallocated: {
        type: DataTypes.BOOLEAN,
        allowNull: false,
        defaultValue: false,
        comment: 'Resource overallocation flag',
      },
      metadata: {
        type: DataTypes.JSON,
        allowNull: false,
