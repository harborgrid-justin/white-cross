...
/**
 * Document types in construction projects
 */
...
export enum DocumentStatus {
  ...
  ISSUED_FOR_BIDDING = 'issued_for_bidding',
  ISSUED_FOR_PERMIT = 'issued_for_permit',
  AS_BUILT = 'as_built',
}

/**
 * Document discipline categories
 */
...
/**
 * Construction Document Model
 * Represents a construction project document with version control and metadata
 */
 ...
 * Tracks all revisions and changes to construction documents
 */
...
/**
 * Document Distribution Model
 * Tracks document distribution, delivery, and acknowledgment
 */
...
export interface DocumentStatistics {
  ...
  documentsByDiscipline: Record<DocumentDiscipline, number>;
...
export class CreateDocumentDto {
  ...
  @ApiProperty({ enum: DocumentDiscipline, description: 'Document discipline' })
  @IsEnum(DocumentDiscipline)
  discipline: DocumentDiscipline;
...
export class CreateRevisionDto {
  ...
  @ApiProperty({ enum: RevisionType, description: 'Revision type' })
  @IsEnum(RevisionType)
  revisionType: RevisionType;

  @ApiProperty({ description: 'Revision description' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(2000)
  description: string;

  @ApiProperty({ description: 'File URL for revised document' })
  @IsString()
  @IsNotEmpty()
  fileUrl: string;

  @ApiProperty({ description: 'Revision changes', type: 'array' })
  @IsArray()
...
export class DistributeDocumentDto {
  ...
  @ApiProperty({ description: 'Recipient IDs', type: [String] })
  @IsArray()
  @IsUUID('4', { each: true })
  ...
  @ApiProperty({ description: 'Requires signature', required: false })
  @IsOptional()
  @IsBoolean()
  requiresSignature?: boolean;
}
...
export class AcknowledgeDocumentDto {
  ...
  @ApiProperty({ description: 'Acknowledgment notes', required: false })
  @IsOptional()
  @IsString()
  @MaxLength(500)
  notes?: string;
