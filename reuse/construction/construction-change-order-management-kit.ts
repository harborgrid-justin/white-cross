...
export class CreateChangeRequestDto {
  ...
  @ApiProperty({ enum: ChangeCategory })
  ...
  @ApiProperty({ description: 'Required by date', required: false })
  @IsOptional()
  @Type(() => Date)
  @IsDate()
  requiredByDate?: Date;
...
/**
 * Create impact analysis DTO
 */
export class CreateImpactAnalysisDto {
  ...
  @ApiProperty({ description: 'Equipment cost' })
  @IsNumber()
  @Min(0)
  equipmentCost: number;

  @ApiProperty({ description: 'Schedule impact in days' })
  @IsNumber()
  timeImpact: number;

  @ApiProperty({ description: 'Critical path affected' })
  @IsBoolean()
  criticalPathAffected: boolean;
...
export class CreatePricingDto {
  ...
  @ApiProperty({ enum: PricingMethod })
  ...
  @ApiProperty({ description: 'Contingency amount' })
  @IsNumber()
  @Min(0)
  contingency: number;
...
export class CreateNegotiationDto {
  ...
  @ApiProperty({ description: 'Proposed time impact' })
  @IsNumber()
  proposedTimeImpact: number;
...
export class UpdateChangeRequestDto {
  ...
  @ApiProperty({ enum: ChangeRequestStatus, required: false })
  @IsOptional()
