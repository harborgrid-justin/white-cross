...
/**
 * Inspection types in construction projects
 */
...
/**
 * Construction Inspection Model
 * Represents a construction inspection with scheduling and results
 */
 ...
 * Tracks deficiencies and non-compliance issues found during inspections
 */
 ...
 * Tracks individual checklist items for inspections
 */
...
export interface InspectionScheduleRequest {
  inspectionType: InspectionType;
  projectId: string;
  location: string;
  scheduledDate: Date;
...
export interface InspectionStatistics {
  ...
  inspectionsByResult: Record<InspectionResult, number>;
  passRate: number;
...
/**
 * Schedule inspection DTO
 */
export class ScheduleInspectionDto {
  @ApiProperty({ enum: InspectionType, description: 'Inspection type' })
  ...
  @ApiProperty({ description: 'Inspection location' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(500)
  location: string;
  ...
  @ApiProperty({ description: 'Floor level', required: false })
  @IsOptional()
  @IsString()
  @MaxLength(100)
  level?: string;
  ...
  @ApiProperty({ description: 'Permit ID', required: false })
  @IsOptional()
  @IsUUID()
  permitId?: string;
}
...
export class CompleteInspectionDto {
  ...
  @ApiProperty({ description: 'Inspector comments' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(2000)
  comments: string;
  ...
  @ApiProperty({ description: 'Requires reinspection', required: false })
  @IsOptional()
  @IsBoolean()
  requiresReinspection?: boolean;
}
...
export class CreateDeficiencyDto {
  ...
  @ApiProperty({ description: 'Deficiency title' })
  @IsString()
  @IsNotEmpty()
  @MinLength(3)
  @MaxLength(500)
  ...
  @ApiProperty({ description: 'Deficiency description' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(2000)
  description: string;
  ...
  @ApiProperty({ enum: DeficiencySeverity, description: 'Severity level' })
  @IsEnum(DeficiencySeverity)
  severity: DeficiencySeverity;

  @ApiProperty({ description: 'Code reference', required: false })
  @IsOptional()
  @IsString()
  @MaxLength(500)
  codeReference?: string;

  @ApiProperty({ description: 'Required action', required: false })
  @IsOptional()
  @IsString()
  @MaxLength(2000)
  requiredAction?: string;
...
/**
 * Verify deficiency DTO
 */
export class VerifyDeficiencyDto {
  ...
  @ApiProperty({ description: 'Approved', required: false })
  @IsOptional()
  @IsBoolean()
  approved?: boolean;
}
