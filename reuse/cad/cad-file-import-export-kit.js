...
exports.parseDWGFile = parseDWGFile;
exports.parseDXFFile = parseDXFFile;
exports.exportToDWG = exportToDWG;
exports.exportToDXF = exportToDXF;
exports.exportToSVG = exportToSVG;
exports.exportToPDF = exportToPDF;
exports.importFromDWG = importFromDWG;
exports.importFromDXF = importFromDXF;
exports.importFromSVG = importFromSVG;
exports.validateFileFormat = validateFileFormat;
exports.convertDWGToDXF = convertDWGToDXF;
exports.convertDXFToDWG = convertDXFToDWG;
...
exports.parseEntitySection = parseEntitySection;
exports.parseLayerSection = parseLayerSection;
exports.parseBlockSection = parseBlockSection;
exports.exportEntities = exportEntities;
exports.exportLayers = exportLayers;
exports.exportBlocks = exportBlocks;
...
exports.repairCorruptedFile = repairCorruptedFile;
exports.mergeCADFiles = mergeCADFiles;
exports.splitCADFile = splitCADFile;
exports.extractPageFromFile = extractPageFromFile;
exports.batchImport = batchImport;
exports.batchExport = batchExport;
exports.streamFileImport = streamFileImport;
exports.streamFileExport = streamFileExport;
exports.parseFileReferences = parseFileReferences;
exports.resolveExternalReferences = resolveExternalReferences;
exports.embedExternalReferences = embedExternalReferences;
exports.optimizeFileSize = optimizeFileSize;
exports.cleanupUnusedData = cleanupUnusedData;
exports.validateDWGVersion = validateDWGVersion;
 ...
 */
async function parseDWGFile(params) {
    const logger = new common_1.Logger('parseDWGFile');
 ...
 * @returns Result with success status and data
 */
async function parseDXFFile(params) {
    const logger = new common_1.Logger('parseDXFFile');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function exportToDWG(params) {
    const logger = new common_1.Logger('exportToDWG');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function exportToDXF(params) {
    const logger = new common_1.Logger('exportToDXF');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function exportToSVG(params) {
    const logger = new common_1.Logger('exportToSVG');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
...
async function exportToPDF(params) {
    const logger = new common_1.Logger('exportToPDF');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function importFromDWG(params) {
    const logger = new common_1.Logger('importFromDWG');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function importFromDXF(params) {
    const logger = new common_1.Logger('importFromDXF');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function importFromSVG(params) {
    const logger = new common_1.Logger('importFromSVG');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function validateFileFormat(params) {
    const logger = new common_1.Logger('validateFileFormat');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function convertDWGToDXF(params) {
    const logger = new common_1.Logger('convertDWGToDXF');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function convertDXFToDWG(params) {
    const logger = new common_1.Logger('convertDXFToDWG');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function extractFileMetadata(params) {
    const logger = new common_1.Logger('extractFileMetadata');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function readFileHeader(params) {
    const logger = new common_1.Logger('readFileHeader');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function writeFileHeader(params) {
    const logger = new common_1.Logger('writeFileHeader');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function parseEntitySection(params) {
    const logger = new common_1.Logger('parseEntitySection');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function parseLayerSection(params) {
    const logger = new common_1.Logger('parseLayerSection');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function parseBlockSection(params) {
    const logger = new common_1.Logger('parseBlockSection');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function exportEntities(params) {
    const logger = new common_1.Logger('exportEntities');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function exportLayers(params) {
    const logger = new common_1.Logger('exportLayers');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function exportBlocks(params) {
    const logger = new common_1.Logger('exportBlocks');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function compressFile(params) {
    const logger = new common_1.Logger('compressFile');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
...
async function decompressFile(params) {
    const logger = new common_1.Logger('decompressFile');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
...
async function encryptFile(params) {
    const logger = new common_1.Logger('encryptFile');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
...
async function decryptFile(params) {
    const logger = new common_1.Logger('decryptFile');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function validateFileIntegrity(params) {
    const logger = new common_1.Logger('validateFileIntegrity');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function repairCorruptedFile(params) {
    const logger = new common_1.Logger('repairCorruptedFile');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function mergeCADFiles(params) {
    const logger = new common_1.Logger('mergeCADFiles');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function splitCADFile(params) {
    const logger = new common_1.Logger('splitCADFile');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function extractPageFromFile(params) {
    const logger = new common_1.Logger('extractPageFromFile');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function batchImport(params) {
    const logger = new common_1.Logger('batchImport');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function batchExport(params) {
    const logger = new common_1.Logger('batchExport');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function streamFileImport(params) {
    const logger = new common_1.Logger('streamFileImport');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function streamFileExport(params) {
    const logger = new common_1.Logger('streamFileExport');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function parseFileReferences(params) {
    const logger = new common_1.Logger('parseFileReferences');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function resolveExternalReferences(params) {
    const logger = new common_1.Logger('resolveExternalReferences');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function embedExternalReferences(params) {
    const logger = new common_1.Logger('embedExternalReferences');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function optimizeFileSize(params) {
    const logger = new common_1.Logger('optimizeFileSize');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function cleanupUnusedData(params) {
    const logger = new common_1.Logger('cleanupUnusedData');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function validateDWGVersion(params) {
    const logger = new common_1.Logger('validateDWGVersion');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
...
// NESTJS SERVICE
// ============================================================================
let FileimportexportService = (() => {
    let _classDecorators = [(0, common_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var FileimportexportService = _classThis = class {
        constructor(sequelize) {
            this.sequelize = sequelize;
            this.logger = new common_1.Logger(FileimportexportService.name);
        }
        async findAll(query) {
    ...
    __setFunctionName(_classThis, "FileimportexportService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        FileimportexportService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FileimportexportService = _classThis;
})();
exports.FileimportexportService = FileimportexportService;
// ============================================================================
// NESTJS CONTROLLER
// ============================================================================
let FileimportexportController = (() => {
    let _classDecorators = [(0, swagger_1.ApiTags)('file-import-export'), (0, common_1.Controller)('cad/file-import-export'), (0, swagger_1.ApiBearerAuth)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    ...
    var FileimportexportController = _classThis = class {
        constructor(service) {
    ...
    __setFunctionName(_classThis, "FileimportexportController");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        ...
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        FileimportexportController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FileimportexportController = _classThis;
})();
exports.FileimportexportController = FileimportexportController;
// ============================================================================
...
//# sourceMappingURL=cad-file-import-export-kit.js.map