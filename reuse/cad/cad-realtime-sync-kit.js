...
exports.applyRemoteChange = applyRemoteChange;
exports.resolveConflict = resolveConflict;
exports.lockEntity = lockEntity;
exports.unlockEntity = unlockEntity;
exports.requestEntityLock = requestEntityLock;
exports.releaseEntityLock = releaseEntityLock;
exports.checkLockStatus = checkLockStatus;
exports.sendCursorPosition = sendCursorPosition;
exports.receiveCursorPosition = receiveCursorPosition;
exports.showRemoteCursor = showRemoteCursor;
exports.hideRemoteCursor = hideRemoteCursor;
exports.createPresenceIndicator = createPresenceIndicator;
exports.updatePresenceStatus = updatePresenceStatus;
exports.broadcastSelection = broadcastSelection;
exports.syncViewport = syncViewport;
exports.syncLayers = syncLayers;
exports.syncEntities = syncEntities;
exports.queueChangeForSync = queueChangeForSync;
exports.flushSyncQueue = flushSyncQueue;
exports.pauseSync = pauseSync;
exports.resumeSync = resumeSync;
exports.createSnapshot = createSnapshot;
exports.applySnapshot = applySnapshot;
exports.detectNetworkLatency = detectNetworkLatency;
exports.optimizeBandwidth = optimizeBandwidth;
...
exports.recoverLostConnection = recoverLostConnection;
exports.validateSyncState = validateSyncState;
exports.createConflictResolutionStrategy = createConflictResolutionStrategy;
exports.notifyCollaborators = notifyCollaborators;
exports.trackActiveUsers = trackActiveUsers;
 ...
 */
async function initializeWebSocket(params) {
    const logger = new common_1.Logger('initializeWebSocket');
 ...
 * @returns Result with success status and data
 */
async function connectToSession(params) {
    const logger = new common_1.Logger('connectToSession');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function disconnectFromSession(params) {
    const logger = new common_1.Logger('disconnectFromSession');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function broadcastChange(params) {
    const logger = new common_1.Logger('broadcastChange');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function receiveChange(params) {
    const logger = new common_1.Logger('receiveChange');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function applyRemoteChange(params) {
    const logger = new common_1.Logger('applyRemoteChange');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
...
async function resolveConflict(params) {
    const logger = new common_1.Logger('resolveConflict');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function requestEntityLock(params) {
    const logger = new common_1.Logger('requestEntityLock');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function releaseEntityLock(params) {
    const logger = new common_1.Logger('releaseEntityLock');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function checkLockStatus(params) {
    const logger = new common_1.Logger('checkLockStatus');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function sendCursorPosition(params) {
    const logger = new common_1.Logger('sendCursorPosition');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function receiveCursorPosition(params) {
    const logger = new common_1.Logger('receiveCursorPosition');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function showRemoteCursor(params) {
    const logger = new common_1.Logger('showRemoteCursor');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function hideRemoteCursor(params) {
    const logger = new common_1.Logger('hideRemoteCursor');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function createPresenceIndicator(params) {
    const logger = new common_1.Logger('createPresenceIndicator');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function updatePresenceStatus(params) {
    const logger = new common_1.Logger('updatePresenceStatus');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function broadcastSelection(params) {
    const logger = new common_1.Logger('broadcastSelection');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function syncViewport(params) {
    const logger = new common_1.Logger('syncViewport');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function syncLayers(params) {
    const logger = new common_1.Logger('syncLayers');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function syncEntities(params) {
    const logger = new common_1.Logger('syncEntities');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function queueChangeForSync(params) {
    const logger = new common_1.Logger('queueChangeForSync');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function flushSyncQueue(params) {
    const logger = new common_1.Logger('flushSyncQueue');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function pauseSync(params) {
    const logger = new common_1.Logger('pauseSync');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function resumeSync(params) {
    const logger = new common_1.Logger('resumeSync');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
...
async function createSnapshot(params) {
    const logger = new common_1.Logger('createSnapshot');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function applySnapshot(params) {
    const logger = new common_1.Logger('applySnapshot');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function detectNetworkLatency(params) {
    const logger = new common_1.Logger('detectNetworkLatency');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function optimizeBandwidth(params) {
    const logger = new common_1.Logger('optimizeBandwidth');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function compressPayload(params) {
    const logger = new common_1.Logger('compressPayload');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function decompressPayload(params) {
    const logger = new common_1.Logger('decompressPayload');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function enableOfflineMode(params) {
    const logger = new common_1.Logger('enableOfflineMode');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function syncOfflineChanges(params) {
    const logger = new common_1.Logger('syncOfflineChanges');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function handleReconnection(params) {
    const logger = new common_1.Logger('handleReconnection');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function recoverLostConnection(params) {
    const logger = new common_1.Logger('recoverLostConnection');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function validateSyncState(params) {
    const logger = new common_1.Logger('validateSyncState');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function createConflictResolutionStrategy(params) {
    const logger = new common_1.Logger('createConflictResolutionStrategy');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function notifyCollaborators(params) {
    const logger = new common_1.Logger('notifyCollaborators');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
 ...
 * @returns Result with success status and data
 */
async function trackActiveUsers(params) {
    const logger = new common_1.Logger('trackActiveUsers');
    const startTime = Date.now();
    try {
        if (!params)
            throw new common_1.HttpException('Parameters required', common_1.HttpStatus.BAD_REQUEST);
...
let RealtimesyncService = (() => {
    ...
    let _classThis;
    var RealtimesyncService = _classThis = class {
        constructor(sequelize) {
            this.sequelize = sequelize;
            this.logger = new common_1.Logger(RealtimesyncService.name);
        }
        async findAll(query) {
    ...
    __setFunctionName(_classThis, "RealtimesyncService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        RealtimesyncService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RealtimesyncService = _classThis;
})();
exports.RealtimesyncService = RealtimesyncService;
// ============================================================================
// NESTJS CONTROLLER
// ============================================================================
let RealtimesyncController = (() => {
    let _classDecorators = [(0, swagger_1.ApiTags)('realtime-sync'), (0, common_1.Controller)('cad/realtime-sync'), (0, swagger_1.ApiBearerAuth)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    ...
    var RealtimesyncController = _classThis = class {
        constructor(service) {
    ...
    __setFunctionName(_classThis, "RealtimesyncController");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        ...
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        RealtimesyncController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RealtimesyncController = _classThis;
})();
exports.RealtimesyncController = RealtimesyncController;
// ============================================================================
...
//# sourceMappingURL=cad-realtime-sync-kit.js.map