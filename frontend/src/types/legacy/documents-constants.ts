/**
 * WF-COMP-323 | documents-constants.ts - Document constants and mappings
 * Purpose: Constants, label mappings, and configuration values
 * Upstream: ./documents-core | Dependencies: ./documents-core
 * Downstream: Components, services, utilities
 * Related: Document UI components, validation utilities
 * Exports: Label mappings, file type configs, retention policies
 * Last Updated: 2025-11-12 | File Type: .ts
 * Critical Path: Configuration and display values for document system
 * LLM Context: Constants and configuration for document management
 */

/**
 * Document Constants and Mappings
 * Configuration values, label mappings, and system constants
 */
