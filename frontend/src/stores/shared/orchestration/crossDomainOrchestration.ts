...
const orchestrationSlice = createSlice({
  ...
  reducers: {
    ...
    updateOrchestrationWorkflow: (state, action: PayloadAction<OrchestrationWorkflow>) => {
      state.workflows[action.payload.id] = action.payload;
    },
...
export const { addWorkflow, updateOrchestrationWorkflow, addExecution, updateExecution, scheduleExecution } = orchestrationSlice.actions;
