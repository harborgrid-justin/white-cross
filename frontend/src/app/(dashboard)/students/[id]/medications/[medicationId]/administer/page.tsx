 ...
 * @module app/(dashboard)/students/[id]/medications/[medicationId]/administer
 *
...
export default async function AdministerMedicationToStudentPage({ params }: AdministerMedicationToStudentPageProps) {
  const data = await getDataForAdministration(params.id, params.medicationId);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        backLink={`/students/${params.id}/medications/${params.medicationId}`}
