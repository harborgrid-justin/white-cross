 ...
 * Displays different content based on user authentication state, highlighting platform
 * features and providing clear calls-to-action.
 *
 * **Redux State:**
 * - `auth.user` - Current user information
 * - `auth.isAuthenticated` - Authentication status flag
 *
 * **Layout Structure:**
 * ```
 * <Header>
 *   - Logo
 *   - Navigation (conditional on auth state)
 * </Header>
 * <Main>
 ...
 * Welcome, John Doe [Dashboard Button]
 *
