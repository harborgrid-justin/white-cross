...
interface AccessControlState {
  ...
  filters: {
    incidents: SecurityIncidentFilters;
    sessions: SessionFilters;
  };
  pagination: {
    roles: PaginationParams;
    permissions: PaginationParams;
    incidents: PaginationParams;
    sessions: PaginationParams;
  };
  loading: {
    roles: boolean;
    permissions: boolean;
...
export const updateRole = createAsyncThunk<
  Role,
  { id: string; updates: UpdateRoleData },
  { rejectValue: string }
>(
...
export const fetchSecurityIncidents = createAsyncThunk<
  { incidents: SecurityIncident[]; pagination?: PaginationParams },
  SecurityIncidentFilters | undefined,
  { rejectValue: string }
>(
...
export const updateSecurityIncident = createAsyncThunk<
  SecurityIncident,
  { id: string; updates: UpdateSecurityIncidentData },
  { rejectValue: string }
>(
...
const accessControlSlice = createSlice({
  ...
  reducers: {
    ...
    setIncidentFilters: (state, action: PayloadAction<Partial<SecurityIncidentFilters>>) => {
    ...
    setRolesPagination: (state, action: PayloadAction<Partial<PaginationParams>>) => {
      state.pagination.roles = { ...state.pagination.roles, ...action.payload };
    },
    setPermissionsPagination: (state, action: PayloadAction<Partial<PaginationParams>>) => {
      state.pagination.permissions = { ...state.pagination.permissions, ...action.payload };
    },
    setIncidentsPagination: (state, action: PayloadAction<Partial<PaginationParams>>) => {
      state.pagination.incidents = { ...state.pagination.incidents, ...action.payload };
    },
    setSessionsPagination: (state, action: PayloadAction<Partial<PaginationParams>>) => {
...
export const selectIncidentFilters = (state: RootState): SecurityIncidentFilters =>
...
export const selectRolesPagination = (state: RootState): PaginationParams =>
  state.accessControl.pagination.roles;

export const selectPermissionsPagination = (state: RootState): PaginationParams =>
  state.accessControl.pagination.permissions;

export const selectIncidentsPagination = (state: RootState): PaginationParams =>
  state.accessControl.pagination.incidents;

export const selectSessionsPagination = (state: RootState): PaginationParams =>
