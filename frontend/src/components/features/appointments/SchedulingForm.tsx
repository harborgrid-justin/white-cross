  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="rounded-md bg-blue-50 p-4" role="status" aria-live="polite">
          <div className="flex">
            <div className="flex-shrink-0">
              <svg className="h-5 w-5 text-blue-400 animate-spin" fill="none" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <button
                ...
                aria-label="Find available time slots to resolve conflict"
              >
                Find available time slots
              </button>
            </div>
      ...
      {showAvailableSlots && availableSlots.length > 0 && (
        <div className="rounded-md bg-green-50 p-4" role="region" aria-label="Available time slots">
