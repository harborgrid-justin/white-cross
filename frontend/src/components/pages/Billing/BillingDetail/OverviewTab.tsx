/**
 * @fileoverview BillingDetail Overview Tab Component
 * @module components/pages/Billing/BillingDetail/OverviewTab
 ...
 * 
 * Displays comprehensive invoice overview including status, amounts,
 * patient information, dates, and insurance details.
 */
const OverviewTab: React.FC<OverviewTabProps> = ({
  ...
  const paymentPercentage = getPaymentPercentage(invoice.totalAmount, invoice.amountPaid);
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className={`text-lg font-bold ${getBalanceDueColor(invoice.balanceDue)}`}>
            ...
            <div className="mt-4">
              ...
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div 
                  className={`h-3 rounded-full transition-all duration-300 ${getPaymentProgressColor(paymentPercentage)}`}
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getInsuranceStatusColor(invoice.insuranceStatus)}`}>
                {invoice.insuranceStatus ? capitalizeFirst(invoice.insuranceStatus) : 'Pending'}
              </span>
            </div>
          </div>
        </div>
