/**
 * @fileoverview OAuth Authentication Buttons Component
 * 
 * OAuth buttons for Google and Microsoft authentication.
 * 
 * @module components/auth/LoginForm/OAuthButtons
 * @since 1.0.0
 */
 ...
 * 
 * Renders Google and Microsoft OAuth authentication buttons.
 */
