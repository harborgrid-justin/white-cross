...
const Alert = React.forwardRef<HTMLDivElement, AlertProps>(
  ({
    ...
    const defaultIcons = {
      default: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true" focusable="false">
          ...
          {dismissible && (
            <div className="flex-shrink-0 ml-3">
              ...
              >
                ...
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true" focusable="false">
