...
"[project]/src/config/queryClient.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ const queryCache = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$core$2f$build$2f$modern$2f$queryCache$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QueryCache"]({
    onError: (error, query)=>{
        ...
        if (meta?.auditLog && ("TURBOPACK compile-time value", "object") !== 'undefined') {
    ...
    onSuccess: (data, query)=>{
        const meta = query.meta;
        // Log audit trail for PHI-related queries
        if (meta?.auditLog && meta?.containsPHI && ("TURBOPACK compile-time value", "object") !== 'undefined') {
 ...
 */ const mutationCache = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$core$2f$build$2f$modern$2f$mutationCache$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MutationCache"]({
    onSuccess: (data, variables, context, mutation)=>{
        const meta = mutation.meta;
        // Show success message
        if (meta?.successMessage) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(meta.successMessage);
        }
        // Log audit trail for PHI-affecting mutations
        if (meta?.affectsPHI && ("TURBOPACK compile-time value", "object") !== 'undefined') {
...
"[project]/src/constants/config.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const API_CONFIG = {
   ...
   */ INTERNAL_API_URL: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.INTERNAL_API_URL || ("TURBOPACK compile-time value", "http://localhost:3001") || 'http://localhost:3001',
    /**
...
const FEATURE_FLAGS = {
    ENABLE_DEBUG_LOGGING: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_ENABLE_DEBUG === 'true',
    ENABLE_ANALYTICS: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_ENABLE_ANALYTICS === 'true'
};
const SECURITY_CONFIG = {
   ...
   * Encryption settings
   */ ENCRYPTION: {
        /** Whether to encrypt tokens in storage */ ENABLED: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_ENCRYPT_TOKENS === 'true',
...
"[project]/src/services/security/CsrfProtection.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/services/security/tokenManager/storage.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class TokenStorage {
   ...
   */ static setTokenData(metadata) {
        if (("TURBOPACK compile-time value", "object") === 'undefined' || typeof sessionStorage === 'undefined') {
   ...
   */ static hasTokenData() {
        ...
        return !!(sessionStorage.getItem(STORAGE_KEYS.TOKEN_KEY) || sessionStorage.getItem(STORAGE_KEYS.METADATA_KEY));
    }
    /**
...
"[project]/src/services/security/tokenManager/validation.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/constants/config.ts [app-client] (ecmascript)");
;
class JwtParser {
    /**
...
class TokenValidator {
   ...
   */ static validateToken(metadata) {
        ...
        const inactivityThreshold = metadata.lastActivity + __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SECURITY_CONFIG"].INACTIVITY_TIMEOUT;
   ...
   */ static isApproachingInactivityTimeout(metadata, warningThresholdMs = 30 * 60 * 1000) {
        ...
        const inactivityTimeoutMs = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SECURITY_CONFIG"].INACTIVITY_TIMEOUT;
...
"[project]/src/services/security/tokenManager/migration.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/security/tokenManager/storage.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/security/tokenManager/validation.ts [app-client] (ecmascript)");
;
;
class TokenMigration {
   ...
   */ static migrateFromLocalStorage() {
        ...
        try {
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].hasTokenData()) {
                console.info('[TokenMigration] SessionStorage tokens already exist, skipping migration');
                return false;
            }
            // Get legacy tokens
            const legacyTokens = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].getLegacyTokens();
            if (!legacyTokens) {
                console.info('[TokenMigration] No legacy tokens found to migrate');
                return false;
            }
            // Validate token format
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["JwtParser"].isValidFormat(legacyTokens.token)) {
                console.warn('[TokenMigration] Legacy token has invalid format, removing');
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].removeLegacyTokens();
                return false;
            }
            // Parse JWT to get expiration
            const expiration = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["JwtParser"].parseExpiration(legacyTokens.token);
            if (expiration && expiration > Date.now()) {
                // Token is still valid, create metadata and migrate
                const metadata = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenValidator"].createTokenMetadata(legacyTokens.token, legacyTokens.refreshToken);
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].setTokenData(metadata);
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].updateZustandStorage(legacyTokens.token);
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].removeLegacyTokens();
   ...
   */ static isMigrationNeeded() {
        ...
        return !!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].getLegacyTokens();
    }
    /**
   ...
   */ static getMigrationStatus() {
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        const hasLegacyTokens = !!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].getLegacyTokens();
        const hasCurrentTokens = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].hasTokenData();
        const migrationNeeded = TokenMigration.isMigrationNeeded();
        let legacyTokenValid = false;
        if (hasLegacyTokens) {
            try {
                const legacyTokens = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].getLegacyTokens();
                if (legacyTokens && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["JwtParser"].isValidFormat(legacyTokens.token)) {
                    const expiration = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["JwtParser"].parseExpiration(legacyTokens.token);
   ...
   */ static forceCleanMigration() {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].clearAllTokens();
   ...
   */ static validateAndRepairStorage() {
        ...
        try {
            const metadata = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].getTokenMetadata();
            if (!metadata) {
            ...
            const validationResult = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenValidator"].validateToken(metadata);
            ...
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["JwtParser"].isValidFormat(metadata.token)) {
                hadInconsistencies = true;
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].clearAllTokens();
...
"[project]/src/services/security/tokenManager/activityTracker.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ActivityTracker {
   ...
   */ emitSessionExpiredEvent(reason) {
        if (("TURBOPACK compile-time value", "object") === 'undefined' || typeof CustomEvent === 'undefined') {
            return;
        }
        try {
   ...
   */ updateActivity() {
        try {
            ...
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenValidator"].isTokenValid(metadata)) {
                return;
            }
            const updatedMetadata = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenValidator"].updateActivity(metadata);
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].updateTokenMetadata(updatedMetadata);
        } catch (error) {
   ...
   */ getActivityStatus() {
        ...
        const timeSinceActivity = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenValidator"].getTimeSinceActivity(metadata);
        const timeUntilExpiration = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenValidator"].getTimeUntilExpiration(metadata);
        const timeUntilInactivityTimeout = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SECURITY_CONFIG"].INACTIVITY_TIMEOUT - timeSinceActivity;
        ...
        return {
            isActive: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenValidator"].isTokenValid(metadata),
            timeSinceActivity,
   ...
   */ shouldShowSessionWarning(warningThresholdMs = 15 * 60 * 1000) {
        const metadata = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].getTokenMetadata();
        if (!metadata || !__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenValidator"].isTokenValid(metadata)) {
            return false;
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenValidator"].isApproachingInactivityTimeout(metadata, warningThresholdMs);
    }
    /**
...
"[project]/src/services/security/tokenManager/types.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/services/security/tokenManager/index.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/security/tokenManager/storage.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/security/tokenManager/validation.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$migration$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/security/tokenManager/migration.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$activityTracker$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/security/tokenManager/activityTracker.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/security/tokenManager/types.ts [app-client] (ecmascript)");
;
;
;
;
class SecureTokenManager {
    ...
    activityTracker;
    constructor(){
        this.activityTracker = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$activityTracker$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ActivityTracker"].getInstance();
        this.initialize();
    }
    /**
   ...
   */ initialize() {
        try {
            ...
            const initResult = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$migration$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenMigration"].initialize();
   ...
   */ setToken(token, refreshToken, expiresIn) {
        try {
            ...
            const metadata = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenValidator"].createTokenMetadata(token, refreshToken, expiresIn);
            // Store using storage module
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].setTokenData(metadata);
            // Update Zustand storage for backward compatibility
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].updateZustandStorage(token);
   ...
   */ isTokenValid(metadata) {
        try {
            const meta = metadata || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].getTokenMetadata();
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenValidator"].isTokenValid(meta);
        } catch (error) {
   ...
   */ getTimeUntilExpiration() {
        try {
            const metadata = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].getTokenMetadata();
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenValidator"].getTimeUntilExpiration(metadata);
        } catch (error) {
   ...
   */ getTimeSinceActivity() {
        try {
            const metadata = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenStorage"].getTokenMetadata();
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TokenValidator"].getTimeSinceActivity(metadata);
        } catch (error) {
   ...
   */ static reset() {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$activityTracker$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ActivityTracker"].getInstance().reset();
    }
}
...
"[project]/src/services/security/SecureTokenManager.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/services/security/tokenManager/index.ts [app-client] (ecmascript) <locals>");
;
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
 ...
 */ }),
"[project]/src/services/config/apiConfig.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$CsrfProtection$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/security/CsrfProtection.ts [app-client] (ecmascript)");
// ==========================================
// SINGLETON INSTANCES
// ==========================================
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$SecureTokenManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/services/security/SecureTokenManager.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/services/security/tokenManager/index.ts [app-client] (ecmascript) <locals>");
;
;
;
...
function createApiInstance(_tokenManager) {
    const instance = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].create({
        baseURL: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_CONFIG"].BASE_URL,
        timeout: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_CONFIG"].TIMEOUT,
        headers: {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$CsrfProtection$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setupCsrfProtection"])(instance);
    return instance;
}
...
;
;
const apiInstance = createApiInstance(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["secureTokenManager"]);
const tokenUtils = createTokenUtils(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["secureTokenManager"]);
const __TURBOPACK__default__export__ = apiInstance;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/services/core/errors.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/services/core/ApiClient.errors.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/services/utils/logger.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/services/core/ApiClient.interceptors.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = /*#__PURE__*/ __turbopack_context__.i("[project]/node_modules/next/dist/build/polyfills/process.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$ApiClient$2e$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/core/ApiClient.errors.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/utils/logger.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/constants/api.ts [app-client] (ecmascript)");
;
;
;
function createAuthRequestInterceptor(instance, tokenManager, enableLogging) {
    return instance.interceptors.request.use({
        "createAuthRequestInterceptor.use": (config)=>{
            ...
            if (token) {
                ...
                if (tokenManager?.isTokenValid()) {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].warn('ApiClient: Token expired, clearing tokens');
            ...
            if (enableLogging && ("TURBOPACK compile-time value", "development") === 'development') {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].debug(`API Request: ${config.method?.toUpperCase()} ${config.url}`, {
    ...
    }["createAuthRequestInterceptor.use"], {
        "createAuthRequestInterceptor.use": (error)=>{
            if (enableLogging && ("TURBOPACK compile-time value", "development") === 'development') {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('API Request Error', error);
            }
            return Promise.reject((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$ApiClient$2e$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeError"])(error));
        }
    }["createAuthRequestInterceptor.use"]);
}
function createAuthResponseInterceptor(options) {
    ...
    return instance.interceptors.response.use({
        "createAuthResponseInterceptor.use": (response)=>{
            // Log response in development
            if (enableLogging && ("TURBOPACK compile-time value", "development") === 'development') {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].debug(`API Response: ${response.config.method?.toUpperCase()} ${response.config.url}`, {
    ...
    }["createAuthResponseInterceptor.use"], {
        "createAuthResponseInterceptor.use": async (error)=>{
            ...
            if (error.response?.status === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HTTP_STATUS"].UNAUTHORIZED && !originalRequest._retry && !isAuthEndpoint) {
                ...
                try {
                    ...
                    onAuthFailure();
                    return Promise.reject((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$ApiClient$2e$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeError"])(refreshError));
                }
            }
            ...
            if (enableRetry && isRetryableError(error) && !originalRequest._retry) {
                ...
                if (retryCount < maxRetries) {
                    ...
                    await sleep(delay);
                    if (enableLogging && ("TURBOPACK compile-time value", "development") === 'development') {
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].debug(`API Retry: Attempt ${retryCount + 1}/${maxRetries} for ${originalRequest.url}`);
                    }
                    return instance(originalRequest);
                }
            }
            ...
            if (enableLogging) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('API Response Error', error, {
...
function isRetryableError(error) {
    ...
    // Rate limiting
    if (status === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HTTP_STATUS"].TOO_MANY_REQUESTS) {
        return true;
    }
    return false;
}
...
"[project]/src/services/core/ApiClient.auth.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function refreshAuthToken(tokenManager) {
    ...
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_CONFIG"].BASE_URL}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].AUTH.REFRESH}`, {
            refreshToken
        });
...
"[project]/src/services/core/ApiClient.cancellation.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/services/core/ApiClient.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$ApiClient$2e$interceptors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/core/ApiClient.interceptors.ts [app-client] (ecmascript)");
// Import authentication utilities from extracted module
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$ApiClient$2e$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/core/ApiClient.auth.ts [app-client] (ecmascript)");
// Re-export error class for backward compatibility
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$ApiClient$2e$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/core/ApiClient.errors.ts [app-client] (ecmascript)");
// Re-export cancellation utilities for backward compatibility
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$ApiClient$2e$cancellation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/core/ApiClient.cancellation.ts [app-client] (ecmascript)");
// ==========================================
// SINGLETON INSTANCE
// ==========================================
...
class ApiClient {
    ...
    constructor(config = {}){
        ...
        this.maxRetries = config.maxRetries ?? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_CONFIG"].RETRY.MAX_RETRIES;
        this.retryDelay = config.retryDelay ?? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_CONFIG"].RETRY.RETRY_DELAY;
        ...
        this.instance = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].create({
            baseURL: config.baseURL ?? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_CONFIG"].BASE_URL,
            timeout: config.timeout ?? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_CONFIG"].TIMEOUT,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$CsrfProtection$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setupCsrfProtection"])(this.instance);
    ...
    setupDefaultInterceptors() {
        ...
        const authRequestId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$ApiClient$2e$interceptors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createAuthRequestInterceptor"])(this.instance, this.tokenManager, this.enableLogging);
        this.requestInterceptorIds.push(authRequestId);
        // Response interceptor: Handle token refresh and errors
        const authResponseId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$ApiClient$2e$interceptors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createAuthResponseInterceptor"])({
            ...
            onAuthFailure: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$ApiClient$2e$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handleAuthFailure"])(this.tokenManager),
            refreshAuthToken: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$ApiClient$2e$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["refreshAuthToken"])(this.tokenManager)
        });
...
const apiClient = new ApiClient({
    ...
    enableRetry: true,
    tokenManager: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$security$2f$tokenManager$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["secureTokenManager"]
});
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/identity-access/services/authApi.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/services/config/apiConfig.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/constants/api.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/constants/config.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__ = __turbopack_context__.i("[project]/node_modules/zod/v4/classic/external.js [app-client] (ecmascript) <export * as z>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/core/errors.ts [app-client] (ecmascript)");
// Create and export a default instance for backward compatibility
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$ApiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/services/core/ApiClient.ts [app-client] (ecmascript) <locals>");
;
;
;
;
...
const registerSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    schoolId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional()
});
class AuthApi {
    client;
    constructor(client){
   ...
   */ async login(credentials) {
        try {
            ...
            console.log('[AuthApi] Sending login request to:', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].AUTH.LOGIN);
            const response = await this.client.post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].AUTH.LOGIN, credentials);
            ...
            // Store tokens
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tokenUtils"].setToken(accessToken);
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tokenUtils"].setRefreshToken(refreshToken);
            ...
            if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].ZodError) {
                throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createValidationError"])(error.issues[0]?.message || 'Validation error', error.issues[0]?.path.join('.'), error.issues.reduce((acc, err)=>{
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createApiError"])(error, 'Login failed');
        }
    }
    /**
   ...
   */ async register(userData) {
        try {
            ...
            console.log('Register API endpoint:', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].AUTH.REGISTER);
            console.log('API client base URL:', this.client);
            const response = await this.client.post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].AUTH.REGISTER, userData);
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createApiError"])(error, 'Registration failed');
        }
    }
    /**
   ...
   */ async verifyToken() {
        try {
            const response = await this.client.post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].AUTH.VERIFY);
            return response.data.user;
        } catch (error) {
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createApiError"])(error, 'Token verification failed');
        }
    }
    /**
   ...
   */ async refreshToken() {
        try {
            const refreshToken = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tokenUtils"].getRefreshToken();
            if (!refreshToken) {
                throw new Error('No refresh token available');
            }
            const response = await this.client.post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].AUTH.REFRESH, {
                refreshToken
            });
            const { accessToken, refreshToken: newRefreshToken, expiresIn } = response.data;
            // Update stored tokens
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tokenUtils"].setToken(accessToken);
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tokenUtils"].setRefreshToken(newRefreshToken);
            return {
                token: accessToken,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tokenUtils"].clearAll();
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createApiError"])(error, 'Token refresh failed');
        }
    }
    /**
   * Logout user
   */ async logout() {
        try {
            await this.client.post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].AUTH.LOGOUT);
        } catch (error) {
   ...
   */ async getCurrentUser() {
        try {
            const response = await this.client.get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].AUTH.PROFILE);
            if (!response.data.success || !response.data.data) {
                throw new Error('Failed to get current user');
            }
            return response.data.data;
        } catch (error) {
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createApiError"])(error, 'Failed to get current user');
        }
    }
    /**
   * Google OAuth login
   */ async loginWithGoogle() {
        const baseUrl = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_CONFIG"].BASE_URL.replace('/api', '');
        window.location.href = `${baseUrl}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].AUTH.LOGIN}/google`;
    }
    /**
   * Microsoft OAuth login
   */ async loginWithMicrosoft() {
        const baseUrl = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_CONFIG"].BASE_URL.replace('/api', '');
        window.location.href = `${baseUrl}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].AUTH.LOGIN}/microsoft`;
    }
    /**
   * Request password reset
   */ async forgotPassword(email) {
        try {
            const response = await this.client.post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].AUTH.FORGOT_PASSWORD, {
                email
            });
            return response.data;
        } catch (error) {
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createApiError"])(error, 'Password reset request failed');
        }
    }
    /**
   ...
   */ async resetPassword(token, password) {
        try {
            const response = await this.client.post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].AUTH.RESET_PASSWORD, {
                token,
                password
            });
            return response.data;
        } catch (error) {
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createApiError"])(error, 'Password reset failed');
        }
    }
    /**
   * Check if user is authenticated
   */ isAuthenticated() {
        const token = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tokenUtils"].getToken();
        return !!token;
    }
    /**
   ...
   */ async getDevUsers() {
        try {
            const response = await this.client.get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].USERS.BASE + '/dev');
            if (!response.data.success || !response.data.data) {
                throw new Error('Failed to fetch development users');
            }
            return response.data.data.users;
        } catch (error) {
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createApiError"])(error, 'Failed to fetch development users');
        }
    }
}
...
;
const authApi = createAuthApi(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$ApiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiClient"]);
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/identity-access/stores/authSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$services$2f$authApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/services/authApi.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-hot-toast/dist/index.mjs [app-client] (ecmascript)");
...
;
;
const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$debug$2f$src$2f$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])('whitecross:auth-slice');
/**
...
const loginUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('auth/loginUser', async (credentials, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$services$2f$authApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].login(credentials);
        return response;
    } catch (error) {
...
const registerUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('auth/registerUser', async (userData, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$services$2f$authApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].register(userData);
        return response;
    } catch (error) {
...
const logoutUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('auth/logoutUser', async (_, { rejectWithValue })=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$services$2f$authApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].logout();
    } catch (error) {
...
const refreshUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('auth/refreshUser', async (_, { rejectWithValue })=>{
    try {
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$services$2f$authApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].verifyToken();
        return user;
    } catch (error) {
 ...
 */ const authSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    ...
    extraReducers: (builder)=>{
       ...
       */ .addCase(loginUser.fulfilled, (state, action)=>{
            ...
            state.error = null;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`Welcome back, ${action.payload.user.firstName}!`);
        })/**
       ...
       */ .addCase(loginUser.rejected, (state, action)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(action.payload);
        })/**
       ...
       */ .addCase(registerUser.fulfilled, (state, action)=>{
            ...
            state.isLoading = false;
            state.error = null;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`Welcome, ${action.payload.user.firstName}! Your account has been created.`);
        })/**
       ...
       */ .addCase(logoutUser.fulfilled, (state)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('You have been logged out successfully');
        })/**
...
"[project]/src/identity-access/stores/accessControl/state.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/services/utils/apiUtils.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$debug$2f$src$2f$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])('whitecross:api-utils');
...
const formatDateForApi = (date)=>{
    try {
        if (typeof date === 'string') {
            ...
            const parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(date);
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isValid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValid"])(parsed)) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatISO$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatISO"])(parsed);
            }
            // If not valid ISO, try as Date constructor
            const fallback = new Date(date);
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isValid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValid"])(fallback)) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatISO$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatISO"])(fallback);
            }
        ...
        if (date instanceof Date) {
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isValid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValid"])(date)) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatISO$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatISO"])(date);
            }
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatISO$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatISO"])(new Date()); // Fallback to current time
    }
};
const parseDateFromApi = (dateString)=>{
    try {
        const parsedDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(dateString);
...
const formatDateForDisplay = (date)=>{
    try {
        const dateObj = typeof date === 'string' ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(date) : date;
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isValid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValid"])(dateObj)) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(dateObj, 'MMM dd, yyyy');
        }
        return 'Invalid Date';
    } catch (error) {
...
const formatDateTimeForDisplay = (date)=>{
    try {
        const dateObj = typeof date === 'string' ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(date) : date;
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isValid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValid"])(dateObj)) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(dateObj, 'MMM dd, yyyy HH:mm');
        }
        return 'Invalid Date';
    } catch (error) {
...
const isDateExpired = (date)=>{
    try {
        const dateObj = typeof date === 'string' ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(date) : date;
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isValid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValid"])(dateObj)) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isBefore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isBefore"])(dateObj, new Date());
        }
        return false;
    } catch (error) {
...
const getTimeUntilExpiry = (date)=>{
    try {
        const expiryDate = typeof date === 'string' ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(date) : date;
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isValid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValid"])(expiryDate)) {
            return 'Unknown';
        }
        const now = new Date();
        const diff = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInMilliseconds$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["differenceInMilliseconds"])(expiryDate, now);
...
"[project]/src/services/modules/accessControlApi.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$utils$2f$apiUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/utils/apiUtils.ts [app-client] (ecmascript)");
 ...
 */ class AccessControlApiImpl {
   ...
   */ async getRoles() {
        try {
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$utils$2f$apiUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handleApiError"])(error);
        }
    }
    /**
   * Get role by ID
...
;
;
const accessControlApi = createAccessControlApi(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$core$2f$ApiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiClient"]);
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/identity-access/stores/accessControl/thunks/rolesThunks.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@reduxjs/toolkit/dist/redux-toolkit.modern.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/modules/accessControlApi.ts [app-client] (ecmascript)");
;
;
const fetchRoles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/fetchRoles', async (_, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].getRoles();
...
const fetchRoleById = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/fetchRoleById', async (id, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].getRoleById(id);
...
const createRole = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/createRole', async (roleData, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].createRole(roleData);
        return response.role;
    } catch (error) {
...
const updateRole = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/updateRole', async ({ id, updates }, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].updateRole(id, updates);
        return response.role;
    } catch (error) {
...
const deleteRole = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/deleteRole', async (id, { rejectWithValue })=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].deleteRole(id);
        return id;
    } catch (error) {
...
const initializeDefaultRoles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/initializeDefaultRoles', async (_, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].initializeDefaultRoles();
        return response.roles;
    } catch (error) {
...
const assignPermissionToRole = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/assignPermissionToRole', async ({ roleId, permissionId }, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].assignPermissionToRole(roleId, permissionId);
...
const removePermissionFromRole = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/removePermissionFromRole', async ({ roleId, permissionId }, { rejectWithValue })=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].removePermissionFromRole(roleId, permissionId);
        return {
            roleId,
            permissionId
        };
...
const assignRoleToUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/assignRoleToUser', async ({ userId, roleId }, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].assignRoleToUser(userId, roleId);
...
const removeRoleFromUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/removeRoleFromUser', async ({ userId, roleId }, { rejectWithValue })=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].removeRoleFromUser(userId, roleId);
        return {
            userId,
            roleId
        };
...
"[project]/src/identity-access/stores/accessControl/thunks/permissionsThunks.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const fetchPermissions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/fetchPermissions', async (_, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].getPermissions();
...
const createPermission = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/createPermission', async (permissionData, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].createPermission(permissionData);
...
const fetchUserPermissions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/fetchUserPermissions', async (userId, { rejectWithValue })=>{
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].getUserPermissions(userId);
    } catch (error) {
...
const checkUserPermission = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/checkUserPermission', async ({ userId, resource, action }, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].checkPermission(userId, resource, action);
        return {
            userId,
            resource,
            action,
...
"[project]/src/identity-access/stores/accessControl/thunks/sessionsThunks.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const fetchUserSessions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/fetchUserSessions', async (userId, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].getUserSessions(userId);
...
const deleteSession = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/deleteSession', async (token, { rejectWithValue })=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].deleteSession(token);
        return token;
    } catch (error) {
...
const deleteAllUserSessions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/deleteAllUserSessions', async (userId, { rejectWithValue })=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].deleteAllUserSessions(userId);
    } catch (error) {
...
"[project]/src/identity-access/stores/accessControl/thunks/incidentsThunks.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const fetchSecurityIncidents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/fetchSecurityIncidents', async (params, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].getSecurityIncidents(params);
        return response;
    } catch (error) {
...
const createSecurityIncident = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/createSecurityIncident', async (incidentData, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].createSecurityIncident(incidentData);
...
const updateSecurityIncident = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/updateSecurityIncident', async ({ id, updates }, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].updateSecurityIncident(id, updates);
        return response.incident;
    } catch (error) {
...
const fetchIpRestrictions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/fetchIpRestrictions', async (_, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].getIpRestrictions();
...
const addIpRestriction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/addIpRestriction', async (restrictionData, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].addIpRestriction(restrictionData);
...
const removeIpRestriction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/removeIpRestriction', async (id, { rejectWithValue })=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].removeIpRestriction(id);
        return id;
    } catch (error) {
...
const fetchAccessControlStatistics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('accessControl/fetchStatistics', async (_, { rejectWithValue })=>{
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$modules$2f$accessControlApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["accessControlApi"].getStatistics();
    } catch (error) {
...
"[project]/src/identity-access/stores/accessControl/selectors.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const selectActiveRoles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
    selectRoles
], (roles)=>roles.filter((role)=>role.isActive));
const selectCriticalIncidents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
    selectSecurityIncidents
], (incidents)=>incidents.filter((incident)=>incident.severity === 'CRITICAL' || incident.severity === 'HIGH'));
const selectActiveSessions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
    selectSessions
], (sessions)=>sessions.filter((session)=>session.isActive));
const selectFilteredIncidents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
    selectSecurityIncidents,
    selectIncidentFilters
], (incidents, filters)=>{
...
const selectFilteredSessions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
    selectSessions,
    selectSessionFilters
], (sessions, filters)=>{
...
const selectSecurityMetrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
    selectRoles,
    selectPermissions,
    selectSecurityIncidents,
    selectSessions
...
const selectRoleById = (roleId)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
        selectRoles
    ], (roles)=>roles.find((role)=>role.id === roleId) || null);
const selectPermissionById = (permissionId)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
        selectPermissions
    ], (permissions)=>permissions.find((perm)=>perm.id === permissionId) || null);
const selectIncidentsBySeverity = (severity)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
        selectSecurityIncidents
    ], (incidents)=>incidents.filter((incident)=>incident.severity === severity));
const selectSessionsByUserId = (userId)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
        selectSessions
    ], (sessions)=>sessions.filter((session)=>session.userId === userId));
const selectRolesWithPermissionCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
    selectRoles
], (roles)=>roles.map((role)=>({
            ...role,
            permissionCount: role.permissions?.length || 0
        })));
const selectRecentIncidents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
    selectSecurityIncidents
], (incidents)=>{
    const yesterday = new Date(Date.now() - 24 * 60 * 60 * 1000);
    return incidents.filter((incident)=>new Date(incident.createdAt) > yesterday);
});
const selectUnreadNotifications = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
    selectNotifications
], (notifications)=>notifications.filter((notification)=>!notification.read));
const selectIsAnyLoading = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
    selectLoading
...
"[project]/src/identity-access/stores/accessControl/index.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@reduxjs/toolkit/dist/redux-toolkit.modern.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$state$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/stores/accessControl/state.ts [app-client] (ecmascript)");
// Import all thunks from modular files
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$rolesThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/stores/accessControl/thunks/rolesThunks.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$permissionsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/stores/accessControl/thunks/permissionsThunks.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$sessionsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/stores/accessControl/thunks/sessionsThunks.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$incidentsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/stores/accessControl/thunks/incidentsThunks.ts [app-client] (ecmascript)");
// Selectors
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$selectors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/stores/accessControl/selectors.ts [app-client] (ecmascript)");
;
;
;
;
...
// SLICE DEFINITION
// ==========================================
const accessControlSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    name: 'accessControl',
    initialState: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$state$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initialState"],
    reducers: {
        ...
        resetState: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$state$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initialState"]
    },
    extraReducers: (builder)=>{
        // ==========================================
        // ROLES REDUCERS
        // ==========================================
        builder.addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$rolesThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchRoles"].pending, (state)=>{
            state.loading.roles = true;
            state.error = null;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$rolesThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchRoles"].fulfilled, (state, action)=>{
            state.loading.roles = false;
            state.roles = action.payload;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$rolesThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchRoles"].rejected, (state, action)=>{
            state.loading.roles = false;
            state.error = action.payload || 'Failed to fetch roles';
        })// Role by ID
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$rolesThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchRoleById"].pending, (state)=>{
            state.loading.operations = true;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$rolesThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchRoleById"].fulfilled, (state, action)=>{
            state.loading.operations = false;
            state.selectedRole = action.payload;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$rolesThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchRoleById"].rejected, (state, action)=>{
            state.loading.operations = false;
            state.error = action.payload || 'Failed to fetch role';
        })// Create role
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$rolesThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRole"].pending, (state)=>{
            state.loading.operations = true;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$rolesThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRole"].fulfilled, (state, action)=>{
            state.loading.operations = false;
            state.roles.push(action.payload);
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$rolesThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRole"].rejected, (state, action)=>{
            state.loading.operations = false;
            state.error = action.payload || 'Failed to create role';
        })// Update role
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$rolesThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateRole"].pending, (state)=>{
            state.loading.operations = true;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$rolesThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateRole"].fulfilled, (state, action)=>{
            state.loading.operations = false;
        ...
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$rolesThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateRole"].rejected, (state, action)=>{
            state.loading.operations = false;
            state.error = action.payload || 'Failed to update role';
        })// Delete role
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$rolesThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteRole"].pending, (state)=>{
            state.loading.operations = true;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$rolesThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteRole"].fulfilled, (state, action)=>{
            state.loading.operations = false;
            state.roles = state.roles.filter((r)=>r.id !== action.payload);
            if (state.selectedRole?.id === action.payload) {
                state.selectedRole = null;
            }
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$rolesThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteRole"].rejected, (state, action)=>{
            state.loading.operations = false;
            state.error = action.payload || 'Failed to delete role';
        })// Initialize default roles
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$rolesThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeDefaultRoles"].fulfilled, (state, action)=>{
            state.roles = [
                ...state.roles,
                ...action.payload
            ];
        ...
        // ==========================================
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$permissionsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchPermissions"].pending, (state)=>{
            state.loading.permissions = true;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$permissionsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchPermissions"].fulfilled, (state, action)=>{
            state.loading.permissions = false;
            state.permissions = action.payload;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$permissionsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchPermissions"].rejected, (state, action)=>{
            state.loading.permissions = false;
            state.error = action.payload || 'Failed to fetch permissions';
        })// Create permission
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$permissionsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPermission"].fulfilled, (state, action)=>{
            state.permissions.push(action.payload);
        })// ==========================================
        // SESSIONS REDUCERS
        // ==========================================
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$sessionsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchUserSessions"].pending, (state)=>{
            state.loading.sessions = true;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$sessionsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchUserSessions"].fulfilled, (state, action)=>{
            state.loading.sessions = false;
            state.sessions = action.payload;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$sessionsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchUserSessions"].rejected, (state, action)=>{
            state.loading.sessions = false;
            state.error = action.payload || 'Failed to fetch sessions';
        })// Delete session
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$sessionsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteSession"].fulfilled, (state, action)=>{
            state.sessions = state.sessions.filter((s)=>s.token !== action.payload);
        })// ==========================================
        // SECURITY INCIDENTS REDUCERS
        // ==========================================
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$incidentsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchSecurityIncidents"].pending, (state)=>{
            state.loading.incidents = true;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$incidentsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchSecurityIncidents"].fulfilled, (state, action)=>{
        ...
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$incidentsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchSecurityIncidents"].rejected, (state, action)=>{
            state.loading.incidents = false;
            state.error = action.payload || 'Failed to fetch security incidents';
        })// Create security incident
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$incidentsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSecurityIncident"].fulfilled, (state, action)=>{
            state.securityIncidents.push(action.payload);
        })// Update security incident
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$incidentsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateSecurityIncident"].fulfilled, (state, action)=>{
        ...
        // ==========================================
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$incidentsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchIpRestrictions"].fulfilled, (state, action)=>{
            state.ipRestrictions = action.payload;
        })// Add IP restriction
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$incidentsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addIpRestriction"].fulfilled, (state, action)=>{
            state.ipRestrictions.push(action.payload);
        })// Remove IP restriction
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$incidentsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeIpRestriction"].fulfilled, (state, action)=>{
            state.ipRestrictions = state.ipRestrictions.filter((r)=>r.id !== action.payload);
        })// ==========================================
        // STATISTICS REDUCERS
        // ==========================================
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$incidentsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchAccessControlStatistics"].pending, (state)=>{
            state.loading.statistics = true;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$incidentsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchAccessControlStatistics"].fulfilled, (state, action)=>{
            state.loading.statistics = false;
            state.statistics = action.payload;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$thunks$2f$incidentsThunks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchAccessControlStatistics"].rejected, (state, action)=>{
            state.loading.statistics = false;
...
"[project]/src/identity-access/stores/accessControlSlice.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/identity-access/stores/accessControl/index.ts [app-client] (ecmascript) <locals>");
;
;
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
"[project]/src/identity-access/stores/index.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/stores/authSlice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControlSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/identity-access/stores/accessControlSlice.ts [app-client] (ecmascript) <locals>");
;
;
;
;
...
"[project]/src/identity-access/stores/authSlice.ts [app-client] (ecmascript) <export default as authReducer>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "authReducer",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/stores/authSlice.ts [app-client] (ecmascript)");
}),
"[project]/src/identity-access/stores/accessControl/index.ts [app-client] (ecmascript) <locals> <export default as accessControlReducer>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "accessControlReducer",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/identity-access/stores/accessControl/index.ts [app-client] (ecmascript) <locals>");
}),
"[project]/src/stores/sliceFactory/helpers.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createStandardEntityAdapter() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createEntityAdapter"])({
...
"[project]/src/stores/sliceFactory/core.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@reduxjs/toolkit/dist/redux-toolkit.modern.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/sliceFactory/helpers.ts [app-client] (ecmascript)");
;
;
function createEntitySlice(name, apiService, options = {}) {
    ...
    const adapter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createStandardEntityAdapter"])();
    // Create initial state
    const initialState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createInitialEnhancedState"])(adapter, customInitialState);
    // Create async thunks
    const fetchList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])(`${name}/fetchList`, async (params, { rejectWithValue })=>{
        try {
            const result = await apiService.getAll(params || {});
            return result;
        } catch (error) {
            const errorInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["extractErrorInfo"])(error);
    ...
    const fetchById = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])(`${name}/fetchById`, async (id, { rejectWithValue })=>{
        try {
    ...
    const create = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])(`${name}/create`, async (data, { rejectWithValue })=>{
        try {
    ...
    const update = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])(`${name}/update`, async ({ id, data }, { rejectWithValue })=>{
        try {
    ...
    const deleteEntity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])(`${name}/delete`, async (id, { rejectWithValue })=>{
        try {
    ...
    const slice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
        ...
        extraReducers: (builder)=>{
            ...
            builder.addCase(fetchList.pending, (state)=>{
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateLoadingState"])(state, 'list', {
                    status: 'pending',
                    isLoading: true,
                    error: null,
                    startedAt: Date.now()
            ...
            builder.addCase(fetchById.pending, (state)=>{
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateLoadingState"])(state, 'detail', {
                    status: 'pending',
                    isLoading: true,
                    error: null,
                    startedAt: Date.now()
            ...
            builder.addCase(create.pending, (state)=>{
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateLoadingState"])(state, 'create', {
                    status: 'pending',
                    isLoading: true,
                    error: null,
                    startedAt: Date.now()
            ...
            builder.addCase(update.pending, (state)=>{
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateLoadingState"])(state, 'update', {
                    status: 'pending',
                    isLoading: true,
                    error: null,
                    startedAt: Date.now()
            ...
            builder.addCase(deleteEntity.pending, (state)=>{
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateLoadingState"])(state, 'delete', {
                    status: 'pending',
                    isLoading: true,
                    error: null,
                    startedAt: Date.now()
            ...
            if (bulkDelete) {
                builder.addCase(bulkDelete.pending, (state)=>{
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateLoadingState"])(state, 'bulk', {
                        status: 'pending',
                        isLoading: true,
                        error: null,
                        startedAt: Date.now()
...
"[project]/src/stores/sliceFactory/healthcare.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$core$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/sliceFactory/core.ts [app-client] (ecmascript)");
;
function createHealthcareEntitySlice(name, apiService, options = {}) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$core$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])(name, apiService, healthcareOptions);
}
...
"[project]/src/stores/sliceFactory/index.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$healthcare$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/sliceFactory/healthcare.ts [app-client] (ecmascript)");
// Helper utilities
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/sliceFactory/helpers.ts [app-client] (ecmascript)");
;
;
...
"[project]/src/stores/sliceFactory.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/stores/sliceFactory/index.ts [app-client] (ecmascript) <locals>");
;
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
        ...
        try {
            ...
            if (!response.ok) {
                ...
                if (response.status === 401 && ("TURBOPACK compile-time value", "object") !== 'undefined') {
                    window.location.href = '/login';
                    return Promise.reject(error);
                } else if (response.status === 403 && ("TURBOPACK compile-time value", "object") !== 'undefined') {
...
"[project]/src/stores/slices/usersSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/stores/sliceFactory.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$core$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/sliceFactory/core.ts [app-client] (ecmascript)");
...
const usersApiService = {
    async getAll (params) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].administration.getUsers(params);
        return {
            data: response.data || [],
    ...
    async getById (id) {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].administration.getUsers();
    ...
    async create (data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].administration.createUser(data);
        return {
            data: response
        };
    },
    async update (id, data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].administration.updateUser(id, data);
        return {
            data: response
        };
    },
    async delete (id) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].administration.deleteUser(id);
        return {
            success: true
        };
    }
...
const usersSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$core$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('users', usersApiService, {
...
"[project]/src/stores/slices/dashboardSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class DashboardApiService {
   ...
   */ async getDashboardStats() {
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].dashboard.getDashboardStats();
        } catch (error) {
   ...
   */ async getRecentActivities(params) {
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].dashboard.getRecentActivities(params);
        } catch (error) {
   ...
   */ async getUpcomingAppointments(params) {
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].dashboard.getUpcomingAppointments(params);
        } catch (error) {
   ...
   */ async getChartData(params) {
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].dashboard.getChartData(params);
        } catch (error) {
   ...
   */ async getCompleteDashboardData(options) {
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].dashboard.getCompleteDashboardData(options);
        } catch (error) {
   ...
   */ async refreshCache() {
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].dashboard.refreshCache();
        } catch (error) {
   ...
   */ async getDashboardStatsByDateRange(startDate, endDate) {
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].dashboard.getDashboardStatsByDateRange(startDate, endDate);
        } catch (error) {
   ...
   */ async getDashboardStatsByScope(scope) {
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].dashboard.getDashboardStatsByScope(scope);
        } catch (error) {
...
const fetchRecentActivities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('dashboard/fetchRecentActivities', async (params = {}, { rejectWithValue })=>{
    try {
...
const fetchChartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('dashboard/fetchChartData', async (params = {}, { rejectWithValue })=>{
    try {
...
const refreshDashboardCache = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('dashboard/refreshCache', async (_, { rejectWithValue, dispatch })=>{
    try {
...
const fetchDashboardStatsByScope = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('dashboard/fetchStatsByScope', async (scope, { rejectWithValue })=>{
    try {
...
"[project]/src/stores/slices/healthRecordsSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ const healthRecordsApiService = {
   ...
   */ async getAll (params) {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].healthRecords.getRecords(studentId, params);
        return {
   ...
   * ```
   */ async getById (id) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].healthRecords.getRecordById(id);
        return {
   ...
   */ async create (data) {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].healthRecords.createRecord(apiData);
        return {
            data: transformApiToStore(response)
        };
    },
   ...
   */ async update (id, data) {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].healthRecords.updateRecord(id, apiData);
        return {
            data: transformApiToStore(response)
        };
    },
   ...
   * ```
   */ async delete (id) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].healthRecords.deleteRecord(id);
        return {
            success: true
        };
    }
 ...
 *
 * @see {@link createEntitySlice} for factory implementation details
 */ const healthRecordsSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$core$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('healthRecords', healthRecordsApiService, {
    enableBulkOperations: false
});
...
"[project]/src/stores/slices/medicationsSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ const medicationsApiService = {
   ...
   */ async getAll (params) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].medications.getAll(params);
        return {
   ...
   */ async getById (id) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].medications.getById(id);
        return {
            data: response
        };
    },
   ...
   */ async create (data) {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].medications.create(data);
        return {
   ...
   */ async update (id, data) {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].medications.update(id, data);
        return {
            data: response
        };
    },
   ...
   */ async delete (id) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].medications.delete(id);
        return {
            success: true
        };
    }
 ...
 *
 * @see {@link createEntitySlice} for factory implementation details
 */ const medicationsSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$core$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('medications', medicationsApiService, {
    enableBulkOperations: false
});
...
"[project]/src/stores/slices/appointmentsSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ const appointmentsApiService = {
   ...
   */ async getAll (params) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].appointments.getAll(params);
        return {
            data: response.data || [],
            total: response.pagination?.total || 0,
            pagination: response.pagination
   ...
   */ async getById (id) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].appointments.getById(id);
        return {
   ...
   */ async create (data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].appointments.create(data);
        return {
            data: response.appointment
        };
    },
   ...
   */ async update (id, data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].appointments.update(id, data);
        return {
            data: response.appointment
        };
    },
   ...
   */ async delete (id) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].appointments.cancel(id, 'Deleted');
        return {
            success: true
        };
    }
 ...
 */ const appointmentsSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$core$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('appointments', appointmentsApiService, {
    enableBulkOperations: false
});
...
"[project]/src/stores/slices/studentsSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ const studentsApiService = {
   ...
   * ```
   */ async getAll (params) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].students.getAll(params);
        return {
   ...
   * ```
   */ async getById (id) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].students.getById(id);
        return {
            data: response
        };
    },
   ...
   * ```
   */ async create (data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].students.create(data);
        return {
            data: response
        };
    },
   ...
   * ```
   */ async update (id, data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].students.update(id, data);
        return {
            data: response
        };
    },
   ...
   * ```
   */ async delete (id) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].students.delete(id);
        return {
            success: true
        };
    }
 ...
 *
 * @see {@link createEntitySlice} for factory implementation details
 */ const studentsSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$core$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('students', studentsApiService, {
    enableBulkOperations: true
});
/**
 ...
 *
 * @const
 */ const studentUISlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    name: 'studentUI',
 ...
 *
 * @const
 */ const combinedStudentsSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    name: 'students',
    initialState: {
...
"[project]/src/stores/slices/emergencyContactsSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ const emergencyContactsApiService = {
   ...
   * ```
   */ async getAll (params) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].emergencyContacts.getAll(params);
        return {
   ...
   * ```
   */ async getById (id) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].emergencyContacts.getById(id);
        return {
            data: response.data
        };
    },
   ...
   * ```
   */ async create (data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].emergencyContacts.create(data);
        return {
            data: response.data
        };
    },
   ...
   * ```
   */ async update (id, data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].emergencyContacts.update(id, data);
        return {
            data: response.data
        };
    },
   ...
   * ```
   */ async delete (id) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].emergencyContacts.delete(id);
        return {
            success: true
        };
    }
 ...
 *
 * @see {@link createEntitySlice} for factory implementation details
 */ const emergencyContactsSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$core$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('emergencyContacts', emergencyContactsApiService, {
    enableBulkOperations: false
});
...
"[project]/src/types/domain/incidents.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/stores/slices/incidentReportsSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@reduxjs/toolkit/dist/redux-toolkit.modern.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/lib/api/index.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$domain$2f$incidents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/types/domain/incidents.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-hot-toast/dist/index.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$debug$2f$src$2f$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/debug/src/browser.js [app-client] (ecmascript)");
;
;
...
;
;
const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$debug$2f$src$2f$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])('whitecross:incident-reports-slice');
// =====================
// INITIAL STATE
// =====================
/**
...
const fetchIncidentReports = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('incidentReports/fetchIncidentReports', async (filters, { rejectWithValue })=>{
    try {
        log('Fetching incident reports with filters:', filters);
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].incidents.getAll(filters);
        return response;
    } catch (error) {
...
const fetchIncidentReportById = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('incidentReports/fetchIncidentReportById', async (id, { rejectWithValue })=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].incidents.getById(id);
...
const createIncidentReport = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('incidentReports/createIncidentReport', async (data, { rejectWithValue })=>{
    try {
        log('Creating incident report:', data);
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].incidents.create(data);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Incident report created successfully');
        return response.report;
    } catch (error) {
        log('Error creating incident report:', error);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(error.message || 'Failed to create incident report');
        return rejectWithValue(error.message || 'Failed to create incident report');
    }
});
const updateIncidentReport = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('incidentReports/updateIncidentReport', async ({ id, data }, { rejectWithValue })=>{
    try {
        log('Updating incident report:', id, data);
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].incidents.update(id, data);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Incident report updated successfully');
        return response.report;
    } catch (error) {
        log('Error updating incident report:', error);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(error.message || 'Failed to update incident report');
        return rejectWithValue(error.message || 'Failed to update incident report');
    }
});
const deleteIncidentReport = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('incidentReports/deleteIncidentReport', async (id, { rejectWithValue })=>{
    try {
        log('Deleting incident report:', id);
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].incidents.delete(id);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Incident report deleted successfully');
        return id;
    } catch (error) {
        log('Error deleting incident report:', error);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(error.message || 'Failed to delete incident report');
...
const searchIncidentReports = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('incidentReports/searchIncidentReports', async (params, { rejectWithValue })=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].incidents.search(params);
        return response;
    } catch (error) {
...
const fetchWitnessStatements = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('incidentReports/fetchWitnessStatements', async (incidentReportId, { rejectWithValue })=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].incidents.getWitnessStatements(incidentReportId);
...
const createWitnessStatement = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('incidentReports/createWitnessStatement', async (data, { rejectWithValue })=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].incidents.addWitnessStatement(data);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Witness statement added successfully');
        return response.statement;
    } catch (error) {
        log('Error creating witness statement:', error);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(error.message || 'Failed to add witness statement');
...
const fetchFollowUpActions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('incidentReports/fetchFollowUpActions', async (incidentReportId, { rejectWithValue })=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].incidents.getFollowUpActions(incidentReportId);
...
const createFollowUpAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('incidentReports/createFollowUpAction', async (data, { rejectWithValue })=>{
    try {
        log('Creating follow-up action:', data);
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].incidents.addFollowUpAction(data);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Follow-up action created successfully');
        return response.action;
    } catch (error) {
        log('Error creating follow-up action:', error);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(error.message || 'Failed to create follow-up action');
...
// SLICE DEFINITION
// =====================
const incidentReportsSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
...
"[project]/src/types/domain/administration.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/stores/slices/settingsSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/stores/sliceFactory.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$core$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/sliceFactory/core.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$domain$2f$administration$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/types/domain/administration.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/lib/api/index.ts [app-client] (ecmascript) <locals>");
;
;
;
...
const settingsApiService = {
    async getAll () {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].administration.getSettings();
                ...
                if (Array.isArray(items)) {
                    items.forEach((item)=>{
                        configurations.push({
                            ...
                            scope: item.scope || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$domain$2f$administration$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ConfigScope"].SYSTEM,
    ...
    async create (data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].administration.setConfiguration(data);
        return {
            data: response.data
        };
    },
    async update (id, data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].administration.setConfiguration({
            ...data,
            id
        });
        return {
...
const settingsSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$core$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('settings', settingsApiService, {
    enableBulkOperations: false
});
...
"[project]/src/services/configurationApi.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const configurationApi = {
   ...
   */ getAll: async (filter)=>{
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiInstance"].get(`/configurations${queryString ? `?${queryString}` : ''}`);
        return response.data;
    },
    /**
   * Get public configurations (no auth required)
   */ getPublic: async ()=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiInstance"].get('/configurations/public');
        return response.data;
    },
    /**
   ...
   */ getByKey: async (key, scopeId)=>{
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiInstance"].get(`/configurations/${key}${params}`);
        return response.data;
    },
    /**
   ...
   */ getByCategory: async (category, scopeId)=>{
        const params = scopeId ? `?scopeId=${scopeId}` : '';
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiInstance"].get(`/configurations/category/${category}${params}`);
        return response.data;
    },
    /**
   * Update a configuration value
   */ update: async (key, data)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiInstance"].put(`/configurations/${key}`, data);
        return response.data;
    },
    /**
   * Bulk update configurations
   */ bulkUpdate: async (data)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiInstance"].put('/configurations/bulk', data);
        return response.data;
    },
    /**
   * Create a new configuration
   */ create: async (data)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiInstance"].post('/configurations', data);
        return response.data;
    },
    /**
   ...
   */ delete: async (key, scopeId)=>{
        const params = scopeId ? `?scopeId=${scopeId}` : '';
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiInstance"].delete(`/configurations/${key}${params}`);
        return response.data;
    },
    /**
   ...
   */ resetToDefault: async (key, scopeId)=>{
        const params = scopeId ? `?scopeId=${scopeId}` : '';
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiInstance"].post(`/configurations/${key}/reset${params}`);
        return response.data;
    },
    /**
   * Get configuration change history
   */ getHistory: async (key, limit = 50)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiInstance"].get(`/configurations/${key}/history?limit=${limit}`);
        return response.data;
    },
    /**
   * Get recent configuration changes
   */ getRecentChanges: async (limit = 100)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiInstance"].get(`/configurations/history/recent?limit=${limit}`);
        return response.data;
    },
    /**
   * Get configuration changes by user
   */ getChangesByUser: async (userId, limit = 50)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiInstance"].get(`/configurations/history/user/${userId}?limit=${limit}`);
        return response.data;
    },
    /**
   ...
   */ export: async (filter)=>{
        ...
        const queryString = params.toString();
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiInstance"].get(`/configurations/export${queryString ? `?${queryString}` : ''}`, {
            responseType: 'blob'
        });
        return response.data;
    },
   ...
   */ import: async (data)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$config$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiInstance"].post('/configurations/import', data);
        return response.data;
    }
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
"[project]/src/stores/slices/configurationSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@reduxjs/toolkit/dist/redux-toolkit.modern.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/reselect/dist/reselect.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$configurationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/configurationApi.ts [app-client] (ecmascript)");
;
;
class ConfigurationApiService {
    // Configuration management
    async getConfigurations(filter) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$configurationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["configurationApi"].getAll(filter);
    }
    async getPublicConfigurations() {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$configurationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["configurationApi"].getPublic();
    }
    async getConfigurationByKey(key, scopeId) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$configurationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["configurationApi"].getByKey(key, scopeId);
    }
    async getConfigurationsByCategory(category, scopeId) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$configurationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["configurationApi"].getByCategory(category, scopeId);
    }
    async updateConfiguration(key, data) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$configurationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["configurationApi"].update(key, data);
    }
    async bulkUpdateConfigurations(data) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$configurationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["configurationApi"].bulkUpdate(data);
    }
    async createConfiguration(data) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$configurationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["configurationApi"].create(data);
    }
    async deleteConfiguration(key, scopeId) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$configurationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["configurationApi"].delete(key, scopeId);
    }
    async resetConfigurationToDefault(key, scopeId) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$configurationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["configurationApi"].resetToDefault(key, scopeId);
    }
    // History and audit
    async getConfigurationHistory(key, limit) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$configurationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["configurationApi"].getHistory(key, limit);
    }
    async getRecentChanges(limit) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$configurationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["configurationApi"].getRecentChanges(limit);
    }
    async getChangesByUser(userId, limit) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$configurationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["configurationApi"].getChangesByUser(userId, limit);
    }
    // Import/Export
    async exportConfigurations(filter) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$configurationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["configurationApi"].export(filter);
    }
    async importConfigurations(data) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$configurationApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["configurationApi"].import(data);
    }
}
// Create service instance
...
const fetchConfigurations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('configuration/fetchConfigurations', async (filter)=>{
    const response = await configurationService.getConfigurations(filter);
    return response;
});
const fetchPublicConfigurations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('configuration/fetchPublicConfigurations', async ()=>{
    const response = await configurationService.getPublicConfigurations();
    return response;
});
const fetchConfigurationByKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('configuration/fetchConfigurationByKey', async ({ key, scopeId })=>{
...
const updateConfiguration = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('configuration/updateConfiguration', async ({ key, data })=>{
...
const bulkUpdateConfigurations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('configuration/bulkUpdateConfigurations', async (data)=>{
    const response = await configurationService.bulkUpdateConfigurations(data);
    return response;
});
const createConfiguration = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('configuration/createConfiguration', async (data)=>{
    const response = await configurationService.createConfiguration(data);
    return response;
});
const deleteConfiguration = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('configuration/deleteConfiguration', async ({ key, scopeId })=>{
...
const resetConfigurationToDefault = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('configuration/resetConfigurationToDefault', async ({ key, scopeId })=>{
...
const fetchConfigurationHistory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('configuration/fetchConfigurationHistory', async ({ key, limit })=>{
    const response = await configurationService.getConfigurationHistory(key, limit);
    return response;
});
const fetchRecentChanges = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('configuration/fetchRecentChanges', async (limit)=>{
    const response = await configurationService.getRecentChanges(limit);
    return response;
});
const fetchChangesByUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('configuration/fetchChangesByUser', async ({ userId, limit })=>{
    const response = await configurationService.getChangesByUser(userId, limit);
    return response;
});
const exportConfigurations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('configuration/exportConfigurations', async (filter)=>{
    const response = await configurationService.exportConfigurations(filter);
    return response;
});
const importConfigurations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('configuration/importConfigurations', async (data)=>{
    const response = await configurationService.importConfigurations(data);
    return response;
});
// Slice
const configurationSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    name: 'configuration',
    initialState,
    reducers: {
...
const selectFilteredConfigurations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
    selectConfigurations,
    selectFilters
...
const selectConfigurationsByCategory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
    selectConfigurations
], (configurations)=>{
    const grouped = {};
...
const selectEditableConfigurations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
    selectConfigurations
], (configurations)=>configurations.filter((c)=>c.isEditable));
const selectConfigurationsRequiringRestart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
    selectConfigurations
], (configurations)=>configurations.filter((c)=>c.requiresRestart));
const selectConfigurationMetrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$reselect$2f$dist$2f$reselect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSelector"])([
    selectConfigurations
], (configurations)=>{
...
"[project]/src/stores/slices/communicationSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ const communicationApiService = {
   ...
   */ async getAll (params) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].communication.getMessages(params);
        return {
   ...
   */ async getById (id) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].communication.getMessageById(id);
        return {
   ...
   * @returns {Promise<{data: Message}>}
   */ async create (data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].communication.sendMessage(data);
        return {
            data: response.message
        };
    },
 ...
 */ const communicationSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$core$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('communication', communicationApiService, {
    enableBulkOperations: true
});
...
"[project]/src/stores/slices/documentsSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ const documentsApiService = {
   ...
   */ async getAll (params) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].documents.getDocuments(params);
        return {
   ...
   */ async getById (id) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].documents.getDocumentById(id);
        return {
   ...
   * @returns {Promise<{data: Document}>}
   */ async create (data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].documents.createDocument(data);
        return {
            data: response.document
        };
    },
   ...
   * @returns {Promise<{data: Document}>}
   */ async update (id, data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].documents.updateDocument(id, data);
        return {
            data: response.document
        };
    },
   ...
   * @returns {Promise<{success: boolean}>}
   */ async delete (id) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].documents.deleteDocument(id);
        return {
            success: true
        };
    }
 ...
 * @property {Object} thunks - Async thunk creators for API operations
 * @property {Object} actions - Synchronous action creators
 */ const documentsSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2f$core$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('documents', documentsApiService, {
    enableBulkOperations: true
});
...
"[project]/src/stores/slices/contactsSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ContactsApiService {
    ...
    async getContactsByStudent(studentId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].emergencyContacts.getByStudent(studentId);
    }
    async createEmergencyContact(data) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].emergencyContacts.create(data);
    }
    async updateEmergencyContact(id, data) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].emergencyContacts.update(id, data);
    }
    async deleteEmergencyContact(id) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].emergencyContacts.delete(id);
    }
    // Notifications
    async notifyStudent(studentId, notification) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].emergencyContacts.notifyStudent(studentId, notification);
    }
    async notifyContact(contactId, notification) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].emergencyContacts.notifyContact(contactId, notification);
    }
    // Verification
    async verifyContact(contactId, method) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].emergencyContacts.verify(contactId, method);
    }
    // Statistics
    async getStatistics() {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["apiActions"].emergencyContacts.getStatistics();
    }
}
...
const fetchContactsByStudent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('contacts/fetchByStudent', async (studentId)=>{
...
const createEmergencyContact = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('contacts/create', async (data)=>{
    const response = await contactsApiService.createEmergencyContact(data);
    return response.contact;
});
const updateEmergencyContact = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('contacts/update', async ({ id, data })=>{
    const response = await contactsApiService.updateEmergencyContact(id, data);
    return response.contact;
});
const deleteEmergencyContact = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('contacts/delete', async (id)=>{
    await contactsApiService.deleteEmergencyContact(id);
    return id;
});
const notifyStudent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('contacts/notifyStudent', async ({ studentId, notification })=>{
    const response = await contactsApiService.notifyStudent(studentId, notification);
    return response.results;
});
const notifyContact = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('contacts/notifyContact', async ({ contactId, notification })=>{
    const response = await contactsApiService.notifyContact(contactId, notification);
    return response.result;
});
const verifyContact = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('contacts/verify', async ({ contactId, method })=>{
    const response = await contactsApiService.verifyContact(contactId, method);
    return response;
});
const fetchContactStatistics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('contacts/fetchStatistics', async ()=>{
    const statistics = await contactsApiService.getStatistics();
    return statistics;
});
// Slice
const contactsSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    name: 'contacts',
    initialState,
    reducers: {
        // Clear errors
...
"[project]/src/stores/slices/themeSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/stores/slices/notificationsSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ const notificationsSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    name: 'notifications',
    initialState,
    reducers: {
        /**
...
"[project]/src/stores/slices/index.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$usersSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/usersSlice.ts [app-client] (ecmascript)");
// ============================================================
// DASHBOARD & OVERVIEW
// ============================================================
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$dashboardSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/dashboardSlice.ts [app-client] (ecmascript)");
// ============================================================
// HEALTHCARE DOMAIN
// ============================================================
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$healthRecordsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/healthRecordsSlice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$medicationsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/medicationsSlice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$appointmentsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/appointmentsSlice.ts [app-client] (ecmascript)");
// ============================================================
// STUDENT MANAGEMENT
// ============================================================
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$studentsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/studentsSlice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$emergencyContactsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/emergencyContactsSlice.ts [app-client] (ecmascript)");
// ============================================================
// INCIDENT MANAGEMENT
// ============================================================
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$incidentReportsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/incidentReportsSlice.ts [app-client] (ecmascript)");
// ============================================================
// ADMINISTRATION
// ============================================================
// REMOVED: districtsReducer - Unused, legacy pages-old only
// REMOVED: schoolsReducer - Unused, legacy pages-old only
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$settingsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/settingsSlice.ts [app-client] (ecmascript)");
// REMOVED: adminReducer - Unused, 43KB removed
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$configurationSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/configurationSlice.ts [app-client] (ecmascript)");
// ============================================================
// COMMUNICATION & DOCUMENTATION
// ============================================================
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$communicationSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/communicationSlice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$documentsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/documentsSlice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$contactsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/contactsSlice.ts [app-client] (ecmascript)");
// ============================================================
...
// ============================================================
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$themeSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/themeSlice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$notificationsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/notificationsSlice.ts [app-client] (ecmascript)");
;
;
;
;
...
"[project]/src/stores/slices/dashboardSlice.ts [app-client] (ecmascript) <export default as dashboardReducer>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "dashboardReducer",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$dashboardSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$dashboardSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/dashboardSlice.ts [app-client] (ecmascript)");
}),
"[project]/src/stores/slices/incidentReportsSlice.ts [app-client] (ecmascript) <export default as incidentReportsReducer>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "incidentReportsReducer",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$incidentReportsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$incidentReportsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/incidentReportsSlice.ts [app-client] (ecmascript)");
}),
"[project]/src/stores/slices/configurationSlice.ts [app-client] (ecmascript) <export default as configurationReducer>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "configurationReducer",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$configurationSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$configurationSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/configurationSlice.ts [app-client] (ecmascript)");
}),
"[project]/src/stores/slices/contactsSlice.ts [app-client] (ecmascript) <export default as contactsReducer>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "contactsReducer",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$contactsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$contactsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/contactsSlice.ts [app-client] (ecmascript)");
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/identity-access/stores/index.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__authReducer$3e$__ = __turbopack_context__.i("[project]/src/identity-access/stores/authSlice.ts [app-client] (ecmascript) <export default as authReducer>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__$3c$export__default__as__accessControlReducer$3e$__ = __turbopack_context__.i("[project]/src/identity-access/stores/accessControl/index.ts [app-client] (ecmascript) <locals> <export default as accessControlReducer>");
// Import all domain reducers
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/stores/slices/index.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$usersSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/usersSlice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$dashboardSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__dashboardReducer$3e$__ = __turbopack_context__.i("[project]/src/stores/slices/dashboardSlice.ts [app-client] (ecmascript) <export default as dashboardReducer>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$healthRecordsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/healthRecordsSlice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$medicationsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/medicationsSlice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$appointmentsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/appointmentsSlice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$studentsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/studentsSlice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$emergencyContactsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/emergencyContactsSlice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$incidentReportsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__incidentReportsReducer$3e$__ = __turbopack_context__.i("[project]/src/stores/slices/incidentReportsSlice.ts [app-client] (ecmascript) <export default as incidentReportsReducer>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$settingsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/settingsSlice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$configurationSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__configurationReducer$3e$__ = __turbopack_context__.i("[project]/src/stores/slices/configurationSlice.ts [app-client] (ecmascript) <export default as configurationReducer>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$communicationSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/communicationSlice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$documentsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/slices/documentsSlice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$contactsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__contactsReducer$3e$__ = __turbopack_context__.i("[project]/src/stores/slices/contactsSlice.ts [app-client] (ecmascript) <export default as contactsReducer>");
'use client';
;
;
;
 ...
 */ const rootReducer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$redux$2f$dist$2f$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["combineReducers"])({
    ...
    // ============================================================
    auth: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__authReducer$3e$__["authReducer"],
    accessControl: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControl$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__$3c$export__default__as__accessControlReducer$3e$__["accessControlReducer"],
    users: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$usersSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usersReducer"],
    // ============================================================
    // DASHBOARD & OVERVIEW
    // ============================================================
    dashboard: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$dashboardSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__dashboardReducer$3e$__["dashboardReducer"],
    // ============================================================
    // CORE DOMAINS - INCIDENT MANAGEMENT
    // ============================================================
    incidentReports: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$incidentReportsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__incidentReportsReducer$3e$__["incidentReportsReducer"],
    // ============================================================
    // ADMINISTRATION & CONFIGURATION
    // ============================================================
    // REMOVED: districts, schools (unused in active code)
    settings: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$settingsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["settingsReducer"],
    // REMOVED: admin (43KB, unused in active code)
    configuration: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$configurationSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__configurationReducer$3e$__["configurationReducer"],
    // ============================================================
    // STUDENT & HEALTH MANAGEMENT
    // ============================================================
    students: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$studentsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["studentsReducer"],
    healthRecords: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$healthRecordsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["healthRecordsReducer"],
    medications: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$medicationsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["medicationsReducer"],
    appointments: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$appointmentsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["appointmentsReducer"],
    emergencyContacts: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$emergencyContactsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emergencyContactsReducer"],
    // ============================================================
    // COMMUNICATION & DOCUMENTATION
    // ============================================================
    communication: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$communicationSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["communicationReducer"],
    documents: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$documentsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["documentsReducer"],
    contacts: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$slices$2f$contactsSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__contactsReducer$3e$__["contactsReducer"]
});
// ==========================================
 ...
 */ function loadPersistedState() {
    ...
    try {
        ...
        if (uiState.incidentReportsUI) {
            mappedState.incidentReports = uiState.incidentReportsUI;
        }
        return mappedState;
    } catch (error) {
...
function clearPersistedState() {
    ...
    try {
        // Clear localStorage
        const localKeys = Object.keys(localStorage).filter((key)=>key.startsWith('whitecross_'));
        localKeys.forEach((key)=>localStorage.removeItem(key));
        // Clear sessionStorage
        const sessionKeys = Object.keys(sessionStorage).filter((key)=>key.startsWith('whitecross_'));
...
function ReduxProvider(t0) {
    ...
    if ($[0] !== "1b9dd9cd6e8b83908298940a4f2f67198f3add87db0e3c5f8098a430a82daae5") {
        for(let $i = 0; $i < 4; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "1b9dd9cd6e8b83908298940a4f2f67198f3add87db0e3c5f8098a430a82daae5";
    }
    const { children } = t0;
    const [store] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(_ReduxProviderUseState);
    let t1;
    if ($[1] !== children || $[2] !== store) {
...
_s(ReduxProvider, "zMAQufJewGeLf06AldbMNP3c+74=");
_c = ReduxProvider;
function _ReduxProviderUseState() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["makeStore"])();
}
...
"[project]/src/config/apolloClient.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$link$2f$retry$2f$retryLink$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@apollo/client/link/retry/retryLink.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-hot-toast/dist/index.mjs [app-client] (ecmascript)");
;
;
;
 ...
 */ const retryLink = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$link$2f$retry$2f$retryLink$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RetryLink"]({
    delay: {
        initial: 300,
        max: 5000,
        jitter: true
    ...
    if (graphQLErrors) {
        graphQLErrors.forEach(({ message, locations, path, extensions })=>{
            ...
            if (!message.includes('Network')) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(message || 'An unexpected error occurred');
            }
        });
    }
    if (networkError) {
        ...
        if ('statusCode' in networkError) {
            switch(networkError.statusCode){
                case 401:
                    if ("TURBOPACK compile-time truthy", 1) {
                        localStorage.removeItem('auth_token');
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Authentication required');
                        window.location.href = '/login';
                    }
                    break;
                case 403:
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Access denied');
                    break;
                case 404:
                ...
                case 429:
                    ...
                    break;
                case 500:
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Server error. Please try again.');
                    break;
                default:
            ...
            // Connection errors
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Connection error. Please check your internet connection.');
        }
    }
});
// ==========================================
...
"[project]/src/providers/ApolloProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$apolloClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/config/apolloClient.ts [app-client] (ecmascript)");
'use client';
;
;
;
;
function ApolloProvider(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(3);
    if ($[0] !== "213f347851df085a0a541c0ecb44c1430dd1c186968f01c2e37831610f037757") {
        for(let $i = 0; $i < 3; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "213f347851df085a0a541c0ecb44c1430dd1c186968f01c2e37831610f037757";
    }
    const { children } = t0;
    let t1;
    if ($[1] !== children) {
        t1 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$react$2f$context$2f$ApolloProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ApolloProvider"], {
            client: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$apolloClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apolloClient"],
            children: children
        }, void 0, false, {
...
"[project]/src/identity-access/components/session/SessionWarningModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function SessionWarningModal(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(38);
    if ($[0] !== "d4d6668585f0dad3d602561c596093711c161f99ba0ff379cfc0f0eb56c35d98") {
        for(let $i = 0; $i < 38; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "d4d6668585f0dad3d602561c596093711c161f99ba0ff379cfc0f0eb56c35d98";
    }
    const { isOpen, timeRemainingSeconds, onExtendSession, onLogout } = t0;
    const [countdown, setCountdown] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(timeRemainingSeconds);
    const extendButtonRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const modalRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    let t1;
    let t2;
    if ($[1] !== timeRemainingSeconds) {
        t1 = ({
            "SessionWarningModal[useEffect()]": ()=>{
        ...
        t3 = ({
            "SessionWarningModal[useEffect()]": ()=>{
                ...
                const interval = setInterval({
                    "SessionWarningModal[useEffect() > setInterval()]": ()=>{
                        setCountdown({
                            "SessionWarningModal[useEffect() > setInterval() > setCountdown()]": (prev)=>{
                                if (prev <= 1) {
                                    clearInterval(interval);
                                    onLogout();
                                    return 0;
                        ...
                        }["SessionWarningModal[useEffect() > setInterval() > setCountdown()]"]);
                    }
                }["SessionWarningModal[useEffect() > setInterval()]"], 1000);
        ...
        t5 = ({
            "SessionWarningModal[useEffect()]": ()=>{
                ...
                const focusTimeout = setTimeout({
                    "SessionWarningModal[useEffect() > setTimeout()]": ()=>{
                        extendButtonRef.current?.focus();
                    }
                }["SessionWarningModal[useEffect() > setTimeout()]"], 100);
                const previouslyFocusedElement = document.activeElement;
                const handleTabKey = {
                    "SessionWarningModal[useEffect() > handleTabKey]": (e)=>{
                        if (!modalRef.current) {
                            return;
                        }
                ...
                }["SessionWarningModal[useEffect() > handleTabKey]"];
                const handleKeyDown = {
                    "SessionWarningModal[useEffect() > handleKeyDown]": (e_0)=>{
                        if (e_0.key === "Tab") {
                            handleTabKey(e_0);
                        }
                    }
                }["SessionWarningModal[useEffect() > handleKeyDown]"];
    ...
    let t7;
    if ($[11] !== onExtendSession) {
        t7 = ({
            "SessionWarningModal[handleKeyDown_0]": (e_1)=>{
                if (e_1.key === "Escape") {
                    e_1.preventDefault();
                    onExtendSession();
                }
            }
        })["SessionWarningModal[handleKeyDown_0]"];
        $[11] = onExtendSession;
        $[12] = t7;
    } else {
        t7 = $[12];
    }
    const handleKeyDown_0 = t7;
    let t8;
    if ($[13] !== onExtendSession) {
        t8 = ({
            "SessionWarningModal[handleExtend]": ()=>{
                onExtendSession();
            }
        })["SessionWarningModal[handleExtend]"];
        $[13] = onExtendSession;
    ...
    const handleExtend = t8;
    let t9;
    if ($[15] !== onLogout) {
        t9 = ({
            "SessionWarningModal[handleLogout]": ()=>{
                onLogout();
            }
        })["SessionWarningModal[handleLogout]"];
        $[15] = onLogout;
    ...
    let t10;
    if ($[17] !== seconds) {
        t10 = seconds.toString().padStart(2, "0");
        $[17] = seconds;
        $[18] = t10;
    } else {
        t10 = $[18];
    }
    const formattedTime = `${minutes}:${t10}`;
    ...
    let t13;
    if ($[22] !== screenReaderAnnouncement) {
...
_s(SessionWarningModal, "KtCLwKL5QvpxrfBwevZF5UnCO/A=");
...
"[project]/src/identity-access/components/session/index.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
 ...
 */ __turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$components$2f$session$2f$SessionWarningModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/components/session/SessionWarningModal.tsx [app-client] (ecmascript)");
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/identity-access/contexts/AuthContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-redux/dist/react-redux.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/stores/authSlice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$components$2f$session$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/identity-access/components/session/index.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$components$2f$session$2f$SessionWarningModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/components/session/SessionWarningModal.tsx [app-client] (ecmascript)");
;
...
function AuthProvider({ children }) {
    ...
    const authState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "AuthProvider.useSelector[authState]": (state)=>state.auth
    }["AuthProvider.useSelector[authState]"]);
    ...
    const [lastActivityAt, setLastActivityAt] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [showSessionWarning, setShowSessionWarning] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const activityCheckInterval = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(undefined);
    const tokenRefreshInterval = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(undefined);
    ...
    const isBroadcastChannelSupported = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    // ==========================================
    // HYDRATION HANDLING
    // ==========================================
    ...
    const updateActivity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[updateActivity]": ()=>{
            ...
            if (isBroadcastChannelSupported.current && broadcastChannel.current) {
                try {
                    ...
                    console.warn('[Auth] Failed to broadcast activity:', error_0);
                }
            }
        }
    }["AuthProvider.useCallback[updateActivity]"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            return ({
                "AuthProvider.useEffect": ()=>{
                    events.forEach({
                        "AuthProvider.useEffect": (event_0)=>{
                            window.removeEventListener(event_0, updateActivity);
                        }
                    }["AuthProvider.useEffect"]);
                }
            })["AuthProvider.useEffect"];
    ...
    const checkSession = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[checkSession]": ()=>{
            ...
            const idleTime = now_0 - lastActivityAt;
            ...
            if (idleTime >= HIPAA_IDLE_TIMEOUT) {
                ...
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logoutUser"])(undefined));
            ...
            // Check token expiration
            if (sessionExpiresAt && now_0 >= sessionExpiresAt) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            }["AuthProvider.useEffect"], ACTIVITY_CHECK_INTERVAL);
            return ({
                "AuthProvider.useEffect": ()=>{
    ...
    const refreshToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[refreshToken]": async ()=>{
            try {
                await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["refreshAuthToken"])()).unwrap();
                updateActivity(); // Reset activity on successful refresh
            } catch (error_1) {
                console.error('[Auth] Token refresh failed:', error_1);
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logoutUser"])(undefined));
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            const BroadcastChannelConstructor = ("TURBOPACK compile-time value", "object") !== 'undefined' && 'BroadcastChannel' in window ? window.BroadcastChannel : undefined;
            ...
            try {
                ...
                broadcastChannel.current.onmessage = ({
                    "AuthProvider.useEffect": (event_1)=>{
                        const { type, timestamp } = event_1.data;
                        switch(type){
                            case 'logout':
                            ...
                            case 'login':
                                ...
                                if (event_1.data.user) {
                                    dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setUserFromSession"])(event_1.data.user));
                                }
                                break;
                ...
                console.warn('[Auth] Failed to initialize BroadcastChannel:', error_2);
                isBroadcastChannelSupported.current = false;
                ...
                "AuthProvider.useEffect": ()=>{
                    if (broadcastChannel.current) {
                        try {
                            ...
                            console.warn('[Auth] Error closing BroadcastChannel:', error_3);
                        }
                        broadcastChannel.current = null;
                    }
                }
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[login]": async (email, password, rememberMe = false)=>{
            try {
                const result = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginUser"])({
                    email,
                    password
                })).unwrap();
                updateActivity();
                ...
                if (isBroadcastChannelSupported.current && broadcastChannel.current) {
                    try {
                        ...
                        console.warn('[Auth] Failed to broadcast login:', error_5);
                    }
                }
                ...
                console.error('[Auth] Login failed:', error_4);
                throw error_4;
            }
        }
    ...
    const logout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[logout]": async ()=>{
            try {
                await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logoutUser"])(undefined)).unwrap();
                ...
                if (isBroadcastChannelSupported.current && broadcastChannel.current) {
                    try {
                        ...
                        console.warn('[Auth] Failed to broadcast logout:', error_7);
                    }
                }
                ...
                console.error('[Auth] Logout failed:', error_6);
    ...
    const clearError = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[clearError]": ()=>{
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clearAuthError"])());
        }
    }["AuthProvider.useCallback[clearError]"], [
        dispatch
    ]);
    ...
    const timeRemainingSeconds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuthProvider.useMemo[timeRemainingSeconds]": ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthContext.Provider, {
        ...
        children: [
            children,
            showSessionWarning && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$components$2f$session$2f$SessionWarningModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SessionWarningModal"], {
...
_s(AuthProvider, "RWhPgPUyMDNfmQBbkxjdMJMeKmA=", false, function() {
    return [
...
function useAuth() {
    ...
    if ($[0] !== "4530b0cef7fd7388b8ddf93a24608515ec1e3290de55617f549e3e242adf84df") {
        for(let $i = 0; $i < 1; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "4530b0cef7fd7388b8ddf93a24608515ec1e3290de55617f549e3e242adf84df";
    }
...
const NavigationProvider = ({ children, initialSidebarOpen = true, initialSidebarCollapsed = false, maxHistoryEntries = 50, persistState = true })=>{
    ...
    const getInitialSidebarOpen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NavigationProvider.useCallback[getInitialSidebarOpen]": ()=>{
            if (("TURBOPACK compile-time value", "object") === 'undefined' || !persistState) {
    ...
    const getInitialSidebarCollapsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NavigationProvider.useCallback[getInitialSidebarCollapsed]": ()=>{
            if (("TURBOPACK compile-time value", "object") === 'undefined' || !persistState) {
                return initialSidebarCollapsed;
            }
            try {
                const stored_0 = localStorage.getItem(STORAGE_KEYS.SIDEBAR_COLLAPSED);
                return stored_0 !== null ? stored_0 === 'true' : initialSidebarCollapsed;
            } catch (error_0) {
                console.warn('Failed to read sidebar collapsed state from localStorage:', error_0);
                return initialSidebarCollapsed;
            }
        }
    }["NavigationProvider.useCallback[getInitialSidebarCollapsed]"], [
    ...
    const getInitialActiveRoute = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NavigationProvider.useCallback[getInitialActiveRoute]": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            if (persistState) {
                try {
                    const stored_1 = localStorage.getItem(STORAGE_KEYS.ACTIVE_ROUTE);
                    if (stored_1) return stored_1;
                } catch (error_1) {
                    console.warn('Failed to read active route from localStorage:', error_1);
                }
            }
    ...
    // State management
    const [isSidebarOpen, setIsSidebarOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(getInitialSidebarOpen);
    ...
    const [activeRoute, setActiveRouteState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(getInitialActiveRoute);
    const [breadcrumbs, setBreadcrumbsState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [isSidebarCollapsed, setIsSidebarCollapsed] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(getInitialSidebarCollapsed);
    const [notificationOpen, setNotificationOpenState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // Persist sidebar state to localStorage
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NavigationProvider.useEffect": ()=>{
            if (!persistState || ("TURBOPACK compile-time value", "object") === 'undefined') return;
            try {
                localStorage.setItem(STORAGE_KEYS.SIDEBAR_OPEN, String(isSidebarOpen));
            } catch (error_2) {
                console.warn('Failed to persist sidebar state:', error_2);
            }
        }
    }["NavigationProvider.useEffect"], [
        isSidebarOpen,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NavigationProvider.useEffect": ()=>{
            ...
            try {
                ...
                console.warn('Failed to persist sidebar collapsed state:', error_3);
            }
        }
    }["NavigationProvider.useEffect"], [
        isSidebarCollapsed,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NavigationProvider.useEffect": ()=>{
            ...
            try {
                ...
                console.warn('Failed to persist active route:', error_4);
            }
        }
    }["NavigationProvider.useEffect"], [
        activeRoute,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NavigationProvider.useEffect": ()=>{
            ...
            return ({
                "NavigationProvider.useEffect": ()=>window.removeEventListener('resize', handleResize)
            })["NavigationProvider.useEffect"];
        }
    }["NavigationProvider.useEffect"], [
        isMobileSidebarOpen
   ...
   */ const toggleSidebar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NavigationProvider.useCallback[toggleSidebar]": ()=>{
            setIsSidebarOpen({
                "NavigationProvider.useCallback[toggleSidebar]": (prev)=>!prev
            }["NavigationProvider.useCallback[toggleSidebar]"]);
        }
    }["NavigationProvider.useCallback[toggleSidebar]"], []);
    /**
   * Set desktop sidebar open/closed explicitly
   */ const setSidebarOpen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NavigationProvider.useCallback[setSidebarOpen]": (open)=>{
            setIsSidebarOpen(open);
        }
    }["NavigationProvider.useCallback[setSidebarOpen]"], []);
    /**
   ...
   */ const toggleMobileSidebar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NavigationProvider.useCallback[toggleMobileSidebar]": ()=>{
            setIsMobileSidebarOpen({
                "NavigationProvider.useCallback[toggleMobileSidebar]": (prev_0)=>!prev_0
            }["NavigationProvider.useCallback[toggleMobileSidebar]"]);
        }
    }["NavigationProvider.useCallback[toggleMobileSidebar]"], []);
    /**
   * Set mobile sidebar open/closed explicitly
   */ const setMobileSidebarOpen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NavigationProvider.useCallback[setMobileSidebarOpen]": (open_0)=>{
            setIsMobileSidebarOpen(open_0);
        }
    }["NavigationProvider.useCallback[setMobileSidebarOpen]"], []);
    /**
   * Set the active route and update navigation history
   */ const setActiveRoute = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NavigationProvider.useCallback[setActiveRoute]": (route)=>{
            setActiveRouteState(route);
            // Add to history
            setNavigationHistory({
                "NavigationProvider.useCallback[setActiveRoute]": (prev_1)=>{
                    const newEntry = {
                        path: route,
                        timestamp: Date.now()
                    };
                    // Avoid duplicate consecutive entries
                    if (prev_1.length > 0 && prev_1[prev_1.length - 1].path === route) {
                        return prev_1;
                    }
            ...
            }["NavigationProvider.useCallback[setActiveRoute]"]);
        }
    }["NavigationProvider.useCallback[setActiveRoute]"], [
        maxHistoryEntries
    ]);
   ...
   */ const setBreadcrumbs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NavigationProvider.useCallback[setBreadcrumbs]": (newBreadcrumbs)=>{
            setBreadcrumbsState(newBreadcrumbs);
        }
    }["NavigationProvider.useCallback[setBreadcrumbs]"], []);
    /**
   ...
   */ const addToHistory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NavigationProvider.useCallback[addToHistory]": (entry)=>{
            setNavigationHistory({
                "NavigationProvider.useCallback[addToHistory]": (prev_2)=>{
                    const newEntry_0 = {
                        ...entry,
                        timestamp: Date.now()
                    };
                    // Avoid duplicate consecutive entries
                    if (prev_2.length > 0 && prev_2[prev_2.length - 1].path === entry.path) {
                        return prev_2;
                    }
                    const updated_0 = [
                        ...prev_2,
                    ...
                    return updated_0.slice(-maxHistoryEntries);
                }
            }["NavigationProvider.useCallback[addToHistory]"]);
        }
    }["NavigationProvider.useCallback[addToHistory]"], [
        maxHistoryEntries
    ]);
   ...
   */ const clearHistory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NavigationProvider.useCallback[clearHistory]": ()=>{
            setNavigationHistory([]);
        }
    }["NavigationProvider.useCallback[clearHistory]"], []);
    /**
   * Toggle sidebar collapsed state (mini sidebar)
   */ const toggleSidebarCollapsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NavigationProvider.useCallback[toggleSidebarCollapsed]": ()=>{
            setIsSidebarCollapsed({
                "NavigationProvider.useCallback[toggleSidebarCollapsed]": (prev_3)=>!prev_3
            }["NavigationProvider.useCallback[toggleSidebarCollapsed]"]);
        }
    }["NavigationProvider.useCallback[toggleSidebarCollapsed]"], []);
    /**
   ...
   */ const setSidebarCollapsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NavigationProvider.useCallback[setSidebarCollapsed]": (collapsed)=>{
            setIsSidebarCollapsed(collapsed);
        }
    }["NavigationProvider.useCallback[setSidebarCollapsed]"], []);
    /**
   * Navigate back to previous route in history
   * Returns the previous navigation entry or null if history is empty
   */ const navigateBack = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NavigationProvider.useCallback[navigateBack]": ()=>{
            ...
            setNavigationHistory({
                "NavigationProvider.useCallback[navigateBack]": (prev_4)=>prev_4.slice(0, -1)
            }["NavigationProvider.useCallback[navigateBack]"]);
   ...
   */ const toggleNotificationCenter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NavigationProvider.useCallback[toggleNotificationCenter]": ()=>{
            setNotificationOpenState({
                "NavigationProvider.useCallback[toggleNotificationCenter]": (prev_5)=>!prev_5
            }["NavigationProvider.useCallback[toggleNotificationCenter]"]);
        }
    }["NavigationProvider.useCallback[toggleNotificationCenter]"], []);
    /**
   * Set notification center open/closed explicitly
   */ const setNotificationOpen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NavigationProvider.useCallback[setNotificationOpen]": (open_1)=>{
            setNotificationOpenState(open_1);
        }
    }["NavigationProvider.useCallback[setNotificationOpen]"], []);
    // Memoize context value to prevent unnecessary re-renders
    const contextValue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NavigationProvider.useMemo[contextValue]": ()=>({
                // State
                isSidebarOpen,
                isMobileSidebarOpen,
                activeRoute,
...
_s(NavigationProvider, "7sfMp5whoi/4a3f3rbwIYxMknUA=");
_c = NavigationProvider;
const useNavigation = ()=>{
    _s1();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(1);
    if ($[0] !== "4eca22ec2fff1ee29d22b340a20ba51375d08437a57862adbdcf8538571365db") {
        for(let $i = 0; $i < 1; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "4eca22ec2fff1ee29d22b340a20ba51375d08437a57862adbdcf8538571365db";
    }
...
class NavigationErrorBoundary extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Component {
    constructor(props){
        super(props);
        this.state = {
            hasError: false,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$queryClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/config/queryClient.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$providers$2f$ApolloProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/providers/ApolloProvider.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/contexts/AuthContext.tsx [app-client] (ecmascript)");
...
function Providers(t0) {
    ...
    if ($[0] !== "0f7a67d32325a3ee11abeff2ce44e5f3f1606c4c27641590cf39614cff82bf22") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "0f7a67d32325a3ee11abeff2ce44e5f3f1606c4c27641590cf39614cff82bf22";
    }
    const { children } = t0;
    ...
    let t1;
    if ($[1] !== children) {
        t1 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthProvider"], {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$NavigationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NavigationProvider"], {
                children: children
            }, void 0, false, {
    ...
    let t4;
    if ($[6] !== queryClient || $[7] !== t3) {
        t4 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$providers$2f$ReduxProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ReduxProvider"], {
...
function _ProvidersUseState() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$queryClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getQueryClient"])();
}
var _c;
...
//# sourceMappingURL=src_827d4f13._.js.map