...
;
;
function createApiInstance(tokenManager) {
...
"[project]/src/identity-access/stores/accessControlSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControlSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/stores/accessControlSlice.ts [app-client] (ecmascript)");
;
;
;
;
...
"[project]/src/identity-access/stores/accessControlSlice.ts [app-client] (ecmascript) <export default as accessControlReducer>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "accessControlReducer",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControlSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControlSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/stores/accessControlSlice.ts [app-client] (ecmascript)");
}),
"[project]/src/stores/sliceFactory.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createEntitySlice(name, apiService, options = {}) {
    ...
    const adapter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createEntityAdapter"])({
    ...
    const initialState = createInitialEnhancedState(adapter, customInitialState);
    ...
    const updateLoadingState = (state, operation, loading)=>{
...
const __TURBOPACK__default__export__ = createEntitySlice;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/sliceFactory.ts [app-client] (ecmascript)");
...
const usersSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('users', usersApiService, {
    enableBulkOperations: true
});
 ...
 *
 * @see {@link createEntitySlice} for factory implementation details
 */ const healthRecordsSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('healthRecords', healthRecordsApiService, {
    enableBulkOperations: false
});
 ...
 *
 * @see {@link createEntitySlice} for factory implementation details
 */ const medicationsSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('medications', medicationsApiService, {
    enableBulkOperations: false
});
 ...
 */ const appointmentsSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('appointments', appointmentsApiService, {
    enableBulkOperations: false
});
 ...
 *
 * @see {@link createEntitySlice} for factory implementation details
 */ const studentsSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('students', studentsApiService, {
    enableBulkOperations: true
});
/**
 ...
 *
 * @see {@link createEntitySlice} for factory implementation details
 */ const emergencyContactsSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('emergencyContacts', emergencyContactsApiService, {
    enableBulkOperations: false
});
...
const settingsSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('settings', settingsApiService, {
    enableBulkOperations: false
});
 ...
 */ const communicationSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('communication', communicationApiService, {
    enableBulkOperations: true
});
 ...
 * @property {Object} thunks - Async thunk creators for API operations
 * @property {Object} actions - Synchronous action creators
 */ const documentsSliceFactory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$sliceFactory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEntitySlice"])('documents', documentsApiService, {
    enableBulkOperations: true
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControlSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__accessControlReducer$3e$__ = __turbopack_context__.i("[project]/src/identity-access/stores/accessControlSlice.ts [app-client] (ecmascript) <export default as accessControlReducer>");
 ...
 */ const rootReducer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$redux$2f$dist$2f$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["combineReducers"])({
    ...
    accessControl: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$stores$2f$accessControlSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__accessControlReducer$3e$__["accessControlReducer"],
...
"[project]/src/identity-access/utils/tokenSecurity.types.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/identity-access/utils/tokenSecurity.encryption.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/utils/tokenSecurity.types.ts [app-client] (ecmascript)");
;
class EncryptionManager {
   ...
   */ async init() {
        try {
            const keyData = localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TOKEN_SECURITY_CONFIG"].ENCRYPTION_KEY_NAME);
            if (keyData) {
   ...
   */ async generateNewKey() {
        ...
        localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TOKEN_SECURITY_CONFIG"].ENCRYPTION_KEY_NAME, this.arrayBufferToBase64(keyBuffer));
    }
    /**
...
"[project]/src/identity-access/utils/tokenSecurity.storage.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/utils/tokenSecurity.types.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$encryption$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/utils/tokenSecurity.encryption.ts [app-client] (ecmascript)");
;
;
class TokenSecurityManager {
   ...
   */ async init() {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$encryption$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["encryptionManager"].init();
    }
    /**
   ...
   */ async storeToken(token, user, expiresIn = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TOKEN_SECURITY_CONFIG"].DEFAULT_TOKEN_LIFETIME) {
        const now = Date.now();
        const tokenData = {
            token,
            user,
        ...
        try {
            if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$encryption$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["encryptionManager"].isEncryptionAvailable()) {
                const encrypted = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$encryption$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["encryptionManager"].encryptData(JSON.stringify(tokenData));
                localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TOKEN_SECURITY_CONFIG"].STORAGE_KEY, JSON.stringify(encrypted));
            } else {
                // Fallback to unencrypted storage
                localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TOKEN_SECURITY_CONFIG"].STORAGE_KEY, JSON.stringify(tokenData));
            }
        } catch (error) {
   ...
   */ async getValidToken() {
        try {
            const storedData = localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TOKEN_SECURITY_CONFIG"].STORAGE_KEY);
            if (!storedData) return null;
            let tokenData;
            if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$encryption$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["encryptionManager"].isEncryptionAvailable()) {
                try {
                    const encryptedData = JSON.parse(storedData);
                    const decryptedString = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$encryption$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["encryptionManager"].decryptData(encryptedData);
            ...
            if (tokenData.expiresAt && tokenData.expiresAt - now < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TOKEN_SECURITY_CONFIG"].TOKEN_EXPIRY_BUFFER) {
   ...
   */ clearToken() {
        localStorage.removeItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TOKEN_SECURITY_CONFIG"].STORAGE_KEY);
        // Clear legacy storage keys for backward compatibility
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TOKEN_SECURITY_CONFIG"].LEGACY_TOKEN_KEYS.forEach((key)=>{
            localStorage.removeItem(key);
        });
        localStorage.removeItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TOKEN_SECURITY_CONFIG"].LEGACY_USER_KEY);
    }
    /**
...
"[project]/src/identity-access/components/AuthTokenSync.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/**
 * @fileoverview Authentication Token Synchronizer
 * @module identity-access/components/AuthTokenSync
 * 
 * Client-side component that synchronizes authentication tokens between
 * server-side cookies and client-side token security manager for production use.
 */ __turbopack_context__.s([
    "AuthTokenSync",
    ()=>AuthTokenSync,
    "useServerAuthTokens",
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/compiler-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/identity-access/utils/tokenSecurity.storage.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
'use client';
;
;
;
function AuthTokenSync(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(8);
    if ($[0] !== "c886557b7ba6693aa3ddae6ce68fd3339bc2fbf871c7835eab8939cfa350dea1") {
        for(let $i = 0; $i < 8; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "c886557b7ba6693aa3ddae6ce68fd3339bc2fbf871c7835eab8939cfa350dea1";
    }
    const { accessToken, refreshToken, user } = t0;
    let t1;
    if ($[1] !== accessToken || $[2] !== user) {
        t1 = ({
            "AuthTokenSync[useEffect()]": ()=>{
                const syncTokens = async function syncTokens() {
                    if (!accessToken || !user) {
                        return;
                    }
                    ;
                    try {
                        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tokenSecurityManager"].init();
                        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$utils$2f$tokenSecurity$2e$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tokenSecurityManager"].storeToken(accessToken, user, 86400000);
                        console.log("[AuthTokenSync] Tokens synchronized successfully");
                    } catch (t2) {
                        const error = t2;
                        console.error("[AuthTokenSync] Token synchronization failed:", error);
                    }
                };
                syncTokens();
            }
    ...
    let t2;
    if ($[4] !== accessToken || $[5] !== refreshToken || $[6] !== user) {
        t2 = [
            accessToken,
            refreshToken,
            user
...
_s(AuthTokenSync, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = AuthTokenSync;
function useServerAuthTokens() {
    // This would typically read from cookies or server state
    // Implementation depends on your auth state management
    return {
        accessToken: null,
        refreshToken: null,
        user: null
...
var _c;
__turbopack_context__.k.register(_c, "AuthTokenSync");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_c40466ec._.js.map