...
"[project]/src/components/shared/errors/GenericDomainError.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const GenericDomainError = (t0)=>{
    ...
    if ($[0] !== "2a9f2e15ee455b62b6944d9c371a20eddc042b4085661dbc4b54c34232f826b1") {
        for(let $i = 0; $i < 35; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2a9f2e15ee455b62b6944d9c371a20eddc042b4085661dbc4b54c34232f826b1";
    }
    const { error, reset, domain, domainIcon, customMessage, customRecoverySteps } = t0;
    let t1;
    if ($[1] !== domain) {
        t1 = domain.toLowerCase();
        $[1] = domain;
        $[2] = t1;
    } else {
        t1 = $[2];
    }
    const defaultMessage = `Unable to load ${t1} data. This may be due to a network issue or server problem.`;
    ...
    const defaultRecoverySteps = t2;
    const recoverySteps = customRecoverySteps || defaultRecoverySteps;
    let t3;
    if ($[4] !== domainIcon) {
        t3 = domainIcon || /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$triangle$2d$alert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__AlertTriangle$3e$__["AlertTriangle"], {
            className: "h-8 w-8 text-red-600 dark:text-red-400"
        }, void 0, false, {
            fileName: "[project]/src/components/shared/errors/GenericDomainError.tsx",
            lineNumber: 63,
            columnNumber: 24
        }, ("TURBOPACK compile-time value", void 0));
        $[4] = domainIcon;
    ...
    if ($[6] !== t3) {
        t4 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-red-100 dark:bg-red-900/30 mb-4",
            children: t3
        }, void 0, false, {
            fileName: "[project]/src/components/shared/errors/GenericDomainError.tsx",
            lineNumber: 71,
    ...
    let t14;
    if ($[23] !== error) {
        t14 = ("TURBOPACK compile-time value", "development") === "development" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "mt-6 p-4 bg-gray-100 dark:bg-gray-900 rounded-lg text-left",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: "text-xs font-mono text-gray-700 dark:text-gray-300 mb-2",
                    children: [
    ...
    let t15;
    if ($[25] !== error) {
        t15 = ("TURBOPACK compile-time value", "development") === "production" && error.digest && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
    ...
    let t16;
    if ($[27] !== t13 || $[28] !== t14 || $[29] !== t15 || $[30] !== t4 || $[31] !== t5 || $[32] !== t6 || $[33] !== t9) {
...
_c = GenericDomainError;
GenericDomainError.displayName = 'GenericDomainError';
const __TURBOPACK__default__export__ = GenericDomainError;
...
var _c;
__turbopack_context__.k.register(_c, "GenericDomainError");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/app/(dashboard)/medications/error.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * @since 1.0.0
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/compiler-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$errors$2f$GenericDomainError$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/shared/errors/GenericDomainError.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$triangle$2d$alert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__AlertTriangle$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/triangle-alert.js [app-client] (ecmascript) <export default as AlertTriangle>");
...
function MedicationsError(t0) {
    ...
    if ($[0] !== "03608fca5162c6094a8e7e0eb8a969aaa863a0a9b624a1e4e81392de41bc1f54") {
        for(let $i = 0; $i < 31; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "03608fca5162c6094a8e7e0eb8a969aaa863a0a9b624a1e4e81392de41bc1f54";
    }
    const { error, reset } = t0;
    let t1;
    if ($[1] !== error.message) {
        t1 = error.message?.includes("emergency") || error.message?.includes("critical");
        $[1] = error.message;
        $[2] = t1;
    } else {
        t1 = $[2];
    }
    const isEmergencyScenario = t1;
    let t2;
    if ($[3] !== error.message) {
        t2 = error.message?.includes("network") || error.message?.includes("fetch");
        $[3] = error.message;
        $[4] = t2;
    } else {
        t2 = $[4];
    }
    const isNetworkError = t2;
    let t3;
    if ($[5] !== error.message) {
        t3 = error.message?.includes("database") || error.message?.includes("sync");
        $[5] = error.message;
        $[6] = t3;
    } else {
        t3 = $[6];
    }
    const isDataError = t3;
    let t4;
    if ($[7] !== isDataError || $[8] !== isEmergencyScenario || $[9] !== isNetworkError) {
        t4 = ({
            "MedicationsError[getHealthcareMessage]": ()=>{
        ...
        $[7] = isDataError;
        $[8] = isEmergencyScenario;
        $[9] = isNetworkError;
        $[10] = t4;
    } else {
        t4 = $[10];
    }
    const getHealthcareMessage = t4;
    let t5;
    if ($[11] !== isDataError || $[12] !== isEmergencyScenario || $[13] !== isNetworkError) {
        t5 = ({
            "MedicationsError[getRecoverySteps]": ()=>{
                const baseSteps = [
        ...
        $[11] = isDataError;
        $[12] = isEmergencyScenario;
        $[13] = isNetworkError;
        $[14] = t5;
    } else {
        t5 = $[14];
    }
    const getRecoverySteps = t5;
    let t6;
    if ($[15] !== isDataError || $[16] !== isEmergencyScenario || $[17] !== isNetworkError) {
        t6 = ({
            "MedicationsError[getErrorIcon]": ()=>{
                if (isEmergencyScenario) {
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$triangle$2d$alert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__AlertTriangle$3e$__["AlertTriangle"], {
                        className: "h-8 w-8 text-red-600 dark:text-red-400"
                    }, void 0, false, {
                        fileName: "[project]/src/app/(dashboard)/medications/error.tsx",
                        lineNumber: 122,
                        columnNumber: 18
                    }, this);
                }
        ...
        $[15] = isDataError;
        $[16] = isEmergencyScenario;
        $[17] = isNetworkError;
        $[18] = t6;
    } else {
        t6 = $[18];
    }
    const getErrorIcon = t6;
    let t7;
    if ($[19] !== getErrorIcon) {
        t7 = getErrorIcon();
        $[19] = getErrorIcon;
    ...
    const t8 = getHealthcareMessage();
    let t9;
    if ($[21] !== getRecoverySteps) {
        t9 = getRecoverySteps();
        $[21] = getRecoverySteps;
        $[22] = t9;
    } else {
    ...
    const t10 = isEmergencyScenario ? "critical" : isNetworkError ? "high" : "medium";
    let t11;
    if ($[23] !== error || $[24] !== isEmergencyScenario || $[25] !== reset || $[26] !== t10 || $[27] !== t7 || $[28] !== t8 || $[29] !== t9) {
        t11 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$errors$2f$GenericDomainError$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GenericDomainError"], {
            error: error,
            reset: reset,
            domain: "Medication Management",
            domainIcon: t7,
            customMessage: t8,
            customRecoverySteps: t9,
            severity: t10,
...
_c = MedicationsError;
var _c;
__turbopack_context__.k.register(_c, "MedicationsError");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_99796ead._.js.map