...
"[project]/src/app/(dashboard)/students/error.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Error(t0) {
    ...
    if ($[0] !== "fdcf44692522bd23fc893cac3ea95b71508186054a0db201d4eb10691ba59811") {
        for(let $i = 0; $i < 27; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "fdcf44692522bd23fc893cac3ea95b71508186054a0db201d4eb10691ba59811";
    }
    ...
    const getErrorIcon = _ErrorGetErrorIcon;
    const t3 = getErrorIcon(error);
    let t4;
    if ($[4] !== t3) {
        t4 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            fileName: "[project]/src/app/(dashboard)/students/error.tsx",
            lineNumber: 48,
            columnNumber: 10
        }, this);
        $[4] = t3;
    ...
    const t7 = getErrorMessage(error);
    let t8;
    if ($[9] !== t7) {
    ...
    let t9;
    if ($[11] !== error) {
        t9 = ("TURBOPACK compile-time value", "development") === "development" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("details", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("summary", {
                    ...
                    children: "Technical Details (Development)"
                }, void 0, false, {
                    fileName: "[project]/src/app/(dashboard)/students/error.tsx",
                    lineNumber: 80,
                    columnNumber: 110
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "mt-2 text-xs text-gray-600 font-mono",
                    children: [
...
function _ErrorGetErrorIcon(error_1) {
    if (error_1.message.includes("fetch") || error_1.message.includes("network")) {
        return "\uD83C\uDF10";
    }
    if (error_1.message.includes("404")) {
        return "\uD83D\uDD0D";
    }
    if (error_1.message.includes("403")) {
        return "\uD83D\uDD12";
    }
...
function _ErrorGetErrorMessage(error_0) {
    if (error_0.message.includes("fetch")) {
        return "Unable to connect to the server. Please check your internet connection and try again.";
    }
    if (error_0.message.includes("404")) {
        return "The requested student data could not be found.";
    }
    if (error_0.message.includes("403")) {
        return "You do not have permission to view this student data.";
    }
    if (error_0.message.includes("500")) {
        return "A server error occurred. Please try again later.";
    }
    return "An unexpected error occurred while loading student data.";
}
var _c;
...
//# sourceMappingURL=src_11d64650._.js.map