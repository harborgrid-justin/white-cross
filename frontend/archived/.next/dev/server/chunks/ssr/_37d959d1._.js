...
/**
 * Get authentication token with production-grade token management
 * Uses identity-access infrastructure for secure token retrieval
 */ async function getAuthToken() {
    try {
        // First try to get token from cookies (server-side auth)
        const cookieStore = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cookies"])();
        const cookieToken = cookieStore.get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$identity$2d$access$2f$lib$2f$config$2f$cookies$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["COOKIE_NAMES"].ACCESS_TOKEN)?.value;
        if (cookieToken) {
            return cookieToken;
        }
        // Fallback to identity-access token security manager (client-side auth)
...
//# sourceMappingURL=_37d959d1._.js.map