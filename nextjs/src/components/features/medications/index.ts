/**
 * Medications Feature Components
 *
 * All components related to medication management functionality.
 */

// Tab Components from components/medications/tabs
export { default as MedicationsOverviewTab } from '../../medications/tabs/MedicationsOverviewTab'
export { default as MedicationsListTab } from '../../medications/tabs/MedicationsListTab'
export { default as MedicationsInventoryTab } from '../../medications/tabs/MedicationsInventoryTab'
