 ...
 * @module app/(dashboard)/students/[id]/medications/[medicationId]
 *
...
export default async function StudentMedicationDetailPage({ params }: StudentMedicationDetailPageProps) {
  const data = await getStudentMedication(params.id, params.medicationId);
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <Link
          href={`/students/${params.id}/medications/${params.medicationId}/administer`}
