 ...
 * @module app/(dashboard)/students/[studentId]/medications
 *
...
export default async function StudentMedicationsPage({ params, searchParams }: StudentMedicationsPageProps) {
  const data = await getStudentMedications(params.studentId, searchParams);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        backLink={`/students/${params.studentId}`}
        backLabel="Back to Student"
      >
        <Link
          href={`/students/${params.studentId}/medications/new`}
